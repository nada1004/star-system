...
const _DEFAULT_CATSECS = {
  ...
  '🖼️ 스트리머/프로필':['b2layout','imgsettings','imgmodalsettings','profileshape','univlogoimg','si','siAssign','pdModeBadge','pd','matchdetail','streamerheader','streamer-view','tierrank-view'],
  '🧾 카드/기록':['reccard','tourneycard','procompcard','h2hpanel','minicard','univckcard','univmcard','tiertourcard','tiertourleaguecard','tiertourbrackcard','procompleaguecard','procompteamcard','procompgjcard','sharecard','calui'],
  '🎨 UI/테마':['designv2','designv2-colors','hdr','appfont','uisize','uibtn','uifilter','tablabels','tabcolors','autofitall'],
  ...
  try{
    ...
    if(!open){
      ...
      document.querySelectorAll('[data-cfg-sec]').forEach(el=>{
        ...
        if(_alwaysVisible.has(secId)) return; // 핵심 섹션 항상 유지
...
(function(){
  ...
  function _lazyCheckFbSyncStatus(){
    try{
      ...
      loader('js/cloud-board.js?v=20260717-ds01').then(()=>{
  ...
  function _lazyRCal(C, T){
    try{
      ...
      loader('js/calendar.js?v=20260717-ds01').then(()=>{
  ...
  function _lazyRStats(C, T){
    try{
      ...
      Promise.resolve().then(()=>ensureChart()).then(()=>loader('js/stats-core-utils.js?v=20260503-02')).then(()=>loader('js/stats-tier-rank-utils.js?v=20260503-01')).then(()=>loader('js/stats-heatmap-utils.js?v=20260503-01')).then(()=>loader('js/stats-period-utils.js?v=20260503-01')).then(()=>loader('js/stats-period-renderer.js?v=20260717-ds01')).then(()=>loader('js/stats-tierwin-renderer.js?v=20260717-ds01')).then(()=>loader('js/stats-heatmap-renderer.js?v=20260717-ds01')).then(()=>loader('js/stats-maprank-renderer.js?v=20260717-ds01')).then(()=>loader('js/stats-univmatrix-renderer.js?v=20260717-ds01')).then(()=>loader('js/stats-advanced-renderers.js?v=20260717-ds01')).then(()=>loader('js/stats-export-utils.js?v=20260717-ds01')).then(()=>loader('js/sharecard-normalize.js?v=20260717-ds01')).then(()=>loader('js/sharecard-theme.js?v=20260717-ds01')).then(()=>loader('js/sharecard-team.js?v=20260717-ds01')).then(()=>loader('js/sharecard-runtime.js?v=20260717-ds01')).then(()=>loader('js/sharecard-render-entity.js?v=20260717-ds01')).then(()=>loader('js/sharecard-render-match-helpers.js?v=20260717-ds01')).then(()=>loader('js/sharecard-render-match-score.js?v=20260717-ds01')).then(()=>loader('js/sharecard-render-match-layout.js?v=20260717-ds01')).then(()=>loader('js/sharecard-render-match-shell.js?v=20260717-ds01')).then(()=>loader('js/sharecard-render-match-sections.js?v=20260717-ds01')).then(()=>loader('js/sharecard-render-match-context.js?v=20260717-ds01')).then(()=>loader('js/sharecard-render-match-utils.js?v=20260717-ds01')).then(()=>loader('js/sharecard-render-match-pipeline.js?v=20260717-ds01')).then(()=>loader('js/sharecard-match-openers.js?v=20260717-ds01')).then(()=>loader('js/stats.js?v=' + (window.SU_STATS_JS_V || '20260516-01'))).then(()=>{
