...
(function _prInjectCss(){
  ...
  s.textContent = [
    ...
    '.pr-level-badge{display:inline-flex;align-items:center;gap:7px;padding:5px 12px 5px 10px;border-radius:999px;border:1.5px solid;line-height:1}',
    '.pr-level-grade{font-size:17px;font-weight:950;letter-spacing:-.01em}',
