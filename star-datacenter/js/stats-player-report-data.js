...
(function _prInjectCss(){
  ...
  s.textContent = [
    ...
    '.pr-level-badge{position:relative;display:inline-flex;align-items:center;gap:9px;padding:6px 14px 6px 6px;border-radius:999px;border:1.5px solid;line-height:1;background:linear-gradient(135deg,rgba(255,255,255,.9),rgba(255,255,255,.55));backdrop-filter:blur(2px);box-shadow:0 1px 2px rgba(15,23,42,.05)}',
    '.pr-level-gradebox{display:inline-flex;align-items:center;justify-content:center;width:26px;height:26px;border-radius:9px;font-size:14px;font-weight:950;color:#fff;flex-shrink:0;box-shadow:0 2px 6px rgba(0,0,0,.22),inset 0 1px 0 rgba(255,255,255,.35)}',
    '.pr-level-info{display:flex;flex-direction:column;gap:3px;min-width:64px}',
    '.pr-level-num{font-size:12.5px;font-weight:900;letter-spacing:-.01em;color:var(--text1)}',
    '.pr-level-bar{width:56px;height:6px;border-radius:999px;background:var(--border2);overflow:hidden;display:inline-block;box-shadow:inset 0 1px 1.5px rgba(0,0,0,.12)}',
    '.pr-level-bar-fill{display:block;height:100%;border-radius:999px;background-image:linear-gradient(90deg,rgba(255,255,255,.35),rgba(255,255,255,0));transition:width .25s ease}',
    'body.dark .pr-level-badge{background:linear-gradient(135deg,rgba(30,41,59,.75),rgba(30,41,59,.4))}',
