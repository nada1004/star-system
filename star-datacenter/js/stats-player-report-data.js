...
(function _prInjectCss(){
  ...
  s.textContent = [
    ...
    '.pr-recent-chip:hover{background:color-mix(in srgb, var(--pr-accent,var(--blue)) calc(12% * var(--pr-intensity,1)), white);border-color:var(--pr-accent,var(--blue));color:var(--pr-accent,var(--blue))}',
    ...
    '#pr-report-capture{background:color-mix(in srgb, var(--pr-accent,var(--blue)) calc(4% * var(--pr-intensity,1)), transparent);border-radius:22px}',
    '#pr-report-capture .pr-hero{background:color-mix(in srgb, var(--pr-accent,var(--blue)) calc(16% * var(--pr-intensity,1)), var(--white));border-color:color-mix(in srgb, var(--pr-accent,var(--blue)) calc(34% * var(--pr-intensity,1)), var(--border))}',
    '#pr-report-capture .ssec{background:color-mix(in srgb, var(--pr-accent,var(--blue)) calc(6% * var(--pr-intensity,1)), var(--white))}',
    ...
    '#pr-report-capture .pr-info-card{background:color-mix(in srgb, var(--pr-accent,var(--blue)) calc(10% * var(--pr-intensity,1)), var(--white));border-color:color-mix(in srgb, var(--pr-accent,var(--blue)) calc(22% * var(--pr-intensity,1)), var(--border))}',
    '#pr-report-capture .pr-wr-card{background:color-mix(in srgb, var(--pr-accent,var(--blue)) calc(9% * var(--pr-intensity,1)), var(--white));border-color:color-mix(in srgb, var(--pr-accent,var(--blue)) calc(22% * var(--pr-intensity,1)), var(--border))}',
    '#pr-report-capture .pr-gauge-ring::before{background:color-mix(in srgb, var(--pr-accent,var(--blue)) calc(9% * var(--pr-intensity,1)), var(--white))}',
    '#pr-report-capture .pr-chip-neutral{background:color-mix(in srgb, var(--pr-accent,var(--blue)) calc(10% * var(--pr-intensity,1)), var(--white))}',
    '#pr-report-capture .pr-mtrend-summary,#pr-report-capture .pr-mode-legend{background:color-mix(in srgb, var(--pr-accent,var(--blue)) calc(7% * var(--pr-intensity,1)), var(--white))}',
    '#pr-report-capture .pr-empty-sec{background:color-mix(in srgb, var(--pr-accent,var(--blue)) calc(6% * var(--pr-intensity,1)), var(--white))}',
    ...
    '#pr-report-capture .pr-btn:not(.pr-btn-primary){background:color-mix(in srgb, var(--pr-accent,var(--blue)) calc(7% * var(--pr-intensity,1)), var(--white))}',
    '#pr-report-capture .pr-btn:not(.pr-btn-primary):hover{background:color-mix(in srgb, var(--pr-accent,var(--blue)) calc(16% * var(--pr-intensity,1)), var(--white))}',
    '#pr-report-capture .pr-btn.pr-btn-ghost{background:color-mix(in srgb, var(--pr-accent,var(--blue)) calc(6% * var(--pr-intensity,1)), transparent)}',
    '#pr-report-capture .pr-nav-chip{background:color-mix(in srgb, var(--pr-accent,var(--blue)) calc(7% * var(--pr-intensity,1)), var(--white))}',
    '#pr-report-capture .pr-period-btn:not(.on){background:color-mix(in srgb, var(--pr-accent,var(--blue)) calc(7% * var(--pr-intensity,1)), var(--white))}',
    /* 최근 경기 리스트도 흰 배경만 있지 않도록 대학색 옅은 톤을 행 배경에 적용(행 자체 인라인 배경보다 우선되도록 !important) */
    '#pr-report-capture .pr-recent-table tbody tr.pd-hist-row{background:color-mix(in srgb, var(--pr-accent,var(--blue)) calc(5% * var(--pr-intensity,1)), var(--white))!important}',
    '#pr-report-capture .pr-recent-table tbody tr.pd-hist-row:hover{background:color-mix(in srgb, var(--pr-accent,var(--blue)) calc(14% * var(--pr-intensity,1)), var(--white))!important}',
    'body.dark #pr-report-capture{background:color-mix(in srgb, var(--pr-accent,var(--blue)) calc(7% * var(--pr-intensity,1)), transparent)}',
    'body.dark #pr-report-capture .pr-hero{background:color-mix(in srgb, var(--pr-accent,var(--blue)) calc(28% * var(--pr-intensity,1)), #1e293b);border-color:color-mix(in srgb, var(--pr-accent,var(--blue)) calc(40% * var(--pr-intensity,1)), rgba(148,163,184,.16))}',
    'body.dark #pr-report-capture .ssec{background:color-mix(in srgb, var(--pr-accent,var(--blue)) calc(13% * var(--pr-intensity,1)), #1e293b)}',
    'body.dark #pr-report-capture .pr-info-card,body.dark #pr-report-capture .pr-wr-card{background:color-mix(in srgb, var(--pr-accent,var(--blue)) calc(16% * var(--pr-intensity,1)), #1e293b);border-color:color-mix(in srgb, var(--pr-accent,var(--blue)) calc(28% * var(--pr-intensity,1)), #2d3f55)}',
    'body.dark #pr-report-capture .pr-gauge-ring::before{background:color-mix(in srgb, var(--pr-accent,var(--blue)) calc(16% * var(--pr-intensity,1)), #1e293b)}',
    'body.dark #pr-report-capture .pr-chip-neutral,body.dark #pr-report-capture .pr-mtrend-summary,body.dark #pr-report-capture .pr-mode-legend,body.dark #pr-report-capture .pr-empty-sec{background:color-mix(in srgb, var(--pr-accent,var(--blue)) calc(14% * var(--pr-intensity,1)), #1e293b)}',
    'body.dark #pr-report-capture .pr-btn:not(.pr-btn-primary){background:color-mix(in srgb, var(--pr-accent,var(--blue)) calc(12% * var(--pr-intensity,1)), #1e293b)}',
    'body.dark #pr-report-capture .pr-btn:not(.pr-btn-primary):hover{background:color-mix(in srgb, var(--pr-accent,var(--blue)) calc(22% * var(--pr-intensity,1)), #1e293b)}',
    'body.dark #pr-report-capture .pr-nav-chip,body.dark #pr-report-capture .pr-period-btn:not(.on){background:color-mix(in srgb, var(--pr-accent,var(--blue)) calc(12% * var(--pr-intensity,1)), #1e293b)}',
    'body.dark #pr-report-capture .pr-recent-table tbody tr.pd-hist-row{background:color-mix(in srgb, var(--pr-accent,var(--blue)) calc(12% * var(--pr-intensity,1)), #1e293b)!important}',
    'body.dark #pr-report-capture .pr-recent-table tbody tr.pd-hist-row:hover{background:color-mix(in srgb, var(--pr-accent,var(--blue)) calc(20% * var(--pr-intensity,1)), #1e293b)!important}',
    /* ── 스트리머 리포트 전체 테마 (설정탭 "🎨 리포트 색상 & 효과" > 리포트 전체 테마에서 선택) ──
       data-pr-theme 속성으로 전환. 위 기본(연한 톤) 규칙 뒤에 와서 같은 클래스 조합에서 우선 적용됨. ── */
    '#pr-report-capture[data-pr-theme="vivid"]{background:color-mix(in srgb, var(--pr-accent,var(--blue)) calc(9% * var(--pr-intensity,1)), transparent)}',
    '#pr-report-capture[data-pr-theme="vivid"] .pr-hero{background:color-mix(in srgb, var(--pr-accent,var(--blue)) calc(30% * var(--pr-intensity,1)), var(--white))!important;border-color:color-mix(in srgb, var(--pr-accent,var(--blue)) calc(55% * var(--pr-intensity,1)), var(--border))!important}',
    '#pr-report-capture[data-pr-theme="vivid"] .ssec{background:color-mix(in srgb, var(--pr-accent,var(--blue)) calc(15% * var(--pr-intensity,1)), var(--white))}',
    '#pr-report-capture[data-pr-theme="vivid"] .pr-info-card,#pr-report-capture[data-pr-theme="vivid"] .pr-wr-card{background:color-mix(in srgb, var(--pr-accent,var(--blue)) calc(22% * var(--pr-intensity,1)), var(--white));border-color:color-mix(in srgb, var(--pr-accent,var(--blue)) calc(40% * var(--pr-intensity,1)), var(--border))}',
    'body.dark #pr-report-capture[data-pr-theme="vivid"] .pr-hero{background:color-mix(in srgb, var(--pr-accent,var(--blue)) calc(36% * var(--pr-intensity,1)), #1e293b)!important;border-color:color-mix(in srgb, var(--pr-accent,var(--blue)) calc(46% * var(--pr-intensity,1)), rgba(148,163,184,.16))!important}',
    'body.dark #pr-report-capture[data-pr-theme="vivid"] .ssec{background:color-mix(in srgb, var(--pr-accent,var(--blue)) calc(24% * var(--pr-intensity,1)), #1e293b)}',
    'body.dark #pr-report-capture[data-pr-theme="vivid"] .pr-info-card,body.dark #pr-report-capture[data-pr-theme="vivid"] .pr-wr-card{background:color-mix(in srgb, var(--pr-accent,var(--blue)) calc(28% * var(--pr-intensity,1)), #1e293b);border-color:color-mix(in srgb, var(--pr-accent,var(--blue)) calc(42% * var(--pr-intensity,1)), #2d3f55)}',
    '#pr-report-capture[data-pr-theme="glass"] .pr-hero,#pr-report-capture[data-pr-theme="glass"] .ssec,#pr-report-capture[data-pr-theme="glass"] .pr-info-card,#pr-report-capture[data-pr-theme="glass"] .pr-wr-card{background:color-mix(in srgb, var(--pr-accent,var(--blue)) calc(10% * var(--pr-intensity,1)), rgba(255,255,255,.55))!important;backdrop-filter:blur(14px) saturate(1.3);-webkit-backdrop-filter:blur(14px) saturate(1.3);border:1px solid color-mix(in srgb, var(--pr-accent,var(--blue)) calc(30% * var(--pr-intensity,1)), rgba(255,255,255,.6))!important;box-shadow:0 8px 32px color-mix(in srgb, var(--pr-accent,var(--blue)) calc(18% * var(--pr-intensity,1)), transparent)!important}',
    'body.dark #pr-report-capture[data-pr-theme="glass"] .pr-hero,body.dark #pr-report-capture[data-pr-theme="glass"] .ssec,body.dark #pr-report-capture[data-pr-theme="glass"] .pr-info-card,body.dark #pr-report-capture[data-pr-theme="glass"] .pr-wr-card{background:color-mix(in srgb, var(--pr-accent,var(--blue)) calc(22% * var(--pr-intensity,1)), rgba(15,23,42,.55))!important;border-color:color-mix(in srgb, var(--pr-accent,var(--blue)) calc(38% * var(--pr-intensity,1)), rgba(148,163,184,.25))!important}',
    '#pr-report-capture[data-pr-theme="outline"] .pr-hero{background:var(--white)!important;border:2px solid var(--pr-accent,var(--blue))!important}',
    '#pr-report-capture[data-pr-theme="outline"] .ssec,#pr-report-capture[data-pr-theme="outline"] .pr-info-card,#pr-report-capture[data-pr-theme="outline"] .pr-wr-card{background:var(--white)!important;border:1.5px solid color-mix(in srgb, var(--pr-accent,var(--blue)) calc(55% * var(--pr-intensity,1)), rgba(148,163,184,.3))!important}',
    'body.dark #pr-report-capture[data-pr-theme="outline"] .pr-hero,body.dark #pr-report-capture[data-pr-theme="outline"] .ssec,body.dark #pr-report-capture[data-pr-theme="outline"] .pr-info-card,body.dark #pr-report-capture[data-pr-theme="outline"] .pr-wr-card{background:#1e293b!important;border-color:var(--pr-accent,var(--blue))!important}',
    '#pr-report-capture[data-pr-theme="minimal"]{background:transparent!important}',
    '#pr-report-capture[data-pr-theme="minimal"] .pr-hero{background:var(--white)!important;border:1px solid var(--border)!important;border-left:4px solid var(--pr-accent,var(--blue))!important}',
    '#pr-report-capture[data-pr-theme="minimal"] .ssec,#pr-report-capture[data-pr-theme="minimal"] .pr-info-card,#pr-report-capture[data-pr-theme="minimal"] .pr-wr-card{background:var(--white)!important;border-color:var(--border)!important}',
    'body.dark #pr-report-capture[data-pr-theme="minimal"] .pr-hero,body.dark #pr-report-capture[data-pr-theme="minimal"] .ssec,body.dark #pr-report-capture[data-pr-theme="minimal"] .pr-info-card,body.dark #pr-report-capture[data-pr-theme="minimal"] .pr-wr-card{background:#1e293b!important;border-color:#334155!important}',
    '#pr-report-capture[data-pr-theme="neon"] .pr-hero{background:linear-gradient(135deg,#0f172a,#1e293b)!important;border:1px solid var(--pr-accent,var(--blue))!important;box-shadow:0 0 0 1px color-mix(in srgb, var(--pr-accent,var(--blue)) calc(60% * var(--pr-intensity,1)), transparent),0 0 30px color-mix(in srgb, var(--pr-accent,var(--blue)) calc(45% * var(--pr-intensity,1)), transparent)!important}',
    '#pr-report-capture[data-pr-theme="neon"] .pr-hero .pr-hero-name{color:var(--pr-accent,var(--blue))!important;text-shadow:0 0 10px color-mix(in srgb, var(--pr-accent,var(--blue)) calc(80% * var(--pr-intensity,1)), transparent),0 0 22px color-mix(in srgb, var(--pr-accent,var(--blue)) calc(55% * var(--pr-intensity,1)), transparent)}',
    '#pr-report-capture[data-pr-theme="neon"] .pr-hero .pr-hero-wr-sub,#pr-report-capture[data-pr-theme="neon"] .pr-hero .rbadge{color:#cbd5e1!important}',
    '#pr-report-capture[data-pr-theme="neon"] .pr-chip-neutral{background:rgba(255,255,255,.08)!important;color:#e2e8f0!important}',
    '#pr-report-capture[data-pr-theme="neon"] .ssec{border-color:color-mix(in srgb, var(--pr-accent,var(--blue)) calc(45% * var(--pr-intensity,1)), var(--border))!important;box-shadow:0 0 16px color-mix(in srgb, var(--pr-accent,var(--blue)) calc(14% * var(--pr-intensity,1)), transparent)}',
    '#pr-report-capture[data-pr-theme="fade"] .pr-hero{background:linear-gradient(120deg,color-mix(in srgb, var(--pr-accent,var(--blue)) calc(85% * var(--pr-intensity,1)), black 6%) 0%,color-mix(in srgb, var(--pr-accent,var(--blue)) calc(45% * var(--pr-intensity,1)), white) 45%,color-mix(in srgb, var(--pr-accent,var(--blue)) calc(6% * var(--pr-intensity,1)), white) 100%)!important;border-color:color-mix(in srgb, var(--pr-accent,var(--blue)) calc(60% * var(--pr-intensity,1)), transparent)!important}',
    '#pr-report-capture[data-pr-theme="fade"] .pr-hero .pr-hero-name,#pr-report-capture[data-pr-theme="fade"] .pr-hero .pr-hero-wr-sub,#pr-report-capture[data-pr-theme="fade"] .pr-hero .rbadge{color:#fff!important;text-shadow:0 1px 3px rgba(0,0,0,.35)}',
    '#pr-report-capture[data-pr-theme="fade"] .pr-hero .pr-chip-neutral{background:rgba(255,255,255,.16)!important;color:#fff!important}',
    '#pr-report-capture[data-pr-theme="fade"] .ssec{background:linear-gradient(160deg,color-mix(in srgb, var(--pr-accent,var(--blue)) calc(30% * var(--pr-intensity,1)), var(--white)) 0%,var(--white) 70%)!important;border-color:color-mix(in srgb, var(--pr-accent,var(--blue)) calc(30% * var(--pr-intensity,1)), var(--border))!important}',
    '#pr-report-capture[data-pr-theme="fade"] .pr-info-card,#pr-report-capture[data-pr-theme="fade"] .pr-wr-card{background:linear-gradient(160deg,color-mix(in srgb, var(--pr-accent,var(--blue)) calc(38% * var(--pr-intensity,1)), var(--white)) 0%,var(--white) 80%)!important}',
    'body.dark #pr-report-capture[data-pr-theme="fade"] .ssec{background:linear-gradient(160deg,color-mix(in srgb, var(--pr-accent,var(--blue)) calc(38% * var(--pr-intensity,1)), #1e293b) 0%,#1e293b 70%)!important}',
    'body.dark #pr-report-capture[data-pr-theme="fade"] .pr-info-card,body.dark #pr-report-capture[data-pr-theme="fade"] .pr-wr-card{background:linear-gradient(160deg,color-mix(in srgb, var(--pr-accent,var(--blue)) calc(46% * var(--pr-intensity,1)), #1e293b) 0%,#1e293b 80%)!important}',
    ...
    'body.dark .pr-recent-chip:hover,body.dark .pr-nav-chip:hover{background:color-mix(in srgb, var(--pr-accent,var(--blue)) calc(20% * var(--pr-intensity,1)), transparent);border-color:var(--pr-accent,var(--blue));color:var(--pr-accent,var(--blue))}',
    ...
    '.pr-nav-chip:hover{background:color-mix(in srgb, var(--pr-accent,var(--blue)) calc(12% * var(--pr-intensity,1)), white);border-color:var(--pr-accent,var(--blue));color:var(--pr-accent,var(--blue))}',
    ...
    '.pr-nav-more[open] .pr-nav-more-btn{background:color-mix(in srgb, var(--pr-accent,var(--blue)) calc(12% * var(--pr-intensity,1)), white);border-color:var(--pr-accent,var(--blue));color:var(--pr-accent,var(--blue))}',
    ...
    /* ── 스트리머 리포트 메뉴 버튼(섹션 이동 칩) 전용 효과 ── */
    '.pr-nav-chip.prfx-nav-glow:hover{box-shadow:0 0 12px 2px color-mix(in srgb, var(--pr-accent,var(--blue)) 55%, transparent)}',
    '.pr-nav-chip.prfx-nav-fill{transition:background .15s,color .15s,transform .12s}',
    '.pr-nav-chip.prfx-nav-fill:hover{background:var(--pr-accent,var(--blue))!important;color:#fff!important;border-color:var(--pr-accent,var(--blue))!important}',
    '.pr-nav-chip.prfx-nav-underline{position:relative;overflow:hidden}',
    '.pr-nav-chip.prfx-nav-underline::after{content:"";position:absolute;left:50%;bottom:2px;width:0;height:2px;background:var(--pr-accent,var(--blue));transition:width .18s ease,left .18s ease}',
    '.pr-nav-chip.prfx-nav-underline:hover::after{left:14%;width:72%}',
    '.pr-nav-chip.prfx-nav-bounce:hover{animation:prfxNavBounce .4s ease}',
    '.pr-nav-chip.prfx-nav-outline{background:transparent!important;border:1.5px solid var(--pr-accent,var(--blue))!important;color:var(--pr-accent,var(--blue))!important}',
    '@keyframes prfxNavBounce{0%,100%{transform:translateY(0)}40%{transform:translateY(-4px)}70%{transform:translateY(1px)}}'
  ].join('\n');
...
function _prNormalizeBrandColor(hex){
  ...
  // (2026-08-19) 채도/명도를 임의 범위로 강제 조정하던 로직 제거 — 이렇게 하면
  // 실제 설정된 대학색과 다른 색(더 쨍하거나, 더 어둡거나)으로 보이는 문제가 있었음.
  // hue는 그대로 고정(중간 톤 탁해짐 방지)하되, 채도·명도는 실제 대학색 값을 그대로 사용.
  // 카드 배경 위에서 완전히 안 보이는 극단값만 아주 살짝 보정.
  l = Math.max(10, Math.min(l, 88));
  return { h, s, l };
}
