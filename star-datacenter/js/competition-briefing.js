...
function _cbInjectShellStyle(){
  ...
  s.textContent=[
    /* === 액센트 토큰 (따뜻한 파스텔, 라이트) === */
    '.cbs-wrap.tone-mt{--cbs-accent:#0d9488;--cbs-accent-2:#14b8a6;--cbs-accent-soft:#99f6e4;--cbs-accent-bg:#ecfdf5;--cbs-glow:rgba(20,184,166,.28);--cbs-paper:#f1f5f9;--cbs-paper-2:#eef2f6;--cbs-paper-3:#e2e8f0;--cbs-ink:#0f172a;--cbs-ink-mid:#475569;--cbs-ink-soft:#64748b;--cbs-ink-mute:#94a3b8;--cbs-rule:#cbd5e1;--cbs-rule-2:#e2e8f0;--cbs-card:#f0f7fc}',
    '.cbs-wrap.tone-pc{--cbs-accent:#ea580c;--cbs-accent-2:#f97316;--cbs-accent-soft:#fed7aa;--cbs-accent-bg:#fff7ed;--cbs-glow:rgba(249,115,22,.28);--cbs-paper:#f1f5f9;--cbs-paper-2:#eef2f6;--cbs-paper-3:#e2e8f0;--cbs-ink:#0f172a;--cbs-ink-mid:#475569;--cbs-ink-soft:#64748b;--cbs-ink-mute:#94a3b8;--cbs-rule:#cbd5e1;--cbs-rule-2:#e2e8f0;--cbs-card:#f0f7fc}',
    '.cbs-wrap.tone-lv{--cbs-accent:#0369a1;--cbs-accent-2:#0ea5e9;--cbs-accent-soft:#bae6fd;--cbs-accent-bg:#f0f9ff;--cbs-glow:rgba(3,105,161,.28);--cbs-paper:#f1f5f9;--cbs-paper-2:#eef2f6;--cbs-paper-3:#e2e8f0;--cbs-ink:#0f172a;--cbs-ink-mid:#475569;--cbs-ink-soft:#64748b;--cbs-ink-mute:#94a3b8;--cbs-rule:#cbd5e1;--cbs-rule-2:#e2e8f0;--cbs-card:#f0f7fc}',
    /* === 컨테이너 (종이톤 — 좌측 띠 제거) === */
