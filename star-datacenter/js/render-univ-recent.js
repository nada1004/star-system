...
function buildUnivRecentMatchesHTML(opts){
  ...
  recent.forEach((m, idx) => {
    ...
    const resultBg = win?'linear-gradient(135deg,#dcfce7,#bbf7d0)':draw?'linear-gradient(135deg,#fef9c3,#fde68a)':'linear-gradient(135deg,#fee2e2,#fecaca)';
    const resultCol = win?'#16a34a':draw?'#d97706':'#dc2626';
    const resultBd = win?'#86efac':draw?'#fcd34d':'#fca5a5';
    const leftBarColor = win?'#16a34a':draw?'#f59e0b':'#dc2626';
