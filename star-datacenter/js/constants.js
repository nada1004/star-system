...
══════════════════════════════════════ */
const MAIN_ROLES = ['이사장','선장','동아리장','동아리 회장','반장','총장','부총장','총괄','교수','코치'];
const ROLE_ICONS = {'이사장':'👔','선장':'⚓','동아리장':'🏅','동아리 회장':'🏅','반장':'📋','총장':'🎓','부총장':'📚','총괄':'🏛️','교수':'🏫','코치':'🎯'};
const ROLE_COLORS = {'이사장':'#6d28d9','선장':'#0369a1','동아리장':'#0f766e','동아리 회장':'#0f766e','반장':'#7c3aed','총장':'#b91c1c','부총장':'#b45309','총괄':'#0c6e9e','교수':'#1d4ed8','코치':'#0e7490'};
