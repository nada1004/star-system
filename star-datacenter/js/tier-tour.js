...
function rCfg(C,T){
  ...
  <div class="ssec"><h4>🎨 현황판 설정</h4>
    ...
    <div style="display:flex;align-items:center;gap:20px;flex-wrap:wrap;margin-top:16px;padding-top:16px;border-top:1px solid var(--border2)">
      <div style="display:flex;align-items:center;gap:8px">
        <span style="font-size:13px;font-weight:700;color:var(--text2);min-width:80px">👤 프로필 배경</span>
...
window.openEP=function(name){
  ...
  document.getElementById('emBody').innerHTML=`
    ...
    <label>🎬 두번째 프로필 URL <span style="font-size:10px;font-weight:400;color:var(--gray-l)">(1초 후 자동 전환 · GIF/비디오)</span></label>
    <input type="text" id="ed-video" value="${p.videoFile||''}" placeholder="https://... GIF 또는 비디오 URL 입력" style="width:100%">
    <div style="font-size:10px;color:var(--gray-l);margin-top:-6px">현황판 프로필 탭과 스트리머 상세에서 1초 후 두번째 프로필(GIF/비디오)로 자동 전환됩니다.</div>
