...
(function _injectStreamerTabUiStyle(){
  ...
  s.textContent=[
    ...
    '.streamer-focus-card-name{font-size:12.5px;font-weight:950;color:#fff;letter-spacing:-.02em;overflow:hidden;text-overflow:ellipsis;white-space:nowrap;text-shadow:0 2px 8px rgba(0,0,0,.4)}',
    '.streamer-focus-card-sub{font-size:10.5px;font-weight:800;color:rgba(255,255,255,.86);overflow:hidden;text-overflow:ellipsis;white-space:nowrap;text-shadow:0 1px 4px rgba(0,0,0,.4)}',
    ...
    '.streamer-shell[data-st-layout="cozy"] .streamer-avatar{width:60px;height:60px}',
