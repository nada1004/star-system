...
async function _ensureRouletteLoaded(){
  const scripts=[
    ...
    'js/roulette.js?v=20260715-01',
    'js/team-match-game.js?v=20260715-01',
    'js/tier-match-game.js?v=20260715-01',
    'js/photo-quiz-game.js?v=20260715-01',
...
async function _ensureStatsLoaded(){
  ...
  await _loadScriptOnce('js/heatmap-day-popup.js?v=20260630-01');
