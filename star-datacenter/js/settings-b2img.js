...
const _DEFAULT_CATSECS = {
  ...
  '🖼️ 스트리머/프로필':['b2layout','imgsettings','b2trans','imgmodalsettings','profileshape','univlogoimg','si','siAssign','pdModeBadge','pd','matchdetail','ud','streamerheader','streamerchannel','streamer-view','streamer-tab-style','reportstyle'],
  '🧾 카드/기록':[
