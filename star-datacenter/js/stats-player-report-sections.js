...
function _prRecentTableHTML(p){
  ...
  let h=`<div class="pr-recent-table" style="border:1px solid var(--border);border-radius:var(--r);overflow:hidden">
    <table style="margin:0;border:none;width:100%"><thead><tr><th style="width:86px">날짜</th><th style="width:88px">종류</th><th style="width:66px">결과</th><th style="width:122px">대학</th><th style="width:130px">상대</th><th style="width:60px;padding-left:0px">종족</th><th class="ph-col-map" style="width:104px">맵</th><th class="ph-col-elo" style="width:66px">ELO</th></tr></thead><tbody>`;
  shown.forEach(hh=>{
