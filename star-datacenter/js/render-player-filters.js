...
function buildPlayerHistFilterBar(opts){
  ...
  return `<div style="display:flex;gap:4px;flex-wrap:wrap;margin:0 0 8px;align-items:center">
...
function buildPlayerYearFilterBar(opts){
  ...
  return `<div style="display:flex;align-items:center;gap:6px;flex-wrap:wrap;margin:0 0 10px;padding:${isMobile?'5px 7px':'6px 8px'};background:var(--surface);border:1px solid var(--border);border-radius:10px">
