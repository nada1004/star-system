...
(function _omInjectCSS() {
  ...
  s.textContent = [
    ...
    '.om-board{position:relative;width:100%;max-width:560px;aspect-ratio:1/1;display:grid;grid-template-columns:repeat(var(--om-size),1fr);background:linear-gradient(160deg,#e8c583,#d9a85a);border-radius:16px;padding:9px;box-shadow:0 16px 34px rgba(120,80,20,.28),inset 0 2px 4px rgba(255,255,255,.35);touch-action:manipulation}',
    ...
    '.om-ghost{position:absolute;inset:14%;border-radius:50%;background:var(--om-my-color,#334155);opacity:0;pointer-events:none;transition:.1s}',
    '.om-stone{position:absolute;inset:7%;border-radius:50%;overflow:hidden;box-shadow:0 3px 6px rgba(0,0,0,.35),inset 0 0 0 2.5px rgba(255,255,255,.85);animation:omDropIn .22s ease both;background:#e2e8f0}',
    ...
    '.om-result-title{font-size:clamp(20px,4.4vw,28px);font-weight:900;color:#1e293b;margin:4px 0 4px}',
