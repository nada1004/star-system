          ...
          <table style="min-width:300px;table-layout:fixed">
            ...
            <tbody>
              ...
              ${(()=>{
                ...
                return '<tr><td style="text-align:right;padding:5px 10px">'+(recentForm(pA))+'</td><td style="text-align:center;padding:5px 6px;color:var(--gray-l);font-size:11px">최근5경기</td><td style="text-align:left;padding:5px 10px">'+(recentForm(pB))+'</td></tr>';
              })()}
              ${(()=>{
                ...
                if(!rwA&&!rwB) return '';
                return '<tr><td style="text-align:right;padding:5px 10px;font-size:11px">'+(rwA||'-')+'</td><td style="text-align:center;padding:5px 6px;color:var(--gray-l);font-size:11px">종족별승률</td><td style="text-align:left;padding:5px 10px;font-size:11px">'+(rwB||'-')+'</td></tr>';
              })()}
            </tbody>
          </table>
        </div>
