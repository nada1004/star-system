function rHist(C,T){
  ...
  if(histSub==='all') h+=histAllHTML();
    ...
    // (요청, 2026-08-10) 대회 탭: 기본 / 그리드 / 컴팩트 테이블형
    ...
    if(typeof compAltTitleModeBarHTML==='function'){
      h+=compAltTitleModeBarHTML('histtourney','🎖️ 대회 기록',{bg:'#eff6ff',bd:'#bfdbfe',col:'#2563eb',modes:['basic','mini','grid','compact']});
    }
    ...
    // (요청, 2026-08-10) 티어대회 탭: 기본 / 그리드 / 컴팩트 테이블형
    ...
    if(typeof compAltTitleModeBarHTML==='function'){
      ...
      h+=compAltTitleModeBarHTML('histtt',_ttTitle,{bg:'#ecfdf5',bd:'#86efac',col:'#059669',modes:['basic','mini','grid','compact']});
    }
