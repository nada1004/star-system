...
function statsUnivCompareHTML() {
  ...
  const _svcInjectStyle = () => {
    ...
    s.textContent = [
      ...
      '.svc-pick-logo{width:44px;height:44px;border-radius:0;background:rgba(255,255,255,.35);display:flex;align-items:center;justify-content:center;overflow:visible;flex-shrink:0}',
      '.svc-pick-logo img{width:100%;height:100%;object-fit:contain}',
      ...
      '.svc-roster-avatar{width:48px;height:48px;border-radius:var(--su_profile_radius,50%);clip-path:var(--su_profile_clip,none);overflow:hidden;flex-shrink:0;display:flex;align-items:center;justify-content:center;font-size:16px;font-weight:900;color:#fff;margin-bottom:6px;box-shadow:0 0 0 2px #fff,0 0 0 3.5px var(--accent,transparent)}',
      ...
      'body.dark .svc-pick-logo{background:rgba(255,255,255,.08)}',
