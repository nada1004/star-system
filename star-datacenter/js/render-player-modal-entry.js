...
;(function _injectPlayerModalPremiumStyle(){
  ...
  s.textContent=[
    ...
    '#playerModal[data-pd-univbg-enabled="1"][data-pd-univbg-scope="cards"] .pd-elo-chart-card,#playerModal[data-pd-univbg-enabled="1"][data-pd-univbg-scope="cards"] .pd-mode-card,#playerModal[data-pd-univbg-enabled="1"][data-pd-univbg-scope="cards"] .pd-race-card,#playerModal[data-pd-univbg-enabled="1"][data-pd-univbg-scope="cards"] .pd-map-card,#playerModal[data-pd-univbg-enabled="1"][data-pd-univbg-scope="cards"] .pd-univ-card,#playerModal[data-pd-univbg-enabled="1"][data-pd-univbg-scope="cards"] .pd-memo-input,#playerModal[data-pd-univbg-enabled="1"][data-pd-univbg-scope="cards"] .pd-teammate-chip{background:var(--su-pd-card-bg)!important;border-color:var(--su-pd-card-border)!important}',
