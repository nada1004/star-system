...
(function(){
  ...
  function _catOf(k){
    ...
    if(k.includes('femco') || k.startsWith('su_board') || k==='su_boardOrder' || k==='su_old_board' || k.startsWith('su_board2') || k.startsWith('su_chip') || k.startsWith('su_b2mvp_') || k==='su_b2_briefing_theme' || k==='su_plb_briefing_theme' || k==='su_plgb_briefing_theme' || k==='su_pcb_briefing_theme' || k==='su_cb_briefing_theme') return 'board';
