  ...
  `:"",A=a("weekly","#f59e0b",typeof getTabLabel=="function"?getTabLabel("board2","weekly","\u{1F4C5} \uBE0C\uB9AC\uD551"):"\u{1F4C5} \uBE0C\uB9AC\uD551"),U=isLoggedIn?a("old","#64748b",typeof getTabLabel=="function"?getTabLabel("board2","old","\u{1F4CA} \uAD6C\uD604\uD669\uD310"):"\u{1F4CA} \uAD6C\uD604\uD669\uD310"):"",C=a("summary","#10b981",typeof getTabLabel=="function"?getTabLabel("board2","summary","\u{1F4CA} \uC694\uC57D"):"\u{1F4CA} \uC694\uC57D"),E=a("compare","#ef4444",typeof getTabLabel=="function"?getTabLabel("board2","compare","\u2694\uFE0F \uB300\uD559\uBE44\uAD50"):"\u2694\uFE0F \uB300\uD559\uBE44\uAD50"),H=a("ranking","#f97316",typeof getTabLabel=="function"?getTabLabel("board2","ranking","\u{1F947} \uB7AD\uD0B9"):"\u{1F947} \uB7AD\uD0B9"),V=a("radar","#a855f7",typeof getTabLabel=="function"?getTabLabel("board2","radar","\u{1F578}\uFE0F \uB808\uC774\uB354"):"\u{1F578}\uFE0F \uB808\uC774\uB354"),P=a("heatmap","#db2777",typeof getTabLabel=="function"?getTabLabel("board2","heatmap","\u{1F5FA}\uFE0F \uD788\uD2B8\uB9F5"):"\u{1F5FA}\uFE0F \uD788\uD2B8\uB9F5"),R=a("bubble","#0891b2",typeof getTabLabel=="function"?getTabLabel("board2","bubble","\u{1F310} \uBC84\uBE14\uB9F5"):"\u{1F310} \uBC84\uBE14\uB9F5"),z=d,j=_b2View==="players"?"#b2-nav.b2-nav-new { padding-top: 0; }":"",{fromN:D,toN:F}=_b2ThisWeekRange(),N=_b2DateNum;try{const e=(function(){try{return[miniM,univM,ckM,proM,ttM,comps,tourneys,proTourneys,indM,gjM].map(s=>Array.isArray(s)?s.length:0).join("|")}catch(l){return""}})();if(typeof window.__b2_hist_sig=="undefined"&&(window.__b2_hist_sig=""),window.__b2_hist_sig!==e&&typeof _rebuildAllPlayerHistoryCore=="function"){const l=e.split("|").some(b=>Number(b)>0),s=typeof players!="undefined"&&Array.isArray(players)?players.some(b=>Array.isArray(b==null?void 0:b.history)&&b.history.length):!1;l&&!s&&_rebuildAllPlayerHistoryCore(),window.__b2_hist_sig=e}}catch(e){}const w=(()=>{const e=new Set,l=f=>{const p=String(f||"").trim();p&&e.add(p)},s=f=>{(f||[]).forEach(p=>l(typeof p=="string"?p:(p==null?void 0:p.name)||p))},b=f=>{((f==null?void 0:f.sets)||[]).forEach(p=>{((p==null?void 0:p.games)||[]).forEach(c=>{l(c==null?void 0:c.playerA),l(c==null?void 0:c.playerB),l(c==null?void 0:c.a1),l(c==null?void 0:c.a2),l(c==null?void 0:c.b1),l(c==null?void 0:c.b2),l(c==null?void 0:c.a),l(c==null?void 0:c.b),s(c==null?void 0:c.teamA),s(c==null?void 0:c.teamB)})})},v=f=>{!Array.isArray(f)||!f.length||f.forEach(p=>{const c=N((p==null?void 0:p.d)||(p==null?void 0:p.date)||"");c<D||c>F||(l(p==null?void 0:p.wName),l(p==null?void 0:p.lName),b(p))})};v(typeof miniM!="undefined"?miniM:[]),v(typeof univM!="undefined"?univM:[]),v(typeof ckM!="undefined"?ckM:[]),v(typeof proM!="undefined"?proM:[]),v(typeof ttM!="undefined"?ttM:[]),v(typeof comps!="undefined"?comps:[]),v(typeof indM!="undefined"?indM:[]),v(typeof gjM!="undefined"?gjM:[]);const W=new Set(h.map(f=>String((f==null?void 0:f.name)||"").trim()).filter(Boolean));let _=0;return e.forEach(f=>{W.has(f)&&_++}),_})(),m={univ:{label:"\uB300\uD559\uBCC4",desc:"\uB300\uD559 \uCE74\uB4DC \uC911\uC2EC\uC73C\uB85C \uC18C\uC18D \uD604\uD669\uACFC \uD65C\uB3D9 \uD750\uB984\uC744 \uBE60\uB974\uAC8C \uC0B4\uD3B4\uBCFC \uC218 \uC788\uC2B5\uB2C8\uB2E4."},free:{label:"\uBB34\uC18C\uC18D",desc:"\uBB34\uC18C\uC18D \uC2A4\uD2B8\uB9AC\uBA38\uB9CC \uBAA8\uC544\uC11C \uD604\uC7AC \uACF5\uBC31 \uAD6C\uAC04\uACFC \uAC1C\uBCC4 \uC0C1\uD0DC\uB97C \uBCF4\uAE30 \uC27D\uAC8C \uC815\uB9AC\uD569\uB2C8\uB2E4."},femco:{label:"\uD3A8\uCF54",desc:"\uCEEC\uB7EC \uC911\uC2EC\uC758 \uD604\uD669\uD310 \uB808\uC774\uC544\uC6C3\uC73C\uB85C \uD55C\uB208\uC5D0 \uBCF4\uAE30 \uC88B\uC740 \uAD6C\uC131\uC744 \uC81C\uACF5\uD569\uB2C8\uB2E4."},players:{label:"\uD504\uB85C\uD544",desc:"\uD504\uB85C\uD544 \uC911\uC2EC\uC73C\uB85C \uD544\uD130\uB97C \uBC14\uAFD4\uAC00\uBA70 \uC2A4\uD2B8\uB9AC\uBA38\uBCC4 \uC0C1\uD0DC\uB97C \uC9C1\uAD00\uC801\uC73C\uB85C \uD655\uC778\uD569\uB2C8\uB2E4."},weekly:{label:"\uBE0C\uB9AC\uD551",desc:"\uC774\uBC88 \uC8FC\uC640 \uC774\uBC88 \uB2EC \uD65C\uB3D9 \uD750\uB984\uC744 \uC694\uC57D \uCE74\uB4DC \uC704\uC8FC\uB85C \uBE60\uB974\uAC8C \uD6D1\uC5B4\uBCFC \uC218 \uC788\uC2B5\uB2C8\uB2E4."},ranking:{label:"\uB7AD\uD0B9",desc:"\uB300\uD559\uBCC4 \uC131\uACFC\uB97C \uB9AC\uB354\uBCF4\uB4DC \uD615\uD0DC\uB85C \uC815\uB9AC\uD574 \uBE44\uAD50\uAC00 \uC27D\uB3C4\uB85D \uAD6C\uC131\uD569\uB2C8\uB2E4."},heatmap:{label:"\uD788\uD2B8\uB9F5",desc:"\uBD84\uD3EC\uC640 \uC9D1\uC911 \uAD6C\uAC04\uC744 \uC0C9 \uBC00\uB3C4\uB85C \uD655\uC778\uD560 \uC218 \uC788\uAC8C \uC815\uB9AC\uD569\uB2C8\uB2E4."},bubble:{label:"\uBC84\uBE14\uB9F5",desc:"\uADDC\uBAA8\uC640 \uBE44\uC911\uC744 \uC2DC\uAC01\uC801\uC73C\uB85C \uBE44\uAD50\uD558\uAE30 \uC27D\uAC8C \uBC30\uCE58\uD569\uB2C8\uB2E4."},radar:{label:"\uB808\uC774\uB354",desc:"\uB300\uD559\uBCC4 \uAC15\uC810\uACFC \uADE0\uD615\uAC10\uC744 \uB2E4\uCC28\uC6D0\uC73C\uB85C \uBE44\uAD50\uD574\uC11C \uBCF4\uC5EC\uC90D\uB2C8\uB2E4."},summary:{label:"\uC694\uC57D",desc:"\uD575\uC2EC \uC22B\uC790\uC640 \uD750\uB984\uB9CC \uBAA8\uC544 \uAC04\uACB0\uD558\uAC8C \uD655\uC778\uD560 \uC218 \uC788\uB3C4\uB85D \uAD6C\uC131\uD569\uB2C8\uB2E4."},compare:{label:"\uB300\uD559\uBE44\uAD50",desc:"\uC5EC\uB7EC \uB300\uD559 \uC9C0\uD45C\uB97C \uD55C \uC790\uB9AC\uC5D0\uC11C \uBE44\uAD50\uD558\uAE30 \uC88B\uAC8C \uC815\uB9AC\uD569\uB2C8\uB2E4."},old:{label:"\uAD6C\uD604\uD669\uD310",desc:"\uAE30\uC874 \uD604\uD669\uD310 \uB808\uC774\uC544\uC6C3\uC744 \uADF8\uB300\uB85C \uC720\uC9C0\uD558\uBA74\uC11C \uD604\uC7AC \uB370\uC774\uD130\uC640 \uC5F0\uACB0\uD569\uB2C8\uB2E4."}}[_b2View]||{label:"\uD604\uD669\uD310",desc:"\uC5EC\uB7EC \uC2DC\uAC01\uD654\uC640 \uCE74\uB4DC\uD615 \uD654\uBA74\uC73C\uB85C \uD604\uD669\uC744 \uBE60\uB974\uAC8C \uD0D0\uC0C9\uD560 \uC218 \uC788\uC2B5\uB2C8\uB2E4."},q=`
    ...
    <div class="b2-shell">
      ...
      <div style="display:flex;align-items:center;gap:8px;margin:-6px 0 14px;padding:8px 12px;background:var(--surface);border:1px solid var(--border);border-radius:12px;overflow-x:auto;scrollbar-width:none" class="b2-lineup-jumpbar">
        ...
        ${o.map(e=>{const l=gc(e.name),s=e.name===_b2LineupUniv;return`<button type="button" onclick="_b2LineupUniv='${e.name.replace(/'/g,"\\'")}';document.getElementById('b2-content').innerHTML=_b2LineupView();injectUnivIcons(document.getElementById('b2-content'));render();" style="padding:2px 9px;border-radius:999px;border:1px solid ${s?l:"transparent"};background:${s?l+"1a":"var(--white)"};color:${s?l:"var(--text3)"};font-size:10px;font-weight:${s?900:700};cursor:pointer;white-space:nowrap;flex-shrink:0;transition:all .15s">${e.name}</button>`}).join("")}
      </div>
      `:""}
...
var at=Object.defineProperty,st=Object.defineProperties;var lt=Object.getOwnPropertyDescriptors;var qe=Object.getOwnPropertySymbols;var dt=Object.prototype.hasOwnProperty,pt=Object.prototype.propertyIsEnumerable;var Ve=(t,e,n)=>e in t?at(t,e,{enumerable:!0,configurable:!0,writable:!0,value:n}):t[e]=n,ve=(t,e)=>{for(var n in e||(e={}))dt.call(e,n)&&Ve(t,n,e[n]);if(qe)for(var n of qe(e))pt.call(e,n)&&Ve(t,n,e[n]);return t},Me=(t,e)=>st(t,lt(e));function _b2UnivView(){let t=_b2VisUnivs().filter(o=>o.name!=="\uBB34\uC18C\uC18D"&&o.name);if(!t.length)return'<div style="text-align:center;color:var(--text3);padding:40px">\uD45C\uC2DC\uD560 \uB300\uD559\uC774 \uC5C6\uC2B5\uB2C8\uB2E4</div>';const e=new Set((typeof univCfg!="undefined"?univCfg:[]).filter(o=>o.dissolved).map(o=>String(o.name||"").trim())),n=new Set(t.map(o=>String(o&&o.name||"").trim()).filter(Boolean)),c={},i=[];(players||[]).forEach(o=>{const w=String((o==null?void 0:o.univ)||"").trim();n.has(w)&&(o.hidden||o.retired||o.hideFromBoard||e.has(w)||(i.push(o),(c[w]||(c[w]=[])).push(o)))});const g={};i.forEach(o=>{const w=o.tier||"?";g[w]=(g[w]||0)+1});const{fromN:a,toN:x}=_b2ThisWeekRange(),y=_b2WeeklyAggregate(i,String(a).replace(/(\d{4})(\d{2})(\d{2})/,"$1-$2-$3"),String(x).replace(/(\d{4})(\d{2})(\d{2})/,"$1-$2-$3")),f=y.filter(o=>o.total>0).length,r=y.reduce((o,w)=>o+w.total,0),s={P:0,T:0,Z:0};i.forEach(o=>{const w=String(o.race||"").trim().toUpperCase();(w==="P"||w==="T"||w==="Z")&&s[w]++});const d=s.P+s.T+s.Z,T=d>0?["T","P","Z"].map(o=>{const w={T:{cls:"race-T",label:"\uD14C\uB780"},P:{cls:"race-P",label:"\uD504\uB85C\uD1A0\uC2A4"},Z:{cls:"race-Z",label:"\uC800\uADF8"}}[o];if(!s[o])return"";const U=Math.round(s[o]/d*100);return`<button type="button" class="b2-race-badge ${w.cls}" title="${w.label} ${U}%" style="cursor:pointer" onclick="if(typeof openB2RaceTierModal==='function')openB2RaceTierModal('${o}')">${o}<span style="opacity:.75;font-size:10px;margin-left:6px">${U}%</span></button>`}).filter(Boolean).join(""):"",l=(Array.isArray(TIERS)?TIERS:[]).filter(o=>g[o]).map(o=>{const w=typeof getTierBtnColor=="function"?getTierBtnColor(o):"#64748b",U=typeof getTierBtnTextColor=="function"&&getTierBtnTextColor(o)||"#fff";return`<button type="button" class="b2-tier-badge" title="${o}\uD2F0\uC5B4 ${g[o]}\uBA85" style="cursor:pointer;background:${w};color:${U};border:1px solid ${w}55" onclick="if(typeof openB2TierUnivModal==='function')openB2TierUnivModal('${String(o).replace(/\\/g,"\\\\").replace(/'/g,"\\'")}')">${o}</button>`}).join("");try{window._b2LastAllVisPlayers=i}catch(o){}const z=t.map(o=>{if(!(c[String(o.name||"").trim()]||[]).length)return"";const U=gc(o.name),j=_b2ContrastColor(U);return`<button class="b2-jump-chip" onclick="const el=document.getElementById('${"b2-univ-anchor-"+o.name.replace(/[^a-zA-Z0-9가-힣]/g,"_")}');if(el){el.scrollIntoView({behavior:'smooth',block:'start'});}" style="--chip-color:${U}40;border:1.5px solid ${U}bb;background:linear-gradient(135deg,${U}ee,${U}cc);color:${j}"><span style="letter-spacing:-.01em">${o.name}</span></button>`}).join(""),B=_b2GetUnivProfileViewMode(),v=(o,w)=>`
    <button type="button" class="b2-jump-chip" onclick="_b2SetUnivProfileViewMode('${o}')" style="border:${B===o?"1.5px solid #2563eb":"1.5px solid rgba(148,163,184,.20)"};background:${B===o?"linear-gradient(135deg,#eff6ff,#dbeafe)":"linear-gradient(135deg,rgba(255,255,255,.98),rgba(248,250,252,.94))"};color:${B===o?"#1d4ed8":"var(--text2)"};box-shadow:${B===o?"0 6px 16px rgba(37,99,235,.12)":"0 4px 10px rgba(15,23,42,.04)"}">${w}</button>`,h=`<div style="margin-bottom:12px">
    <div style="padding:14px;border-radius:22px;border:1px solid rgba(148,163,184,.18);background:linear-gradient(180deg,rgba(255,255,255,.99),rgba(248,250,252,.96));box-shadow:0 16px 28px rgba(15,23,42,.05)">
      <div style="display:grid;grid-template-columns:repeat(auto-fit,minmax(160px,1fr));gap:10px">
        <div style="padding:13px 14px;border-radius:18px;border:1px solid rgba(148,163,184,.14);background:linear-gradient(180deg,rgba(255,255,255,.98),rgba(248,250,252,.94))">
          ...
          <div style="margin-top:6px;font-size:22px;font-weight:950;letter-spacing:-.03em;color:var(--text1)">${i.length}</div>
        ...
        <div style="padding:13px 14px;border-radius:18px;border:1px solid rgba(148,163,184,.14);background:linear-gradient(180deg,rgba(255,255,255,.98),rgba(248,250,252,.94))">
          ...
          <div style="margin-top:6px;font-size:22px;font-weight:950;letter-spacing:-.03em;color:#f59e0b">${f}</div>
      ...
      <div style="display:flex;align-items:center;gap:8px;flex-wrap:wrap;margin-top:12px;padding-top:12px;border-top:1px solid rgba(148,163,184,.14)">
        ...
        ${T||'<span style="font-size:11px;font-weight:700;color:var(--gray-l)">\uC9D1\uACC4 \uC5C6\uC74C</span>'}
        ${l?`<span style="width:1px;height:20px;background:var(--border2);display:inline-block;margin:0 4px;flex-shrink:0"></span><span class="b2-jump-label">\uD2F0\uC5B4</span>${l}`:""}
      </div>
      ...
      <div style="display:flex;align-items:center;gap:6px;flex-wrap:wrap;margin-top:10px;padding-top:10px;border-top:1px dashed rgba(148,163,184,.14)">
        ...
        ${v("heat","\uD788\uD2B8\uB9F5")}
  ...
  </div>`,M=typeof boardGridCols!="undefined"&&boardGridCols===2?"repeat(2,1fr)":"1fr";let L=h+"<style>.b2-bottom-img{max-width:130px;max-height:110px;object-fit:contain;}.b2-side-panel{float:right;width:230px;margin:0 0 6px 10px;border-radius:10px;padding:8px;box-sizing:border-box;}@media(min-width:769px) and (max-width:1024px){.b2-univ-grid{grid-template-columns:1fr!important;}.b2-side-panel{width:180px;}}@media(max-width:900px){.b2-univ-grid{grid-template-columns:1fr!important;}}@media(max-width:640px){.b2-side-panel{display:none!important;}.b2-bottom-img{display:none!important;}}</style>";return L+=`<div class="b2-univ-grid" style="display:grid;grid-template-columns:${M};gap:12px;align-items:start">`,t.forEach(o=>{if(!o.name){console.warn("[\uD604\uD669\uD310] \uB300\uD559 \uC774\uB984\uC774 \uC5C6\uB294 \uB370\uC774\uD130\uAC00 \uBC1C\uACAC\uB418\uC5C8\uC2B5\uB2C8\uB2E4:",o);return}const w=c[String(o.name||"").trim()]||[],U="b2-univ-anchor-"+o.name.replace(/[^a-zA-Z0-9가-힣]/g,"_");L+=`<div id="${U}" style="scroll-margin-top:56px">`+_b2UnivBlock(o.name,gc(o.name),w)+"</div>"}),L+="</div>",L}try{window.openB2RaceTierModal||(window.openB2RaceTierModal=function(t){try{const e=Array.isArray(window._b2LastAllVisPlayers)?window._b2LastAllVisPlayers:[],n=String(t||"").trim().toUpperCase(),c=n==="P"?"\uD504\uB85C\uD1A0\uC2A4":n==="T"?"\uD14C\uB780":n==="Z"?"\uC800\uADF8":"\uC885\uC871",i=e.filter(r=>String((r==null?void 0:r.race)||"").trim().toUpperCase()===n),g=Array.isArray(window.TIERS)&&window.TIERS.length?window.TIERS.slice():["S","A","B","C","D","E","F","?"],a={},x={};if(i.forEach(r=>{const s=String((r==null?void 0:r.tier)||"?"),d=String((r==null?void 0:r.univ)||"\uBB34\uC18C\uC18D");a[s]=(a[s]||0)+1,x[d]=(x[d]||0)+1}),window._b2RaceTierState=window._b2RaceTierState||{},window._b2RaceTierState.race=n,window._b2RaceTierState.tier=window._b2RaceTierState.tier||"ALL",window._b2RaceTierState.univ=window._b2RaceTierState.univ||"ALL",window._b2RaceTierState.list=i,window._b2RaceTierState.counts=a,window._b2RaceTierState.univCounts=x,window._b2RaceTierState.tiers=g,window._b2RaceTierState.label=c,!document.getElementById("b2RaceTierStyle")){const r=document.createElement("style");r.id="b2RaceTierStyle",r.textContent=`
          ...
          `,document.head.appendChild(r)}let y=document.getElementById("b2RaceTierOverlay");if(!y){y=document.createElement("div"),y.id="b2RaceTierOverlay",y.innerHTML=`
            <div class="su-modal">
          ...
          `,document.body.appendChild(y),y.addEventListener("click",s=>{try{s.target&&s.target.id==="b2RaceTierOverlay"&&window.closeB2RaceTierModal()}catch(d){}});const r=y.querySelector("#b2rtClose");r&&r.addEventListener("click",()=>window.closeB2RaceTierModal()),window.closeB2RaceTierModal=function(){const s=document.getElementById("b2RaceTierOverlay");s&&(s.style.display="none")}}window._b2RaceTierRender=function(){const r=window._b2RaceTierState||{},s=document.getElementById("b2RaceTierOverlay");if(!s)return;const d=s.querySelector("#b2rtTitle"),T=s.querySelector("#b2rtSub"),l=s.querySelector("#b2rtUnivBar"),z=s.querySelector("#b2rtGrid");d&&(d.textContent=`\uC885\uC871 \uBE44\uC911 \xB7 ${r.label||""}`);const B=r.univ&&r.univ!=="ALL"?(r.list||[]).filter(v=>String((v==null?void 0:v.univ)||"\uBB34\uC18C\uC18D")===r.univ):r.list||[];if(T&&(T.textContent=`${r.univ&&r.univ!=="ALL"?`${r.univ} \xB7 `:""}${B.length}\uBA85`),l){const v=["ALL"].concat(Object.keys(r.univCounts||{}).sort((h,M)=>(r.univCounts[M]||0)-(r.univCounts[h]||0)||h.localeCompare(M)));l.innerHTML=v.map(h=>{const M=h==="ALL"?(r.list||[]).length:(r.univCounts||{})[h]||0,L=(r.univ||"ALL")===h,o=h==="ALL"?`\uC804\uCCB4 (${M})`:`${h} (${M})`;return`<button type="button" class="b2rt-univbtn ${L?"on":""}" onclick="window._b2RaceTierSetUniv && window._b2RaceTierSetUniv('${String(h).replace(/'/g,"\\'")}')">${o}</button>`}).join("")}z&&(z.innerHTML=B.map(v=>{const h=String((v==null?void 0:v.name)||""),M=String((v==null?void 0:v.univ)||"\uBB34\uC18C\uC18D"),L=String((v==null?void 0:v.tier)||"?"),o=String((v==null?void 0:v.photo)||"").trim(),w=typeof gc=="function"&&gc(M)||"#64748b",U=M&&M!=="\uBB34\uC18C\uC18D"&&typeof gUI=="function"?gUI(M,typeof getUnivLogoSizeStr=="function"?getUnivLogoSizeStr(M,"players","16px"):"16px"):"",j=h.replace(/\\/g,"\\\\").replace(/'/g,"\\'"),q=o?`<img src="${toHttpsUrl(o).replace(/\"/g,"&quot;")}" loading="lazy" decoding="async" onerror="this.style.display='none'">`:"",V=`<div class="b2rt-fb" style="display:${o?"none":"flex"}">${String((v==null?void 0:v.race)||"?")}</div>`;return`<div class="b2rt-card" onclick="if(typeof openPlayerModal==='function')openPlayerModal('${j}')">
                ${q}${V}
                <div class="b2rt-bottom">
                  <div class="b2rt-name" title="${h.replace(/\"/g,"&quot;")}">${h}</div>
                  <div class="b2rt-meta"><span>${L}\uD2F0\uC5B4</span><span class="b2rt-ubadge" style="background:${w}22;border-color:${w}55;color:#fff">${U}${M}</span></div>
                </div>
              </div>`}).join(""))},window._b2RaceTierSetUniv=function(r){window._b2RaceTierState=window._b2RaceTierState||{},window._b2RaceTierState.univ=String(r||"ALL"),window._b2RaceTierRender&&window._b2RaceTierRender()};const f=document.getElementById("b2RaceTierOverlay");f&&(f.style.display="block"),window._b2RaceTierSetUniv("ALL")}catch(e){console.error(e)}})}catch(t){}try{window.openB2TierUnivModal||(window.openB2TierUnivModal=function(t){try{const e=Array.isArray(window._b2LastAllVisPlayers)?window._b2LastAllVisPlayers:[],n=String(t||"?").trim(),c=e.filter(s=>String((s==null?void 0:s.tier)||"?")===n),i=new Map;c.forEach(s=>{const d=String((s==null?void 0:s.univ)||"\uBB34\uC18C\uC18D");i.has(d)?i.get(d).push(s):i.set(d,[s])});const g=Array.from(i.entries()).sort((s,d)=>d[1].length-s[1].length||s[0].localeCompare(d[0]));if(!document.getElementById("b2TierUnivStyle")){const s=document.createElement("style");s.id="b2TierUnivStyle",s.textContent=`
          ...
          `,document.body.appendChild(a),a.addEventListener("click",d=>{try{d.target&&d.target.id==="b2TierUnivOverlay"&&window.closeB2TierUnivModal()}catch(T){}});const s=a.querySelector("#b2tuClose");s&&s.addEventListener("click",()=>window.closeB2TierUnivModal()),window.closeB2TierUnivModal=function(){const d=document.getElementById("b2TierUnivOverlay");d&&(d.style.display="none")}}window._b2TierUnivState={tier:n,pool:c,ordered:g,selectedUniv:"ALL"};const x=a.querySelector("#b2tuTitle"),y=a.querySelector("#b2tuSub"),f=a.querySelector("#b2tuBody"),r=a.querySelector("#b2tuFilter");x&&(x.textContent=`\uD2F0\uC5B4 \xB7 ${n}\uD2F0\uC5B4`),window._b2TierUnivRender=function(){const s=window._b2TierUnivState||{},d=s.selectedUniv||"ALL";r&&(r.innerHTML=["ALL"].concat((s.ordered||[]).map(([l])=>l)).map(l=>{const z=l==="ALL"?(s.pool||[]).length:(((s.ordered||[]).find(([v])=>v===l)||[])[1]||[]).length;return`<button type="button" class="b2tu-filterbtn ${d===l?"on":""}" onclick="window._b2TierUnivSetFilter && window._b2TierUnivSetFilter('${String(l).replace(/'/g,"\\'")}')">${l==="ALL"?`\uC804\uCCB4 (${z})`:`${l} (${z})`}</button>`}).join(""));const T=d==="ALL"?s.pool||[]:(s.pool||[]).filter(l=>String((l==null?void 0:l.univ)||"\uBB34\uC18C\uC18D")===d);y&&(y.textContent=`${d!=="ALL"?`${d} \xB7 `:""}${T.length}\uBA85`),f&&(f.innerHTML=T.length?`<div class="b2tu-grid">${T.map(l=>{const z=String((l==null?void 0:l.name)||""),B=String((l==null?void 0:l.photo)||"").trim(),v=String((l==null?void 0:l.race)||"?"),h=String((l==null?void 0:l.univ)||"\uBB34\uC18C\uC18D"),M=typeof gc=="function"&&gc(h)||"#64748b",L=h&&h!=="\uBB34\uC18C\uC18D"&&typeof gUI=="function"?gUI(h,typeof getUnivLogoSizeStr=="function"?getUnivLogoSizeStr(h,"players","16px"):"16px"):"",o=z.replace(/\\/g,"\\\\").replace(/'/g,"\\'"),w=B?`<img src="${toHttpsUrl(B).replace(/\"/g,"&quot;")}" loading="lazy" decoding="async" onerror="this.style.display='none'">`:"",U=`<div class="b2tu-fb" style="display:${B?"none":"flex"}">${v}</div>`;return`<div class="b2tu-card" onclick="if(typeof openPlayerModal==='function')openPlayerModal('${o}')">
                ${w}${U}
                <div class="b2tu-bottom">
                  <div class="b2tu-name" title="${z.replace(/\"/g,"&quot;")}">${z}</div>
                  <div class="b2tu-meta"><span>${v}</span><span class="b2tu-ubadge" style="background:${M}22;border-color:${M}55;color:#fff">${L}${h}</span></div>
                </div>
              </div>`}).join("")}</div>`:'<div style="padding:24px;text-align:center;color:var(--text3);font-weight:800">\uD45C\uC2DC\uD560 \uC120\uC218\uAC00 \uC5C6\uC2B5\uB2C8\uB2E4.</div>')},window._b2TierUnivSetFilter=function(s){window._b2TierUnivState=window._b2TierUnivState||{},window._b2TierUnivState.selectedUniv=String(s||"ALL"),window._b2TierUnivRender&&window._b2TierUnivRender()},window._b2TierUnivSetFilter("ALL"),a.style.display="block"}catch(e){console.error(e)}})}catch(t){}function _b2FemcoView(){var Ce,Be,Ue,Le,Ee;const t=()=>({autoLayout:1,logoSize:150,logoPos:"top",logoAttachTitle:1,headGap:10,logoOffsetX:0,logoOffsetY:0,titleSize:28,titleFont:"system",titlePos:"top",titleOffsetX:0,titleOffsetY:0,playerImgSize:76,playerImgShape:"square",rowsPerCol:5,colWidth:170,colGap:10,univGap:18,countFontSize:12,contentPadX:16,contentAlign:"left",contentOffsetX:0,univSubtitles:{},subtitleSize:12,subtitleWeight:800,subtitleColor:"",nameFontSize:18,roleFontSize:10,tierBadgeSize:10,tierBadgePadX:6,starSize:15,statusIconSize:18,bgOverlay:0,univColorOverrides:{},univBgMedia:{}});let e=typeof window._cfgFemcoLoad=="function"?window._cfgFemcoLoad():(function(){try{return JSON.parse(localStorage.getItem("b2_femco_settings_v1")||"null")||t()}catch(b){return t()}})();window._b2FemcoOpenBgMedia=function(b,p){const m=String(b||""),$=String(p||"").trim();if(!$)return;const k=$.toLowerCase(),I=/\.(mp4|webm|ogg)(\?|#|$)/i.test(k);if(/(youtube\.com|youtu\.be|twitch\.tv)/i.test(k)){try{window.open($,"_blank","noopener")}catch(Z){location.href=$}return}if(!I){try{window.open($,"_blank","noopener")}catch(Z){location.href=$}return}const O=document.getElementById("b2-femco-bg-modal");O&&O.remove();const P=document.createElement("div");P.id="b2-femco-bg-modal",P.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,.60);z-index:var(--z-modal-5);display:flex;align-items:center;justify-content:center;padding:16px";const Q=(m||"\uC601\uC0C1").replace(/</g,"&lt;").replace(/>/g,"&gt;");P.innerHTML=`
        <div style="width:min(980px,96vw);background:var(--white);border-radius:16px;overflow:hidden;border:1px solid rgba(255,255,255,.16);box-shadow:0 18px 60px rgba(0,0,0,.35)">
          ...
          <div style="padding:12px 14px">
            <video src="${$}" controls playsinline style="width:100%;max-height:72vh;border-radius:12px;background:#000"></video>
          </div>
        </div>
      `,P.addEventListener("click",Z=>{Z.target===P&&P.remove()}),document.body.appendChild(P)};const n=_b2VisUnivs().filter(b=>b.name);if(!n.length)return'<div style="text-align:center;color:var(--text3);padding:40px">\uD45C\uC2DC\uD560 \uB300\uD559\uC774 \uC5C6\uC2B5\uB2C8\uB2E4</div>';typeof univCfg!="undefined"&&univCfg.length?n.sort((b,p)=>{const m=univCfg.findIndex(k=>k.name===b.name),$=univCfg.findIndex(k=>k.name===p.name);return(m>=0?m:999)-($>=0?$:999)}):n.sort((b,p)=>(b.name||"").localeCompare(p.name||"","ko",{sensitivity:"base"}));const c=new Set((typeof univCfg!="undefined"?univCfg:[]).filter(b=>b.dissolved).map(b=>String(b.name||"").trim())),i={};n.forEach(b=>{i[b.name]=players.filter(p=>String((p==null?void 0:p.univ)||"").trim()===String(b.name||"").trim()&&!p.hidden&&!p.retired&&!p.hideFromBoard&&!c.has(String((p==null?void 0:p.univ)||"").trim()))});const g=Math.max(60,Math.min(520,parseInt(e.logoSize||150,10)||150)),a=Math.max(-120,Math.min(120,parseInt((Ce=e.logoOffsetX)!=null?Ce:0,10)||0)),x=Math.max(-120,Math.min(120,parseInt((Be=e.logoOffsetY)!=null?Be:0,10)||0)),y=Math.max(-120,Math.min(120,parseInt((Ue=e.titleOffsetX)!=null?Ue:0,10)||0)),f=Math.max(-120,Math.min(120,parseInt((Le=e.titleOffsetY)!=null?Le:0,10)||0)),r=Math.max(0,Math.min(70,parseInt((Ee=e.bgOverlay)!=null?Ee:0,10))),s=r/70*.22,d=r/70*.52,T=Math.max(16,Math.min(44,parseInt(e.titleSize||28,10)||28)),l=Math.max(28,Math.min(160,parseInt(e.playerImgSize||64,10)||64)),z={sharp:"0px",roundedsm:"6px",square:"10px",roundedlg:"22px",roundedxl:"34px",circle:"50%"}[e.playerImgShape]||"10px",B=Math.max(2,Math.min(12,parseInt(e.rowsPerCol||5,10)||5)),v=Math.max(80,Math.min(360,parseInt(e.colWidth||170,10)||170)),h=Math.max(0,Math.min(28,parseInt(e.colGap||10,10)||10)),M=10,L=Math.max(0,Math.min(120,parseInt(e.univGap||18,10)||18)),o=Math.max(10,Math.min(18,parseInt(e.countFontSize||12,10)||12)),w=Math.max(0,Math.min(40,parseInt(e.contentPadX||16,10)||16)),U=e.contentAlign==="left"||e.contentAlign==="center"?e.contentAlign:"left",j=Math.max(-40,Math.min(40,parseInt(e.contentOffsetX||0,10)||0)),q=Math.max(0,Math.min(80,parseInt(e.headGap||10,10)||10)),V=!(e.autoLayout===0||e.autoLayout===!1),u=typeof window!="undefined"&&(document.documentElement.clientWidth||window.innerWidth)||1280,R=Math.max(0,Math.min(80,w+j)),A=Math.max(0,Math.min(80,w-j));function W(b){let p=5;b>=55?p=9:b>=45?p=8:b>=35?p=7:b>=25?p=6:p=5;let m=175;return u<=520?(p=Math.max(p,8),m=150):u<=768?(p=Math.max(p,7),m=160):u<=1024?(p=Math.max(p,6),m=170):m=b>=45?160:175,p=Math.max(4,Math.min(12,p)),m=Math.max(130,Math.min(220,m)),{rowsPerCol:p,colWidth:m}}const ee=Math.max(10,Math.min(24,parseInt(e.subtitleSize||12,10)||12)),te=[400,500,600,700,800,900].includes(parseInt(e.subtitleWeight||800,10))?parseInt(e.subtitleWeight||800,10):800,ie=typeof e.subtitleColor=="string"?e.subtitleColor:"",he=Math.max(10,Math.min(28,parseInt(e.nameFontSize||16,10)||16)),ce=Math.max(9,Math.min(16,parseInt(e.roleFontSize||10,10)||10)),ge=Math.max(9,Math.min(16,parseInt(e.tierBadgeSize||10,10)||10)),Y=Math.max(4,Math.min(12,parseInt(e.tierBadgePadX||6,10)||6)),be=Math.max(10,Math.min(28,parseInt(e.starSize||15,10)||15)),oe=(()=>{switch(e.titleFont){case"app":return"var(--app-font)";case"noto":return"'Noto Sans KR', system-ui, -apple-system, 'Segoe UI', Roboto, Arial, sans-serif";case"pretendard":return"'Pretendard Variable', Pretendard, system-ui, -apple-system, 'Segoe UI', Roboto, Arial, sans-serif";case"nanum":return"'Nanum Gothic', 'Noto Sans KR', system-ui, -apple-system, 'Segoe UI', Roboto, Arial, sans-serif";case"gmarket":return"'GmarketSans', 'Noto Sans KR', system-ui, -apple-system, 'Segoe UI', Roboto, Arial, sans-serif";default:return"system-ui, -apple-system, 'Segoe UI', Roboto, Arial, sans-serif"}})();(function(){const b=document.head||document.getElementsByTagName("head")[0];if(!b)return;const p=(k,I)=>{if(!I){const O=document.getElementById(k);O&&O.remove();return}let E=document.getElementById(k);E||(E=document.createElement("link"),E.id=k,E.rel="stylesheet",b.appendChild(E)),E.href=I},m={noto:"https://fonts.googleapis.com/css2?family=Noto+Sans+KR:wght@400;700;900&display=swap",pretendard:"https://cdn.jsdelivr.net/gh/orioncactus/pretendard@latest/dist/web/variable/pretendardvariable.css",nanum:"https://fonts.googleapis.com/css2?family=Nanum+Gothic:wght@400;700;800&display=swap",gmarket:"https://cdn.jsdelivr.net/gh/projectnoonnu/noonfonts_2001@1.1/GmarketSans.css"},$=e.titleFont;p("femco-titlefont-css",m[$]||"")})();const fe=b=>{const p=b.tier||"",m=typeof TIERS!="undefined"&&TIERS.includes(p)?TIERS.indexOf(p):999;return m>=0?m:999},ne=b=>{const p=(b.role||"").trim(),$=["\uC774\uC0AC\uC7A5","\uCD1D\uC7A5","\uAD50\uC218","\uCF54\uCE58"].indexOf(p);return $>=0?$:99},S=b=>b.race==="P"?"P":b.race==="T"?"T":b.race==="Z"?"Z":"?",C=b=>{const p=String(b||"").replace("#","").trim();if(p.length<6)return null;const m=parseInt(p.slice(0,2),16),$=parseInt(p.slice(2,4),16),k=parseInt(p.slice(4,6),16);return[m,$,k].some(I=>Number.isNaN(I))?null:{r:m,g:$,b:k}},K=(b,p,m)=>"#"+[b,p,m].map($=>Math.max(0,Math.min(255,Math.round($))).toString(16).padStart(2,"0")).join(""),re=(b,p,m)=>{const $=C(b),k=C(p);if(!$||!k)return b||p||"#94a3b8";const I=Math.max(0,Math.min(1,+m||0));return K($.r*(1-I)+k.r*I,$.g*(1-I)+k.g*I,$.b*(1-I)+k.b*I)},xe=b=>{const p=C(b);if(!p)return 0;const m=E=>(E/=255,E<=.03928?E/12.92:Math.pow((E+.055)/1.055,2.4)),$=m(p.r),k=m(p.g),I=m(p.b);return .2126*$+.7152*k+.0722*I},Re=(b,p)=>{const m=xe(b),$=xe(p),k=Math.max(m,$),I=Math.min(m,$);return(k+.05)/(I+.05)},Ne=(b,p=3)=>{let m=b||"#94a3b8";if(Re(m,"#ffffff")>=p)return m;const $=[.25,.4,.55,.7];for(const k of $){const I=re(m,"#0f172a",k);if(Re(I,"#ffffff")>=p)return I}return re(m,"#0f172a",.75)},Ge=(b,p)=>{const m=b.race==="P"?"#c084fc":b.race==="T"?"#38bdf8":b.race==="Z"?"#34d399":"#94a3b8",$=p?re(m,p,.22):m;return Ne($,3)};function Ze(b,p){var E;const m=b&&b.photo?String(b.photo):"",$=b&&b.name?String(b.name).slice(0,1):"?",k=`${p}55`;let I="";try{const O=getStatusIcon(b.name),P=getStatusIconHTML(b.name),Q=l,Z=parseInt((E=e.statusIconSize)!=null?E:18,10),N=Z===0?0:Math.max(10,Math.min(36,Z||Math.round(Q*.38))),ue=O&&(typeof _siIsImg=="function"?_siIsImg(O):!1),we=ue?`<img src="${O}" style="width:${N}px;height:${N}px;border-radius:50%;object-fit:cover;opacity:.86" onerror="this.style.display='none'">`:P?P.replace(/margin-left:[^;]+;/g,"").replace(/font-size:[^;]+;/g,""):"",me=ue?"rgba(255,255,255,.72)":"transparent",$e=-Math.round(N*.26),X=-Math.round(N*.26);I=P?`<span style="position:absolute;top:${$e}px;left:${X}px;width:${N}px;height:${N}px;border-radius:50%;background:${me};overflow:hidden;display:flex;align-items:center;justify-content:center;font-size:${Math.round(N*.82)}px;line-height:1;filter:drop-shadow(0 1px 2px rgba(0,0,0,.65))">${we}</span>`:""}catch(O){console.warn("[femcoAvatarSquare] \uC0C1\uD0DC \uC544\uC774\uCF58 \uC0DD\uC131 \uC2E4\uD328:",O.message)}return m?`<span style="position:relative;display:block;width:100%;height:100%">
        <img src="${m}" decoding="async" fetchpriority="high" style="width:100%;height:100%;object-fit:cover;border-radius:inherit;border:2px solid ${k};background:rgba(255,255,255,.25)" onerror="this.closest('span').outerHTML='<div style=&quot;position:relative;width:100%;height:100%;border-radius:inherit;background:${p};display:flex;align-items:center;justify-content:center;font-weight:1000;font-size:22px;color:#fff;border:2px solid ${k}&quot;>${$}</div>'">
        ${I}
      </span>`:`<div style="position:relative;width:100%;height:100%;border-radius:inherit;background:${p};display:flex;align-items:center;justify-content:center;font-weight:1000;font-size:22px;color:#fff;border:2px solid ${k}">${$}${I}</div>`}let ye=`
    <style>
      .b2-femco-wrap{display:flex;flex-direction:column;gap:${L}px}
      ...
      .b2-femco-headcol{display:flex;flex-direction:column;align-items:center;justify-content:center;gap:${q}px}
      ...
      .b2-femco-title{font-weight:1000;font-size:${T}px;letter-spacing:-.04em;line-height:1.1;font-family:${oe}}
      .b2-femco-stars{display:inline-flex;gap:1px;align-items:center;opacity:.95}
      .b2-femco-stars span{font-size:${be}px;line-height:1}
      .b2-femco-subtitle{margin-top:6px;font-size:${ee}px;font-weight:${te};line-height:1.2;opacity:.95}
      /* \uC778\uC6D0\uC218: \uC88C\uCE21 \uC0C1\uB2E8 \uACE0\uC815 (\uBC30\uACBD \uC5C6\uC74C) */
      .b2-femco-countbox{
      ...
      .b2-femco-countbox div{font-size:${o}px;font-weight:1000;line-height:1.15;white-space:nowrap}
      ...
      */
      ...
      .b2-femco-avatar{width:${l}px;height:${l}px;border-radius:${z};overflow:hidden;flex-shrink:0;position:relative}
      ...
      .b2-femco-tierbadge{font-size:${ge}px;padding:2px ${Y}px;border-radius:999px;border:1px solid rgba(0,0,0,.12);display:inline-flex;align-items:center;line-height:1}
      .b2-femco-role{font-size:${ce}px;font-weight:1000;opacity:.9}
      .b2-femco-name{font-size:${he}px;font-weight:1000;white-space:nowrap;overflow:hidden;text-overflow:ellipsis}
  ...
  `;return n.forEach(b=>{var We;const p=b.name,m=i[p]||[];if(!m.length)return;const k=(e.univColorOverrides||{})[p]||gc(p),I=_b2ContrastColor(k),E=(typeof univCfg!="undefined"?univCfg.find(_=>_.name===p):null)||{},O=(()=>{const _=parseInt(E.logoSizeFemco||"",10);return!isNaN(_)&&_>0?Math.max(60,Math.min(520,_)):g})(),P=E.icon||E.img||"",Q=P?`<img src="${toHttpsUrl(P)}" style="width:${O}px;height:${O}px;object-fit:contain" onerror="this.style.display='none'">`:`<span style="display:inline-flex;align-items:center;justify-content:center;width:${Math.round(O*.62)}px;height:${Math.round(O*.62)}px;opacity:.85;font-size:${Math.round(O*.48)}px;line-height:1">\u{1F3EB}</span>`,Z=m.filter(_=>(_.role||"").trim()==="\uC774\uC0AC\uC7A5").length,N=m.filter(_=>["\uAD50\uC218","\uCF54\uCE58"].includes((_.role||"").trim())).length,ue=Math.max(0,m.length-Z-N),we=[...m].sort((_,D)=>{const F=ne(_),le=ne(D);if(F!==le)return F-le;const de=fe(_),pe=fe(D);return de!==pe?de-pe:(_.name||"").localeCompare(D.name||"","ko",{sensitivity:"base"})}),me=((e.univSubtitles||{})[p]||"").trim(),$e=ie&&ie.trim()?ie:I,X=(e.univBgMedia||{})[p]||"",H=(function(){const _={url:"",alpha:30,sizeMode:"cover",sizeVal:90,pos:"center",repeat:"no-repeat",ox:0,oy:0};return X?typeof X=="string"?Me(ve({},_),{url:String(X).trim()}):typeof X=="object"?Me(ve(ve({},_),X),{url:String(X.url||"").trim()}):_:_})(),G=(H.url||"").trim(),_e=G.toLowerCase(),Se=G&&/\.(png|jpe?g|webp|gif)(\?|#|$)/i.test(_e),Te=G&&/\.(mp4|webm|ogg)(\?|#|$)/i.test(_e),ke=G&&/(youtube\.com|youtu\.be|twitch\.tv)/i.test(_e),Oe=Te||ke||G&&!Se?`<button class="b2-femco-pill no-export" style="cursor:pointer" onclick="_b2FemcoOpenBgMedia('${p.replace(/'/g,"\\'")}', '${G.replace(/'/g,"\\'")}');event.stopPropagation();">${Te?"\u{1F39E}\uFE0F \uBC30\uACBD\uC601\uC0C1":ke?"\u{1F517} \uBC30\uACBD\uB9C1\uD06C":"\u{1F5BC}\uFE0F \uBC30\uACBD\uB9C1\uD06C"}</button>`:"",je=e.logoPos||"top",J=["left","right","top","bottom","center"].includes(je)?je:"top",Ae=!!((We=e.logoAttachTitle)==null||We),Pe=e.titlePos||"bottom",ze=["left","right","top","bottom"].includes(Pe)?Pe:"bottom",Xe=(E.championships||0)>0?`<span class="b2-femco-stars">${"<span>\u2B50</span>".repeat(E.championships)}</span>`:"",ae=`
      <div style="min-width:220px;transform:translate(${y}px,${f}px)">
        <div class="b2-femco-title-row">
          <div class="b2-femco-title">${p}</div>
          ${Xe}
        </div>
        ${me?`<div class="b2-femco-subtitle" style="color:${$e}">${me}</div>`:""}
        ${Oe?`<div class="b2-femco-meta">${Oe}</div>`:""}
      </div>
    `,Ye=(()=>{if(Ae)return"";const _=w;return J==="left"?`position:absolute;left:${_}px;top:50%;transform:translateY(-50%) translate(${a}px,${x}px);`:J==="right"?`position:absolute;right:${_}px;top:50%;transform:translateY(-50%) translate(${a}px,${x}px);`:J==="bottom"?`position:absolute;left:50%;bottom:10px;transform:translateX(-50%) translate(${a}px,${x}px);`:`position:absolute;left:50%;top:10px;transform:translateX(-50%) translate(${a}px,${x}px);`})(),Ke=(()=>{if(!Ae){const F=Math.max(0,Math.round(O*.55)+16);return`
          <div class="b2-femco-headrow" style="padding-left:${J==="left"?F:0}px;padding-right:${J==="right"?F:0}px">
            <div class="b2-femco-logo" style="${Ye}">${Q}</div>
            ${ae}
          </div>
        `}const _=J==="left"?"justify-content:flex-start":J==="right"?"justify-content:flex-end":"justify-content:center",D=`<div class="b2-femco-logo" style="transform:translate(${a}px,${x}px)">${Q}</div>`;return ze==="left"?`<div class="b2-femco-headrow" style="${_}">${ae}${D}</div>`:ze==="right"?`<div class="b2-femco-headrow" style="${_}">${D}${ae}</div>`:ze==="top"?`<div class="b2-femco-headcol" style="${_}">${ae}${D}</div>`:`<div class="b2-femco-headcol" style="${_}">${D}${ae}</div>`})(),Fe=V?W(m.length):{rowsPerCol:B,colWidth:v},Je=_=>{const D=String(_||"center");return{center:[50,50],top:[50,0],bottom:[50,100],left:[0,50],right:[100,50],"top left":[0,0],"top right":[100,0],"bottom left":[0,100],"bottom right":[100,100]}[D]||[50,50]},[Qe,et]=Je(H.pos),tt=parseInt(H.ox||0,10)||0,it=parseInt(H.oy||0,10)||0,He=`calc(${Qe}% + ${tt}px) calc(${et}% + ${it}px)`;let se="cover";H.sizeMode==="contain"?se="contain":H.sizeMode==="pct"?se=`${Math.max(10,Math.min(220,parseInt(H.sizeVal||90,10)||90))}%`:H.sizeMode==="px"&&(se=`${Math.max(30,Math.min(900,parseInt(H.sizeVal||240,10)||240))}px`);const De=Math.max(0,Math.min(100,parseInt(H.alpha||30,10)||0))/100,ot=["no-repeat","repeat","repeat-x","repeat-y"].includes(H.repeat)?H.repeat:"no-repeat",nt=Se&&G?`<img src="${toHttpsUrl(G).replace(/"/g,"&quot;")}" style="position:absolute;inset:0;width:100%;height:100%;object-fit:${se};object-position:${He};opacity:${De.toFixed(3)};pointer-events:none;z-index:0" onerror="this.style.display='none'">`:Te||ke?`<div style="position:absolute;inset:0;background-image:url('${G.replace(/'/g,"%27")}');background-repeat:${ot};background-size:${se};background-position:${He};opacity:${De.toFixed(3)};pointer-events:none;z-index:0"></div>`:"",rt=Se&&G&&r>0?`<div style="position:absolute;inset:0;background:linear-gradient(180deg, rgba(2,6,23,${s.toFixed(3)}), rgba(2,6,23,${d.toFixed(3)}));pointer-events:none;z-index:1"></div>`:"";ye+=`
      <section class="b2-femco-univ" style="position:relative;overflow:hidden;background:${k};">
        ${nt}${rt}
        <div class="b2-femco-head" style="position:relative;z-index:2;color:${I};padding-left:${R}px;padding-right:${A}px">
          <div class="b2-femco-countbox" style="color:${I};left:${R}px;${I==="#ffffff"?"text-shadow:0 1px 2px rgba(0,0,0,.45);":""}">
            <div>\uCD1D ${m.length}</div>
            <div>\uC774\uC0AC\uC7A5 ${Z}</div>
            <div>\uAD50\uC218+\uCF54\uCE58 ${N}</div>
            <div>\uD559\uC0DD ${ue}</div>
        ...
        <div class="b2-femco-body" style="position:relative;z-index:2;background:transparent;padding-left:${R}px;padding-right:${A}px">
          <div class="b2-femco-grid" style="--rowsPerCol:${Fe.rowsPerCol};--colWidth:${Fe.colWidth}px">
            ${we.map(_=>{const D=(_.name||"").replace(/'/g,"\\'"),F=_.tier||"?",le=F&&F!=="?"&&typeof getTierBtnColor=="function"?getTierBtnColor(F):"#64748b",de=F&&F!=="?"&&(typeof getTierBtnTextColor=="function"?getTierBtnTextColor(F):"#fff")||"#fff",pe=(_.role||"").trim(),Ie=Ge(_,k);return`
                <div class="b2-femco-item" onclick="openPlayerModal('${D}');event.stopPropagation();">
                  <div class="b2-femco-avatar">${Ze(_,Ie)}</div>
                  <div class="b2-femco-text" style="${_.inactive?"opacity:.65":""};color:${I}">
                    <div class="b2-femco-tier">
                      <span class="b2-femco-tierbadge" style="background:${le};color:${de}">${F}</span>
                    </div>
                    ${pe?`<div class="b2-femco-role">${pe}</div>`:""}
                    <div class="b2-femco-name">${_.name||""}</div>
                    <div><span class="b2-femco-race-pill" style="color:${Ie};border-color:${Ie}88;background:${I==="#ffffff"?"rgba(0,0,0,.28)":"rgba(255,255,255,.92)"};box-shadow:0 1px 2px rgba(0,0,0,.18)">${S(_)}</span></div>
                  </div>
                </div>
              `}).join("")}
          </div>
    ...
    `}),ye+="</div>",ye}function openB2PlayerCreateModal(){if(!isLoggedIn||typeof isSubAdmin!="undefined"&&isSubAdmin||document.getElementById("b2-player-create-modal"))return;const t=(typeof univCfg!="undefined"?univCfg:[]).map(i=>i.name).filter(Boolean),e=typeof TIERS!="undefined"&&Array.isArray(TIERS)?TIERS:["0","1","2","3","4","5","6","7","8","\uC720\uC2A4"],n=["\uD559\uC0DD","\uCF54\uCE58","\uAD50\uC218","\uCD1D\uC7A5","\uC774\uC0AC\uC7A5"],c=document.createElement("div");c.id="b2-player-create-modal",c.style.cssText="position:fixed;top:0;left:0;width:100%;height:100%;background:rgba(0,0,0,0.5);display:flex;align-items:center;justify-content:center;z-index:var(--z-modal-5)",c.innerHTML=`
    <div style="background:var(--white);border-radius:16px;padding:24px;max-width:560px;width:92%;max-height:84vh;overflow-y:auto;box-shadow:0 10px 40px rgba(0,0,0,0.3)">
      ...
      <div style="display:grid;grid-template-columns:140px 1fr;gap:10px;align-items:center;margin-bottom:12px">
        ...
        <select id="b2-newplayer-role" style="padding:8px 12px;border:1px solid var(--border2);border-radius:10px;font-size:13px">
          ${n.map(i=>`<option value="${i}"${i==="\uD559\uC0DD"?" selected":""}>${i}</option>`).join("")}
        </select>
      </div>
  ...
  `,document.body.appendChild(c)}function saveB2NewPlayer(){var T,l,z,B,v,h,M,L;const t=document.getElementById("b2-newplayer-msg"),e=(((T=document.getElementById("b2-newplayer-name"))==null?void 0:T.value)||"").trim(),n=(((l=document.getElementById("b2-newplayer-univ"))==null?void 0:l.value)||"").trim(),c=(((z=document.getElementById("b2-newplayer-role"))==null?void 0:z.value)||"").trim(),i=(((B=document.getElementById("b2-newplayer-race"))==null?void 0:B.value)||"N").trim(),g=(((v=document.getElementById("b2-newplayer-tier"))==null?void 0:v.value)||"?").trim(),a=(((h=document.getElementById("b2-newplayer-channel"))==null?void 0:h.value)||"").trim(),x=(((M=document.getElementById("b2-newplayer-photo"))==null?void 0:M.value)||"").trim(),y=(((L=document.getElementById("b2-newplayer-photo2"))==null?void 0:L.value)||"").trim();if(!e){alert("\uC774\uB984\uC740 \uD544\uC218\uC785\uB2C8\uB2E4.");return}if(players.find(o=>o.name===e)){alert("\uC774\uBBF8 \uC874\uC7AC\uD558\uB294 \uC774\uB984\uC785\uB2C8\uB2E4: "+e);return}if(x&&x.startsWith("data:")){alert("\u274C base64 \uC774\uBBF8\uC9C0(data:...)\uB294 \uC800\uC7A5/\uB3D9\uAE30\uD654\uAC00 \uC2E4\uD328\uD560 \uC218 \uC788\uC5B4 \uAE08\uC9C0\uC785\uB2C8\uB2E4. URL\uC744 \uC0AC\uC6A9\uD558\uC138\uC694.");return}const f={name:e,univ:n||"\uBB34\uC18C\uC18D",role:c||"\uD559\uC0DD",race:i,tier:g,channelUrl:a||void 0,photo:x||void 0,secondProfileFile:y||void 0};players.push(f),save(),render(),["b2-newplayer-name","b2-newplayer-channel","b2-newplayer-photo","b2-newplayer-photo2"].forEach(o=>{const w=document.getElementById(o);w&&(w.value="")});const r=document.getElementById("b2-newplayer-tier");r&&(r.value="?");const s=document.getElementById("b2-newplayer-race");s&&(s.value="N");const d=document.getElementById("b2-newplayer-role");d&&(d.value="\uD559\uC0DD"),t&&(t.style.color="#16a34a",t.textContent=`\u2705 \uC800\uC7A5\uB428: ${e} (\uB2E4\uC74C \uC2A4\uD2B8\uB9AC\uBA38\uB97C \uACC4\uC18D \uB4F1\uB85D\uD560 \uC218 \uC788\uC2B5\uB2C8\uB2E4)`)}async function saveB2FemcoAllImg(){return _saveB2FemcoInternal()}async function _saveB2FemcoInternal(){const e=document.querySelector('[onclick="saveB2FemcoAllImg()"]');e&&(e.disabled=!0,e.textContent="\u23F3...");try{const x="download"in document.createElement("a"),y=String(navigator.userAgent||""),f=/iPad|iPhone|iPod/i.test(y),r=/KAKAOTALK|Instagram|FBAN|FBAV|NAVER|Whale|Line/i.test(y);if(!x||f||r){const s=window.open("","_blank");if(s){try{s.document.write('<html><head><meta charset="utf-8"><title>\uC774\uBBF8\uC9C0 \uC0DD\uC131 \uC911...</title></head><body style="margin:0;font-family:sans-serif;background:#111;color:#fff;padding:14px">\uD3A8\uCF54\uC2A4\uD0C0\uC77C \uC774\uBBF8\uC9C0 \uC0DD\uC131 \uC911\uC785\uB2C8\uB2E4... \uC7A0\uC2DC\uB9CC \uAE30\uB2E4\uB824\uC8FC\uC138\uC694.</body></html>'),s.document.close()}catch(d){}window.__captureDlWin=s}}}catch(a){}const n=document.createElement("div");n.style.cssText="position:fixed;left:-9999px;top:0;padding:24px;background:#0b1220;box-sizing:border-box;",n.innerHTML=_b2FemcoView(),document.body.appendChild(n),n.querySelectorAll(".b2-femco-subnav,.b2-femco-panel,.no-export,.no-export-movebtns").forEach(a=>a.remove()),await new Promise(a=>setTimeout(a,120));try{typeof injectUnivIcons=="function"&&injectUnivIcons(n)}catch(a){console.warn("[saveB2FemcoAllImg] \uB300\uD559 \uC544\uC774\uCF58 \uC8FC\uC785 \uC2E4\uD328:",a.message)}try{typeof _imgToDataUrls=="function"&&await _imgToDataUrls(n,12e3)}catch(a){}try{typeof _waitForImages=="function"&&await _waitForImages(n,1500)}catch(a){}const c=n.scrollHeight+32,i=n.scrollWidth,g="\uD3A8\uCF54\uD604\uD669\uD310_\uC804\uCCB4_"+new Date().toISOString().slice(0,10)+".png";try{if(console.log("[\uD3A8\uCF54] \uC774\uBBF8\uC9C0 \uC800\uC7A5 \uC2DC\uC791"),typeof window._captureAndSave!="function")throw new Error("\uC774\uBBF8\uC9C0 \uC800\uC7A5 \uAE30\uB2A5\uC744 \uBD88\uB7EC\uC624\uC9C0 \uBABB\uD588\uC2B5\uB2C8\uB2E4.");await window._captureAndSave(n,i,c,g)}catch(a){console.error("[\uD3A8\uCF54\uD604\uD669 \uC774\uBBF8\uC9C0 \uC800\uC7A5 \uC2E4\uD328]",a),alert(`\u274C \uD3A8\uCF54\uC2A4\uD0C0\uC77C \uC774\uBBF8\uC9C0 \uC800\uC7A5 \uC2E4\uD328

`+(a.message||"\uC54C \uC218 \uC5C6\uB294 \uC624\uB958\uAC00 \uBC1C\uC0DD\uD588\uC2B5\uB2C8\uB2E4."))}finally{document.body.removeChild(n),e&&(e.disabled=!1,e.textContent="\u{1F4BE} \uC804\uCCB4 \uC800\uC7A5")}}function _b2UnivBlock(t,e,n,c=!1){var ne;if(!t)return`<div style="border-radius:14px;border:2px dashed #ccc55;padding:16px 18px;background:#f5f5f5;display:flex;align-items:center;gap:10px;opacity:.7">
    ...
    </div>`;const i=univCfg.find(S=>S.name===t)||{},g=i.icon||i.img||UNIV_ICONS[t]||"",a=_b2ContrastColor(e),x=e+_b2AlphaHex(b2BgAlpha),y=e+_b2AlphaHex(b2LabelAlpha),f=!!i.bgImg,r="linear-gradient(180deg,rgba(255,255,255,.98),rgba(248,250,252,.94))",s=f?"rgba(255,255,255,.18)":"rgba(255,255,255,.55)",d=f?"linear-gradient(180deg,rgba(255,255,255,.00),rgba(248,250,252,.00))":r,T=f?"linear-gradient(180deg,rgba(255,255,255,.12),rgba(248,250,252,.04))":r,l=f?"rgba(255,255,255,.04)":s,z=f?"none":"0 10px 18px rgba(15,23,42,.04)";if(!n.length)return`<div style="border-radius:14px;border:2px dashed ${e}55;padding:16px 18px;background:${x};display:flex;align-items:center;gap:10px;opacity:.7">
    ...
    </div>`;const B=n.filter(S=>_B2_ROLE_ORDER.includes(S.role||""));B.sort((S,C)=>_b2RoleRank(S)-_b2RoleRank(C));const v=n.filter(S=>!_B2_ROLE_ORDER.includes(S.role||"")),h={};v.forEach(S=>{const C=S.tier||"?";h[C]||(h[C]=[]),h[C].push(S)});const M=TIERS.filter(S=>h[S]).concat(Object.keys(h).filter(S=>!TIERS.includes(S))),L=i.memo||"",o=(i.memoImgs||[]).concat(i.memoImg?[i.memoImg]:[]),w=!!(L||o.length),U=(S,C,K)=>`
    <div style="display:flex;align-items:stretch;gap:0;margin-bottom:8px">
      <div style="background:${y}!important;min-width:70px;width:70px;display:flex;align-items:center;justify-content:center;padding:10px 6px;flex-shrink:0;border-radius:16px 0 0 16px;border:1px solid ${e}33;border-right:none;box-shadow:inset 0 1px 0 rgba(255,255,255,.28)">
        <span style="font-size:11px;font-weight:900;color:${e};text-align:center;line-height:1.35;word-break:keep-all;letter-spacing:-.01em">${S}</span>
      </div>
      <div style="flex:1;background:${d};padding:10px 12px;border-radius:0 16px 16px 0;border:1px solid ${l};box-shadow:${z}">
        ${K}
      </div>
    </div>`,j={},q=[];B.forEach(S=>{const C=S.role||"";j[C]||(j[C]=[],q.push(C)),j[C].push(S)});const V=i.bgImgPos||"center center",u=i.bgImgSize||"auto",R=((ne=i.bgImgAlpha)!=null?ne:b2BgImgAlpha)/100,A=(f?Math.max(.64,R+.08):R).toFixed(2),W=_b2GetUnivProfileViewMode(),ee=i.bgImg?c?`<img src="${i.bgImg}" crossorigin="anonymous" class="b2-fit-auto" data-fit-kind="bg" data-fit-mode="${u}" style="position:absolute;inset:0;width:100%;height:100%;object-fit:${u==="auto"?"cover":u};object-position:${V};opacity:${A};pointer-events:none;z-index:0" onload="_b2ApplyBgAutoSizing(this)">`:`<div class="b2-bg-layer" data-bg-src="${String(i.bgImg).replace(/"/g,"&quot;")}" data-bg-pos="${String(V).replace(/"/g,"&quot;")}" data-bg-size-mode="${u}" style="position:absolute;inset:0;opacity:${A};pointer-events:none;z-index:0;background-position:${V};background-size:${u==="auto"?"cover":u};background-repeat:no-repeat"></div>`:"";let te="";q.forEach(S=>{const C=j[S],K=_b2RenderUnivGroupCards(C,e,!0,W);te+=U(S,!0,K)}),M.forEach(S=>{const C=h[S];C.sort((re,xe)=>(re.name||"").localeCompare(xe.name||"","ko",{sensitivity:"base"}));const K=_b2RenderUnivGroupCards(C,e,!1,W);te+=U(S,!1,K)});const ie=w?`<div style="margin-top:10px;background:${T};padding:12px;box-sizing:border-box;overflow:hidden;border-radius:18px;border:1px solid ${s};box-shadow:0 14px 26px rgba(15,23,42,.06)">
    <div style="font-size:11px;font-weight:900;color:${e};margin-bottom:${o.length||L?"10px":"0"}">\uC0AC\uC774\uB4DC \uBA54\uBAA8</div>
    ${o.map((S,C)=>`<img src="${S}" style="width:100%;max-width:260px;border-radius:12px;${C<o.length-1||L?"margin-bottom:8px;":""}display:block;object-fit:contain;border:1px solid rgba(148,163,184,.14);background:#fff" onerror="this.style.display='none'">`).join("")}
    ${L?`<div style="font-size:11px;color:#334155;white-space:pre-wrap;line-height:1.65;margin-top:${o.length?"8px":"0"}">${L}</div>`:""}
  </div>`:"",he=`<div class="b2-bg-host" style="position:relative;overflow:hidden;background:${f?"transparent":"linear-gradient(180deg,rgba(255,255,255,.92),rgba(248,250,252,.82))"}">
    ${ee}
    ${g?`<img src="${toHttpsUrl(g)}" aria-hidden="true" style="position:absolute;right:16px;bottom:10px;width:min(36%,240px);max-width:240px;opacity:${f?".42":".32"};object-fit:contain;pointer-events:none;z-index:0;filter:drop-shadow(0 12px 28px rgba(15,23,42,.18))" onerror="this.style.display='none'">`:""}
    <div style="position:relative;z-index:1;padding:16px;background:transparent">
      <div>${te}</div>
      ${ie}
    </div>
  </div>`,ce=String(i.createdAt||i.created||i.createDate||i.since||i.startDate||"").trim(),ge=(()=>{if(!ce)return"";const S=String(ce).trim();let C=S.match(/^(\d{4})[.\-\/](\d{2})[.\-\/](\d{2})/);return C||(C=S.match(/^(\d{4})(\d{2})(\d{2})/)),C?`${C[1]}.${C[2]}.${C[3]}`:S.slice(0,10)})(),Y=i.bMemo||"",be=(i.bMemoImgs||[]).concat(i.bMemoImg?[i.bMemoImg]:[]),oe=be.map(S=>`<img class="b2-bottom-img" src="${S}" style="border-radius:12px;display:inline-block;border:1px solid rgba(148,163,184,.14);background:#fff" onerror="this.style.display='none'">`).join(""),fe=Y||be.length?`<div style="padding:14px 16px 16px;background:${f?"linear-gradient(180deg,rgba(255,255,255,.28),rgba(248,250,252,.14))":"linear-gradient(180deg,rgba(255,255,255,.92),rgba(248,250,252,.86))"};border-top:1px solid rgba(148,163,184,.16)">
    <div style="font-size:11px;font-weight:900;color:${e};margin-bottom:${oe||Y?"10px":"0"}">\uD558\uB2E8 \uBA54\uBAA8</div>
    ${oe?`<div style="display:flex;flex-wrap:wrap;gap:8px;margin-bottom:${Y?"8px":"0"}">${oe}</div>`:""}
    ${Y?`<div style="font-size:12px;color:#334155;white-space:pre-wrap;line-height:1.7">${Y}</div>`:""}
  </div>`:"";return`
    <div data-b2card="${t.replace(/"/g,"&quot;")}" style="border-radius:22px;overflow:hidden;border:1px solid rgba(148,163,184,.16);background:linear-gradient(180deg,rgba(255,255,255,.98),rgba(248,250,252,.96));box-shadow:0 18px 32px rgba(15,23,42,.06)">
      <div style="background:linear-gradient(135deg,${e} 0%,${e}dd 100%);padding:16px 16px 14px;position:relative;overflow:hidden">
        <div style="position:absolute;inset:0;background:linear-gradient(145deg,rgba(255,255,255,${f?".08":".18"}),rgba(255,255,255,0) 58%);pointer-events:none"></div>
        <div style="display:flex;align-items:stretch;gap:12px;position:relative;z-index:1">
          ${g?`<img src="${toHttpsUrl(g)}" style="width:var(--su_univ_logo_size,56px);height:var(--su_univ_logo_size,56px);object-fit:contain;border-radius:var(--su_univ_logo_radius,16px);flex-shrink:0;cursor:pointer;background:rgba(255,255,255,.22);border:1px solid rgba(255,255,255,.28);padding:6px;box-shadow:0 14px 26px rgba(15,23,42,.12)" onclick="if(typeof openUnivModal==='function')openUnivModal('${t}')" onerror="this.style.display='none'">`:""}
              ...
              <div style="min-width:0;flex:1">
                <div style="display:flex;align-items:center;gap:8px;flex-wrap:nowrap;min-width:0">
                  ...
                  <span style="display:inline-flex;align-items:center;gap:6px;flex-shrink:0;white-space:nowrap">
                    <span style="background:${a}1f;color:${a};font-size:11px;font-weight:800;padding:4px 9px;border-radius:999px;border:1px solid ${a}26;cursor:pointer;box-shadow:inset 0 1px 0 rgba(255,255,255,.06);white-space:nowrap" onclick="event.stopPropagation();openB2MemberBreakdown(this,'${t}')">${n.length}\uBA85</span>
                    ${ge?`<span style="background:${a}18;color:${a};font-size:10px;font-weight:900;padding:4px 8px;border-radius:999px;border:1px solid ${a}22;box-shadow:inset 0 1px 0 rgba(255,255,255,.06);flex-shrink:0;white-space:nowrap">${ge}</span>`:""}
                  </span>
                </div>
                ${i.memo2?`<div style="margin-top:5px;font-size:10px;font-weight:700;color:${a}dd;line-height:1.45;display:flex;align-items:center;gap:6px;flex-wrap:wrap">
                  <span style="overflow:hidden;text-overflow:ellipsis;white-space:nowrap;flex:0 1 auto;max-width:48%;background:rgba(255,255,255,.12);border:1px solid rgba(255,255,255,.14);border-radius:999px;padding:3px 8px">${i.memo2}</span>
                </div>`:""}
              </div>
              <div style="display:flex;align-items:flex-start;gap:6px;flex-wrap:wrap;justify-content:flex-end">
                ${(i.championships||0)>0?`<span style="display:flex;gap:1px;flex-shrink:0;padding:5px 8px;border-radius:999px;background:rgba(255,255,255,.12);border:1px solid rgba(255,255,255,.12)">${'<span style="font-size:15px">\u2B50</span>'.repeat(i.championships)}</span>`:""}
    ...
    </div>`}function _b2FreeView(){const t=new Set((typeof univCfg!="undefined"?univCfg:[]).filter(u=>u.dissolved).map(u=>String(u.name||"").trim())),e=players.filter(u=>{const R=String((u==null?void 0:u.univ)||"").trim();return(!R||R==="\uBB34\uC18C\uC18D")&&!u.hidden&&!u.retired&&!u.hideFromBoard&&!t.has(R)});if(!e.length)return'<div style="text-align:center;color:var(--text3);padding:40px">\uBB34\uC18C\uC18D \uBA64\uBC84\uAC00 \uC5C6\uC2B5\uB2C8\uB2E4</div>';const n=e.filter(u=>_B2_ROLE_ORDER.includes(u.role||""));n.sort((u,R)=>_b2RoleRank(u)-_b2RoleRank(R));const c=e.filter(u=>!_B2_ROLE_ORDER.includes(u.role||"")),i={};c.forEach(u=>{const R=u.tier||"?";i[R]||(i[R]=[]),i[R].push(u)});const g=TIERS.filter(u=>i[u]).concat(Object.keys(i).filter(u=>!TIERS.includes(u))),a=new Date,x=a.getDay(),y=new Date(a);y.setDate(a.getDate()+(x===0?-6:1-x));const f=parseInt(y.toISOString().slice(0,10).replace(/-/g,"")),r=parseInt(a.toISOString().slice(0,10).replace(/-/g,"")),s=u=>parseInt(String(u||"").replace(/[-\.]/g,""))||0;let d=0,T=0,l=0,z=0,B=0;c.forEach(u=>{let R=!1;(Array.isArray(u.history)?u.history:[]).forEach(A=>{A.result==="\uC2B9"?d++:A.result==="\uD328"&&T++;const W=s(A.date||A.d||"");W>=f&&W<=r&&(A.result==="\uC2B9"?l++:A.result==="\uD328"&&z++,R=!0)}),R&&B++});const v=d+T,h=v>0?Math.round(d/v*100):null,M=h===null?"#94a3b8":h>=60?"#10b981":h>=40?"#f59e0b":"#ef4444",L=l+z,o={P:0,T:0,Z:0,"?":0};c.forEach(u=>{const R=u.race||"?";o[R in o?R:"?"]++});const w=c.length||1,U="#64748b";let j=`<div style="border-radius:22px;overflow:hidden;border:1px solid rgba(148,163,184,.16);background:linear-gradient(180deg,rgba(255,255,255,.99),rgba(248,250,252,.96));box-shadow:0 18px 32px rgba(15,23,42,.06)">
    <div style="background:linear-gradient(135deg,${U} 0%,#475569 100%);padding:14px 16px 12px;position:relative;overflow:hidden">
      ...
      <div style="display:flex;align-items:center;gap:6px;flex-wrap:wrap">
        ...
        ${B>0?`<span style="background:rgba(255,165,0,.35);color:#fef08a;font-size:10px;font-weight:900;padding:4px 8px;border-radius:999px;border:1px solid rgba(255,255,255,.12)">\u{1F525} \uC774\uBC88\uC8FC ${B}\uBA85</span>`:""}
        ${L>0?`<span style="background:rgba(0,0,0,.18);color:${l>=z?"#bbf7d0":"#fecaca"};font-size:10px;font-weight:900;padding:4px 8px;border-radius:999px;border:1px solid rgba(255,255,255,.12)">${l}\uC2B9${z}\uD328</span>`:""}
        ${h!==null?`<span style="background:rgba(0,0,0,.18);color:${M};font-size:10px;font-weight:900;padding:4px 8px;border-radius:999px;border:1px solid rgba(255,255,255,.12)" title="\uD1B5\uC0B0 ${d}\uC2B9 ${T}\uD328">\u{1F4CA} \uD1B5\uC0B0 ${h}%</span>`:""}
        <div style="margin-left:auto;display:flex;gap:4px;align-items:center">
          ${o.P?`<span style="font-size:10px;background:rgba(124,58,237,.4);color:#ede9fe;padding:4px 8px;border-radius:999px;font-weight:900;border:1px solid rgba(255,255,255,.12)">\u{1F52E}${o.P}</span>`:""}
          ${o.T?`<span style="font-size:10px;background:rgba(2,132,199,.4);color:#e0f2fe;padding:4px 8px;border-radius:999px;font-weight:900;border:1px solid rgba(255,255,255,.12)">\u2694\uFE0F${o.T}</span>`:""}
          ${o.Z?`<span style="font-size:10px;background:rgba(5,150,105,.4);color:#d1fae5;padding:4px 8px;border-radius:999px;font-weight:900;border:1px solid rgba(255,255,255,.12)">\u{1F98E}${o.Z}</span>`:""}
        </div>
      </div>
      <div style="display:flex;height:5px;border-radius:3px;overflow:hidden;margin-top:8px;background:rgba(255,255,255,.15)">
        ${o.P?`<div style="flex:${o.P};background:#7c3aed;opacity:.85"></div>`:""}
        ${o.T?`<div style="flex:${o.T};background:#0284c7;opacity:.85"></div>`:""}
        ${o.Z?`<div style="flex:${o.Z};background:#059669;opacity:.85"></div>`:""}
        ${o["?"]?`<div style="flex:${o["?"]};background:rgba(255,255,255,.2)"></div>`:""}
      </div>
      </div>
    </div>
    <div style="background:linear-gradient(180deg,rgba(255,255,255,.96),rgba(248,250,252,.90));padding:16px">`;const q=(u,R)=>`<div style="display:flex;align-items:stretch;gap:0;margin-bottom:8px">${u}<div style="flex:1;padding:10px 12px;background:linear-gradient(180deg,rgba(255,255,255,.98),rgba(248,250,252,.94));border:1px solid rgba(148,163,184,.14);border-left:none;border-radius:0 16px 16px 0;box-shadow:0 10px 18px rgba(15,23,42,.04)">${R}</div></div>`,V=(u,R)=>`<span style="font-size:12px;font-weight:900;color:${R?U:"var(--text3)"};width:68px;min-width:68px;text-align:center;flex-shrink:0;display:inline-flex;align-items:center;justify-content:center;background:#64748b${_b2AlphaHex(b2LabelAlpha)}!important;border:1px solid rgba(100,116,139,.28);border-right:none;border-radius:16px 0 0 16px;padding:8px 6px;box-shadow:inset 0 1px 0 rgba(255,255,255,.2)">${u}</span>`;return n.forEach(u=>{j+=q(V(u.role||"",!0),_b2PlayerRow(u,U))}),g.forEach(u=>{const R=i[u];R.sort((W,ee)=>(W.name||"").localeCompare(ee.name||"","ko",{sensitivity:"base"}));const A=getTierBtnColor(u);j+=q(V(u,!1),`<div style="display:flex;flex-wrap:wrap;gap:5px;padding:2px 0">${R.map(W=>_b2NameTag(W,A,!1)).join("")}</div>`)}),j+="</div></div>",j}function openB2MemberBreakdown(t,e){const n=document.getElementById("b2-mbp");if(n){const d=n._forEl;if(n.remove(),d===t)return}const c=gc(e),i=players.filter(d=>String((d==null?void 0:d.univ)||"").trim()===String(e||"").trim()&&!d.hidden&&!d.retired&&!d.hideFromBoard),g=i.filter(d=>_B2_ROLE_ORDER.includes(d.role||"")),a=i.filter(d=>!_B2_ROLE_ORDER.includes(d.role||"")),x={};a.forEach(d=>{const T=d.tier||"?";x[T]=(x[T]||0)+1});const y=TIERS.filter(d=>x[d]).concat(Object.keys(x).filter(d=>!TIERS.includes(d))),f=(d,T,l)=>`<div style="display:flex;justify-content:space-between;align-items:center;gap:16px;padding:2px 0">
    <span style="color:${l||"var(--text2)"};font-size:12px">${d}</span>
    <span style="font-weight:700;color:var(--text1);font-size:12px">${T}\uBA85</span></div>`,r=document.createElement("div");r.id="b2-mbp",r.style.cssText="position:fixed;z-index:var(--z-top);background:var(--white);border:1px solid var(--border2);border-radius:12px;box-shadow:0 4px 20px #0003;padding:12px 14px;min-width:170px",r.innerHTML=`
    <div style="font-weight:800;font-size:13px;color:${c};margin-bottom:8px">${e} \uAD6C\uC131</div>
    ${f("\uC9C1\uCC45\uC790",g.length)}
    ${f("\uC77C\uBC18 \uC2A4\uD2B8\uB9AC\uBA38",a.length)}
    ${y.length?`<div style="border-top:1px solid var(--border2);margin:6px 0"></div>${y.map(d=>f(d,x[d],getTierBtnColor(d))).join("")}`:""}`,r._forEl=t,document.body.appendChild(r);const s=t.getBoundingClientRect();r.style.top=s.bottom+6+"px",r.style.left=s.left+"px",requestAnimationFrame(()=>{s.left+r.offsetWidth>window.innerWidth-8&&(r.style.left=s.right-r.offsetWidth+"px"),s.bottom+r.offsetHeight+6>window.innerHeight&&(r.style.top=s.top-r.offsetHeight-6+"px")}),setTimeout(()=>{function d(z){!r.contains(z.target)&&z.target!==t&&l()}function T(){l()}function l(){r.remove(),document.removeEventListener("click",d),window.removeEventListener("scroll",T,!0)}document.addEventListener("click",d),window.addEventListener("scroll",T,{capture:!0,once:!0})},0)}async function saveB2Img(){const t=_b2VisUnivs().filter(r=>r.name!=="\uBB34\uC18C\uC18D"),e=_b2SaveUniv==="\uC804\uCCB4"?t:t.filter(r=>r.name===_b2SaveUniv);if(!e.length){alert("\uC800\uC7A5\uD560 \uB300\uD559\uC774 \uC5C6\uC2B5\uB2C8\uB2E4.");return}const n=document.querySelector('[onclick="saveB2Img()"]');n&&(n.disabled=!0,n.textContent="\u23F3...");const c=720,i=14,g=24,a=document.createElement("div");a.style.cssText=`position:fixed;left:-9999px;top:0;padding:${g}px;background:#f0f2f5;box-sizing:border-box;width:${c+g*2}px`,a.innerHTML=`<style>.b2-bottom-img{max-width:160px;max-height:130px;object-fit:contain;}</style>
    <div style="display:flex;flex-direction:column;gap:${i}px">
      ${e.map(r=>_b2UnivBlock(r.name,gc(r.name),players.filter(s=>String((s==null?void 0:s.univ)||"").trim()===String(r.name||"").trim()&&!s.hidden&&!s.retired&&!s.hideFromBoard),!0)).join("")}
    </div>`,document.body.appendChild(a),a.querySelectorAll(".no-export,.no-export-movebtns").forEach(r=>r.remove()),await new Promise(r=>setTimeout(r,100)),injectUnivIcons(a);const x=a.scrollHeight+32,y=a.scrollWidth,f=(_b2SaveUniv==="\uC804\uCCB4"?"\uB300\uD559\uBCC4\uD604\uD669\uD310_\uC804\uCCB4":`\uB300\uD559\uBCC4\uD604\uD669\uD310_${_b2SaveUniv}`)+"_"+new Date().toISOString().slice(0,10)+".png";try{if(typeof _captureAndSave!="function")throw new Error("\uC774\uBBF8\uC9C0 \uC800\uC7A5 \uAE30\uB2A5\uC744 \uBD88\uB7EC\uC624\uC9C0 \uBABB\uD588\uC2B5\uB2C8\uB2E4.");await _captureAndSave(a,y,x,f)}catch(r){console.error("[\uD604\uD669\uD310 \uC774\uBBF8\uC9C0 \uC800\uC7A5 \uC2E4\uD328]",r),alert(`\u274C \uC774\uBBF8\uC9C0 \uC800\uC7A5 \uC2E4\uD328

`+(r.message||"\uC54C \uC218 \uC5C6\uB294 \uC624\uB958\uAC00 \uBC1C\uC0DD\uD588\uC2B5\uB2C8\uB2E4."))}finally{document.body.removeChild(a),n&&(n.disabled=!1,n.textContent="\u{1F4F7} \uC774\uBBF8\uC9C0\uC800\uC7A5")}}function _b2PastelBg(t,e){const{r:n,g:c,b:i}=typeof _hexToRgbObj=="function"?_hexToRgbObj(t):{r:100,g:116,b:139},g=typeof e=="number"?e:.1,a=x=>Math.round(255*(1-g)+x*g);return`rgb(${a(n)},${a(c)},${a(i)})`}function _b2GetUnivProfileViewMode(){try{const t=String(localStorage.getItem("su_b2_univ_profile_view")||"").trim();return t==="card"?"poster":t==="compact"||t==="media"?"default":["default","poster","heat"].includes(t)?t:"default"}catch(t){return"default"}}function _b2SetUnivProfileViewMode(t){const e=["default","poster","heat"].includes(String(t||""))?String(t):"default";try{localStorage.setItem("su_b2_univ_profile_view",e)}catch(n){}typeof render=="function"&&render()}function _b2UnivPhotoCard(t,e,n){const c=(t.name||"").replace(/'/g,"\\'"),i=t.photo?toHttpsUrl(t.photo):"",g=t.race&&t.race!=="N"?t.race:"?",a="border-radius:var(--su_profile_radius,50%);clip-path:var(--su_profile_clip,none);",x=n&&(t.tier||t.role)||"",y=t.tier&&typeof getTierBtnColor=="function"?getTierBtnColor(t.tier):e,f=t.tier&&typeof getTierBtnTextColor=="function"&&getTierBtnTextColor(t.tier)||"#fff",r={T:"#2563eb",P:"#d97706",Z:"#7c3aed"}[t.race]||"#475569",s=i?`<img src="${i}" crossorigin="anonymous" aria-hidden="true" style="position:absolute;inset:0;width:100%;height:100%;object-fit:cover;object-position:top center;transform:scale(1.16);filter:blur(14px) saturate(1.08) brightness(.88);opacity:.88" onerror="this.style.display='none'">
       <div style="position:absolute;inset:0;background:linear-gradient(180deg,${e}24 0%,rgba(2,6,23,.12) 100%)"></div>`:`<div style="position:absolute;inset:0;background:linear-gradient(160deg,${e}44 0%,${e}18 100%)"></div>`,d=i?`<img src="${i}" crossorigin="anonymous" style="position:absolute;inset:0;width:100%;height:100%;object-fit:cover;object-position:top center" onerror="this.style.display='none';this.nextElementSibling.style.display='flex'">
       <div style="position:absolute;inset:0;display:none;align-items:center;justify-content:center;font-size:34px;font-weight:1000;color:${e};opacity:.78">${g}</div>`:`<div style="position:absolute;inset:0;display:flex;align-items:center;justify-content:center;font-size:34px;font-weight:1000;color:${e};opacity:.78">${g}</div>`;return`
    <div style="position:relative;width:122px;max-width:100%;aspect-ratio:.78;${a}overflow:hidden;border:1px solid rgba(255,255,255,.16);background:#0b1120;box-shadow:0 10px 20px rgba(15,23,42,.12);cursor:pointer" onclick="openPlayerModal('${c}')">
      ${s}
      ${d}
      ${t.race&&t.race!=="N"?`<div style="position:absolute;top:8px;right:8px;padding:2px 8px;border-radius:999px;background:${r};color:#fff;font-size:10px;font-weight:900;z-index:2;box-shadow:0 2px 6px rgba(0,0,0,.26)">${t.race}</div>`:""}
      <div style="position:absolute;left:0;right:0;bottom:0;padding:9px 9px 10px;background:linear-gradient(180deg,rgba(2,6,23,0) 0%,rgba(2,6,23,.20) 30%,rgba(2,6,23,.62) 100%);z-index:2">
        ${x?`<div style="margin-bottom:3px"><span style="display:inline-flex;align-items:center;padding:2px 7px;border-radius:999px;background:${y};color:${f};font-size:10px;font-weight:900;line-height:1.4">${x}</span></div>`:""}
        <div style="color:#fff;font-size:12px;font-weight:950;letter-spacing:-.02em;white-space:nowrap;overflow:hidden;text-overflow:ellipsis;text-shadow:0 1px 4px rgba(0,0,0,.5)">${t.name||""}</div>
      </div>
    </div>`}function _b2UnivDefaultTag(t,e,n){const c=(t.name||"").replace(/'/g,"\\'"),i=t.crewName&&typeof _gcCrew=="function"&&_gcCrew(t.crewName)||"";return`
    <div style="display:flex;align-items:center;gap:8px;padding:4px 10px 4px 4px;border-radius:24px;cursor:pointer;transition:background .12s;white-space:nowrap;flex-shrink:0"
      onmouseover="this.style.background='${e}14'"
      onmouseout="this.style.background='transparent'">
      <div onclick="openPlayerModal('${c}')" style="display:flex;align-items:center;gap:8px;flex:1;min-width:0">
      ${_b2Avatar(t,i||e,58)}
      <span style="font-weight:800;font-size:20px;color:var(--text1);white-space:nowrap;${t.inactive?"opacity:.6":""}">${t.name||""}</span>
      ${t.race&&t.race!=="N"?`<span class="rbadge r${t.race}" style="font-size:11px;flex-shrink:0">${t.race}</span>`:""}
      ${n&&t.tier?`<span style="font-size:11px;font-weight:800;padding:2px 7px;border-radius:6px;background:${getTierBtnColor(t.tier)};color:${getTierBtnTextColor(t.tier)||"#fff"};flex-shrink:0">${t.tier}</span>`:""}
      ${t.inactive?'<span style="font-size:9px;background:#fff7ed;color:#9a3412;border-radius:4px;padding:1px 4px;font-weight:700;flex-shrink:0">\u23F8\uFE0F</span>':""}
      </div>
    </div>`}function _b2UnivHeatCard(t,e){const n=(t.name||"").replace(/'/g,"\\'"),c=t.photo?toHttpsUrl(t.photo):"",i=t.race&&t.race!=="N"?t.race:"?";return`<button type="button" title="${(t.name||"").replace(/"/g,"&quot;")}" onclick="openPlayerModal('${n}')" style="width:112px;height:112px;padding:0;border:none;border-radius:var(--su_profile_radius,50%);clip-path:var(--su_profile_clip,none);overflow:hidden;background:${e}22;box-shadow:0 8px 20px rgba(15,23,42,.09);cursor:pointer">
    ${c?`<img src="${c}" crossorigin="anonymous" style="width:100%;height:100%;object-fit:cover;object-position:top center" onerror="this.style.display='none';this.nextElementSibling.style.display='flex'"><span style="display:none;align-items:center;justify-content:center;width:100%;height:100%;font-size:32px;font-weight:1000;color:${e}">${i}</span>`:`<span style="display:flex;align-items:center;justify-content:center;width:100%;height:100%;font-size:32px;font-weight:1000;color:${e}">${i}</span>`}
  </button>`}function _b2RenderUnivGroupCards(t,e,n,c){const i=Array.isArray(t)?t:[];return c==="heat"?`<div style="display:flex;flex-wrap:wrap;gap:14px">${i.map(g=>_b2UnivHeatCard(g,e)).join("")}</div>`:c==="poster"?`<div style="display:flex;flex-wrap:wrap;gap:14px">${i.map(g=>_b2UnivPhotoCard(g,e,n)).join("")}</div>`:`<div style="display:grid;grid-template-columns:repeat(5,max-content);align-items:center;justify-content:start;column-gap:10px;row-gap:8px;max-width:100%;overflow-x:auto;overflow-y:hidden;padding-bottom:2px;scrollbar-width:thin">${i.map(g=>_b2UnivDefaultTag(g,e,n)).join("")}</div>`}function _b2LineupCard(t,e,n,c){const i=(t.name||"").replace(/'/g,"\\'"),g=t.race&&t.race!=="N"?t.race:"?",a=t.photo?toHttpsUrl(t.photo):"",x={T:"#2563eb",P:"#d97706",Z:"#7c3aed"}[t.race]||"#475569",y=n?t.role||"":t.tier||"",f=!n&&t.tier&&typeof getTierBtnColor=="function"?getTierBtnColor(t.tier):e,r=!n&&t.tier&&typeof getTierBtnTextColor=="function"&&getTierBtnTextColor(t.tier)||"#fff",s=a?`<img src="${a}" crossorigin="anonymous" aria-hidden="true" style="position:absolute;inset:0;width:100%;height:100%;object-fit:cover;object-position:top center;transform:scale(1.22);filter:blur(16px) saturate(1.15) brightness(.8);opacity:.85" onerror="this.style.display='none'">
       <div style="position:absolute;inset:0;background:linear-gradient(180deg,${e}33 0%,rgba(0,0,0,.18) 100%)"></div>`:`<div style="position:absolute;inset:0;background:linear-gradient(160deg,${e}44 0%,${e}1a 100%)"></div>`,d=a?`<img src="${a}" crossorigin="anonymous" style="position:absolute;inset:0;width:100%;height:100%;object-fit:cover;object-position:top center" onerror="this.style.display='none';this.nextElementSibling.style.display='flex'">
       <div style="position:absolute;inset:0;display:none;align-items:center;justify-content:center;flex-direction:column;gap:6px">
         ...
         <div style="font-size:56px;font-weight:900;color:${e};opacity:.7">${g}</div>
       </div>`,T=t.race&&t.race!=="N"?`<div style="position:absolute;top:10px;right:10px;padding:3px 10px;border-radius:999px;background:${x};color:#fff;font-size:12px;font-weight:800;box-shadow:0 2px 8px rgba(0,0,0,.32);z-index:2;letter-spacing:.02em">${t.race}</div>`:"",l=`
    <div style="position:absolute;bottom:0;left:0;right:0;z-index:2;padding:12px 14px 13px">
      ${y?`<div style="margin-bottom:4px"><span style="background:${f};color:${r};font-weight:900;font-size:13px;padding:2px 9px;border-radius:999px;white-space:nowrap;line-height:1.6;letter-spacing:-.01em">${y}</span></div>`:""}
    ...
    <div style="position:relative;cursor:pointer;border-radius:16px;overflow:hidden;background:${_b2PastelBg(e,.1)};box-shadow:0 4px 16px rgba(15,23,42,.18);border:1px solid ${e}33;transition:transform .15s,box-shadow .15s" onclick="openPlayerModal('${i}')"
    ...
    </div>`}function _b2LineupPoster(t,e,n=!1){if(!t)return'<div style="text-align:center;color:var(--text3);padding:40px">\uB300\uD559\uC744 \uC120\uD0DD\uD574\uC8FC\uC138\uC694</div>';const c=(typeof univCfg!="undefined"?univCfg.find(l=>l.name===t):null)||{},i=c.icon||c.img||UNIV_ICONS[t]||"",g=players.filter(l=>String((l==null?void 0:l.univ)||"").trim()===String(t||"").trim()&&!l.hidden&&!l.retired&&!l.hideFromBoard);if(!g.length)return`<div style="border-radius:18px;border:2px dashed ${e}55;padding:30px;background:${e}10;text-align:center;color:var(--text3)">\uB4F1\uB85D\uB41C \uC120\uC218\uAC00 \uC5C6\uC2B5\uB2C8\uB2E4</div>`;const a=g.filter(l=>_B2_ROLE_ORDER.includes(l.role||""));a.sort((l,z)=>_b2RoleRank(l)-_b2RoleRank(z));const x=g.filter(l=>!_B2_ROLE_ORDER.includes(l.role||""));x.sort((l,z)=>{const B=TIERS.indexOf(l.tier||""),v=TIERS.indexOf(z.tier||""),h=B>=0?B:99,M=v>=0?v:99;return h!==M?h-M:(l.name||"").localeCompare(z.name||"","ko",{sensitivity:"base"})});const y=a.map(l=>_b2LineupCard(l,e,!0,i)).join(""),f=x.map(l=>_b2LineupCard(l,e,!1,i)).join(""),r=new Date().toISOString().slice(0,10).replace(/-/g,"."),s={T:0,P:0,Z:0};x.forEach(l=>{s.hasOwnProperty(l.race)&&s[l.race]++});const T=[{k:"T",ico:"\u2694\uFE0F",col:"#2563eb"},{k:"P",ico:"\u{1F52E}",col:"#d97706"},{k:"Z",ico:"\u{1F98E}",col:"#7c3aed"}].filter(l=>s[l.k]>0).map(l=>`
    <span style="display:inline-flex;align-items:center;gap:4px;background:rgba(255,255,255,.14);border:1px solid rgba(255,255,255,.22);border-radius:999px;padding:5px 12px 5px 10px;color:#fff;font-size:12px;font-weight:800">
      <span style="font-size:12px">${l.ico}</span>${l.k} ${s[l.k]}
    </span>`).join("");return`
    <div data-b2lineup="${t.replace(/"/g,"&quot;")}" style="border-radius:24px;overflow:hidden;background:#0b1220;box-shadow:0 20px 40px rgba(15,23,42,.28)">
      <div style="padding:30px 30px 24px;position:relative;overflow:hidden;background:linear-gradient(135deg,${e} 0%,${e}cc 65%,#0b1220 130%)">
        ...
        ${i?`<img src="${toHttpsUrl(i)}" aria-hidden="true" style="position:absolute;left:50%;top:50%;transform:translate(-50%,-50%);max-height:84%;max-width:160px;width:auto;height:auto;opacity:.20;object-fit:contain;pointer-events:none;filter:drop-shadow(0 0 20px ${e})" onerror="this.style.display='none'">`:""}
        <div style="position:relative;z-index:1;display:flex;align-items:center;justify-content:space-between;gap:10px;flex-wrap:wrap">
          <div style="display:flex;align-items:center;gap:14px;min-width:0">
            ${i?`<img src="${toHttpsUrl(i)}" style="width:62px;height:62px;object-fit:contain;border-radius:16px;background:rgba(255,255,255,.16);border:1px solid rgba(255,255,255,.26);padding:7px;flex-shrink:0;box-shadow:0 4px 14px rgba(0,0,0,.22)" onerror="this.style.display='none'">`:""}
          ...
          <div style="display:flex;align-items:center;gap:8px;flex-shrink:0">
            ...
            <span style="color:rgba(255,255,255,.55);font-size:12px;font-weight:700">${r}</span>
          </div>
        </div>
        ${T?`<div style="position:relative;z-index:1;display:flex;align-items:center;gap:6px;flex-wrap:wrap;margin-top:16px">${T}</div>`:""}
      </div>
      <div style="position:relative;overflow:hidden;background:linear-gradient(180deg,${_b2PastelBg(e,.26)} 0%,${_b2PastelBg(e,.18)} 100%);padding:26px 28px 32px">
        ${i?`<img src="${toHttpsUrl(i)}" style="position:absolute;top:50%;left:50%;transform:translate(-50%,-50%);width:58%;max-width:560px;opacity:.16;object-fit:contain;pointer-events:none;z-index:0" onerror="this.style.display='none'">`:""}
        <div style="position:relative;z-index:1">
          ${y?`
          ...
          <div style="display:grid;grid-template-columns:repeat(auto-fill,minmax(170px,1fr));gap:16px;margin-bottom:24px">${y}</div>
          ...
          <div style="display:grid;grid-template-columns:repeat(auto-fill,minmax(170px,1fr));gap:16px">${f}</div>
        </div>
      </div>
    </div>`}function _b2LineupView(){const t=_b2VisUnivs().filter(n=>n.name!=="\uBB34\uC18C\uC18D");if(!t.length)return'<div style="text-align:center;color:var(--text3);padding:40px">\uB4F1\uB85D\uB41C \uB300\uD559\uC774 \uC5C6\uC2B5\uB2C8\uB2E4</div>';(!_b2LineupUniv||!t.some(n=>n.name===_b2LineupUniv))&&(_b2LineupUniv=t[0].name);const e=gc(_b2LineupUniv);return`<div style="max-width:1360px;margin:0 auto">${_b2LineupPoster(_b2LineupUniv,e,!1)}</div>`}async function saveB2LineupImg(){const t=_b2VisUnivs().filter(f=>f.name!=="\uBB34\uC18C\uC18D");if((!_b2LineupUniv||!t.some(f=>f.name===_b2LineupUniv))&&(_b2LineupUniv=t[0]?t[0].name:""),!_b2LineupUniv){alert("\uC800\uC7A5\uD560 \uB300\uD559\uC774 \uC5C6\uC2B5\uB2C8\uB2E4.");return}const e=document.querySelector('[onclick="saveB2LineupImg()"]');e&&(e.disabled=!0,e.textContent="\u23F3...");const n=1360,c=0,i=gc(_b2LineupUniv),g=document.createElement("div");g.style.cssText=`position:fixed;left:-9999px;top:0;padding:${c}px;background:#f0f2f5;box-sizing:border-box;width:${n+c*2}px`,g.innerHTML=_b2LineupPoster(_b2LineupUniv,i,!0),document.body.appendChild(g),g.querySelectorAll(".no-export,.no-export-movebtns").forEach(f=>f.remove()),await new Promise(f=>setTimeout(f,100)),injectUnivIcons(g);const a=g.scrollHeight+8,x=g.scrollWidth,y=`\uB300\uD559\uB77C\uC778\uC5C5_${_b2LineupUniv}_`+new Date().toISOString().slice(0,10)+".png";try{if(typeof _captureAndSave!="function")throw new Error("\uC774\uBBF8\uC9C0 \uC800\uC7A5 \uAE30\uB2A5\uC744 \uBD88\uB7EC\uC624\uC9C0 \uBABB\uD588\uC2B5\uB2C8\uB2E4.");await _captureAndSave(g,x,a,y)}catch(f){console.error("[\uB77C\uC778\uC5C5 \uC774\uBBF8\uC9C0 \uC800\uC7A5 \uC2E4\uD328]",f),alert(`\u274C \uC774\uBBF8\uC9C0 \uC800\uC7A5 \uC2E4\uD328

`+(f.message||"\uC54C \uC218 \uC5C6\uB294 \uC624\uB958\uAC00 \uBC1C\uC0DD\uD588\uC2B5\uB2C8\uB2E4."))}finally{document.body.removeChild(g),e&&(e.disabled=!1,e.textContent="\u{1F4F7} \uC774\uBBF8\uC9C0\uC800\uC7A5")}}async function saveB2FreeImg(){const t=document.querySelector('[onclick="saveB2FreeImg()"]');t&&(t.disabled=!0,t.textContent="\u23F3...");const e=720,n=24,c=document.createElement("div");c.style.cssText=`position:fixed;left:-9999px;top:0;padding:${n}px;background:#f0f2f5;box-sizing:border-box;width:${e+n*2}px`,c.innerHTML=`<style>.b2-bottom-img{max-width:160px;max-height:130px;object-fit:contain;}</style>${_b2FreeView()}`,document.body.appendChild(c),c.querySelectorAll(".no-export,.no-export-movebtns").forEach(x=>x.remove()),await new Promise(x=>setTimeout(x,100)),injectUnivIcons(c);const i=c.scrollHeight+32,g=c.scrollWidth,a="\uBB34\uC18C\uC18D\uD604\uD669\uD310_"+new Date().toISOString().slice(0,10)+".png";try{if(typeof _captureAndSave!="function")throw new Error("\uC774\uBBF8\uC9C0 \uC800\uC7A5 \uAE30\uB2A5\uC744 \uBD88\uB7EC\uC624\uC9C0 \uBABB\uD588\uC2B5\uB2C8\uB2E4.");await _captureAndSave(c,g,i,a)}catch(x){console.error("[\uBB34\uC18C\uC18D \uD604\uD669\uD310 \uC774\uBBF8\uC9C0 \uC800\uC7A5 \uC2E4\uD328]",x),alert(`\u274C \uC774\uBBF8\uC9C0 \uC800\uC7A5 \uC2E4\uD328

`+(x.message||"\uC54C \uC218 \uC5C6\uB294 \uC624\uB958\uAC00 \uBC1C\uC0DD\uD588\uC2B5\uB2C8\uB2E4."))}finally{document.body.removeChild(c),t&&(t.disabled=!1,t.textContent="\u{1F4F7} \uC774\uBBF8\uC9C0\uC800\uC7A5")}}function _b2ContrastColor(t){try{const e=String(t||"").replace("#","").trim(),n=parseInt(e.slice(0,2),16),c=parseInt(e.slice(2,4),16),i=parseInt(e.slice(4,6),16);if([n,c,i].some(f=>Number.isNaN(f)))return"#ffffff";const g=f=>(f/=255,f<=.03928?f/12.92:Math.pow((f+.055)/1.055,2.4)),a=.2126*g(n)+.7152*g(c)+.0722*g(i),x=(1+.05)/(a+.05),y=(a+.05)/(.02+.05);return x>=y?"#ffffff":"#0f172a"}catch(e){return"#ffffff"}}localStorage.removeItem("su_b2SelectedPlayer"),(function(){const t=players.filter(c=>c&&!c.hidden&&!c.retired&&!c.hideFromBoard),e=t.filter(c=>c.photo||window.playerPhotos&&window.playerPhotos[c.name]),n=e.length?e:t;n.length&&(_b2SelectedPlayer=n[Math.floor(Math.random()*n.length)])})();
      ...
      `:""}`};f&&W==="\uC804\uCCB4"&&(m+=`<section class="b2w2-monthly-grid">
        ...
        <div class="b2w2-card-head" onclick="(function(){
          ...
          <div class="b2w2-card-title">
            <span class="b2w2-card-dot" style="background:${x}"></span>
            <div style="min-width:0">
