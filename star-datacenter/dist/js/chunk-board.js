...
`+n),100)}},window._autoSyncApply=async function(){const t=await _fetchGithubData();return _applyFetchedCloudData(t)};var _brdPhotoCache=(function(){try{const t=localStorage.getItem("su_brd_photo_cache");return t?JSON.parse(t):{}}catch(t){return{}}})();(async function(){try{if(typeof MiscStore=="undefined")return;const e=await MiscStore.get("su_brd_photo_cache");e&&typeof e=="object"&&(_brdPhotoCache=e)}catch(e){}})();function _brdPhotoCacheSet(t,e){e?_brdPhotoCache[t]=e:delete _brdPhotoCache[t];try{typeof MiscStore!="undefined"?MiscStore.set("su_brd_photo_cache",_brdPhotoCache):localStorage.setItem("su_brd_photo_cache",JSON.stringify(_brdPhotoCache))}catch(o){}}function _getBrdPhoto(t){return t.photo||window.playerPhotos&&window.playerPhotos[t.name]||_brdPhotoCache[t.name]||""}let boardSelUniv="\uC804\uCCB4",boardCompactMode=!1,boardGridCols=1,boardCardView=!1,boardCardShape="circle",boardCollapsed=new Set;var boardChipPhotoShape=localStorage.getItem("su_bcp_shape")||"circle",boardChipPhotoSize=parseInt(localStorage.getItem("su_bcp_size")||"26",10),boardChipLayoutScale=parseInt(localStorage.getItem("su_bcp_layout")||"100",10);function saveBoardChipPhotoSettings(){localStorage.setItem("su_bcp_shape",boardChipPhotoShape),localStorage.setItem("su_bcp_size",String(boardChipPhotoSize)),localStorage.setItem("su_bcp_layout",String(boardChipLayoutScale||100));try{typeof window.cfgTouchPrefsSync=="function"&&window.cfgTouchPrefsSync()}catch(t){}try{typeof applyProfileShapeVars=="function"&&applyProfileShapeVars()}catch(t){}}let boardPlayerOrder=J("su_bpo")||{};function _findBrdCardByUniv(t,e){try{const o=e||document.getElementById("board-wrap")||document,n=o&&o.querySelectorAll?o.querySelectorAll(".brd-card"):[];for(const i of n)if(i&&i.dataset&&i.dataset.univ===t)return i;return null}catch(o){return null}}function _getBoardUnivs(){const t=getAllUnivs();if(!boardOrder.length)return t;const e=[],o=new Set;return boardOrder.forEach(n=>{const i=t.find(r=>r.name===n);i&&!o.has(i.name)&&(e.push(i),o.add(i.name))}),t.forEach(n=>{o.has(n.name)||(e.push(n),o.add(n.name))}),e}function toggleBoardUniv(t){if(typeof boardSelUniv=="undefined")return;boardSelUniv=boardSelUniv===t?"\uC804\uCCB4":t;const e=document.getElementById("board-univ-sel");e&&(e.value=boardSelUniv),_updateBoardSaveLabel(),render()}function _brdCollapseToggle(t){boardCollapsed.has(t)?boardCollapsed.delete(t):boardCollapsed.add(t);const e=_findBrdCardByUniv(t);if(!e)return;const o=e.querySelector(".brd-card-body");o&&(o.style.display=boardCollapsed.has(t)?"none":"");const n=e.querySelector(".brd-collapse-btn");n&&(n.textContent=boardCollapsed.has(t)?"\u25B6":"\u25BC")}function _brdCollapseAll(){_getBoardUnivs().forEach(t=>boardCollapsed.add(t.name)),document.querySelectorAll(".brd-card").forEach(t=>{const e=t.querySelector(".brd-card-body");e&&(e.style.display="none");const o=t.querySelector(".brd-collapse-btn");o&&(o.textContent="\u25B6")})}function _brdExpandAll(){boardCollapsed.clear(),document.querySelectorAll(".brd-card").forEach(t=>{const e=t.querySelector(".brd-card-body");e&&(e.style.display="");const o=t.querySelector(".brd-collapse-btn");o&&(o.textContent="\u25BC")})}function _updateBoardSaveLabel(){const t=document.getElementById("btn-img-save-label"),e=document.getElementById("brd-save-btn-label"),o=boardSelUniv&&boardSelUniv!=="\uC804\uCCB4"?boardSelUniv+" \uC774\uBBF8\uC9C0\uC800\uC7A5":"\uC774\uBBF8\uC9C0\uC800\uC7A5";t&&(t.textContent=o),e&&(e.textContent=o)}function _captureErrText(t){try{if(!t)return"\uC54C \uC218 \uC5C6\uB294 \uC624\uB958";if(typeof t=="string")return t;if(t instanceof Error)return t.message||String(t);if(typeof Event!="undefined"&&t instanceof Event)return"\uC774\uBCA4\uD2B8 \uC624\uB958("+(t&&t.type?t.type:"event")+")";if(t&&typeof t=="object"){if(typeof t.message=="string"&&t.message)return t.message;if(typeof t.type=="string"&&t.type)return"\uC774\uBCA4\uD2B8 \uC624\uB958("+t.type+")"}return String(t)}catch(e){return"\uC54C \uC218 \uC5C6\uB294 \uC624\uB958"}}window.saveCurrentView=async function(){const e=document.getElementById("cap");if(!e){alert("\uCEA1\uCC98\uD560 \uC601\uC5ED\uC774 \uC5C6\uC2B5\uB2C8\uB2E4.");return}const o=document.getElementById("btn-img-save"),n=o?o.innerHTML:"";o&&(o.disabled=!0,o.innerHTML="\u23F3 \uC800\uC7A5\uC911");const i=g=>{try{const m=document.getElementById("_save-toast");m&&(m.innerHTML=g)}catch(m){}},r=document.createElement("div"),d=e.getBoundingClientRect(),l=Math.max(320,Math.round(d.width||e.scrollWidth||900)),p=Math.max(200,Math.round(e.scrollHeight||e.offsetHeight||d.height||600));r.style.cssText=`position:fixed;left:-9999px;top:0;width:${l}px;min-height:${p}px;background:#ffffff;padding:24px;box-sizing:border-box;`,r.innerHTML=e.innerHTML,r.querySelectorAll(".no-export").forEach(g=>g.remove()),document.body.appendChild(r);try{typeof _showSaveLoading=="function"&&_showSaveLoading(),i('<span style="display:inline-block;animation:_spin .8s linear infinite">\u23F3</span> \uC900\uBE44 \uC911...');try{const a="download"in document.createElement("a"),c=String(navigator.userAgent||""),u=/iPad|iPhone|iPod/i.test(c),x=/KAKAOTALK|Instagram|FBAN|FBAV|NAVER|Whale|Line/i.test(c);if(!a||u||x){const f=window.open("","_blank");if(f){try{f.document.write('<html><head><meta charset="utf-8"><title>\uC774\uBBF8\uC9C0 \uC0DD\uC131 \uC911...</title></head><body style="margin:0;font-family:sans-serif;background:#111;color:#fff;padding:14px">\uC774\uBBF8\uC9C0 \uC0DD\uC131 \uC911\uC785\uB2C8\uB2E4... \uC7A0\uC2DC\uB9CC \uAE30\uB2E4\uB824\uC8FC\uC138\uC694.</body></html>'),f.document.close()}catch(w){}window.__captureDlWin=f}}}catch(s){}try{typeof _applyBoardBgAutoSizing=="function"&&_applyBoardBgAutoSizing(r),typeof _b2ApplyBgAutoSizing=="function"&&_b2ApplyBgAutoSizing(r)}catch(s){}const g=Math.max(320,r.scrollWidth||l),m=Math.max(200,r.scrollHeight||p),h=`\uC2A4\uD0C0\uB300\uD559_${{total:"\uC2A4\uD2B8\uB9AC\uBA38",board2:"\uD604\uD669\uD310",tier:"\uD2F0\uC5B4\uC21C\uC704",mini:"\uBBF8\uB2C8\uB300\uC804",univm:"\uB300\uD559\uB300\uC804",univck:"\uB300\uD559CK",comp:"\uB300\uD68C",pro:"\uD504\uB85C\uB9AC\uADF8",hist:"\uB300\uC804\uAE30\uB85D",stats:"\uD1B5\uACC4",cal:"\uCE98\uB9B0\uB354"}[window.curTab]||window.curTab||"\uD654\uBA74"}_${new Date().toISOString().slice(0,10)}.png`;await _captureAndSave(r,g,m,h)}catch(g){alert("\uC774\uBBF8\uC9C0 \uC800\uC7A5 \uC624\uB958: "+_captureErrText(g))}finally{r.parentNode&&document.body.removeChild(r),typeof _hideSaveLoading=="function"&&_hideSaveLoading(),o&&(o.disabled=!1,o.innerHTML=n)}};function _getBoardPlayers(t,e=!1){const o=players.filter(r=>r.univ===t&&(e||!r.retired)&&!r.hideFromBoard&&!r.hidden),n=boardPlayerOrder[t]||[];if(!n.length)return t==="\uBB34\uC18C\uC18D"?[...o].sort((r,d)=>TIERS.indexOf(r.tier)-TIERS.indexOf(d.tier)||d.points-r.points):[...o].sort((r,d)=>{const l=getRoleOrder(r.role),p=getRoleOrder(d.role);return l!==p?l-p:TIERS.indexOf(r.tier)-TIERS.indexOf(d.tier)||d.points-r.points});const i=[];return n.forEach(r=>{const d=o.find(l=>l.name===r);d&&i.push(d)}),o.forEach(r=>{n.includes(r.name)||i.push(r)}),i}function saveBoardPlayerOrder(){localStorage.setItem("su_bpo",JSON.stringify(boardPlayerOrder))}const _brdBgImageMeta={};let _brdBgAutoResizeBound=!1;function _loadBoardBgImageMeta(t,e){try{const o=toHttpsUrl(t||"");if(!o){e&&e(null);return}if(_brdBgImageMeta[o]&&_brdBgImageMeta[o].w&&_brdBgImageMeta[o].h){e&&e(_brdBgImageMeta[o]);return}const n=new Image;n.onload=function(){_brdBgImageMeta[o]={w:n.naturalWidth||0,h:n.naturalHeight||0},e&&e(_brdBgImageMeta[o])},n.onerror=function(){e&&e(null)},n.src=o}catch(o){e&&e(null)}}function _resolveBoardAutoFit(t,e,o,n){const i=String(e||"auto");if(i==="cover"||i==="contain"||i==="fill")return i;const r=window.innerWidth||1280;if(!o||!o.width||!o.height)return t==="card"?r<=900?"contain":"cover":t==="profile"?r<=640?"contain":"cover":r<=900?"contain":"cover";if(!n||!n.w||!n.h)return t==="profile"?r<=640||o.width<=70?"contain":"cover":t==="card"?r<=900||o.width<120?"contain":"cover":r<=640||o.width<300?"contain":"cover";const d=o.width/o.height,l=n.w/n.h,p=Math.abs(Math.log(l/d));return t==="profile"?r<=640?p>.33?"contain":"cover":r<=1024?p>.3?"contain":"cover":l>1.55||l<.7||p>.28?"contain":"cover":t==="card"?r<=640?p>.24?"contain":"cover":r<=1024?p>.28?"contain":"cover":l>1.14||l<.5||p>.3?"contain":"cover":r<=640?p>.32?"contain":"cover":r<=1024?p>.3?"contain":"cover":o.width<280||o.height<220?p>.24?"contain":"cover":l>1.75||l<.64||p>.4?"contain":"cover"}function _resolveBoardBgSizeMode(t,e,o){return _resolveBoardAutoFit("bg",t,e,o)}function _resolveBoardAutoPosition(t,e,o,n){if(e!=="cover")return"center center";const i=n&&n.w&&n.h?n.w/n.h:1,r=o&&o.width&&o.height?o.width/o.height:1;if(!i||!r)return"center center";const d=r/i;return t==="bg"?d>2.1&&o&&o.height>=260?"bottom center":d>1.35?"top center":"center center":t==="card"?d>1.55||d>1.2?"top center":"center center":t==="profile"&&d>1.45?"top center":"center center"}function _applyBoardBgAutoSizing(t){try{const e=t||document,o=r=>{const d=[];return e&&e.matches&&e.matches(r)&&d.push(e),e&&e.querySelectorAll&&d.push(...e.querySelectorAll(r)),d};o(".brd-bg-layer[data-bg-size-mode]").forEach(r=>{const d=r.getAttribute("data-bg-size-mode")||"auto",l=r.closest(".brd-body")||r.parentElement,p=l?l.getBoundingClientRect():null;if(d!=="auto"){r.style.backgroundSize=d;return}const g=r.getAttribute("data-bg-src")||"";_loadBoardBgImageMeta(g,y=>{const h=_resolveBoardBgSizeMode(d,p,y);r.style.backgroundSize=h,r.setAttribute("data-bg-size-resolved",h)})}),o(".brd-fit-auto[data-fit-kind]").forEach(r=>{const d=r.getAttribute("data-fit-mode")||"auto",l=r.getAttribute("data-fit-kind")||"profile",p=r.getBoundingClientRect?r.getBoundingClientRect():null,g=y=>{const h=_resolveBoardAutoFit(l,d,p,y);r.style.objectFit=h;const s=_resolveBoardAutoPosition(l,h,p,y);r.style.objectPosition=s,r.setAttribute("data-fit-resolved",h)},m=r.currentSrc||r.getAttribute("src")||"";_loadBoardBgImageMeta(m,g)})}catch(e){}}function _bindBoardBgAutoResize(){if(_brdBgAutoResizeBound)return;_brdBgAutoResizeBound=!0;const t=()=>{try{const e=document.getElementById("board-wrap");if(!e)return;requestAnimationFrame(()=>_applyBoardBgAutoSizing(e))}catch(e){}};window.addEventListener("resize",t),window.addEventListener("orientationchange",()=>setTimeout(t,80)),document.addEventListener("visibilitychange",()=>{document.visibilityState==="visible"&&setTimeout(t,60)})}function rBoard(t,e){e.textContent="\u{1F4CA} \uD604\uD669\uD310";const o=_getBoardUnivs(),n=_boardCanManage(),i=(n?o:o.filter(b=>!b.hidden)).filter(b=>!b.dissolved);if(!o.length){t.innerHTML='<div style="padding:40px;text-align:center;color:var(--gray-l)">\uB4F1\uB85D\uB41C \uC120\uC218\uAC00 \uC5C6\uC2B5\uB2C8\uB2E4.</div>';return}const r=(b,v)=>{try{const S=String(b||"#64748b").replace("#",""),B=parseInt(S.slice(0,2),16),$=parseInt(S.slice(2,4),16),k=parseInt(S.slice(4,6),16);return`rgba(${B},${$},${k},${v})`}catch(S){return`rgba(100,116,139,${v||.2})`}},d=b=>{try{const v=String(b||"").replace("#","").trim(),S=parseInt(v.slice(0,2),16),B=parseInt(v.slice(2,4),16),$=parseInt(v.slice(4,6),16),k=C=>(C/=255,C<=.03928?C/12.92:Math.pow((C+.055)/1.055,2.4)),E=.2126*k(S)+.7152*k(B)+.0722*k($);return(1+.05)/(E+.05)>=(E+.05)/(.02+.05)?"#ffffff":"#0f172a"}catch(v){return"#ffffff"}},l=Math.max(.7,Math.min(1.8,(boardChipLayoutScale||100)/100)),p=Math.round(7*l),g=Math.round(5*l),m=Math.round(10*l),y=Math.round(12*l),h=Math.round(9*l),s=i.flatMap(b=>_getBoardPlayers(b.name)),a={};s.forEach(b=>{const v=b.tier||"?";a[v]=(a[v]||0)+1});const c=i.length>0&&i.every(b=>boardCollapsed.has(b.name)),u=boardSelUniv!=="\uC804\uCCB4"&&gc(boardSelUniv)||"#2563eb",x=d(u),f=boardSelUniv!=="\uC804\uCCB4"?boardSelUniv:"\uC804\uCCB4 \uB300\uD559",w=TIERS.filter(b=>a[b]).map(b=>`<span style="font-size:10px;font-weight:800;padding:3px 8px;border-radius:999px;background:${getTierBtnColor(b)||"#64748b"};color:${getTierBtnTextColor(b)||"#fff"}">${b} ${a[b]}</span>`).join(""),I=`<div class="brd-mini-stats">
  ...
  <div id="board-wrap" style="display:grid;grid-template-columns:${boardGridCols===2?"repeat(2,1fr)":"1fr"};gap:14px;align-items:start">`;(boardSelUniv==="\uC804\uCCB4"?i:i.filter(b=>b.name===boardSelUniv)).forEach(b=>{_+=buildUnivBoardCard(b)}),_+=`</div>
</div>
`,t.innerHTML=_,injectUnivIcons(t),requestAnimationFrame(()=>{injectUnivIcons(t),initBoardDrag(),_bindBoardBgAutoResize(),_applyBoardBgAutoSizing(t)}),_brdPopupListenerAdded||(document.addEventListener("click",_closeBrdPopup,{capture:!0}),_brdPopupListenerAdded=!0)}
...
function _b2NameTag(e,t,n){const o=e.crewName&&typeof _gcCrew=="function"&&_gcCrew(e.crewName)||"",a=(e.name||"").replace(/'/g,"\\'");return`
    <div style="display:flex;align-items:center;gap:6px;padding:3px 8px 3px 3px;border-radius:20px;cursor:pointer;transition:background .12s"
      ...
      ${n&&e.tier?`<span style="font-size:10px;font-weight:700;padding:1px 5px;border-radius:4px;background:${getTierBtnColor(e.tier)};color:${getTierBtnTextColor(e.tier)||"#fff"};flex-shrink:0">${e.tier}</span>`:""}
    ...
    </div>`}function _b2PlayerRowCompact(e,t){const n=getTierBtnColor(e.tier||""),o=getTierBtnTextColor(e.tier||"")||"#fff",a=(e.name||"").replace(/'/g,"\\'");return`
    <div style="display:flex;align-items:center;gap:8px;cursor:pointer;flex:1"
      ...
      <span style="font-size:11px;font-weight:700;padding:2px 8px;border-radius:6px;background:${n};color:${o}">${e.tier||"?"}</span>
      </div>
    </div>`}function _b2Chip(e,t){const n=e.crewName&&typeof _gcCrew=="function"&&_gcCrew(e.crewName)||"",o=`border:1.5px solid ${t}44`;return`
    <div onclick="openPlayerModal('${(e.name||"").replace(/'/g,"\\'")}')"
      style="display:flex;align-items:center;gap:7px;padding:5px 13px 5px 5px;border-radius:24px;background:var(--white);${o};cursor:pointer;box-shadow:0 1px 3px #0001;transition:transform .1s,box-shadow .1s"
    ...
    </div>`}function _b2Avatar(e,t,n){const o={T:"T",Z:"Z",P:"P",N:"?"}[e.race||"N"]||"?",a=typeof window.escAttr=="function"?window.escAttr:s=>String(s||"").replace(/&/g,"&amp;").replace(/"/g,"&quot;").replace(/</g,"&lt;").replace(/>/g,"&gt;"),c=typeof window.escJS=="function"?window.escJS:s=>String(s||"").replace(/\\/g,"\\\\").replace(/'/g,"\\'").replace(/\r/g,"\\r").replace(/\n/g,"\\n"),w=n||28;let d=1;try{const s=parseInt(localStorage.getItem("su_bcp_size")||"26",10);d=Math.max(.6,Math.min(2.4,s/26))}catch(s){console.warn("[_b2Avatar] \uC544\uBC14\uD0C0 \uD06C\uAE30 \uC124\uC815 \uB85C\uB4DC \uC2E4\uD328:",s.message)}const r=Math.round(w*d),i=Math.round(r*.38),l=getStatusIcon(e.name),x=getStatusIconHTML(e.name),p=a(t),y=c(t),b=c(o),$=c(e&&e.name?e.name:""),g=r/2,f=i/2,m=Math.round(g*.134-f),_=Math.round(g*.5-f),h=l&&(typeof window._siIsImg=="function"?window._siIsImg(l):!1),v=h?`<img src="${a(l)}" crossorigin="anonymous" style="width:${i}px;height:${i}px;border-radius:50%;object-fit:cover;opacity:.82" onerror="this.style.display='none';console.warn('[\uD604\uD669\uD310] \uC0C1\uD0DC \uC544\uC774\uCF58 \uB85C\uB4DC \uC2E4\uD328:', this.src)">`:x.replace(/margin-left:[^;]+;/g,"").replace(/font-size:[^;]+;/g,""),u=x?`<span style="position:absolute;top:${m}px;right:${_}px;width:${i}px;height:${i}px;border-radius:50%;background:${h?"rgba(255,255,255,.72)":"transparent"};overflow:hidden;display:flex;align-items:center;justify-content:center;font-size:${Math.round(i*.82)}px;line-height:1;filter:drop-shadow(0 1px 2px rgba(0,0,0,.65))">${v}</span>`:"";return e.photo?`<span style="width:${r}px;height:${r}px;flex-shrink:0;display:inline-flex;position:relative">
      <img src="${a(toHttpsUrl(e.photo))}" crossorigin="anonymous" loading="lazy" decoding="async" fetchpriority="low" data-b2-photo="1" style="width:${r}px;height:${r}px;border-radius:var(--su_profile_radius,6px);object-fit:cover;flex-shrink:0;border:2px solid ${p}88" onerror="console.warn('[\uD604\uD669\uD310] \uC120\uC218 \uD504\uB85C\uD544 \uC774\uBBF8\uC9C0 \uB85C\uB4DC \uC2E4\uD328:', this.src, '\uC120\uC218:', '${$}');this.parentNode.innerHTML=_b2AvatarFallback('${b}','${y}',${r})">
      ${u}
    </span>`:`<span style="width:${r}px;height:${r}px;border-radius:var(--su_profile_radius,6px);background:${p};display:inline-flex;align-items:center;justify-content:center;font-weight:900;font-size:${Math.round(r*.45)}px;color:#fff;flex-shrink:0;border:2px solid ${p}88;position:relative">${o}${u}</span>`}function _b2AvatarFallback(e,t,n){const o=n||28;return`<span style="width:${o}px;height:${o}px;border-radius:var(--su_profile_radius,6px);background:${t};display:inline-flex;align-items:center;justify-content:center;font-weight:900;font-size:${Math.round(o*.45)}px;color:#fff;flex-shrink:0;border:2px solid ${t}88">${e}</span>`}try{window._b2NameTag=_b2NameTag,window._b2PlayerRowCompact=_b2PlayerRowCompact,window._b2Chip=_b2Chip,window._b2Avatar=_b2Avatar,window.Board2CardUtils=window.Board2CardUtils||{nameTag:_b2NameTag,playerRowCompact:_b2PlayerRowCompact,chip:_b2Chip,avatar:_b2Avatar}}catch(e){}

/* board2-core.js */
var k,T,I,B,L,$;function _b2InjectAndRunScripts(n){n.querySelectorAll("script").forEach(r=>{const i=document.createElement("script");r.src?i.src=r.src:i.textContent=r.textContent,r.parentNode.replaceChild(i,r)})}if(typeof window._siIsImg!="function"&&(window._siIsImg=function(n){return typeof n=="string"&&(n.startsWith("http")||n.startsWith("data:"))}),typeof window._siRender!="function"&&(window._siRender=function(n,t){return t=t||"16px",n?window._siIsImg(n)?`<img src="${n}" style="width:${t};height:${t};object-fit:contain;vertical-align:middle;flex-shrink:0" onerror="this.style.display='none'">`:n:""}),typeof _b2NameTag!="function")var _b2NameTag=function(n,t,r){try{if(window.Board2CardUtils&&typeof window.Board2CardUtils.nameTag=="function")return window.Board2CardUtils.nameTag(n,t,r);if(typeof window._b2NameTag=="function")return window._b2NameTag(n,t,r)}catch(h){}const i=n&&n.name||"",o=String(i).replace(/'/g,"\\'"),a=n&&n.tier||"",d=n&&n.race||"",u=!!(n&&n.inactive),g=typeof getTierBtnColor=="function"?getTierBtnColor(a):"#64748b",y=typeof getTierBtnTextColor=="function"&&getTierBtnTextColor(a)||"#fff";return`
    ...
    <div class="b2-shell">
      ...
      <div class="b2-toolbar-card">
        ...
        ${U}
          ...
          ${M}
          <div class="b2-toolbar-actions">${z}</div>
        </div>
      </div>
      ${_b2View==="lineup"?`
      <div style="display:flex;align-items:center;gap:8px;margin:-6px 0 14px;padding:8px 12px;background:var(--surface);border:1px solid var(--border);border-radius:12px;overflow-x:auto;scrollbar-width:none" class="b2-lineup-jumpbar">
        ...
        ${o.map(e=>{const l=gc(e.name),s=e.name===_b2LineupUniv;return`<button type="button" onclick="_b2LineupUniv='${e.name.replace(/'/g,"\\'")}';document.getElementById('b2-content').innerHTML=_b2LineupView();injectUnivIcons(document.getElementById('b2-content'));render();" style="padding:3px 11px;border-radius:999px;border:1px solid ${s?l:"transparent"};background:${s?l+"1a":"var(--white)"};color:${s?l:"var(--text3)"};font-size:11px;font-weight:${s?900:700};cursor:pointer;white-space:nowrap;flex-shrink:0;transition:all .15s">${e.name}</button>`}).join("")}
      </div>
      `:""}
  ...
  `;n.innerHTML=q;try{const e=()=>{try{if(typeof prewarmImageUrls!="function")return;const l=new Set((typeof univCfg!="undefined"?univCfg:[]).filter(b=>b.dissolved||b.hidden).map(b=>String(b.name||"").trim())),s=[];(Array.isArray(players)?players:[]).filter(b=>b&&!b.hidden&&!b.retired&&!b.hideFromBoard&&!l.has(String((b==null?void 0:b.univ)||"").trim())).slice(0,220).forEach(b=>{b.photo&&s.push(b.photo)}),prewarmImageUrls(s,180)}catch(l){}};typeof window.requestIdleCallback=="function"?window.requestIdleCallback(e,{timeout:1200}):setTimeout(e,450)}catch(e){}const G=document.getElementById("b2-content"),O=()=>{const e=document.getElementById("b2-content");if(!e)return;if(new Set(["univ","femco","free","players","lineup","summary","weekly","ranking","radar","compare","heatmap","bubble","old"]).has(String(_b2View||""))||(_b2View="univ"),_b2View==="univ"){e.innerHTML=_b2UnivView(),injectUnivIcons(e),_b2BindAutoFitResize();try{_b2LazyLoadBgLayers(e)}catch(s){}setTimeout(()=>{try{window._precacheVisibleImages&&window._precacheVisibleImages(e,60)}catch(s){}},120)}else _b2View==="femco"?(e.innerHTML=_b2FemcoView(),injectUnivIcons(e),setTimeout(()=>{try{window._precacheVisibleImages&&window._precacheVisibleImages(e,80)}catch(s){}},120),requestAnimationFrame(()=>{try{e.querySelectorAll(".b2-femco-grid").forEach(s=>{s.scrollLeft=0})}catch(s){console.warn("[rBoard] \uD3A8\uCF54 \uADF8\uB9AC\uB4DC \uC2A4\uD06C\uB864 \uCD08\uAE30\uD654 \uC2E4\uD328:",s.message)}})):_b2View==="free"?(e.innerHTML=_b2FreeView(),injectUnivIcons(e),setTimeout(()=>{try{window._precacheVisibleImages&&window._precacheVisibleImages(e,60)}catch(s){}},120)):_b2View==="players"?(e.innerHTML=_b2PlayersView(),_b2BindAutoFitResize(),setTimeout(()=>{try{_b2SelectedPlayer&&typeof _b2ApplyImgSettingsToDom=="function"&&(_b2ApplyImgSettingsToDom(_b2SelectedPlayer.name,"primary"),_b2ApplyImgSettingsToDom(_b2SelectedPlayer.name,"secondary")),_b2ApplyBgAutoSizing(e)}catch(s){console.error("[rBoard] \uC774\uBBF8\uC9C0 \uC124\uC815 \uC801\uC6A9 \uC2E4\uD328:",s.message)}},0),setTimeout(()=>{try{window._precacheVisibleImages&&window._precacheVisibleImages(e,80)}catch(s){}},160)):_b2View==="lineup"?(e.innerHTML=_b2LineupView(),injectUnivIcons&&injectUnivIcons(e),setTimeout(()=>{try{window._precacheVisibleImages&&window._precacheVisibleImages(e,60)}catch(s){}},120)):_b2View==="summary"?(e.innerHTML=_b2SummaryView(),injectUnivIcons&&injectUnivIcons(e)):_b2View==="weekly"?(e.innerHTML=_b2WeeklyBriefingView(),injectUnivIcons&&injectUnivIcons(e),_b2InjectAndRunScripts(e)):_b2View==="ranking"?(e.innerHTML=_b2RankingView(),injectUnivIcons&&injectUnivIcons(e)):_b2View==="radar"?(e.innerHTML=_b2RadarView(),_b2InjectAndRunScripts(e)):_b2View==="compare"?(e.innerHTML=_b2CompareView(),injectUnivIcons&&injectUnivIcons(e)):_b2View==="heatmap"?(e.innerHTML=_b2HeatmapView(),_b2InjectAndRunScripts(e)):_b2View==="bubble"?(e.innerHTML=_b2BubbleView(),_b2InjectAndRunScripts(e)):_b2View==="old"&&(typeof rBoard=="function"?rBoard(e,t):(e.innerHTML='<div style="padding:40px;text-align:center;color:var(--gray-l)">\uAD6C\uD604\uD669\uD310 \uB85C\uB529 \uC911...</div>',(async()=>{try{typeof window._ensureCloudBoardLoaded=="function"&&await window._ensureCloudBoardLoaded()}catch(s){}try{if(_b2View!=="old")return;typeof rBoard=="function"?rBoard(e,t):e.innerHTML='<div style="padding:40px;text-align:center;color:var(--gray-l)">\uAD6C\uD604\uD669\uD310\uC744 \uBD88\uB7EC\uC62C \uC218 \uC5C6\uC2B5\uB2C8\uB2E4.</div>'}catch(s){e.innerHTML='<div style="padding:40px;text-align:center;color:#dc2626">\uAD6C\uD604\uD669\uD310 \uC624\uB958: '+String(s&&s.message||s)+"</div>"}})()))};try{O()}catch(e){console.error("[rBoard2] sub render fail",e);try{const l=document.getElementById("b2-content");l&&(l.innerHTML='<div style="padding:40px;text-align:center;color:#dc2626">\uD604\uD669\uD310 \uB80C\uB354\uB9C1 \uC624\uB958: '+String(e&&e.message||e)+"</div>")}catch(l){}}}catch(i){console.error("[rBoard2] \uC624\uB958:",i),n.innerHTML=`<div style="padding:40px;text-align:center;color:#dc2626">
...
var at=Object.defineProperty,st=Object.defineProperties;var dt=Object.getOwnPropertyDescriptors;var Ne=Object.getOwnPropertySymbols;var lt=Object.prototype.hasOwnProperty,pt=Object.prototype.propertyIsEnumerable;var Ge=(t,e,i)=>e in t?at(t,e,{enumerable:!0,configurable:!0,writable:!0,value:i}):t[e]=i,xe=(t,e)=>{for(var i in e||(e={}))lt.call(e,i)&&Ge(t,i,e[i]);if(Ne)for(var i of Ne(e))pt.call(e,i)&&Ge(t,i,e[i]);return t},Me=(t,e)=>st(t,dt(e));function _b2UnivView(){let t=_b2VisUnivs().filter(s=>s.name!=="\uBB34\uC18C\uC18D"&&s.name);if(!t.length)return'<div style="text-align:center;color:var(--text3);padding:40px">\uD45C\uC2DC\uD560 \uB300\uD559\uC774 \uC5C6\uC2B5\uB2C8\uB2E4</div>';const e=new Set((typeof univCfg!="undefined"?univCfg:[]).filter(s=>s.dissolved).map(s=>String(s.name||"").trim())),i=new Set(t.map(s=>String(s&&s.name||"").trim()).filter(Boolean)),l={},o=[];(players||[]).forEach(s=>{const n=String((s==null?void 0:s.univ)||"").trim();i.has(n)&&(s.hidden||s.retired||s.hideFromBoard||e.has(n)||(o.push(s),(l[n]||(l[n]=[])).push(s)))});const g={};o.forEach(s=>{const n=s.tier||"?";g[n]=(g[n]||0)+1});const{fromN:a,toN:b}=_b2ThisWeekRange(),k=_b2WeeklyAggregate(o,String(a).replace(/(\d{4})(\d{2})(\d{2})/,"$1-$2-$3"),String(b).replace(/(\d{4})(\d{2})(\d{2})/,"$1-$2-$3")),x=k.filter(s=>s.total>0).length,f=k.reduce((s,n)=>s+n.total,0),u={P:0,T:0,Z:0};o.forEach(s=>{const n=String(s.race||"").trim().toUpperCase();(n==="P"||n==="T"||n==="Z")&&u[n]++});const m=["P","T","Z"].map(s=>{const n={P:"#a855f7",T:"#3b82f6",Z:"#ef4444"}[s],S={P:"\u{1F52E}P",T:"\u2694\uFE0FT",Z:"\u{1F98E}Z"}[s];return u[s]>0?`<span style="font-size:11px;font-weight:700;color:${n}">${S}${u[s]}</span>`:""}).filter(Boolean).join('<span style="color:var(--border2);margin:0 2px">\xB7</span>'),M=t.map(s=>{const n=(l[String(s.name||"").trim()]||[]).length;if(!n)return"";const S=gc(s.name),T=_b2ContrastColor(S);return`<button onclick="const el=document.getElementById('${"b2-univ-anchor-"+s.name.replace(/[^a-zA-Z0-9가-힣]/g,"_")}');if(el){el.scrollIntoView({behavior:'smooth',block:'start'});}" style="display:inline-flex;align-items:center;gap:5px;padding:6px 9px;border-radius:999px;border:1px solid ${S}cc;background:linear-gradient(135deg,${S}f2,${S}d8);color:${T};font-size:10px;font-weight:800;cursor:pointer;white-space:nowrap;flex-shrink:0;box-shadow:0 6px 12px rgba(15,23,42,.06),0 4px 10px ${S}26"><span>${s.name}</span><span style="display:inline-flex;align-items:center;justify-content:center;min-width:17px;height:17px;padding:0 5px;border-radius:999px;background:rgba(255,255,255,.20);color:${T};font-size:9px;font-weight:900;line-height:1">${n}</span></button>`}).join(""),C=`<div style="margin-bottom:12px">
    <div style="padding:14px;border-radius:22px;border:1px solid rgba(148,163,184,.18);background:linear-gradient(180deg,rgba(255,255,255,.99),rgba(248,250,252,.96));box-shadow:0 16px 28px rgba(15,23,42,.05)">
      <div style="display:grid;grid-template-columns:repeat(auto-fit,minmax(160px,1fr));gap:10px">
        ...
        <div style="padding:13px 14px;border-radius:18px;border:1px solid rgba(148,163,184,.14);background:linear-gradient(180deg,rgba(255,255,255,.98),rgba(248,250,252,.94))">
          ...
          <div style="margin-top:6px;font-size:22px;font-weight:950;letter-spacing:-.03em;color:var(--text1)">${t.length}</div>
        ...
        <div style="padding:13px 14px;border-radius:18px;border:1px solid rgba(148,163,184,.14);background:linear-gradient(180deg,rgba(255,255,255,.98),rgba(248,250,252,.94))">
          ...
          <div style="margin-top:6px;font-size:22px;font-weight:950;letter-spacing:-.03em;color:#2563eb">${f}</div>
      ...
      <div style="display:flex;align-items:center;gap:8px;flex-wrap:wrap;margin-top:12px;padding-top:12px;border-top:1px solid rgba(148,163,184,.14)">
        ...
        ${TIERS.filter(s=>g[s]).length?`<span style="width:1px;height:14px;background:var(--border2);display:inline-block;margin:0 2px"></span>${TIERS.filter(s=>g[s]).map(s=>`<span style="font-size:11px;font-weight:800;padding:4px 9px;border-radius:999px;background:${getTierBtnColor(s)};color:${getTierBtnTextColor(s)||"#fff"};box-shadow:0 8px 14px rgba(15,23,42,.06)">${s} ${g[s]}</span>`).join("")}`:""}
      </div>
      <div style="display:flex;align-items:center;gap:6px;flex-wrap:wrap;margin-top:12px;padding-top:12px;border-top:1px solid rgba(148,163,184,.14)">
  ...
  </div>`,E=typeof boardGridCols!="undefined"&&boardGridCols===2?"repeat(2,1fr)":"1fr";let R=C+"<style>.b2-bottom-img{max-width:130px;max-height:110px;object-fit:contain;}.b2-side-panel{float:right;width:230px;margin:0 0 6px 10px;border-radius:10px;padding:8px;box-sizing:border-box;}@media(min-width:769px) and (max-width:1024px){.b2-univ-grid{grid-template-columns:1fr!important;}.b2-side-panel{width:180px;}}@media(max-width:900px){.b2-univ-grid{grid-template-columns:1fr!important;}}@media(max-width:640px){.b2-side-panel{display:none!important;}.b2-bottom-img{display:none!important;}}</style>";return R+=`<div class="b2-univ-grid" style="display:grid;grid-template-columns:${E};gap:12px;align-items:start">`,t.forEach(s=>{if(!s.name){console.warn("[\uD604\uD669\uD310] \uB300\uD559 \uC774\uB984\uC774 \uC5C6\uB294 \uB370\uC774\uD130\uAC00 \uBC1C\uACAC\uB418\uC5C8\uC2B5\uB2C8\uB2E4:",s);return}const n=l[String(s.name||"").trim()]||[],S="b2-univ-anchor-"+s.name.replace(/[^a-zA-Z0-9가-힣]/g,"_");R+=`<div id="${S}" style="scroll-margin-top:56px">`+_b2UnivBlock(s.name,gc(s.name),n)+"</div>"}),R+="</div>",R}function _b2FemcoView(){var Te,Be,Re,Le,je;const t=()=>({autoLayout:1,logoSize:150,logoPos:"top",logoAttachTitle:1,headGap:10,logoOffsetX:0,logoOffsetY:0,titleSize:28,titleFont:"system",titlePos:"top",titleOffsetX:0,titleOffsetY:0,playerImgSize:46,playerImgShape:"square",rowsPerCol:5,colWidth:170,colGap:10,univGap:18,countFontSize:12,contentPadX:16,contentAlign:"left",contentOffsetX:0,univSubtitles:{},subtitleSize:12,subtitleWeight:800,subtitleColor:"",nameFontSize:12,roleFontSize:10,tierBadgeSize:10,tierBadgePadX:6,starSize:15,statusIconSize:18,bgOverlay:0,univColorOverrides:{},univBgMedia:{}});let e=typeof window._cfgFemcoLoad=="function"?window._cfgFemcoLoad():(function(){try{return JSON.parse(localStorage.getItem("b2_femco_settings_v1")||"null")||t()}catch(d){return t()}})();window._b2FemcoOpenBgMedia=function(d,r){const c=String(d||""),h=String(r||"").trim();if(!h)return;const $=h.toLowerCase(),_=/\.(mp4|webm|ogg)(\?|#|$)/i.test($);if(/(youtube\.com|youtu\.be|twitch\.tv)/i.test($)){try{window.open(h,"_blank","noopener")}catch(Z){location.href=h}return}if(!_){try{window.open(h,"_blank","noopener")}catch(Z){location.href=h}return}const L=document.getElementById("b2-femco-bg-modal");L&&L.remove();const O=document.createElement("div");O.id="b2-femco-bg-modal",O.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,.60);z-index:var(--z-modal-5);display:flex;align-items:center;justify-content:center;padding:16px";const ee=(c||"\uC601\uC0C1").replace(/</g,"&lt;").replace(/>/g,"&gt;");O.innerHTML=`
        <div style="width:min(980px,96vw);background:var(--white);border-radius:16px;overflow:hidden;border:1px solid rgba(255,255,255,.16);box-shadow:0 18px 60px rgba(0,0,0,.35)">
          <div style="display:flex;align-items:center;gap:10px;padding:12px 14px;background:linear-gradient(to bottom, rgba(255,255,255,.95), rgba(255,255,255,.85));border-bottom:1px solid var(--border)">
            <div style="font-weight:1000;color:var(--text2)">\u{1F39E}\uFE0F ${ee} \uBC30\uACBD \uC601\uC0C1</div>
          ...
          <div style="padding:12px 14px">
            <video src="${h}" controls playsinline style="width:100%;max-height:72vh;border-radius:12px;background:#000"></video>
          </div>
        </div>
      `,O.addEventListener("click",Z=>{Z.target===O&&O.remove()}),document.body.appendChild(O)};const i=_b2VisUnivs().filter(d=>d.name);if(!i.length)return'<div style="text-align:center;color:var(--text3);padding:40px">\uD45C\uC2DC\uD560 \uB300\uD559\uC774 \uC5C6\uC2B5\uB2C8\uB2E4</div>';typeof univCfg!="undefined"&&univCfg.length?i.sort((d,r)=>{const c=univCfg.findIndex($=>$.name===d.name),h=univCfg.findIndex($=>$.name===r.name);return(c>=0?c:999)-(h>=0?h:999)}):i.sort((d,r)=>(d.name||"").localeCompare(r.name||"","ko",{sensitivity:"base"}));const l=new Set((typeof univCfg!="undefined"?univCfg:[]).filter(d=>d.dissolved).map(d=>String(d.name||"").trim())),o={};i.forEach(d=>{o[d.name]=players.filter(r=>String((r==null?void 0:r.univ)||"").trim()===String(d.name||"").trim()&&!r.hidden&&!r.retired&&!r.hideFromBoard&&!l.has(String((r==null?void 0:r.univ)||"").trim()))});const g=Math.max(60,Math.min(520,parseInt(e.logoSize||150,10)||150)),a=Math.max(-120,Math.min(120,parseInt((Te=e.logoOffsetX)!=null?Te:0,10)||0)),b=Math.max(-120,Math.min(120,parseInt((Be=e.logoOffsetY)!=null?Be:0,10)||0)),k=Math.max(-120,Math.min(120,parseInt((Re=e.titleOffsetX)!=null?Re:0,10)||0)),x=Math.max(-120,Math.min(120,parseInt((Le=e.titleOffsetY)!=null?Le:0,10)||0)),f=Math.max(0,Math.min(70,parseInt((je=e.bgOverlay)!=null?je:0,10))),u=f/70*.22,m=f/70*.52,M=Math.max(16,Math.min(44,parseInt(e.titleSize||28,10)||28)),C=Math.max(28,Math.min(90,parseInt(e.playerImgSize||46,10)||46)),E=e.playerImgShape==="circle"?"50%":"10px",R=Math.max(2,Math.min(12,parseInt(e.rowsPerCol||5,10)||5)),s=Math.max(80,Math.min(360,parseInt(e.colWidth||170,10)||170)),n=Math.max(0,Math.min(28,parseInt(e.colGap||10,10)||10)),S=10,T=Math.max(0,Math.min(120,parseInt(e.univGap||18,10)||18)),w=Math.max(10,Math.min(18,parseInt(e.countFontSize||12,10)||12)),A=Math.max(0,Math.min(40,parseInt(e.contentPadX||16,10)||16)),W=e.contentAlign==="left"||e.contentAlign==="center"?e.contentAlign:"left",U=Math.max(-40,Math.min(40,parseInt(e.contentOffsetX||0,10)||0)),Y=Math.max(0,Math.min(80,parseInt(e.headGap||10,10)||10)),q=!(e.autoLayout===0||e.autoLayout===!1),p=typeof window!="undefined"&&(document.documentElement.clientWidth||window.innerWidth)||1280,z=Math.max(0,Math.min(80,A+U)),j=Math.max(0,Math.min(80,A-U));function N(d){let r=5;d>=55?r=9:d>=45?r=8:d>=35?r=7:d>=25?r=6:r=5;let c=175;return p<=520?(r=Math.max(r,8),c=150):p<=768?(r=Math.max(r,7),c=160):p<=1024?(r=Math.max(r,6),c=170):c=d>=45?160:175,r=Math.max(4,Math.min(12,r)),c=Math.max(130,Math.min(220,c)),{rowsPerCol:r,colWidth:c}}const K=Math.max(10,Math.min(24,parseInt(e.subtitleSize||12,10)||12)),be=[400,500,600,700,800,900].includes(parseInt(e.subtitleWeight||800,10))?parseInt(e.subtitleWeight||800,10):800,te=typeof e.subtitleColor=="string"?e.subtitleColor:"",le=Math.max(10,Math.min(20,parseInt(e.nameFontSize||12,10)||12)),pe=Math.max(9,Math.min(16,parseInt(e.roleFontSize||10,10)||10)),J=Math.max(9,Math.min(16,parseInt(e.tierBadgeSize||10,10)||10)),ce=Math.max(4,Math.min(12,parseInt(e.tierBadgePadX||6,10)||6)),oe=Math.max(10,Math.min(28,parseInt(e.starSize||15,10)||15)),me=(()=>{switch(e.titleFont){case"app":return"var(--app-font)";case"noto":return"'Noto Sans KR', system-ui, -apple-system, 'Segoe UI', Roboto, Arial, sans-serif";case"pretendard":return"'Pretendard Variable', Pretendard, system-ui, -apple-system, 'Segoe UI', Roboto, Arial, sans-serif";case"nanum":return"'Nanum Gothic', 'Noto Sans KR', system-ui, -apple-system, 'Segoe UI', Roboto, Arial, sans-serif";case"gmarket":return"'GmarketSans', 'Noto Sans KR', system-ui, -apple-system, 'Segoe UI', Roboto, Arial, sans-serif";default:return"system-ui, -apple-system, 'Segoe UI', Roboto, Arial, sans-serif"}})();(function(){const d=document.head||document.getElementsByTagName("head")[0];if(!d)return;const r=($,_)=>{if(!_){const L=document.getElementById($);L&&L.remove();return}let B=document.getElementById($);B||(B=document.createElement("link"),B.id=$,B.rel="stylesheet",d.appendChild(B)),B.href=_},c={noto:"https://fonts.googleapis.com/css2?family=Noto+Sans+KR:wght@400;700;900&display=swap",pretendard:"https://cdn.jsdelivr.net/gh/orioncactus/pretendard@latest/dist/web/variable/pretendardvariable.css",nanum:"https://fonts.googleapis.com/css2?family=Nanum+Gothic:wght@400;700;800&display=swap",gmarket:"https://cdn.jsdelivr.net/gh/projectnoonnu/noonfonts_2001@1.1/GmarketSans.css"},h=e.titleFont;r("femco-titlefont-css",c[h]||"")})();const ne=d=>{const r=d.tier||"",c=typeof TIERS!="undefined"&&TIERS.includes(r)?TIERS.indexOf(r):999;return c>=0?c:999},y=d=>{const r=(d.role||"").trim(),h=["\uC774\uC0AC\uC7A5","\uCD1D\uC7A5","\uAD50\uC218","\uCF54\uCE58"].indexOf(r);return h>=0?h:99},I=d=>d.race==="P"?"P":d.race==="T"?"T":d.race==="Z"?"Z":"?",H=d=>{const r=String(d||"").replace("#","").trim();if(r.length<6)return null;const c=parseInt(r.slice(0,2),16),h=parseInt(r.slice(2,4),16),$=parseInt(r.slice(4,6),16);return[c,h,$].some(_=>Number.isNaN(_))?null:{r:c,g:h,b:$}},ue=(d,r,c)=>"#"+[d,r,c].map(h=>Math.max(0,Math.min(255,Math.round(h))).toString(16).padStart(2,"0")).join(""),he=(d,r,c)=>{const h=H(d),$=H(r);if(!h||!$)return d||r||"#94a3b8";const _=Math.max(0,Math.min(1,+c||0));return ue(h.r*(1-_)+$.r*_,h.g*(1-_)+$.g*_,h.b*(1-_)+$.b*_)},Ce=d=>{const r=H(d);if(!r)return 0;const c=B=>(B/=255,B<=.03928?B/12.92:Math.pow((B+.055)/1.055,2.4)),h=c(r.r),$=c(r.g),_=c(r.b);return .2126*h+.7152*$+.0722*_},Ee=(d,r)=>{const c=Ce(d),h=Ce(r),$=Math.max(c,h),_=Math.min(c,h);return($+.05)/(_+.05)},Ve=(d,r=3)=>{let c=d||"#94a3b8";if(Ee(c,"#ffffff")>=r)return c;const h=[.25,.4,.55,.7];for(const $ of h){const _=he(c,"#0f172a",$);if(Ee(_,"#ffffff")>=r)return _}return he(c,"#0f172a",.75)},Ze=(d,r)=>{const c=d.race==="P"?"#c084fc":d.race==="T"?"#38bdf8":d.race==="Z"?"#34d399":"#94a3b8",h=r?he(c,r,.22):c;return Ve(h,3)};function qe(d,r){var B;const c=d&&d.photo?String(d.photo):"",h=d&&d.name?String(d.name).slice(0,1):"?",$=`${r}55`;let _="";try{const L=getStatusIcon(d.name),O=getStatusIconHTML(d.name),ee=C,Z=parseInt((B=e.statusIconSize)!=null?B:18,10),G=Z===0?0:Math.max(10,Math.min(36,Z||Math.round(ee*.38))),ge=L&&(typeof _siIsImg=="function"?_siIsImg(L):!1),ye=ge?`<img src="${L}" style="width:${G}px;height:${G}px;border-radius:50%;object-fit:cover;opacity:.86" onerror="this.style.display='none'">`:O?O.replace(/margin-left:[^;]+;/g,"").replace(/font-size:[^;]+;/g,""):"",fe=ge?"rgba(255,255,255,.72)":"transparent",we=-Math.round(G*.26),X=-Math.round(G*.26);_=O?`<span style="position:absolute;top:${we}px;left:${X}px;width:${G}px;height:${G}px;border-radius:50%;background:${fe};overflow:hidden;display:flex;align-items:center;justify-content:center;font-size:${Math.round(G*.82)}px;line-height:1;filter:drop-shadow(0 1px 2px rgba(0,0,0,.65))">${ye}</span>`:""}catch(L){console.warn("[femcoAvatarSquare] \uC0C1\uD0DC \uC544\uC774\uCF58 \uC0DD\uC131 \uC2E4\uD328:",L.message)}return c?`<span style="position:relative;display:block;width:100%;height:100%">
        <img src="${c}" decoding="async" fetchpriority="high" style="width:100%;height:100%;object-fit:cover;border-radius:inherit;border:2px solid ${$};background:rgba(255,255,255,.25)" onerror="this.closest('span').outerHTML='<div style=&quot;position:relative;width:100%;height:100%;border-radius:inherit;background:${r};display:flex;align-items:center;justify-content:center;font-weight:1000;font-size:22px;color:#fff;border:2px solid ${$}&quot;>${h}</div>'">
        ${_}
      </span>`:`<div style="position:relative;width:100%;height:100%;border-radius:inherit;background:${r};display:flex;align-items:center;justify-content:center;font-weight:1000;font-size:22px;color:#fff;border:2px solid ${$}">${h}${_}</div>`}let ve=`
    <style>
      .b2-femco-wrap{display:flex;flex-direction:column;gap:${T}px}
      ...
      .b2-femco-headcol{display:flex;flex-direction:column;align-items:center;justify-content:center;gap:${Y}px}
      ...
      .b2-femco-title{font-weight:1000;font-size:${M}px;letter-spacing:-.04em;line-height:1.1;font-family:${me}}
      .b2-femco-stars{display:inline-flex;gap:1px;align-items:center;opacity:.95}
      .b2-femco-stars span{font-size:${oe}px;line-height:1}
      .b2-femco-subtitle{margin-top:6px;font-size:${K}px;font-weight:${be};line-height:1.2;opacity:.95}
      /* \uC778\uC6D0\uC218: \uC88C\uCE21 \uC0C1\uB2E8 \uACE0\uC815 (\uBC30\uACBD \uC5C6\uC74C) */
      .b2-femco-countbox{
      ...
      .b2-femco-countbox div{font-size:${w}px;font-weight:1000;line-height:1.15;white-space:nowrap}
      ...
      */
      ...
      .b2-femco-avatar{width:${C}px;height:${C}px;border-radius:${E};overflow:hidden;flex-shrink:0;position:relative}
      ...
      .b2-femco-tierbadge{font-size:${J}px;padding:2px ${ce}px;border-radius:999px;border:1px solid rgba(0,0,0,.12);display:inline-flex;align-items:center;line-height:1}
      .b2-femco-role{font-size:${pe}px;font-weight:1000;opacity:.9}
      .b2-femco-name{font-size:${le}px;font-weight:1000;white-space:nowrap;overflow:hidden;text-overflow:ellipsis}
  ...
  `;return i.forEach(d=>{var We;const r=d.name,c=o[r]||[];if(!c.length)return;const $=(e.univColorOverrides||{})[r]||gc(r),_=_b2ContrastColor($),B=(typeof univCfg!="undefined"?univCfg.find(v=>v.name===r):null)||{},L=(()=>{const v=parseInt(B.logoSizeFemco||"",10);return!isNaN(v)&&v>0?Math.max(60,Math.min(520,v)):g})(),O=B.icon||B.img||"",ee=O?`<img src="${toHttpsUrl(O)}" style="width:${L}px;height:${L}px;object-fit:contain" onerror="this.style.display='none'">`:`<span style="display:inline-flex;align-items:center;justify-content:center;width:${Math.round(L*.62)}px;height:${Math.round(L*.62)}px;opacity:.85;font-size:${Math.round(L*.48)}px;line-height:1">\u{1F3EB}</span>`,Z=c.filter(v=>(v.role||"").trim()==="\uC774\uC0AC\uC7A5").length,G=c.filter(v=>["\uAD50\uC218","\uCF54\uCE58"].includes((v.role||"").trim())).length,ge=Math.max(0,c.length-Z-G),ye=[...c].sort((v,D)=>{const P=y(v),ae=y(D);if(P!==ae)return P-ae;const se=ne(v),de=ne(D);return se!==de?se-de:(v.name||"").localeCompare(D.name||"","ko",{sensitivity:"base"})}),fe=((e.univSubtitles||{})[r]||"").trim(),we=te&&te.trim()?te:_,X=(e.univBgMedia||{})[r]||"",F=(function(){const v={url:"",alpha:30,sizeMode:"cover",sizeVal:90,pos:"center",repeat:"no-repeat",ox:0,oy:0};return X?typeof X=="string"?Me(xe({},v),{url:String(X).trim()}):typeof X=="object"?Me(xe(xe({},v),X),{url:String(X.url||"").trim()}):v:v})(),V=(F.url||"").trim(),$e=V.toLowerCase(),_e=V&&/\.(png|jpe?g|webp|gif)(\?|#|$)/i.test($e),ke=V&&/\.(mp4|webm|ogg)(\?|#|$)/i.test($e),ze=V&&/(youtube\.com|youtu\.be|twitch\.tv)/i.test($e),Oe=ke||ze||V&&!_e?`<button class="b2-femco-pill no-export" style="cursor:pointer" onclick="_b2FemcoOpenBgMedia('${r.replace(/'/g,"\\'")}', '${V.replace(/'/g,"\\'")}');event.stopPropagation();">${ke?"\u{1F39E}\uFE0F \uBC30\uACBD\uC601\uC0C1":ze?"\u{1F517} \uBC30\uACBD\uB9C1\uD06C":"\u{1F5BC}\uFE0F \uBC30\uACBD\uB9C1\uD06C"}</button>`:"",Pe=e.logoPos||"top",Q=["left","right","top","bottom","center"].includes(Pe)?Pe:"top",Ae=!!((We=e.logoAttachTitle)==null||We),Ue=e.titlePos||"bottom",Se=["left","right","top","bottom"].includes(Ue)?Ue:"bottom",Xe=(B.championships||0)>0?`<span class="b2-femco-stars">${"<span>\u2B50</span>".repeat(B.championships)}</span>`:"",ie=`
      <div style="min-width:220px;transform:translate(${k}px,${x}px)">
        <div class="b2-femco-title-row">
          <div class="b2-femco-title">${r}</div>
          ${Xe}
        </div>
        ${fe?`<div class="b2-femco-subtitle" style="color:${we}">${fe}</div>`:""}
        ${Oe?`<div class="b2-femco-meta">${Oe}</div>`:""}
      </div>
    `,Ye=(()=>{if(Ae)return"";const v=A;return Q==="left"?`position:absolute;left:${v}px;top:50%;transform:translateY(-50%) translate(${a}px,${b}px);`:Q==="right"?`position:absolute;right:${v}px;top:50%;transform:translateY(-50%) translate(${a}px,${b}px);`:Q==="bottom"?`position:absolute;left:50%;bottom:10px;transform:translateX(-50%) translate(${a}px,${b}px);`:`position:absolute;left:50%;top:10px;transform:translateX(-50%) translate(${a}px,${b}px);`})(),Ke=(()=>{if(!Ae){const P=Math.max(0,Math.round(L*.55)+16);return`
          <div class="b2-femco-headrow" style="padding-left:${Q==="left"?P:0}px;padding-right:${Q==="right"?P:0}px">
            <div class="b2-femco-logo" style="${Ye}">${ee}</div>
            ${ie}
          </div>
        `}const v=Q==="left"?"justify-content:flex-start":Q==="right"?"justify-content:flex-end":"justify-content:center",D=`<div class="b2-femco-logo" style="transform:translate(${a}px,${b}px)">${ee}</div>`;return Se==="left"?`<div class="b2-femco-headrow" style="${v}">${ie}${D}</div>`:Se==="right"?`<div class="b2-femco-headrow" style="${v}">${D}${ie}</div>`:Se==="top"?`<div class="b2-femco-headcol" style="${v}">${ie}${D}</div>`:`<div class="b2-femco-headcol" style="${v}">${D}${ie}</div>`})(),Fe=q?N(c.length):{rowsPerCol:R,colWidth:s},Je=v=>{const D=String(v||"center");return{center:[50,50],top:[50,0],bottom:[50,100],left:[0,50],right:[100,50],"top left":[0,0],"top right":[100,0],"bottom left":[0,100],"bottom right":[100,100]}[D]||[50,50]},[Qe,et]=Je(F.pos),tt=parseInt(F.ox||0,10)||0,ot=parseInt(F.oy||0,10)||0,De=`calc(${Qe}% + ${tt}px) calc(${et}% + ${ot}px)`;let re="cover";F.sizeMode==="contain"?re="contain":F.sizeMode==="pct"?re=`${Math.max(10,Math.min(220,parseInt(F.sizeVal||90,10)||90))}%`:F.sizeMode==="px"&&(re=`${Math.max(30,Math.min(900,parseInt(F.sizeVal||240,10)||240))}px`);const He=Math.max(0,Math.min(100,parseInt(F.alpha||30,10)||0))/100,nt=["no-repeat","repeat","repeat-x","repeat-y"].includes(F.repeat)?F.repeat:"no-repeat",it=_e&&V?`<img src="${toHttpsUrl(V).replace(/"/g,"&quot;")}" style="position:absolute;inset:0;width:100%;height:100%;object-fit:${re};object-position:${De};opacity:${He.toFixed(3)};pointer-events:none;z-index:0" onerror="this.style.display='none'">`:ke||ze?`<div style="position:absolute;inset:0;background-image:url('${V.replace(/'/g,"%27")}');background-repeat:${nt};background-size:${re};background-position:${De};opacity:${He.toFixed(3)};pointer-events:none;z-index:0"></div>`:"",rt=_e&&V&&f>0?`<div style="position:absolute;inset:0;background:linear-gradient(180deg, rgba(2,6,23,${u.toFixed(3)}), rgba(2,6,23,${m.toFixed(3)}));pointer-events:none;z-index:1"></div>`:"";ve+=`
      <section class="b2-femco-univ" style="position:relative;overflow:hidden;background:${$};">
        ${it}${rt}
        <div class="b2-femco-head" style="position:relative;z-index:2;color:${_};padding-left:${z}px;padding-right:${j}px">
          <div class="b2-femco-countbox" style="color:${_};left:${z}px;${_==="#ffffff"?"text-shadow:0 1px 2px rgba(0,0,0,.45);":""}">
            <div>\uCD1D ${c.length}</div>
            <div>\uC774\uC0AC\uC7A5 ${Z}</div>
            <div>\uAD50\uC218+\uCF54\uCE58 ${G}</div>
            <div>\uD559\uC0DD ${ge}</div>
        ...
        <div class="b2-femco-body" style="position:relative;z-index:2;background:transparent;padding-left:${z}px;padding-right:${j}px">
          <div class="b2-femco-grid" style="--rowsPerCol:${Fe.rowsPerCol};--colWidth:${Fe.colWidth}px">
            ${ye.map(v=>{const D=(v.name||"").replace(/'/g,"\\'"),P=v.tier||"?",ae=P&&P!=="?"&&typeof getTierBtnColor=="function"?getTierBtnColor(P):"#64748b",se=P&&P!=="?"&&(typeof getTierBtnTextColor=="function"?getTierBtnTextColor(P):"#fff")||"#fff",de=(v.role||"").trim(),Ie=Ze(v,$);return`
                <div class="b2-femco-item" onclick="openPlayerModal('${D}');event.stopPropagation();">
                  <div class="b2-femco-avatar">${qe(v,Ie)}</div>
                  <div class="b2-femco-text" style="${v.inactive?"opacity:.65":""};color:${_}">
                    <div class="b2-femco-tier">
                      <span class="b2-femco-tierbadge" style="background:${ae};color:${se}">${P}</span>
                    </div>
                    ${de?`<div class="b2-femco-role">${de}</div>`:""}
                    <div class="b2-femco-name">${v.name||""}</div>
                    <div><span class="b2-femco-race-pill" style="color:${Ie};border-color:${Ie}88;background:${_==="#ffffff"?"rgba(0,0,0,.28)":"rgba(255,255,255,.92)"};box-shadow:0 1px 2px rgba(0,0,0,.18)">${I(v)}</span></div>
                  </div>
                </div>
              `}).join("")}
          </div>
    ...
    `}),ve+="</div>",ve}function openB2PlayerCreateModal(){if(!isLoggedIn||typeof isSubAdmin!="undefined"&&isSubAdmin||document.getElementById("b2-player-create-modal"))return;const t=(typeof univCfg!="undefined"?univCfg:[]).map(o=>o.name).filter(Boolean),e=typeof TIERS!="undefined"&&Array.isArray(TIERS)?TIERS:["0","1","2","3","4","5","6","7","8","\uC720\uC2A4"],i=["\uD559\uC0DD","\uCF54\uCE58","\uAD50\uC218","\uCD1D\uC7A5","\uC774\uC0AC\uC7A5"],l=document.createElement("div");l.id="b2-player-create-modal",l.style.cssText="position:fixed;top:0;left:0;width:100%;height:100%;background:rgba(0,0,0,0.5);display:flex;align-items:center;justify-content:center;z-index:var(--z-modal-5)",l.innerHTML=`
    <div style="background:var(--white);border-radius:16px;padding:24px;max-width:560px;width:92%;max-height:84vh;overflow-y:auto;box-shadow:0 10px 40px rgba(0,0,0,0.3)">
      ...
      <div style="display:grid;grid-template-columns:140px 1fr;gap:10px;align-items:center;margin-bottom:12px">
        ...
        <select id="b2-newplayer-role" style="padding:8px 12px;border:1px solid var(--border2);border-radius:10px;font-size:13px">
          ${i.map(o=>`<option value="${o}"${o==="\uD559\uC0DD"?" selected":""}>${o}</option>`).join("")}
        </select>
      </div>
  ...
  `,document.body.appendChild(l)}function saveB2NewPlayer(){var M,C,E,R,s,n,S,T;const t=document.getElementById("b2-newplayer-msg"),e=(((M=document.getElementById("b2-newplayer-name"))==null?void 0:M.value)||"").trim(),i=(((C=document.getElementById("b2-newplayer-univ"))==null?void 0:C.value)||"").trim(),l=(((E=document.getElementById("b2-newplayer-role"))==null?void 0:E.value)||"").trim(),o=(((R=document.getElementById("b2-newplayer-race"))==null?void 0:R.value)||"N").trim(),g=(((s=document.getElementById("b2-newplayer-tier"))==null?void 0:s.value)||"?").trim(),a=(((n=document.getElementById("b2-newplayer-channel"))==null?void 0:n.value)||"").trim(),b=(((S=document.getElementById("b2-newplayer-photo"))==null?void 0:S.value)||"").trim(),k=(((T=document.getElementById("b2-newplayer-photo2"))==null?void 0:T.value)||"").trim();if(!e){alert("\uC774\uB984\uC740 \uD544\uC218\uC785\uB2C8\uB2E4.");return}if(players.find(w=>w.name===e)){alert("\uC774\uBBF8 \uC874\uC7AC\uD558\uB294 \uC774\uB984\uC785\uB2C8\uB2E4: "+e);return}if(b&&b.startsWith("data:")){alert("\u274C base64 \uC774\uBBF8\uC9C0(data:...)\uB294 \uC800\uC7A5/\uB3D9\uAE30\uD654\uAC00 \uC2E4\uD328\uD560 \uC218 \uC788\uC5B4 \uAE08\uC9C0\uC785\uB2C8\uB2E4. URL\uC744 \uC0AC\uC6A9\uD558\uC138\uC694.");return}const x={name:e,univ:i||"\uBB34\uC18C\uC18D",role:l||"\uD559\uC0DD",race:o,tier:g,channelUrl:a||void 0,photo:b||void 0,secondProfileFile:k||void 0};players.push(x),save(),render(),["b2-newplayer-name","b2-newplayer-channel","b2-newplayer-photo","b2-newplayer-photo2"].forEach(w=>{const A=document.getElementById(w);A&&(A.value="")});const f=document.getElementById("b2-newplayer-tier");f&&(f.value="?");const u=document.getElementById("b2-newplayer-race");u&&(u.value="N");const m=document.getElementById("b2-newplayer-role");m&&(m.value="\uD559\uC0DD"),t&&(t.style.color="#16a34a",t.textContent=`\u2705 \uC800\uC7A5\uB428: ${e} (\uB2E4\uC74C \uC2A4\uD2B8\uB9AC\uBA38\uB97C \uACC4\uC18D \uB4F1\uB85D\uD560 \uC218 \uC788\uC2B5\uB2C8\uB2E4)`)}async function saveB2FemcoAllImg(){return _saveB2FemcoInternal()}async function _saveB2FemcoInternal(){const e=document.querySelector('[onclick="saveB2FemcoAllImg()"]');e&&(e.disabled=!0,e.textContent="\u23F3...");try{const b="download"in document.createElement("a"),k=String(navigator.userAgent||""),x=/iPad|iPhone|iPod/i.test(k),f=/KAKAOTALK|Instagram|FBAN|FBAV|NAVER|Whale|Line/i.test(k);if(!b||x||f){const u=window.open("","_blank");if(u){try{u.document.write('<html><head><meta charset="utf-8"><title>\uC774\uBBF8\uC9C0 \uC0DD\uC131 \uC911...</title></head><body style="margin:0;font-family:sans-serif;background:#111;color:#fff;padding:14px">\uD3A8\uCF54\uC2A4\uD0C0\uC77C \uC774\uBBF8\uC9C0 \uC0DD\uC131 \uC911\uC785\uB2C8\uB2E4... \uC7A0\uC2DC\uB9CC \uAE30\uB2E4\uB824\uC8FC\uC138\uC694.</body></html>'),u.document.close()}catch(m){}window.__captureDlWin=u}}}catch(a){}const i=document.createElement("div");i.style.cssText="position:fixed;left:-9999px;top:0;padding:24px;background:#0b1220;box-sizing:border-box;",i.innerHTML=_b2FemcoView(),document.body.appendChild(i),i.querySelectorAll(".b2-femco-subnav,.b2-femco-panel,.no-export,.no-export-movebtns").forEach(a=>a.remove()),await new Promise(a=>setTimeout(a,120));try{typeof injectUnivIcons=="function"&&injectUnivIcons(i)}catch(a){console.warn("[saveB2FemcoAllImg] \uB300\uD559 \uC544\uC774\uCF58 \uC8FC\uC785 \uC2E4\uD328:",a.message)}try{typeof _imgToDataUrls=="function"&&await _imgToDataUrls(i,12e3)}catch(a){}try{typeof _waitForImages=="function"&&await _waitForImages(i,1500)}catch(a){}const l=i.scrollHeight+32,o=i.scrollWidth,g="\uD3A8\uCF54\uD604\uD669\uD310_\uC804\uCCB4_"+new Date().toISOString().slice(0,10)+".png";try{if(console.log("[\uD3A8\uCF54] \uC774\uBBF8\uC9C0 \uC800\uC7A5 \uC2DC\uC791"),typeof window._captureAndSave!="function")throw new Error("\uC774\uBBF8\uC9C0 \uC800\uC7A5 \uAE30\uB2A5\uC744 \uBD88\uB7EC\uC624\uC9C0 \uBABB\uD588\uC2B5\uB2C8\uB2E4.");await window._captureAndSave(i,o,l,g)}catch(a){console.error("[\uD3A8\uCF54\uD604\uD669 \uC774\uBBF8\uC9C0 \uC800\uC7A5 \uC2E4\uD328]",a),alert(`\u274C \uD3A8\uCF54\uC2A4\uD0C0\uC77C \uC774\uBBF8\uC9C0 \uC800\uC7A5 \uC2E4\uD328

`+(a.message||"\uC54C \uC218 \uC5C6\uB294 \uC624\uB958\uAC00 \uBC1C\uC0DD\uD588\uC2B5\uB2C8\uB2E4."))}finally{document.body.removeChild(i),e&&(e.disabled=!1,e.textContent="\u{1F4BE} \uC804\uCCB4 \uC800\uC7A5")}}function _b2UnivBlock(t,e,i,l=!1){var ne;if(!t)return`<div style="border-radius:14px;border:2px dashed #ccc55;padding:16px 18px;background:#f5f5f5;display:flex;align-items:center;gap:10px;opacity:.7">
    ...
    </div>`;const o=univCfg.find(y=>y.name===t)||{},g=o.icon||o.img||UNIV_ICONS[t]||"",a=_b2ContrastColor(e),b=e+_b2AlphaHex(b2BgAlpha),k=e+_b2AlphaHex(b2LabelAlpha),x=!!o.bgImg,f="linear-gradient(180deg,rgba(255,255,255,.98),rgba(248,250,252,.94))",u=x?"rgba(255,255,255,.18)":"rgba(255,255,255,.55)",m=x?"linear-gradient(180deg,rgba(255,255,255,.00),rgba(248,250,252,.00))":f,M=x?"linear-gradient(180deg,rgba(255,255,255,.12),rgba(248,250,252,.04))":f,C=x?"rgba(255,255,255,.04)":u,E=x?"none":"0 10px 18px rgba(15,23,42,.04)";if(!i.length)return`<div style="border-radius:14px;border:2px dashed ${e}55;padding:16px 18px;background:${b};display:flex;align-items:center;gap:10px;opacity:.7">
      ${g?`<img src="${toHttpsUrl(g)}" style="width:var(--su_univ_logo_size,36px);height:var(--su_univ_logo_size,36px);object-fit:contain;border-radius:var(--su_univ_logo_radius,10px)" onerror="this.style.display='none'">`:""}
      <span style="font-weight:900;font-size:15px;color:${e};cursor:pointer" onclick="if(typeof openUnivModal==='function')openUnivModal('${t}')">${t}</span>
      <span style="font-size:11px;color:var(--gray-l)">\uB4F1\uB85D\uB41C \uC120\uC218 \uC5C6\uC74C</span>
    </div>`;const R=i.filter(y=>_B2_ROLE_ORDER.includes(y.role||""));R.sort((y,I)=>_b2RoleRank(y)-_b2RoleRank(I));const s=i.filter(y=>!_B2_ROLE_ORDER.includes(y.role||"")),n={};s.forEach(y=>{const I=y.tier||"?";n[I]||(n[I]=[]),n[I].push(y)});const S=TIERS.filter(y=>n[y]).concat(Object.keys(n).filter(y=>!TIERS.includes(y))),T=o.memo||"",w=(o.memoImgs||[]).concat(o.memoImg?[o.memoImg]:[]),A=!!(T||w.length),W=(y,I,H)=>`
    <div style="display:flex;align-items:stretch;gap:0;margin-bottom:8px">
      <div style="background:${k}!important;min-width:70px;width:70px;display:flex;align-items:center;justify-content:center;padding:10px 6px;flex-shrink:0;border-radius:16px 0 0 16px;border:1px solid ${e}33;border-right:none;box-shadow:inset 0 1px 0 rgba(255,255,255,.28)">
        <span style="font-size:11px;font-weight:900;color:${e};text-align:center;line-height:1.35;word-break:keep-all;letter-spacing:-.01em">${y}</span>
      </div>
      <div style="flex:1;background:${m};padding:10px 12px;display:flex;flex-wrap:wrap;gap:6px;align-items:center;border-radius:0 16px 16px 0;border:1px solid ${C};box-shadow:${E}">
        ${H}
      </div>
    </div>`,U={},Y=[];R.forEach(y=>{const I=y.role||"";U[I]||(U[I]=[],Y.push(I)),U[I].push(y)});const q=o.bgImgPos||"center center",p=o.bgImgSize||"auto",z=((ne=o.bgImgAlpha)!=null?ne:b2BgImgAlpha)/100,j=(x?Math.max(.56,z):z).toFixed(2),N=o.bgImg?l?`<img src="${o.bgImg}" crossorigin="anonymous" class="b2-fit-auto" data-fit-kind="bg" data-fit-mode="${p}" style="position:absolute;inset:0;width:100%;height:100%;object-fit:${p==="auto"?"cover":p};object-position:${q};opacity:${j};pointer-events:none;z-index:0" onload="_b2ApplyBgAutoSizing(this)">`:`<div class="b2-bg-layer" data-bg-src="${String(o.bgImg).replace(/"/g,"&quot;")}" data-bg-pos="${String(q).replace(/"/g,"&quot;")}" data-bg-size-mode="${p}" style="position:absolute;inset:0;opacity:${j};pointer-events:none;z-index:0;background-position:${q};background-size:${p==="auto"?"cover":p};background-repeat:no-repeat"></div>`:"";let K="";Y.forEach(y=>{const I=U[y];K+=W(y,!0,I.map(H=>_b2NameTag(H,e,!0)).join(""))}),S.forEach(y=>{const I=n[y];I.sort((H,ue)=>(H.name||"").localeCompare(ue.name||"","ko",{sensitivity:"base"})),K+=W(y,!1,I.map(H=>_b2NameTag(H,e,!1)).join(""))});const be=A?`<div style="margin-top:10px;background:${M};padding:12px;box-sizing:border-box;overflow:hidden;border-radius:18px;border:1px solid ${u};box-shadow:0 14px 26px rgba(15,23,42,.06)">
    <div style="font-size:11px;font-weight:900;color:${e};margin-bottom:${w.length||T?"10px":"0"}">\uC0AC\uC774\uB4DC \uBA54\uBAA8</div>
    ${w.map((y,I)=>`<img src="${y}" style="width:100%;max-width:260px;border-radius:12px;${I<w.length-1||T?"margin-bottom:8px;":""}display:block;object-fit:contain;border:1px solid rgba(148,163,184,.14);background:#fff" onerror="this.style.display='none'">`).join("")}
    ${T?`<div style="font-size:11px;color:#334155;white-space:pre-wrap;line-height:1.65;margin-top:${w.length?"8px":"0"}">${T}</div>`:""}
  </div>`:"",te=`<div class="b2-bg-host" style="position:relative;overflow:hidden;background:${x?"transparent":"linear-gradient(180deg,rgba(255,255,255,.92),rgba(248,250,252,.82))"}">
    ${N}
    <div style="position:relative;z-index:1;padding:16px;background:transparent">
      <div>${K}</div>
      ${be}
    </div>
  </div>`,le=String(o.createdAt||o.created||o.createDate||o.since||o.startDate||"").trim(),pe=(()=>{if(!le)return"";const y=String(le).trim();let I=y.match(/^(\d{4})[.\-\/](\d{2})[.\-\/](\d{2})/);return I||(I=y.match(/^(\d{4})(\d{2})(\d{2})/)),I?`${I[1]}.${I[2]}.${I[3]}`:y.slice(0,10)})(),J=o.bMemo||"",ce=(o.bMemoImgs||[]).concat(o.bMemoImg?[o.bMemoImg]:[]),oe=ce.map(y=>`<img class="b2-bottom-img" src="${y}" style="border-radius:12px;display:inline-block;border:1px solid rgba(148,163,184,.14);background:#fff" onerror="this.style.display='none'">`).join(""),me=J||ce.length?`<div style="padding:14px 16px 16px;background:${x?"linear-gradient(180deg,rgba(255,255,255,.28),rgba(248,250,252,.14))":"linear-gradient(180deg,rgba(255,255,255,.92),rgba(248,250,252,.86))"};border-top:1px solid rgba(148,163,184,.16)">
    <div style="font-size:11px;font-weight:900;color:${e};margin-bottom:${oe||J?"10px":"0"}">\uD558\uB2E8 \uBA54\uBAA8</div>
    ${oe?`<div style="display:flex;flex-wrap:wrap;gap:8px;margin-bottom:${J?"8px":"0"}">${oe}</div>`:""}
    ${J?`<div style="font-size:12px;color:#334155;white-space:pre-wrap;line-height:1.7">${J}</div>`:""}
  </div>`:"";return`
    <div data-b2card="${t.replace(/"/g,"&quot;")}" style="border-radius:22px;overflow:hidden;border:1px solid rgba(148,163,184,.16);background:linear-gradient(180deg,rgba(255,255,255,.98),rgba(248,250,252,.96));box-shadow:0 18px 32px rgba(15,23,42,.06)">
      <div style="background:linear-gradient(135deg,${e} 0%,${e}dd 100%);padding:16px 16px 14px;position:relative;overflow:hidden">
        ...
        <div style="display:flex;align-items:stretch;gap:12px;position:relative;z-index:1">
          ${g?`<img src="${toHttpsUrl(g)}" style="width:var(--su_univ_logo_size,46px);height:var(--su_univ_logo_size,46px);object-fit:contain;border-radius:var(--su_univ_logo_radius,14px);flex-shrink:0;cursor:pointer;background:rgba(255,255,255,.16);border:1px solid rgba(255,255,255,.24);padding:5px;box-shadow:0 12px 22px rgba(15,23,42,.10)" onclick="if(typeof openUnivModal==='function')openUnivModal('${t}')" onerror="this.style.display='none'">`:""}
            ...
            <div style="display:flex;align-items:flex-start;gap:10px;justify-content:space-between;flex-wrap:wrap">
              <div style="min-width:0;flex:1">
                <div style="display:flex;align-items:center;gap:8px;flex-wrap:nowrap;min-width:0">
                  <span style="font-weight:950;font-size:20px;color:${a};cursor:pointer;letter-spacing:-.03em;line-height:1.08;min-width:0;flex:0 1 auto;max-width:min(420px,62%);overflow:hidden;text-overflow:ellipsis;white-space:nowrap" onclick="if(typeof openUnivModal==='function')openUnivModal('${t}')">${t}</span>
                  <span style="display:inline-flex;align-items:center;gap:6px;flex-shrink:0;white-space:nowrap">
                    <span style="background:${a}1f;color:${a};font-size:11px;font-weight:800;padding:4px 9px;border-radius:999px;border:1px solid ${a}26;cursor:pointer;box-shadow:inset 0 1px 0 rgba(255,255,255,.06);white-space:nowrap" onclick="event.stopPropagation();openB2MemberBreakdown(this,'${t}')">${i.length}\uBA85</span>
                    ${pe?`<span style="background:${a}18;color:${a};font-size:10px;font-weight:900;padding:4px 8px;border-radius:999px;border:1px solid ${a}22;box-shadow:inset 0 1px 0 rgba(255,255,255,.06);flex-shrink:0;white-space:nowrap">${pe}</span>`:""}
                  </span>
                </div>
              ...
              <div style="display:flex;align-items:flex-start;gap:6px;flex-wrap:wrap;justify-content:flex-end">
                ...
                ${isLoggedIn?`<button class="no-export" onclick="event.stopPropagation();_b2ToggleCard(this,'${t.replace(/'/g,"\\'")}')" style="background:${a}22;border:1px solid ${a}33;color:${a};font-size:11px;cursor:pointer;padding:4px 9px;border-radius:10px;flex-shrink:0;font-weight:800;z-index:var(--z-dropdown);position:relative;box-shadow:inset 0 1px 0 rgba(255,255,255,.08)" title="${_b2Collapsed.has(t)?"\uD3BC\uCE58\uAE30":"\uC811\uAE30"}">${_b2Collapsed.has(t)?"\u25B6 \uC811\uAE30 \uD574\uC81C":"\u25BC \uC811\uAE30"}</button>`:""}
              </div>
            </div>
          </div>
        </div>
      </div>
      <div class="b2-card-body" style="${_b2Collapsed.has(t)?"display:none":""}">
        ${te}
        ${me}
      </div>
    </div>`}function _b2FreeView(){const t=new Set((typeof univCfg!="undefined"?univCfg:[]).filter(p=>p.dissolved).map(p=>String(p.name||"").trim())),e=players.filter(p=>{const z=String((p==null?void 0:p.univ)||"").trim();return(!z||z==="\uBB34\uC18C\uC18D")&&!p.hidden&&!p.retired&&!p.hideFromBoard&&!t.has(z)});if(!e.length)return'<div style="text-align:center;color:var(--text3);padding:40px">\uBB34\uC18C\uC18D \uBA64\uBC84\uAC00 \uC5C6\uC2B5\uB2C8\uB2E4</div>';const i=e.filter(p=>_B2_ROLE_ORDER.includes(p.role||""));i.sort((p,z)=>_b2RoleRank(p)-_b2RoleRank(z));const l=e.filter(p=>!_B2_ROLE_ORDER.includes(p.role||"")),o={};l.forEach(p=>{const z=p.tier||"?";o[z]||(o[z]=[]),o[z].push(p)});const g=TIERS.filter(p=>o[p]).concat(Object.keys(o).filter(p=>!TIERS.includes(p))),a=new Date,b=a.getDay(),k=new Date(a);k.setDate(a.getDate()+(b===0?-6:1-b));const x=parseInt(k.toISOString().slice(0,10).replace(/-/g,"")),f=parseInt(a.toISOString().slice(0,10).replace(/-/g,"")),u=p=>parseInt(String(p||"").replace(/[-\.]/g,""))||0;let m=0,M=0,C=0,E=0,R=0;l.forEach(p=>{let z=!1;(Array.isArray(p.history)?p.history:[]).forEach(j=>{j.result==="\uC2B9"?m++:j.result==="\uD328"&&M++;const N=u(j.date||j.d||"");N>=x&&N<=f&&(j.result==="\uC2B9"?C++:j.result==="\uD328"&&E++,z=!0)}),z&&R++});const s=m+M,n=s>0?Math.round(m/s*100):null,S=n===null?"#94a3b8":n>=60?"#10b981":n>=40?"#f59e0b":"#ef4444",T=C+E,w={P:0,T:0,Z:0,"?":0};l.forEach(p=>{const z=p.race||"?";w[z in w?z:"?"]++});const A=l.length||1,W="#64748b";let U=`<div style="border-radius:22px;overflow:hidden;border:1px solid rgba(148,163,184,.16);background:linear-gradient(180deg,rgba(255,255,255,.99),rgba(248,250,252,.96));box-shadow:0 18px 32px rgba(15,23,42,.06)">
    <div style="background:linear-gradient(135deg,${W} 0%,#475569 100%);padding:14px 16px 12px;position:relative;overflow:hidden">
      ...
      <div style="display:flex;align-items:center;gap:6px;flex-wrap:wrap">
        ...
        <span style="background:rgba(255,255,255,.18);color:#fff;font-size:11px;font-weight:800;padding:4px 9px;border-radius:999px;border:1px solid rgba(255,255,255,.15)">${e.length}\uBA85</span>
        ${R>0?`<span style="background:rgba(255,165,0,.35);color:#fef08a;font-size:10px;font-weight:900;padding:4px 8px;border-radius:999px;border:1px solid rgba(255,255,255,.12)">\u{1F525} \uC774\uBC88\uC8FC ${R}\uBA85</span>`:""}
        ${T>0?`<span style="background:rgba(0,0,0,.18);color:${C>=E?"#bbf7d0":"#fecaca"};font-size:10px;font-weight:900;padding:4px 8px;border-radius:999px;border:1px solid rgba(255,255,255,.12)">${C}\uC2B9${E}\uD328</span>`:""}
        ${n!==null?`<span style="background:rgba(0,0,0,.18);color:${S};font-size:10px;font-weight:900;padding:4px 8px;border-radius:999px;border:1px solid rgba(255,255,255,.12)" title="\uD1B5\uC0B0 ${m}\uC2B9 ${M}\uD328">\u{1F4CA} \uD1B5\uC0B0 ${n}%</span>`:""}
        <div style="margin-left:auto;display:flex;gap:4px;align-items:center">
          ${w.P?`<span style="font-size:10px;background:rgba(124,58,237,.4);color:#ede9fe;padding:4px 8px;border-radius:999px;font-weight:900;border:1px solid rgba(255,255,255,.12)">\u{1F52E}${w.P}</span>`:""}
          ${w.T?`<span style="font-size:10px;background:rgba(2,132,199,.4);color:#e0f2fe;padding:4px 8px;border-radius:999px;font-weight:900;border:1px solid rgba(255,255,255,.12)">\u2694\uFE0F${w.T}</span>`:""}
          ${w.Z?`<span style="font-size:10px;background:rgba(5,150,105,.4);color:#d1fae5;padding:4px 8px;border-radius:999px;font-weight:900;border:1px solid rgba(255,255,255,.12)">\u{1F98E}${w.Z}</span>`:""}
        </div>
      </div>
      <div style="display:flex;height:5px;border-radius:3px;overflow:hidden;margin-top:8px;background:rgba(255,255,255,.15)">
        ${w.P?`<div style="flex:${w.P};background:#7c3aed;opacity:.85"></div>`:""}
        ${w.T?`<div style="flex:${w.T};background:#0284c7;opacity:.85"></div>`:""}
        ${w.Z?`<div style="flex:${w.Z};background:#059669;opacity:.85"></div>`:""}
        ${w["?"]?`<div style="flex:${w["?"]};background:rgba(255,255,255,.2)"></div>`:""}
      </div>
      </div>
    </div>
    <div style="background:linear-gradient(180deg,rgba(255,255,255,.96),rgba(248,250,252,.90));padding:16px">`;const Y=(p,z)=>`<div style="display:flex;align-items:stretch;gap:0;margin-bottom:8px">${p}<div style="flex:1;padding:10px 12px;background:linear-gradient(180deg,rgba(255,255,255,.98),rgba(248,250,252,.94));border:1px solid rgba(148,163,184,.14);border-left:none;border-radius:0 16px 16px 0;box-shadow:0 10px 18px rgba(15,23,42,.04)">${z}</div></div>`,q=(p,z)=>`<span style="font-size:12px;font-weight:900;color:${z?W:"var(--text3)"};width:68px;min-width:68px;text-align:center;flex-shrink:0;display:inline-flex;align-items:center;justify-content:center;background:#64748b${_b2AlphaHex(b2LabelAlpha)}!important;border:1px solid rgba(100,116,139,.28);border-right:none;border-radius:16px 0 0 16px;padding:8px 6px;box-shadow:inset 0 1px 0 rgba(255,255,255,.2)">${p}</span>`;return i.forEach(p=>{U+=Y(q(p.role||"",!0),_b2PlayerRow(p,W))}),g.forEach(p=>{const z=o[p];z.sort((N,K)=>(N.name||"").localeCompare(K.name||"","ko",{sensitivity:"base"}));const j=getTierBtnColor(p);U+=Y(q(p,!1),`<div style="display:flex;flex-wrap:wrap;gap:5px;padding:2px 0">${z.map(N=>_b2NameTag(N,j,!1)).join("")}</div>`)}),U+="</div></div>",U}function openB2MemberBreakdown(t,e){const i=document.getElementById("b2-mbp");if(i){const m=i._forEl;if(i.remove(),m===t)return}const l=gc(e),o=players.filter(m=>String((m==null?void 0:m.univ)||"").trim()===String(e||"").trim()&&!m.hidden&&!m.retired&&!m.hideFromBoard),g=o.filter(m=>_B2_ROLE_ORDER.includes(m.role||"")),a=o.filter(m=>!_B2_ROLE_ORDER.includes(m.role||"")),b={};a.forEach(m=>{const M=m.tier||"?";b[M]=(b[M]||0)+1});const k=TIERS.filter(m=>b[m]).concat(Object.keys(b).filter(m=>!TIERS.includes(m))),x=(m,M,C)=>`<div style="display:flex;justify-content:space-between;align-items:center;gap:16px;padding:2px 0">
    <span style="color:${C||"var(--text2)"};font-size:12px">${m}</span>
    <span style="font-weight:700;color:var(--text1);font-size:12px">${M}\uBA85</span></div>`,f=document.createElement("div");f.id="b2-mbp",f.style.cssText="position:fixed;z-index:var(--z-top);background:var(--white);border:1px solid var(--border2);border-radius:12px;box-shadow:0 4px 20px #0003;padding:12px 14px;min-width:170px",f.innerHTML=`
    <div style="font-weight:800;font-size:13px;color:${l};margin-bottom:8px">${e} \uAD6C\uC131</div>
    ${x("\uC9C1\uCC45\uC790",g.length)}
    ${x("\uC77C\uBC18 \uC2A4\uD2B8\uB9AC\uBA38",a.length)}
    ${k.length?`<div style="border-top:1px solid var(--border2);margin:6px 0"></div>${k.map(m=>x(m,b[m],getTierBtnColor(m))).join("")}`:""}`,f._forEl=t,document.body.appendChild(f);const u=t.getBoundingClientRect();f.style.top=u.bottom+6+"px",f.style.left=u.left+"px",requestAnimationFrame(()=>{u.left+f.offsetWidth>window.innerWidth-8&&(f.style.left=u.right-f.offsetWidth+"px"),u.bottom+f.offsetHeight+6>window.innerHeight&&(f.style.top=u.top-f.offsetHeight-6+"px")}),setTimeout(()=>{function m(E){!f.contains(E.target)&&E.target!==t&&C()}function M(){C()}function C(){f.remove(),document.removeEventListener("click",m),window.removeEventListener("scroll",M,!0)}document.addEventListener("click",m),window.addEventListener("scroll",M,{capture:!0,once:!0})},0)}async function saveB2Img(){const t=_b2VisUnivs().filter(f=>f.name!=="\uBB34\uC18C\uC18D"),e=_b2SaveUniv==="\uC804\uCCB4"?t:t.filter(f=>f.name===_b2SaveUniv);if(!e.length){alert("\uC800\uC7A5\uD560 \uB300\uD559\uC774 \uC5C6\uC2B5\uB2C8\uB2E4.");return}const i=document.querySelector('[onclick="saveB2Img()"]');i&&(i.disabled=!0,i.textContent="\u23F3...");const l=720,o=14,g=24,a=document.createElement("div");a.style.cssText=`position:fixed;left:-9999px;top:0;padding:${g}px;background:#f0f2f5;box-sizing:border-box;width:${l+g*2}px`,a.innerHTML=`<style>.b2-bottom-img{max-width:160px;max-height:130px;object-fit:contain;}</style>
    <div style="display:flex;flex-direction:column;gap:${o}px">
      ${e.map(f=>_b2UnivBlock(f.name,gc(f.name),players.filter(u=>String((u==null?void 0:u.univ)||"").trim()===String(f.name||"").trim()&&!u.hidden&&!u.retired&&!u.hideFromBoard),!0)).join("")}
    </div>`,document.body.appendChild(a),a.querySelectorAll(".no-export,.no-export-movebtns").forEach(f=>f.remove()),await new Promise(f=>setTimeout(f,100)),injectUnivIcons(a);const b=a.scrollHeight+32,k=a.scrollWidth,x=(_b2SaveUniv==="\uC804\uCCB4"?"\uB300\uD559\uBCC4\uD604\uD669\uD310_\uC804\uCCB4":`\uB300\uD559\uBCC4\uD604\uD669\uD310_${_b2SaveUniv}`)+"_"+new Date().toISOString().slice(0,10)+".png";try{if(typeof _captureAndSave!="function")throw new Error("\uC774\uBBF8\uC9C0 \uC800\uC7A5 \uAE30\uB2A5\uC744 \uBD88\uB7EC\uC624\uC9C0 \uBABB\uD588\uC2B5\uB2C8\uB2E4.");await _captureAndSave(a,k,b,x)}catch(f){console.error("[\uD604\uD669\uD310 \uC774\uBBF8\uC9C0 \uC800\uC7A5 \uC2E4\uD328]",f),alert(`\u274C \uC774\uBBF8\uC9C0 \uC800\uC7A5 \uC2E4\uD328

`+(f.message||"\uC54C \uC218 \uC5C6\uB294 \uC624\uB958\uAC00 \uBC1C\uC0DD\uD588\uC2B5\uB2C8\uB2E4."))}finally{document.body.removeChild(a),i&&(i.disabled=!1,i.textContent="\u{1F4F7} \uC774\uBBF8\uC9C0\uC800\uC7A5")}}function _b2PastelBg(t,e){const{r:i,g:l,b:o}=typeof _hexToRgbObj=="function"?_hexToRgbObj(t):{r:100,g:116,b:139},g=typeof e=="number"?e:.1,a=b=>Math.round(255*(1-g)+b*g);return`rgb(${a(i)},${a(l)},${a(o)})`}function _b2LineupCard(t,e,i,l){const o=(t.name||"").replace(/'/g,"\\'"),g=t.race&&t.race!=="N"?t.race:"?",a=t.photo?toHttpsUrl(t.photo):"",b={T:"#2563eb",P:"#d97706",Z:"#7c3aed"}[t.race]||"#475569",k=i?t.role||"":t.tier||"",x=a?`<img src="${a}" crossorigin="anonymous" aria-hidden="true" style="position:absolute;inset:0;width:100%;height:100%;object-fit:cover;object-position:top center;transform:scale(1.22);filter:blur(16px) saturate(1.15) brightness(.8);opacity:.85" onerror="this.style.display='none'">
       <div style="position:absolute;inset:0;background:linear-gradient(180deg,${e}33 0%,rgba(0,0,0,.18) 100%)"></div>`:`<div style="position:absolute;inset:0;background:linear-gradient(160deg,${e}44 0%,${e}1a 100%)"></div>`,f=a?`<img src="${a}" crossorigin="anonymous" style="position:absolute;inset:0;width:100%;height:100%;object-fit:cover;object-position:top center" onerror="this.style.display='none';this.nextElementSibling.style.display='flex'">
       <div style="position:absolute;inset:0;display:none;align-items:center;justify-content:center;flex-direction:column;gap:6px">
         <div style="font-size:56px;font-weight:900;color:${e};opacity:.7">${g}</div>
         ...
         <div style="font-size:56px;font-weight:900;color:${e};opacity:.7">${g}</div>
       </div>`,u=t.race&&t.race!=="N"?`<div style="position:absolute;top:10px;right:10px;padding:3px 10px;border-radius:999px;background:${b};color:#fff;font-size:12px;font-weight:800;box-shadow:0 2px 8px rgba(0,0,0,.32);z-index:2;letter-spacing:.02em">${t.race}</div>`:"",m='<div style="position:absolute;inset:0;background:linear-gradient(180deg,transparent 45%,rgba(0,0,0,.72) 100%);z-index:1;pointer-events:none"></div>',M=`
    <div style="position:absolute;bottom:0;left:0;right:0;z-index:2;padding:14px 14px 14px">
      ${k?`<div style="margin-bottom:4px"><span style="background:${e};color:#fff;font-weight:900;font-size:13px;padding:2px 9px;border-radius:999px;white-space:nowrap;line-height:1.6;letter-spacing:-.01em">${k}</span></div>`:""}
      <div style="color:#fff;font-weight:900;font-size:19px;letter-spacing:-.02em;white-space:nowrap;overflow:hidden;text-overflow:ellipsis;text-shadow:0 1px 4px rgba(0,0,0,.5)">${t.name||""}</div>
    </div>`;return`
    <div style="position:relative;cursor:pointer;border-radius:16px;overflow:hidden;background:${_b2PastelBg(e,.1)};box-shadow:0 4px 16px rgba(15,23,42,.18);border:1px solid ${e}33;transition:transform .15s,box-shadow .15s" onclick="openPlayerModal('${o}')"
    ...
    </div>`}function _b2LineupPoster(t,e,i=!1){if(!t)return'<div style="text-align:center;color:var(--text3);padding:40px">\uB300\uD559\uC744 \uC120\uD0DD\uD574\uC8FC\uC138\uC694</div>';const l=(typeof univCfg!="undefined"?univCfg.find(n=>n.name===t):null)||{},o=l.icon||l.img||UNIV_ICONS[t]||"",g=players.filter(n=>String((n==null?void 0:n.univ)||"").trim()===String(t||"").trim()&&!n.hidden&&!n.retired&&!n.hideFromBoard);if(!g.length)return`<div style="border-radius:18px;border:2px dashed ${e}55;padding:30px;background:${e}10;text-align:center;color:var(--text3)">\uB4F1\uB85D\uB41C \uC120\uC218\uAC00 \uC5C6\uC2B5\uB2C8\uB2E4</div>`;const a=g.filter(n=>_B2_ROLE_ORDER.includes(n.role||""));a.sort((n,S)=>_b2RoleRank(n)-_b2RoleRank(S));const b=g.filter(n=>!_B2_ROLE_ORDER.includes(n.role||""));b.sort((n,S)=>{const T=TIERS.indexOf(n.tier||""),w=TIERS.indexOf(S.tier||""),A=T>=0?T:99,W=w>=0?w:99;return A!==W?A-W:(n.name||"").localeCompare(S.name||"","ko",{sensitivity:"base"})});const k=a.map(n=>_b2LineupCard(n,e,!0,o)).join(""),x=b.map(n=>_b2LineupCard(n,e,!1,o)).join(""),f=new Date().toISOString().slice(0,10).replace(/-/g,"."),u={T:0,P:0,Z:0};b.forEach(n=>{u.hasOwnProperty(n.race)&&u[n.race]++});const M=[{k:"T",ico:"\u2694\uFE0F",col:"#2563eb"},{k:"P",ico:"\u{1F52E}",col:"#d97706"},{k:"Z",ico:"\u{1F98E}",col:"#7c3aed"}].filter(n=>u[n.k]>0).map(n=>`
    <span style="display:inline-flex;align-items:center;gap:4px;background:rgba(255,255,255,.14);border:1px solid rgba(255,255,255,.22);border-radius:999px;padding:5px 12px 5px 10px;color:#fff;font-size:12px;font-weight:800">
      <span style="font-size:12px">${n.ico}</span>${n.k} ${u[n.k]}
    </span>`).join(""),C=typeof TIERS!="undefined"?TIERS:[],E={};b.forEach(n=>{const S=n.tier||"\uBBF8\uC815";E[S]=(E[S]||0)+1});const s=Object.keys(E).sort((n,S)=>{const T=C.indexOf(n),w=C.indexOf(S);return(T>=0?T:99)-(w>=0?w:99)}).map(n=>({tier:n,n:E[n]})).map(n=>`
    <span style="display:inline-flex;align-items:center;gap:4px;background:${e}14;border:1px solid ${e}33;border-radius:999px;padding:4px 11px;color:${e};font-size:12px;font-weight:800">
      ${n.tier}<span style="opacity:.65;font-weight:700">\xD7${n.n}</span>
    </span>`).join("");return`
    <div data-b2lineup="${t.replace(/"/g,"&quot;")}" style="border-radius:24px;overflow:hidden;background:#0b1220;box-shadow:0 20px 40px rgba(15,23,42,.28)">
      <div style="padding:30px 30px 24px;position:relative;overflow:hidden;background:linear-gradient(135deg,${e} 0%,${e}cc 65%,#0b1220 130%)">
        ...
        ${o?`<img src="${toHttpsUrl(o)}" aria-hidden="true" style="position:absolute;left:50%;top:50%;transform:translate(-50%,-50%);max-height:84%;max-width:160px;width:auto;height:auto;opacity:.20;object-fit:contain;pointer-events:none;filter:drop-shadow(0 0 20px ${e})" onerror="this.style.display='none'">`:""}
        <div style="position:relative;z-index:1;display:flex;align-items:center;justify-content:space-between;gap:10px;flex-wrap:wrap">
          <div style="display:flex;align-items:center;gap:14px;min-width:0">
            ...
            <div style="min-width:0">
              ...
              <div style="color:#fff;font-weight:950;font-size:32px;letter-spacing:-.03em;white-space:nowrap;overflow:hidden;text-overflow:ellipsis;text-shadow:0 2px 8px rgba(0,0,0,.18)">${t}</div>
            </div>
          </div>
          <div style="display:flex;align-items:center;gap:8px;flex-shrink:0">
            <span style="background:rgba(255,255,255,.16);color:#fff;font-size:13px;font-weight:800;padding:7px 16px;border-radius:999px;border:1px solid rgba(255,255,255,.24);backdrop-filter:blur(8px)">\uCD1D ${g.length}\uBA85</span>
            <span style="color:rgba(255,255,255,.55);font-size:12px;font-weight:700">${f}</span>
          </div>
        </div>
        ${M?`<div style="position:relative;z-index:1;display:flex;align-items:center;gap:6px;flex-wrap:wrap;margin-top:16px">${M}</div>`:""}
      </div>
      <div style="position:relative;overflow:hidden;background:linear-gradient(180deg,${_b2PastelBg(e,.26)} 0%,${_b2PastelBg(e,.18)} 100%);padding:26px 28px 32px">
        ...
        <div style="position:relative;z-index:1">
          ...
          <div style="display:flex;align-items:center;gap:8px;margin-bottom:12px">
            <div style="width:3px;height:14px;border-radius:999px;background:${e};flex-shrink:0"></div>
            <div style="font-size:11px;font-weight:900;color:${e};letter-spacing:.06em;text-transform:uppercase">\uC9C1\uAE09\uC790</div>
          </div>
          <div style="display:grid;grid-template-columns:repeat(auto-fill,minmax(170px,1fr));gap:16px;margin-bottom:24px">${k}</div>
          <div style="height:1px;background:linear-gradient(90deg,${e}44,transparent);margin-bottom:20px"></div>
          `:""}
          <div style="display:flex;align-items:center;justify-content:space-between;gap:10px;margin-bottom:12px;flex-wrap:wrap">
            <div style="display:flex;align-items:center;gap:8px">
              <div style="width:3px;height:14px;border-radius:999px;background:${e}99;flex-shrink:0"></div>
              <div style="font-size:11px;font-weight:900;color:${e};letter-spacing:.06em;text-transform:uppercase">\uBA64\uBC84</div>
            </div>
            ${s?`<div style="display:flex;align-items:center;gap:5px;flex-wrap:wrap">${s}</div>`:""}
          </div>
          <div style="display:grid;grid-template-columns:repeat(auto-fill,minmax(170px,1fr));gap:16px">${x}</div>
        </div>
      </div>
    </div>`}function _b2LineupView(){const t=_b2VisUnivs().filter(i=>i.name!=="\uBB34\uC18C\uC18D");if(!t.length)return'<div style="text-align:center;color:var(--text3);padding:40px">\uB4F1\uB85D\uB41C \uB300\uD559\uC774 \uC5C6\uC2B5\uB2C8\uB2E4</div>';(!_b2LineupUniv||!t.some(i=>i.name===_b2LineupUniv))&&(_b2LineupUniv=t[0].name);const e=gc(_b2LineupUniv);return`<div style="max-width:1360px;margin:0 auto">${_b2LineupPoster(_b2LineupUniv,e,!1)}</div>`}async function saveB2LineupImg(){const t=_b2VisUnivs().filter(x=>x.name!=="\uBB34\uC18C\uC18D");if((!_b2LineupUniv||!t.some(x=>x.name===_b2LineupUniv))&&(_b2LineupUniv=t[0]?t[0].name:""),!_b2LineupUniv){alert("\uC800\uC7A5\uD560 \uB300\uD559\uC774 \uC5C6\uC2B5\uB2C8\uB2E4.");return}const e=document.querySelector('[onclick="saveB2LineupImg()"]');e&&(e.disabled=!0,e.textContent="\u23F3...");const i=1360,l=0,o=gc(_b2LineupUniv),g=document.createElement("div");g.style.cssText=`position:fixed;left:-9999px;top:0;padding:${l}px;background:#f0f2f5;box-sizing:border-box;width:${i+l*2}px`,g.innerHTML=_b2LineupPoster(_b2LineupUniv,o,!0),document.body.appendChild(g),g.querySelectorAll(".no-export,.no-export-movebtns").forEach(x=>x.remove()),await new Promise(x=>setTimeout(x,100)),injectUnivIcons(g);const a=g.scrollHeight+8,b=g.scrollWidth,k=`\uB300\uD559\uB77C\uC778\uC5C5_${_b2LineupUniv}_`+new Date().toISOString().slice(0,10)+".png";try{if(typeof _captureAndSave!="function")throw new Error("\uC774\uBBF8\uC9C0 \uC800\uC7A5 \uAE30\uB2A5\uC744 \uBD88\uB7EC\uC624\uC9C0 \uBABB\uD588\uC2B5\uB2C8\uB2E4.");await _captureAndSave(g,b,a,k)}catch(x){console.error("[\uB77C\uC778\uC5C5 \uC774\uBBF8\uC9C0 \uC800\uC7A5 \uC2E4\uD328]",x),alert(`\u274C \uC774\uBBF8\uC9C0 \uC800\uC7A5 \uC2E4\uD328

`+(x.message||"\uC54C \uC218 \uC5C6\uB294 \uC624\uB958\uAC00 \uBC1C\uC0DD\uD588\uC2B5\uB2C8\uB2E4."))}finally{document.body.removeChild(g),e&&(e.disabled=!1,e.textContent="\u{1F4F7} \uC774\uBBF8\uC9C0\uC800\uC7A5")}}async function saveB2FreeImg(){const t=document.querySelector('[onclick="saveB2FreeImg()"]');t&&(t.disabled=!0,t.textContent="\u23F3...");const e=720,i=24,l=document.createElement("div");l.style.cssText=`position:fixed;left:-9999px;top:0;padding:${i}px;background:#f0f2f5;box-sizing:border-box;width:${e+i*2}px`,l.innerHTML=`<style>.b2-bottom-img{max-width:160px;max-height:130px;object-fit:contain;}</style>${_b2FreeView()}`,document.body.appendChild(l),l.querySelectorAll(".no-export,.no-export-movebtns").forEach(b=>b.remove()),await new Promise(b=>setTimeout(b,100)),injectUnivIcons(l);const o=l.scrollHeight+32,g=l.scrollWidth,a="\uBB34\uC18C\uC18D\uD604\uD669\uD310_"+new Date().toISOString().slice(0,10)+".png";try{if(typeof _captureAndSave!="function")throw new Error("\uC774\uBBF8\uC9C0 \uC800\uC7A5 \uAE30\uB2A5\uC744 \uBD88\uB7EC\uC624\uC9C0 \uBABB\uD588\uC2B5\uB2C8\uB2E4.");await _captureAndSave(l,g,o,a)}catch(b){console.error("[\uBB34\uC18C\uC18D \uD604\uD669\uD310 \uC774\uBBF8\uC9C0 \uC800\uC7A5 \uC2E4\uD328]",b),alert(`\u274C \uC774\uBBF8\uC9C0 \uC800\uC7A5 \uC2E4\uD328

`+(b.message||"\uC54C \uC218 \uC5C6\uB294 \uC624\uB958\uAC00 \uBC1C\uC0DD\uD588\uC2B5\uB2C8\uB2E4."))}finally{document.body.removeChild(l),t&&(t.disabled=!1,t.textContent="\u{1F4F7} \uC774\uBBF8\uC9C0\uC800\uC7A5")}}function _b2ContrastColor(t){try{const e=String(t||"").replace("#","").trim(),i=parseInt(e.slice(0,2),16),l=parseInt(e.slice(2,4),16),o=parseInt(e.slice(4,6),16);if([i,l,o].some(x=>Number.isNaN(x)))return"#ffffff";const g=x=>(x/=255,x<=.03928?x/12.92:Math.pow((x+.055)/1.055,2.4)),a=.2126*g(i)+.7152*g(l)+.0722*g(o),b=(1+.05)/(a+.05),k=(a+.05)/(.02+.05);return b>=k?"#ffffff":"#0f172a"}catch(e){return"#ffffff"}}localStorage.removeItem("su_b2SelectedPlayer"),(function(){const t=players.filter(l=>l&&!l.hidden&&!l.retired&&!l.hideFromBoard),e=t.filter(l=>l.photo||window.playerPhotos&&window.playerPhotos[l.name]),i=e.length?e:t;i.length&&(_b2SelectedPlayer=i[Math.floor(Math.random()*i.length)])})();

/* board2-players.js */
function _b2PlayersView(){var ne;const F=typeof univCfg!="undefined"?new Set((univCfg.filter(e=>e.dissolved)||[]).map(e=>e.name)):new Set,t=players.filter(e=>!e.hidden&&!e.retired&&!e.hideFromBoard&&!F.has(e.univ)),_=_b2PlayersUnivFilter==="\uC804\uCCB4"?t:t.filter(e=>String((e==null?void 0:e.univ)||"").trim()===String(_b2PlayersUnivFilter||"").trim()),g=_b2PlayersFilter==="all"?_:_.filter(e=>e.race===_b2PlayersFilter);let l=_b2PlayersTierFilter==="\uC804\uCCB4"?g.filter(e=>e.tier&&e.tier!=="?"&&e.tier!=="\uBBF8\uC815"&&e.tier!=="\uBBF8\uD655\uC778"):g.filter(e=>e.tier===_b2PlayersTierFilter);const{fromN:$,toN:v}=_b2ThisWeekRange(),S=_b2DateNum,B=e=>{let r=0,o=0;return(Array.isArray(e.history)?e.history:[]).forEach(s=>{const d=S(s.date||s.d||"");d>=$&&d<=v&&(s.result==="\uC2B9"?r++:s.result==="\uD328"&&o++)}),{w:r,l:o,total:r+o}};if(!l.length)return`<div style="text-align:center;padding:60px 20px;color:var(--gray-l)">
      <div style="font-size:48px;margin-bottom:12px">\u{1F464}</div>
      <div style="font-weight:700">\uD45C\uC2DC\uD560 \uC120\uC218\uAC00 \uC5C6\uC2B5\uB2C8\uB2E4</div>
    </div>`;if(!_b2SelectedPlayer||!l.find(e=>e.name===_b2SelectedPlayer.name)){const e=l.filter(o=>o.photo||window.playerPhotos&&window.playerPhotos[o.name]),r=e.length?e:l;_b2SelectedPlayer=r[Math.floor(Math.random()*r.length)]}const T=[...new Set(t.map(e=>String((e==null?void 0:e.univ)||"").trim()).filter(e=>e&&e!=="\uBB34\uC18C\uC18D"))];typeof univCfg!="undefined"?T.sort((e,r)=>{const o=univCfg.findIndex(d=>d.name===e),s=univCfg.findIndex(d=>d.name===r);return(o>=0?o:999)-(s>=0?s:999)}):T.sort();const E=((ne=localStorage.getItem("su_b2_profile_shuffle"))!=null?ne:"1")==="1";if(E){const e=[_b2PlayersUnivFilter,_b2PlayersFilter,_b2PlayersTierFilter].join("|");if(window._b2ShuffleKey!==e||!Array.isArray(window._b2ShuffledNames)){for(let r=l.length-1;r>0;r--){const o=Math.floor(Math.random()*(r+1)),s=l[r];l[r]=l[o],l[o]=s}window._b2ShuffleKey=e,window._b2ShuffledNames=l.map(r=>r.name)}else{const r={};window._b2ShuffledNames.forEach((o,s)=>{r[o]=s}),l.sort((o,s)=>{var d,k;return((d=r[o.name])!=null?d:9999)-((k=r[s.name])!=null?k:9999)})}}else{const e=["\uC774\uC0AC\uC7A5","\uCD1D\uC7A5","\uAD50\uC218","\uCF54\uCE58"],r=["0","1","2","3","4","5","6","7","8","\uC720\uC2A4"];l.sort((o,s)=>{const d=e.indexOf(o.role||""),k=e.indexOf(s.role||""),C=d>=0,A=k>=0;if(C&&!A)return-1;if(!C&&A)return 1;if(C&&A&&d!==k)return d-k;const x=o.tier||"?",H=s.tier||"?",K=r.indexOf(x),G=r.indexOf(H);if(K>=0&&G>=0&&K!==G)return K-G;const Y=parseInt(x)||999,ae=parseInt(H)||999;return Y!==ae?Y-ae:(o.name||"").localeCompare(s.name||"","ko",{sensitivity:"base"})})}const P=(e,r)=>{const o=parseInt(e.slice(1,3),16),s=parseInt(e.slice(3,5),16),d=parseInt(e.slice(5,7),16);return`rgba(${o},${s},${d},${r})`},M=gc(_b2SelectedPlayer.univ)||"#6366f1",f=(b2ProfileBgAlpha||10)/100,b={glow:P(M,.3),bg:P(M,f),border:M},m=JSON.parse(localStorage.getItem("su_b2_layout")||"{}"),j=m.autoResize!==!1,i=m.autoHeight!==!1,p=m.rightSize||m.leftSize||55,c=m.pcHeight||600,a=m.mobileHeight||320,N=m.tabletHeight||400,R=Math.min(Math.max(p+7,60),76),U=Math.min(Math.max(p+5,58),74),u=Math.min(Math.max(p+3,56),72),L=N+220;let I=`
    <style>
      .b2-players-wrapper {
        display: flex;
        gap: 24px;
      ...
      .b2-players-main-content {
        ...
        border-radius: 24px;
        overflow: hidden;
        box-shadow: 0 20px 50px rgba(0,0,0,0.3), 0 0 30px ${b.glow};
      ...
      @media (min-width: 769px) and (max-width: 1024px) {
        ...
        .b2-players-main {
          ...
          width: 100%;
          min-height: ${L}px;
          height: ${i?`clamp(${L}px, 78vh, ${c+220}px)`:`${L}px`};
        }
        .b2-players-grid-wrapper {
          flex: none;
          min-height: 0;
  ...
  `;I+='<div class="b2-players-wrapper">';const n=_b2GetImgSettings(_b2SelectedPlayer.name,"primary"),h=_b2GetImgSettings(_b2SelectedPlayer.name,"secondary"),y=n,z=(_b2SelectedPlayer.name||"").replace(/\\/g,"\\\\").replace(/'/g,"\\'"),w=e=>!!String(e||"").trim(),D=w(_b2SelectedPlayer.photo),O=w(_b2SelectedPlayer.secondProfileFile),V=(e,r,o)=>{try{if(e===!1)return"center center";const s=Number(r),d=Number(o);if(!Number.isFinite(s)||!Number.isFinite(d))return"center center";const k=Math.max(0,Math.min(100,s)),C=Math.max(0,Math.min(100,d));return`${k}% ${C}%`}catch(s){return"center center"}},q=V(_b2SelectedPlayer.photo3PosUse,_b2SelectedPlayer.photo3PosX,_b2SelectedPlayer.photo3PosY),X=V(_b2SelectedPlayer.photo4PosUse,_b2SelectedPlayer.photo4PosX,_b2SelectedPlayer.photo4PosY),ee=V(_b2SelectedPlayer.photo5PosUse,_b2SelectedPlayer.photo5PosX,_b2SelectedPlayer.photo5PosY);try{typeof prewarmImageUrls=="function"&&prewarmImageUrls([_b2SelectedPlayer.photo,_b2SelectedPlayer.secondProfileFile,...l.map(e=>e.photo).filter(Boolean)],24)}catch(e){}const J=e=>{const r=String(e||"").trim().toLowerCase().split("#")[0].split("?")[0];return r.endsWith(".mp4")||r.endsWith(".webm")||r.endsWith(".ogg")||r.endsWith(".mov")||r.endsWith(".m4v")},W=(e,r,o)=>{const s=String(r||"").trim();if(!s)return"";const d=toHttpsUrl(s),k=J(s),C=o&&o.z!=null?o.z:e,A=o&&o.opacity!=null?o.opacity:e===1?1:0,x=o&&o.style?o.style:"",H=o&&o.onLoadJs?String(o.onLoadJs):"",G=H?` ${H?k?"onloadedmetadata":"onload":""}="${H}"`:"",Y=`class="b2-players-main-image" id="b2-main-img-${e}" style="position:absolute;inset:0;width:100%;height:100%;min-width:100%;min-height:100%;z-index:${C};opacity:${A};pointer-events:none;${x}"`;return k?`<video ${Y} src="${d}" preload="metadata" muted playsinline${G}></video>`:`<img ${Y} src="${d}" decoding="async" fetchpriority="high"${G}>`},Z=_b2SelectedPlayer.name.replace(/'/g,"\\'"),se=w(_b2SelectedPlayer.photo)?W(1,_b2SelectedPlayer.photo,{z:1,opacity:1,onLoadJs:`_b2ScheduleImageSwap('${Z}'); if(typeof _b2ApplyImgSettingsToDom==='function'){ _b2ApplyImgSettingsToDom('${Z}', 'primary'); }`,style:`object-fit:${n.fit||"cover"};object-position:center center;transform:${_b2GetImgTransform(n)};filter:brightness(${(n.brightness||100)/100});transition:opacity 0.4s ease;`}):`<div style="width:100%;height:100%;display:flex;align-items:center;justify-content:center;background:rgba(255,255,255,0.05);font-size:64px;font-weight:900;color:rgba(255,255,255,0.2)">${(_b2SelectedPlayer.name||"?")[0]}</div>`,le=w(_b2SelectedPlayer.secondProfileFile)?W(2,_b2SelectedPlayer.secondProfileFile,{z:2,opacity:0,onLoadJs:`if(typeof _b2ApplyImgSettingsToDom==='function'){ _b2ApplyImgSettingsToDom('${Z}', 'secondary'); }`,style:`object-fit:${h.fit||"cover"};object-position:center center;transform:${_b2GetImgTransform(h)};filter:brightness(${(h.brightness||100)/100});transition:opacity 0.4s ease;`}):"",pe=w(_b2SelectedPlayer.profileFile3)?W(3,_b2SelectedPlayer.profileFile3,{z:3,opacity:0,style:`object-fit:cover;object-position:${q};transition:opacity 0.4s ease;`}):"",de=w(_b2SelectedPlayer.profileFile4)?W(4,_b2SelectedPlayer.profileFile4,{z:4,opacity:0,style:`object-fit:cover;object-position:${X};transition:opacity 0.4s ease;`}):"",ce=w(_b2SelectedPlayer.profileFile5)?W(5,_b2SelectedPlayer.profileFile5,{z:5,opacity:0,style:`object-fit:cover;object-position:${ee};transition:opacity 0.4s ease;`}):"",te=(()=>{const e=univCfg.find(r=>r.name===_b2SelectedPlayer.univ)||{};return e.icon||e.img||UNIV_ICONS[_b2SelectedPlayer.univ]||""})();I+=`
    <div class="b2-players-main">
      <div class="b2-players-main-content" id="b2-players-main-box" style="--img-zoom:${y.zoom/100};--img-brightness:${y.brightness/100};--img-pos-x:${y.posX}px;--img-pos-y:${y.posY}px;">
        ...
        ${isLoggedIn?`<div class="b2-players-img-controls" id="b2-img-controls" style="display:none">
          ...
          ${_b2BuildImageControlGroup(z,"primary","\uC774\uBBF8\uC9C0 1",D)}
          ${_b2BuildImageControlGroup(z,"secondary","\uC774\uBBF8\uC9C0 2",O)}
        </div>`:""}
        ...
        <div class="b2-players-info">
          ...
          <div class="b2-players-details">
            ...
            <span class="b2-players-chip b2-players-race">${_b2SelectedPlayer.race==="P"?"\u{1F52E} \uD504\uB85C\uD1A0\uC2A4":_b2SelectedPlayer.race==="T"?"\u2694\uFE0F \uD14C\uB780":_b2SelectedPlayer.race==="Z"?"\u{1F98E} \uC800\uADF8":"\uC885\uC871\uBBF8\uC815"}</span>
  ...
  `;const ie=[String(_b2PlayersUnivFilter||""),String(_b2PlayersFilter||""),String(_b2PlayersTierFilter||""),E?"1":"0"].join("|");window._b2PlayersRenderKey!==ie&&(window._b2PlayersRenderKey=ie,window._b2PlayersRenderLimit=240);const be=Math.max(60,parseInt(window._b2PlayersRenderLimit||0,10)||240),ge=Math.min(l.length,be);let Q=l.slice();const oe=Q.slice(0,ge),re=Math.max(0,Q.length-oe.length);return I+=`
    <div class="b2-players-grid-wrapper">
      <div class="b2-players-grid">
  `,oe.forEach(e=>{const r=_b2SelectedPlayer&&_b2SelectedPlayer.name===e.name,o=encodeURIComponent(String(e.name||"")),s=gc(e.univ)||"#6366f1",d={bg:P(s,.1),border:s},k=typeof getTierBtnColor=="function"&&e.tier?getTierBtnColor(e.tier):"#64748b",C=typeof getTierBtnTextColor=="function"&&e.tier&&getTierBtnTextColor(e.tier)||"#fff",A=e.race==="P"?"\u{1F52E}":e.race==="T"?"\u2694\uFE0F":e.race==="Z"?"\u{1F98E}":"",x=B(e),H=x&&x.total>0?x.w/x.total>=.6?"#10b981":x.w/x.total>=.4?"#f59e0b":"#ef4444":"#94a3b8";I+=`
      <div class="b2-players-card" data-player-name="${typeof escAttr=="function"?escAttr(e.name||""):String(e.name||"").replace(/"/g,"&quot;")}" data-player-key="${o}" onclick="_b2UpdateMainDisplay(decodeURIComponent(this.dataset.playerKey||''));openPlayerModal(decodeURIComponent(this.dataset.playerKey||''))" style="width:148px;padding:14px;border-radius:18px;cursor:pointer;transition:all 0.2s ease;display:flex;flex-direction:column;align-items:center;gap:8px;background:linear-gradient(180deg,var(--white),rgba(248,250,252,.98));border:1px solid rgba(148,163,184,.14);box-shadow:0 8px 18px rgba(15,23,42,0.06)">
        <div style="position:relative;width:118px;height:118px;flex-shrink:0">
          ${e.photo?`<img src="${toHttpsUrl(e.photo)}" decoding="async" fetchpriority="auto" class="b2-players-thumbnail b2-fit-auto" data-fit-kind="thumb" data-fit-mode="auto" alt="${e.name}" style="width:118px;height:118px;border-radius:14px;object-fit:contain;display:block;border:2px solid rgba(226,232,240,.8);background:linear-gradient(180deg,#fff,#f8fafc)" onload="_b2ApplyBgAutoSizing(this)" onerror="this.style.display='none';this.nextElementSibling.style.display='flex'">
              <div class="b2-players-thumbnail" style="width:118px;height:118px;border-radius:14px;display:none;align-items:center;justify-content:center;background:${d.bg};font-size:48px;font-weight:900;color:${d.border};border:2px solid rgba(226,232,240,.8)">${(e.name||"?")[0]}</div>`:`<div class="b2-players-thumbnail" style="width:118px;height:118px;border-radius:14px;display:flex;align-items:center;justify-content:center;background:${d.bg};font-size:48px;font-weight:900;color:${d.border};border:2px solid rgba(226,232,240,.8)">${(e.name||"?")[0]}</div>`}
          ${e.tier?`<span style="position:absolute;top:6px;left:6px;font-size:10px;font-weight:800;padding:2px 7px;border-radius:999px;background:${k};color:${C};line-height:1.5;box-shadow:0 8px 16px rgba(15,23,42,.18)">${e.tier}</span>`:""}
          ${x&&x.total>0?`<span style="position:absolute;bottom:6px;right:6px;font-size:9px;font-weight:900;padding:3px 6px;border-radius:999px;background:rgba(15,23,42,.78);color:${H};line-height:1.4;backdrop-filter:blur(6px);box-shadow:0 8px 16px rgba(15,23,42,.18)">${x.w}\uC2B9 ${x.l}\uD328</span>`:""}
          ${x&&x.total>0&&x.w===x.total?'<span style="position:absolute;top:6px;right:6px;font-size:12px">\u{1F525}</span>':""}
        </div>
        <div style="width:100%;display:flex;flex-direction:column;align-items:center;gap:2px">
          <div class="b2-players-label" style="font-size:14px;font-weight:800;text-align:center;color:var(--text1);white-space:nowrap;overflow:hidden;text-overflow:ellipsis;width:100%">${e.name||"\uC774\uB984 \uC5C6\uC74C"}</div>
          <div style="display:flex;align-items:center;gap:4px;flex-wrap:wrap;justify-content:center;padding:0 2px">
            ${A?`<span style="font-size:11px">${A}</span>`:""}
            <span style="font-size:10px;color:var(--text3);font-weight:700;overflow:hidden;text-overflow:ellipsis;white-space:nowrap;max-width:104px">${e.univ||"\uBB34\uC18C\uC18D"}</span>
          </div>
        </div>
      </div>
    `}),I+=`
  ...
  `,I+="</div>",I}function _b2UpdateMainDisplay(F){const t=players.find(n=>n.name===F);if(!t)return;try{typeof prewarmImageUrls=="function"&&prewarmImageUrls([t.photo,t.secondProfileFile],4)}catch(n){}_b2SelectedPlayer=t;const _=(n,h)=>{const y=parseInt(n.slice(1,3),16),z=parseInt(n.slice(3,5),16),w=parseInt(n.slice(5,7),16);return`rgba(${y},${z},${w},${h})`},g=gc(t.univ)||"#6366f1",l=(b2ProfileBgAlpha||10)/100,$={glow:_(g,.3),bg:_(g,l),border:g},v=(n,h,y)=>{try{if(n===!1)return"center center";const z=Number(h),w=Number(y);if(!Number.isFinite(z)||!Number.isFinite(w))return"center center";const D=Math.max(0,Math.min(100,z)),O=Math.max(0,Math.min(100,w));return`${D}% ${O}%`}catch(z){return"center center"}},S=v(t.photo3PosUse,t.photo3PosX,t.photo3PosY),B=v(t.photo4PosUse,t.photo4PosX,t.photo4PosY),T=v(t.photo5PosUse,t.photo5PosX,t.photo5PosY),E=n=>{const h=String(n||"").trim().toLowerCase().split("#")[0].split("?")[0];return h.endsWith(".mp4")||h.endsWith(".webm")||h.endsWith(".ogg")||h.endsWith(".mov")||h.endsWith(".m4v")},P=(n,h,y)=>{const z=String(h||"").trim();if(!z)return"";const w=toHttpsUrl(z),D=E(z),O=y&&y.z!=null?y.z:n,V=y&&y.opacity!=null?y.opacity:n===1?1:0,q=y&&y.style?y.style:"",X=y&&y.onLoadJs?String(y.onLoadJs):"",J=X?` ${X?D?"onloadedmetadata":"onload":""}="${X}"`:"",W=`class="b2-players-main-image" id="b2-main-img-${n}" style="position:absolute;inset:0;width:100%;height:100%;min-width:100%;min-height:100%;z-index:${O};opacity:${V};pointer-events:none;${q}"`;return D?`<video ${W} src="${w}" preload="metadata" muted playsinline${J}></video>`:`<img ${W} src="${w}" decoding="async" fetchpriority="high"${J}>`},M=t.name.replace(/'/g,"\\'"),f=n=>!!String(n||"").trim(),b=f(t.photo)?P(1,t.photo,{z:1,opacity:1,onLoadJs:`_b2ScheduleImageSwap('${M}')`,style:"transition:opacity 0.4s ease;"}):`<div style="width:100%;height:100%;display:flex;align-items:center;justify-content:center;background:rgba(255,255,255,0.05);font-size:64px;font-weight:900;color:rgba(255,255,255,0.2)">${(t.name||"?")[0]}</div>`,m=f(t.secondProfileFile)?P(2,t.secondProfileFile,{z:2,opacity:0,style:"object-fit:cover;transition:opacity 0.4s ease;"}):"",j=f(t.profileFile3)?P(3,t.profileFile3,{z:3,opacity:0,style:`object-fit:cover;object-position:${S};transition:opacity 0.4s ease;`}):"",i=f(t.profileFile4)?P(4,t.profileFile4,{z:4,opacity:0,style:`object-fit:cover;object-position:${B};transition:opacity 0.4s ease;`}):"",p=f(t.profileFile5)?P(5,t.profileFile5,{z:5,opacity:0,style:`object-fit:cover;object-position:${T};transition:opacity 0.4s ease;`}):"",c=(()=>{const n=univCfg.find(h=>h.name===t.univ)||{};return n.icon||n.img||UNIV_ICONS[t.univ]||""})(),a=document.getElementById("b2-players-main-box"),N=_b2GetImgSettings(t.name,"primary"),R=_b2GetImgSettings(t.name,"secondary"),U=(t.name||"").replace(/\\/g,"\\\\").replace(/'/g,"\\'"),u=f(t.photo),L=f(t.secondProfileFile);if(a){_b2ClearSwapTimer(a),a.innerHTML=`
      ${b}
      ${m}
      ${j}
      ${i}
      ...
      ${isLoggedIn?`<div class="b2-players-img-controls" id="b2-img-controls" style="display:none">
        <div class="b2-players-controls-title">\u{1F3A8} \uC774\uBBF8\uC9C0 \uC124\uC815</div>
        ${_b2BuildImageControlGroup(U,"primary","\uC774\uBBF8\uC9C0 1",u)}
        ${_b2BuildImageControlGroup(U,"secondary","\uC774\uBBF8\uC9C0 2",L)}
      </div>`:""}
      ...
      <div class="b2-players-info">
        ...
        <div class="b2-players-details">
          <span class="b2-players-tier" style="background:${$.border}">${t.tier||"?"}\uD2F0\uC5B4</span>
          <span class="b2-players-chip b2-players-race">${t.race==="P"?"\uD504\uB85C\uD1A0\uC2A4":t.race==="T"?"\uD14C\uB780":t.race==="Z"?"\uC800\uADF8":"\uC885\uC871\uBBF8\uC815"}</span>
    ...
    `,_b2ApplyImgSettingsToElement(document.getElementById("b2-main-img-1"),N),_b2ApplyImgSettingsToElement(document.getElementById("b2-main-img-2"),R);const n=document.getElementById("b2-main-img-1"),h=n&&n.tagName==="VIDEO";f(t.photo)?n&&!h&&n.complete&&_b2ScheduleImageSwap(t.name):_b2ScheduleImageSwap(t.name)}const I=String(F||"").trim();document.querySelectorAll(".b2-players-card").forEach(n=>{n.classList.remove("active")})}function openB2ProfileEditModal(F){const t=players.find(i=>i.name===F);if(!t)return;const _=i=>String(i||"").trim(),g=_(t.photo),l=_(t.secondProfileFile),$=_(t.profileFile3),v=_(t.profileFile4),S=_(t.profileFile5),B=[{slot:1,url:g},{slot:2,url:l},{slot:3,url:$},{slot:4,url:v},{slot:5,url:S}].filter(i=>!!i.url),T=(i,p)=>p===1?i===2?"photoDelay21":i===3?"photoDelay31":i===4?"photoDelay41":"photoDelay51":i===1?"photoDelay12":i===2?"photoDelay23":i===3?"photoDelay34":i===4?"photoDelay45":"",E=i=>{var c;const p=parseFloat((c=t==null?void 0:t[i])!=null?c:1);return isNaN(p)?1:Math.max(.2,Math.min(60,p))},P=i=>{const p=parseFloat(i);return isNaN(p)?1:Math.max(.2,Math.min(60,p))},M=B.length<2?'<div style="font-size:11px;color:var(--gray-l);line-height:1.65">\uB4F1\uB85D\uB41C \uC774\uBBF8\uC9C0\uAC00 1\uAC1C\uB77C \uC804\uD658 \uC2DC\uAC04 \uC124\uC815\uC774 \uD544\uC694\uD558\uC9C0 \uC54A\uC2B5\uB2C8\uB2E4.</div>':`<div style="display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:10px">${B.map((i,p)=>{const c=B[(p+1)%B.length],a=T(i.slot,c.slot);return a?`<div>
          <div style="font-size:11px;font-weight:800;color:var(--text3);margin-bottom:6px">${i.slot} \u2192 ${c.slot}</div>
          <input type="number" data-b2-delay-key="${a}" min="0.2" max="60" step="0.1" value="${E(a)}" style="width:100%;padding:8px 12px;border:1px solid var(--border2);border-radius:8px;font-size:13px">
        </div>`:""}).join("")}</div>`,f=document.createElement("div");f.id="b2-profile-edit-modal",f.style.cssText="position:fixed;top:0;left:0;width:100%;height:100%;background:rgba(0,0,0,0.5);display:flex;align-items:center;justify-content:center;z-index:var(--z-modal-5)",f.innerHTML=`
    <div style="background:var(--white);border-radius:16px;padding:24px;max-width:500px;width:90%;max-height:80vh;overflow-y:auto;box-shadow:0 10px 40px rgba(0,0,0,0.3)">
      ...
      <div style="margin-bottom:16px">
        ...
        <div style="display:flex;gap:8px;align-items:center">
          <input type="text" id="b2-ed-photo" value="${g}" placeholder="https://... \uC774\uBBF8\uC9C0 URL \uC785\uB825" style="flex:1;padding:8px 12px;border:1px solid var(--border2);border-radius:8px;font-size:13px">
          <span id="b2-ed-photo-preview-wrap" style="position:relative;width:40px;height:40px;border-radius:var(--su_profile_radius,50%);overflow:hidden;flex-shrink:0;background:#e2e8f0;border:2px solid var(--border);display:${g&&!g.startsWith("data:")?"inline-block":"none"}">
            <img id="b2-ed-photo-preview" src="${g&&!g.startsWith("data:")?toHttpsUrl(g):""}" style="width:40px;height:40px;object-fit:cover;display:block" onerror="this.style.display='none'">
          </span>
        </div>
        <div id="b2-ed-photo-warn" style="font-size:10px;color:${g&&g.startsWith("data:")?"#dc2626":"var(--gray-l)"};margin-top:4px">${g&&g.startsWith("data:")?"\u274C base64 \uC774\uBBF8\uC9C0 \uC9C1\uC811 \uC785\uB825 \uBD88\uAC00 \u2014 imgur.com \uB4F1\uC5D0 \uC5C5\uB85C\uB4DC \uD6C4 URL \uC0AC\uC6A9":"\uC774\uBBF8\uC9C0 URL\uC744 \uBD99\uC5EC\uB123\uC73C\uBA74 \uD604\uD669\uD310 \uC120\uC218 \uCE74\uB4DC\uC5D0 \uD504\uB85C\uD544 \uC0AC\uC9C4\uC774 \uD45C\uC2DC\uB429\uB2C8\uB2E4."}</div>
      </div>
      <div style="margin-bottom:16px">
      ...
      <div style="margin-bottom:16px">
        ...
        <div style="display:flex;gap:8px;align-items:center">
          <input type="text" id="b2-ed-photo4" value="${v}" placeholder="https://... (gif/mp4 \uAC00\uB2A5)" style="flex:1;padding:8px 12px;border:1px solid var(--border2);border-radius:8px;font-size:13px">
          <span id="b2-ed-photo4-preview-wrap" style="position:relative;width:40px;height:40px;border-radius:12px;overflow:hidden;flex-shrink:0;background:#e2e8f0;border:2px solid var(--border);display:${v&&!v.startsWith("data:")?"inline-flex":"none"};align-items:center;justify-content:center">
            <img id="b2-ed-photo4-preview" src="${v&&!v.startsWith("data:")?toHttpsUrl(v).replace(/\"/g,"&quot;"):""}" style="width:40px;height:40px;object-fit:cover;display:block" onerror="this.style.display='none'">
  ...
  `,document.body.appendChild(f);const b=i=>{const p=String(i||"").trim().toLowerCase().split("#")[0].split("?")[0];return p.endsWith(".mp4")||p.endsWith(".webm")||p.endsWith(".ogg")||p.endsWith(".mov")||p.endsWith(".m4v")},m=(i,p,c,a)=>{try{const N=document.getElementById(i),R=document.getElementById(p),U=document.getElementById(c),u=document.getElementById(a);if(!R||!U||!u)return;const L=String((N==null?void 0:N.value)||"").trim();if(!L||L.startsWith("data:")){R.style.display="none",U.style.display="none",u.style.display="none",U.removeAttribute("src"),u.removeAttribute("src");try{u.pause()}catch(n){}return}const I=toHttpsUrl(L);if(R.style.display="inline-flex",b(I)){U.style.display="none",u.style.display="block",u.src=I;try{u.currentTime=0}catch(n){}try{u.play&&u.play()}catch(n){}}else{u.style.display="none";try{u.pause()}catch(n){}u.removeAttribute("src"),U.style.display="block",U.src=I}}catch(N){}},j=document.getElementById("b2-ed-photo");j&&j.addEventListener("input",function(){const i=this.value.trim(),p=document.getElementById("b2-ed-photo-preview"),c=document.getElementById("b2-ed-photo-warn"),a=document.getElementById("b2-ed-photo-preview-wrap");i&&i.startsWith("data:")?(this.style.borderColor="#dc2626",c&&(c.style.color="#dc2626",c.textContent="\u274C base64 \uC774\uBBF8\uC9C0 \uC9C1\uC811 \uC785\uB825 \uBD88\uAC00 \u2014 imgur.com \uB4F1\uC5D0 \uC5C5\uB85C\uB4DC \uD6C4 URL \uC0AC\uC6A9")):(this.style.borderColor="",c&&(c.textContent="\uC774\uBBF8\uC9C0 URL\uC744 \uBD99\uC5EC\uB123\uC73C\uBA74 \uD604\uD669\uD310 \uC120\uC218 \uCE74\uB4DC\uC5D0 \uD504\uB85C\uD544 \uC0AC\uC9C4\uC774 \uD45C\uC2DC\uB429\uB2C8\uB2E4.",c.style.color="var(--gray-l)")),i&&!i.startsWith("data:")?(p.src=toHttpsUrl(i),p.style.display="block",a&&(a.style.display="inline-block")):a&&(a.style.display="none")}),["b2-ed-second-profile","b2-ed-photo3","b2-ed-photo4","b2-ed-photo5"].forEach((i,p)=>{const c=document.getElementById(i);if(!c)return;const a=[["b2-ed-photo2-preview-wrap","b2-ed-photo2-preview","b2-ed-photo2-preview-vid"],["b2-ed-photo3-preview-wrap","b2-ed-photo3-preview","b2-ed-photo3-preview-vid"],["b2-ed-photo4-preview-wrap","b2-ed-photo4-preview","b2-ed-photo4-preview-vid"],["b2-ed-photo5-preview-wrap","b2-ed-photo5-preview","b2-ed-photo5-preview-vid"]][p]||null;a&&(c.addEventListener("input",()=>m(i,a[0],a[1],a[2])),m(i,a[0],a[1],a[2]))})}function saveB2Profile(F){var T,E,P,M,f;const t=players.find(b=>b.name===F);if(!t)return;const _=(((T=document.getElementById("b2-ed-photo"))==null?void 0:T.value)||"").trim(),g=(((E=document.getElementById("b2-ed-second-profile"))==null?void 0:E.value)||"").trim(),l=(((P=document.getElementById("b2-ed-photo3"))==null?void 0:P.value)||"").trim(),$=(((M=document.getElementById("b2-ed-photo4"))==null?void 0:M.value)||"").trim(),v=(((f=document.getElementById("b2-ed-photo5"))==null?void 0:f.value)||"").trim(),S=b=>{const m=parseFloat(b);return isNaN(m)?1:Math.max(.2,Math.min(60,m))};if([_,g,l,$,v].some(b=>b&&b.startsWith("data:"))){alert(`\u274C \uD504\uB85C\uD544 \uC0AC\uC9C4\uC5D0 base64 \uC774\uBBF8\uC9C0(data:...)\uB97C \uC9C1\uC811 \uBD99\uC5EC\uB123\uC73C\uBA74 \uB3D9\uAE30\uD654 \uC800\uC7A5\uC774 \uC2E4\uD328\uD560 \uC218 \uC788\uC2B5\uB2C8\uB2E4.

\uC774\uBBF8\uC9C0\uB97C imgur.com, Discord \uB4F1\uC5D0 \uC5C5\uB85C\uB4DC\uD55C \uD6C4 URL\uC744 \uC0AC\uC6A9\uD558\uC138\uC694.`);return}t.photo=_||void 0,t.secondProfileFile=g||void 0,t.profileFile3=l||void 0,t.profileFile4=$||void 0,t.profileFile5=v||void 0;try{document.querySelectorAll("#b2-profile-edit-modal [data-b2-delay-key]").forEach(b=>{const m=String((b==null?void 0:b.getAttribute("data-b2-delay-key"))||"").trim();if(!m)return;const j=S((b==null?void 0:b.value)||"1");j===1?delete t[m]:t[m]=j})}catch(b){}save(),render(),document.getElementById("b2-profile-edit-modal").remove(),_b2SelectedPlayer&&_b2SelectedPlayer.name===F&&_b2UpdateMainDisplay(F)}window._b2RankingSort=window._b2RankingSort||"tier";

/* board2-analytics.js */
function _b2RankingView(){const H=new Set((typeof univCfg!="undefined"?univCfg:[]).filter(e=>e.dissolved||e.hidden).map(e=>String(e.name||"").trim())),C=players.filter(e=>!e.hidden&&!e.retired&&!e.hideFromBoard&&!H.has(String((e==null?void 0:e.univ)||"").trim())&&!_B2_ROLE_ORDER.includes(e.role||"")),N=_b2VisUnivs?_b2VisUnivs().filter(e=>e.name&&e.name!=="\uBB34\uC18C\uC18D"):[],j=typeof TIERS!="undefined"?TIERS:[],M=window._b2RankingSort||"tier",p=e=>{const i=j.indexOf(e);return i<0?0:Math.max(0,(j.length-i)*10)},{fromN:h,toN:b}=_b2ThisWeekRange(),x=_b2DateNum,A=new Date,P=A.getDay(),B=new Date(A);B.setDate(A.getDate()+(P===0?-6:1-P));const V=new Date(B);V.setDate(B.getDate()-7);const S=new Date(B);S.setDate(B.getDate()-1);const D=e=>parseInt(e.toISOString().slice(0,10).replace(/-/g,"")),u=D(V),I=D(S),O=N.map(e=>{var J;const i=C.filter(v=>String((v==null?void 0:v.univ)||"").trim()===e.name);if(!i.length)return null;const n=i.reduce((v,y)=>v+p(y.tier||""),0);let o=0,c=0,d=0,g=0;const $=new Set(i.map(v=>v.name));i.forEach(v=>{(Array.isArray(v.history)?v.history:[]).forEach(y=>{const F=x(y.date||y.d||"");F>=h&&F<=b&&(y.result==="\uC2B9"?o++:y.result==="\uD328"&&c++),F>=u&&F<=I&&(y.result==="\uC2B9"?d++:y.result==="\uD328"&&g++)})});try{(typeof indM!="undefined"&&Array.isArray(indM)?indM:[]).forEach(v=>{if(!v||!v.d||!v.wName||!v.lName)return;const y=x(v.d);$.has(v.wName)&&(y>=h&&y<=b?o++:y>=u&&y<=I&&d++),$.has(v.lName)&&(y>=h&&y<=b?c++:y>=u&&y<=I&&g++)})}catch(v){}try{(typeof gjM!="undefined"&&Array.isArray(gjM)?gjM:[]).forEach(v=>{if(!v||!v.d||!v.wName||!v.lName||v._proLabel)return;const y=x(v.d);$.has(v.wName)&&(y>=h&&y<=b?o++:y>=u&&y<=I&&d++),$.has(v.lName)&&(y>=h&&y<=b?c++:y>=u&&y<=I&&g++)})}catch(v){}const k=o+c,_=d+g,L=k>0?Math.round(o/k*100):null,W=_>0?Math.round(d/_*100):null,w=i.slice().sort((v,y)=>{const F=j.indexOf(v.tier||""),G=j.indexOf(y.tier||"");return(F>=0?F:999)-(G>=0?G:999)})[0],T=(w==null?void 0:w.tier)||"\uC5C6\uC74C",z=typeof getTierBtnColor=="function"?getTierBtnColor(T):"#64748b",U=typeof getTierBtnTextColor=="function"&&getTierBtnTextColor(T)||"#fff",Z={P:0,T:0,Z:0};i.forEach(v=>{v.race in Z&&Z[v.race]++});const X=((J=Object.entries(Z).sort((v,y)=>y[1]-v[1])[0])==null?void 0:J[0])||"?",q={P:"\u{1F52E}",T:"\u2694\uFE0F",Z:"\u{1F98E}","?":"\u2753"}[X]||"\u2753";return{name:e.name,color:gc(e.name)||"#64748b",count:i.length,score:n,topTier:T,topTierCol:z,topTierTc:U,races:Z,dominantRace:X,raceEmoji:q,tw:o,tl:c,tg:k,wr:L,pwr:W}}).filter(Boolean),R=[...O].sort((e,i)=>{var n,o;return M==="tier"?i.score-e.score||i.count-e.count:M==="count"?i.count-e.count||i.score-e.score:M==="wr"?((n=i.wr)!=null?n:-1)-((o=e.wr)!=null?o:-1)||i.tg-e.tg:M==="games"?i.tg-e.tg||i.tw-e.tw:0}),E=[...O].sort((e,i)=>i.score-e.score||i.count-e.count),l={};E.forEach((e,i)=>{l[e.name]=i+1});const f=Math.max(...R.map(e=>e.score),1),m=Math.max(...R.map(e=>e.count),1),s=Math.max(...R.map(e=>e.tg),1),r=["\u{1F947}","\u{1F948}","\u{1F949}"],a=[{key:"tier",label:"\u{1F3C5} \uD2F0\uC5B4 \uC810\uC218"},{key:"count",label:"\u{1F465} \uC778\uC6D0\uC218"},{key:"wr",label:"\u{1F4C8} \uC774\uBC88\uC8FC \uC2B9\uB960"},{key:"games",label:"\u2694\uFE0F \uC774\uBC88\uC8FC \uACBD\uAE30\uC218"}];let t=`<style>
    .b2rk2-wrap {}
    ...
    ${a.map(e=>`<button class="b2rk2-sbtn${M===e.key?" on":""}" onclick="window._b2RankingSort='${e.key}';render()">${e.label}</button>`).join("")}
  </div>`,t+='<div class="b2rk2-wrap">',R.forEach((e,i)=>{var w;const n=i+1,c=(l[e.name]||n)-n,d=r[i]||`<span style="font-size:14px;font-weight:900;color:var(--text3)">${n}</span>`,g=i<3;let $=0,k="";M==="tier"&&($=Math.round(e.score/f*100),k=`${e.score}pt`),M==="count"&&($=Math.round(e.count/m*100),k=`${e.count}\uBA85`),M==="wr"&&($=(w=e.wr)!=null?w:0,k=e.wr!==null?`${e.wr}%`:"-"),M==="games"&&($=Math.round(e.tg/Math.max(s,1)*100),k=`${e.tg}\uC804`);let _="";if(M==="tier"&&c!==0){const T=c>0?"#10b981":"#ef4444",z=c>0?"\u25B2":"\u25BC";_=`<span class="b2rk2-delta" style="color:${T}">${z}${Math.abs(c)}</span>`}const L=e.wr!==null?`<span style="font-size:10px;padding:2px 7px;border-radius:8px;background:${e.wr>=60?"#10b981":e.wr>=40?"#f59e0b":"#ef4444"};color:#fff;font-weight:800">\u{1F4C8} ${e.wr}%</span>`:"",W=e.wr!==null&&e.pwr!==null?`<span style="font-size:10px;color:${e.wr>=e.pwr?"#10b981":"#ef4444"};font-weight:700">${e.wr>=e.pwr?"\u25B2":"\u25BC"}${Math.abs(e.wr-e.pwr)}%</span>`:"";t+=`<div class="b2rk2-row" onclick="(function(el){document.querySelectorAll('.b2rk2-row').forEach(function(r){r.classList.remove('selected')});el.classList.toggle('selected');})(this)" style="${g?`border-color:${e.color}66;background:${e.color}08`:""}">
      ...
      <div class="b2rk2-bar-wrap">
        <div class="b2rk2-bar" style="width:${$}%;background:linear-gradient(90deg,${e.color},${e.color}88)"></div>
      </div>
  ...
  <\/script>`}function _b2SummaryView(){const H=new Set((typeof univCfg!="undefined"?univCfg:[]).filter(t=>t.dissolved||t.hidden).map(t=>String(t.name||"").trim())),C=players.filter(t=>!t.hidden&&!t.retired&&!t.hideFromBoard&&!H.has(String((t==null?void 0:t.univ)||"").trim())),N=C.filter(t=>!_B2_ROLE_ORDER.includes(t.role||"")),j=C.filter(t=>_B2_ROLE_ORDER.includes(t.role||"")),M=_b2VisUnivs?_b2VisUnivs().filter(t=>t.name&&t.name!=="\uBB34\uC18C\uC18D"):[],p={P:0,T:0,Z:0,"?":0};N.forEach(t=>{const e=t.race||"?";p[e in p?e:"?"]++});const h={};N.forEach(t=>{const e=t.tier||"\uBBF8\uC815";h[e]=(h[e]||0)+1});const{fromN:b,toN:x}=_b2ThisWeekRange(),A=_b2DateNum;let P=0,B=0,V=new Set;N.forEach(t=>{(Array.isArray(t.history)?t.history:[]).forEach(e=>{e.result==="\uC2B9"?P++:e.result==="\uD328"&&B++;const i=A(e.date||e.d||"");i>=b&&i<=x&&V.add(t.name)})});const S=P+B,D=S>0?Math.round(P/S*100):null,u=new Date,I=new Date(u);I.setDate(u.getDate()-30);const O=A(I.toISOString().slice(0,10)),R=N.filter(t=>{const e=Array.isArray(t.history)?t.history:[];return e.length?Math.min(...e.map(n=>A(n.date||n.d||"")).filter(n=>n>0))>=O:!1}).sort((t,e)=>{const i=Math.min(...(Array.isArray(t.history)?t.history:[]).map(o=>A(o.date||o.d||"")).filter(o=>o>0));return Math.min(...(Array.isArray(e.history)?e.history:[]).map(o=>A(o.date||o.d||"")).filter(o=>o>0))-i}).slice(0,8),E=M.map(t=>{const e=N.filter(o=>String((o==null?void 0:o.univ)||"").trim()===String(t.name||"").trim()),i={P:0,T:0,Z:0};e.forEach(o=>{o.race in i&&i[o.race]++});const n={};return e.forEach(o=>{const c=o.tier||"\uBBF8\uC815";n[c]=(n[c]||0)+1}),{name:t.name,color:gc(t.name),count:e.length,races:i,tiers:n}}).filter(t=>t.count>0).sort((t,e)=>e.count-t.count),l=E.length>0?E[0].count:1,f=(typeof TIERS!="undefined"?TIERS:[]).filter(t=>h[t]),m=p.P+p.T+p.Z||1,s=()=>{const c=p.P+p.T+p.Z||1,d=[{val:p.P,col:"#7c3aed",label:"P"},{val:p.T,col:"#0284c7",label:"T"},{val:p.Z,col:"#059669",label:"Z"}].filter(_=>_.val>0),g=2*Math.PI*38;let $=0;return`<svg width="110" height="110" viewBox="0 0 110 110">
    ...
    </div>`},D=(l,f)=>{if(!l||!f)return"";const m=typeof TIERS!="undefined"?TIERS:[],s=w=>{const T=m.indexOf(w);return T<0?0:Math.max(0,(m.length-T)*10)},r=(w,T)=>Math.min(1,T>0?w/T:0),a=w=>w.tiered.reduce((T,z)=>T+s(z.tier||""),0)+w.total*5,t=a(l),e=a(f),i=[{label:"\uC804\uB825",vA:r(t,Math.max(t,e,1)),vB:r(e,Math.max(t,e,1))},{label:"\uC2B9\uB960",vA:l.wr!==null?l.wr/100:0,vB:f.wr!==null?f.wr/100:0},{label:"\uACBD\uAE30\uC218",vA:r(l.tg,Math.max(l.tg,f.tg,1)),vB:r(f.tg,Math.max(l.tg,f.tg,1))},{label:"\uD504\uB85C\uD1A0\uC2A4",vA:r(l.races.P,Math.max(l.races.P,f.races.P,1)),vB:r(f.races.P,Math.max(l.races.P,f.races.P,1))},{label:"\uD14C\uB780",vA:r(l.races.T,Math.max(l.races.T,f.races.T,1)),vB:r(f.races.T,Math.max(l.races.T,f.races.T,1))},{label:"\uC800\uADF8",vA:r(l.races.Z,Math.max(l.races.Z,f.races.Z,1)),vB:r(f.races.Z,Math.max(l.races.Z,f.races.Z,1))}],n=i.length,o=120,c=120,d=90,g=w=>Math.PI*2/n*w-Math.PI/2,$=(w,T)=>{const z=g(T),U=w*d;return`${(o+Math.cos(z)*U).toFixed(1)},${(c+Math.sin(z)*U).toFixed(1)}`},k=w=>i.map((T,z)=>$(w(z),z)).join(" ");let _="";[.25,.5,.75,1].forEach(w=>{const T=i.map((z,U)=>{const Z=g(U);return`${(o+Math.cos(Z)*d*w).toFixed(1)},${(c+Math.sin(Z)*d*w).toFixed(1)}`}).join(" ");_+=`<polygon points="${T}" fill="none" stroke="var(--border2)" stroke-width="1"/>`});const L=i.map((w,T)=>{const z=g(T);return`<line x1="${o}" y1="${c}" x2="${(o+Math.cos(z)*d).toFixed(1)}" y2="${(c+Math.sin(z)*d).toFixed(1)}" stroke="var(--border2)" stroke-width="1"/>`}).join(""),W=i.map((w,T)=>{const z=g(T),U=(o+Math.cos(z)*(d+18)).toFixed(1),Z=(c+Math.sin(z)*(d+18)).toFixed(1);return`<text x="${U}" y="${Z}" text-anchor="middle" dominant-baseline="middle" font-size="10" font-weight="700" fill="var(--text3)">${w.label}</text>`}).join("");return`<div style="display:flex;justify-content:center;margin:8px 0 4px">
...
function _b2HeatmapCloseAll(){try{document.querySelectorAll(".b2hm2-popup").forEach(p=>p.classList.remove("show"))}catch(p){}}function _b2HeatmapCellClick(p){try{if(!p||!p.dataset)return;const T=p.dataset.hmUid||"",f=p.dataset.hmUniv||"",x=p.dataset.hmTier||"",A=p.dataset.hmColor||"#64748b";if(!T||!f||!x)return;_b2HeatmapCloseAll(),typeof _b2HeatmapShowPopup=="function"&&_b2HeatmapShowPopup(T,f,x,A)}catch(T){}}function _b2HeatmapTotalClick(p){try{if(!p||!p.dataset)return;const T=p.dataset.hmUid||"",f=p.dataset.hmUniv||"",x=p.dataset.hmColor||"#64748b";if(!T||!f)return;_b2HeatmapCloseAll(),typeof _b2HeatmapShowAllPopup=="function"&&_b2HeatmapShowAllPopup(T,f,x)}catch(T){}}function _b2HeatmapShowPopup(p,T,f,x){try{const A=document.getElementById(p+"-popup"),r=document.getElementById(p+"-popup-header"),l=document.getElementById(p+"-popup-body");if(!A||!l)return;const g=typeof escHTML=="function"?escHTML:s=>String(s||""),C=typeof escAttr=="function"?escAttr:s=>String(s||""),$=(Array.isArray(window.players)?window.players:[]).filter(s=>{const b=String(s&&s.univ||"").trim(),c=String(s&&s.tier||"\uBBF8\uC815");return b===T&&c===f&&!(s&&(s.hidden||s.retired||s.hideFromBoard))});if(!$.length)return;let m=0,k=0;$.forEach(s=>(Array.isArray(s&&s.history)?s.history:[]).forEach(b=>{b&&b.result==="\uC2B9"?m++:b&&b.result==="\uD328"&&k++}));const y=m+k,w=y>0?Math.round(m/y*100):null,z=w===null?"#94a3b8":w>=60?"#10b981":w>=40?"#f59e0b":"#ef4444",{fromN:I,toN:P}=_b2ThisWeekRange(),M=_b2DateNum;let E=0,v=0;$.forEach(s=>(Array.isArray(s&&s.history)?s.history:[]).forEach(b=>{const c=M(b&&(b.date||b.d||""));c>=I&&c<=P&&(b&&b.result==="\uC2B9"?E++:b&&b.result==="\uD328"&&v++)}));const i=typeof getTierBtnColor=="function"&&f?getTierBtnColor(f):"#64748b",u=typeof getTierBtnTextColor=="function"&&f&&getTierBtnTextColor(f)||"#fff";r&&(r.innerHTML='<div style="display:flex;align-items:center;gap:10px"><div style="width:12px;height:12px;border-radius:50%;background:'+x+";flex-shrink:0;box-shadow:0 0 0 3px "+x+'30"></div><span style="font-size:16px;font-weight:900;color:'+x+';">'+g(T)+'</span><span style="font-size:12px;padding:3px 10px;border-radius:20px;background:'+i+";color:"+u+';font-weight:800;letter-spacing:.3px">'+g(f)+'</span><div style="margin-left:auto;text-align:right">'+(w!==null?'<div style="font-size:18px;font-weight:900;color:'+z+'">'+w+'%</div><div style="font-size:10px;color:var(--text3);">'+m+"\uC2B9 "+k+"\uD328</div>":'<div style="font-size:13px;color:var(--text3)">\uAE30\uB85D \uC5C6\uC74C</div>')+"</div></div>");let h="";h+='<div class="b2hm2-stat-row"><div class="b2hm2-stat-box" style="background:'+x+"0d;border-color:"+x+'22"><div style="font-size:22px;font-weight:900;color:'+x+'">'+$.length+'</div><div style="font-size:10px;color:var(--text3);font-weight:700">\uCD1D \uC778\uC6D0</div></div>',y>0&&(h+='<div class="b2hm2-stat-box" style="background:'+z+"12;border-color:"+z+'30"><div style="font-size:22px;font-weight:900;color:'+z+'">'+w+'%</div><div style="font-size:10px;color:var(--text3);font-weight:700">'+m+"\uC2B9 "+k+"\uD328</div></div>"),E+v>0&&(h+='<div class="b2hm2-stat-box" style="background:#fff7ed;border-color:#fed7aa"><div style="font-size:20px;font-weight:900;color:#c2410c">\u{1F525} '+E+'\uC2B9</div><div style="font-size:10px;color:#c2410c;font-weight:700">\uC774\uBC88\uC8FC '+v+"\uD328</div></div>"),h+="</div>",h+='<div style="font-size:11px;font-weight:800;color:var(--text3);margin-bottom:10px;display:flex;align-items:center;gap:6px"><span style="width:20px;height:2px;background:var(--border2);display:inline-block;border-radius:1px"></span>'+$.length+'\uBA85<span style="flex:1;height:1px;background:var(--border2);display:inline-block;border-radius:1px"></span></div>',h+='<div style="display:grid;grid-template-columns:repeat(auto-fill,minmax(84px,1fr));gap:8px">',$.sort((s,b)=>String(s&&s.name||"").localeCompare(String(b&&b.name||""),"ko",{sensitivity:"base"})).forEach(s=>{const b=s&&s.race==="P"?"\u{1F52E}":s&&s.race==="T"?"\u2694\uFE0F":s&&s.race==="Z"?"\u{1F98E}":"",c=s&&s.photo?typeof toHttpsUrl=="function"?toHttpsUrl(s.photo):s.photo:"",t=c?C(c):"",e=String(s&&s.name||"?").slice(0,1);let o=0,n=0;(Array.isArray(s&&s.history)?s.history:[]).forEach(_=>{_&&_.result==="\uC2B9"?o++:_&&_.result==="\uD328"&&n++});const a=o+n,d=a>0?Math.round(o/a*100):null,S=d===null?"#94a3b8":d>=60?"#10b981":d>=40?"#f59e0b":"#ef4444",B=C(s&&s.name||"");h+='<div class="b2hm2-pcard" style="background:'+x+"09;border-color:"+x+`28" onclick="_b2HeatmapCloseAll();openPlayerModal('`+B.replace(/'/g,"\\'")+`')">`,t?h+='<img class="b2hm2-pcard-photo" src="'+t+`" onerror="this.style.display='none';this.nextSibling.style.display='flex'"><div class="b2hm2-pcard-avatar" style="display:none;background:`+x+"22;color:"+x+'">'+g(e)+"</div>":h+='<div class="b2hm2-pcard-avatar" style="background:'+x+"22;color:"+x+'">'+g(e)+"</div>",h+='<div style="font-size:11px;font-weight:900;color:'+x+';line-height:1.2">'+g(s&&s.name||"")+"</div>",(b||d!==null)&&(h+='<div style="font-size:10px;color:var(--text3);display:flex;align-items:center;gap:2px">'+b,d!==null&&(h+='<span style="color:'+S+';font-weight:800;margin-left:2px">'+d+"%</span>"),h+="</div>"),h+="</div>"}),h+="</div>",l.innerHTML=h,A.classList.add("show")}catch(A){}}function _b2HeatmapShowAllPopup(p,T,f){try{const x=document.getElementById(p+"-popup"),A=document.getElementById(p+"-popup-header"),r=document.getElementById(p+"-popup-body");if(!x||!r)return;const l=typeof escHTML=="function"?escHTML:i=>String(i||""),g=typeof escAttr=="function"?escAttr:i=>String(i||""),C=(Array.isArray(window.players)?window.players:[]).filter(i=>String(i&&i.univ||"").trim()===T&&!(i&&(i.hidden||i.retired||i.hideFromBoard)));if(!C.length)return;let $=0,m=0;C.forEach(i=>(Array.isArray(i&&i.history)?i.history:[]).forEach(u=>{u&&u.result==="\uC2B9"?$++:u&&u.result==="\uD328"&&m++}));const k=$+m,y=k>0?Math.round($/k*100):null,w=y===null?"#94a3b8":y>=60?"#10b981":y>=40?"#f59e0b":"#ef4444",{fromN:z,toN:I}=_b2ThisWeekRange(),P=_b2DateNum;let M=0,E=0;C.forEach(i=>(Array.isArray(i&&i.history)?i.history:[]).forEach(u=>{const h=P(u&&(u.date||u.d||""));h>=z&&h<=I&&(u&&u.result==="\uC2B9"?M++:u&&u.result==="\uD328"&&E++)})),A&&(A.innerHTML='<div style="display:flex;align-items:center;gap:10px"><div style="width:12px;height:12px;border-radius:50%;background:'+f+";flex-shrink:0;box-shadow:0 0 0 3px "+f+'30"></div><span style="font-size:16px;font-weight:900;color:'+f+';">'+l(T)+'</span><div style="margin-left:auto;text-align:right">'+(y!==null?'<div style="font-size:18px;font-weight:900;color:'+w+'">'+y+'%</div><div style="font-size:10px;color:var(--text3);">'+$+"\uC2B9 "+m+"\uD328</div>":'<div style="font-size:13px;color:var(--text3)">\uAE30\uB85D \uC5C6\uC74C</div>')+"</div></div>");let v="";v+='<div class="b2hm2-stat-row"><div class="b2hm2-stat-box" style="background:'+f+"0d;border-color:"+f+'22"><div style="font-size:22px;font-weight:900;color:'+f+'">'+C.length+'</div><div style="font-size:10px;color:var(--text3);font-weight:700">\uCD1D \uC778\uC6D0</div></div>',k>0&&(v+='<div class="b2hm2-stat-box" style="background:'+w+"12;border-color:"+w+'30"><div style="font-size:22px;font-weight:900;color:'+w+'">'+y+'%</div><div style="font-size:10px;color:var(--text3);font-weight:700">'+$+"\uC2B9 "+m+"\uD328</div></div>"),M+E>0&&(v+='<div class="b2hm2-stat-box" style="background:#fff7ed;border-color:#fed7aa"><div style="font-size:20px;font-weight:900;color:#c2410c">\u{1F525} '+M+'\uC2B9</div><div style="font-size:10px;color:#c2410c;font-weight:700">\uC774\uBC88\uC8FC '+E+"\uD328</div></div>"),v+="</div>",v+='<div style="font-size:11px;font-weight:800;color:var(--text3);margin-bottom:10px;display:flex;align-items:center;gap:6px"><span style="width:20px;height:2px;background:var(--border2);display:inline-block;border-radius:1px"></span>'+C.length+'\uBA85<span style="flex:1;height:1px;background:var(--border2);display:inline-block;border-radius:1px"></span></div>',v+='<div style="display:grid;grid-template-columns:repeat(auto-fill,minmax(84px,1fr));gap:8px">',C.sort((i,u)=>String(i&&i.name||"").localeCompare(String(u&&u.name||""),"ko",{sensitivity:"base"})).forEach(i=>{const u=i&&i.race==="P"?"\u{1F52E}":i&&i.race==="T"?"\u2694\uFE0F":i&&i.race==="Z"?"\u{1F98E}":"",h=i&&i.photo?typeof toHttpsUrl=="function"?toHttpsUrl(i.photo):i.photo:"",s=h?g(h):"",b=String(i&&i.name||"?").slice(0,1),c=(typeof gc=="function"?gc(i&&i.univ):null)||f;let t=0,e=0;(Array.isArray(i&&i.history)?i.history:[]).forEach(S=>{S&&S.result==="\uC2B9"?t++:S&&S.result==="\uD328"&&e++});const o=t+e,n=o>0?Math.round(t/o*100):null,a=n===null?"#94a3b8":n>=60?"#10b981":n>=40?"#f59e0b":"#ef4444",d=g(i&&i.name||"");v+='<div class="b2hm2-pcard" style="background:'+c+"09;border-color:"+c+`28" onclick="_b2HeatmapCloseAll();openPlayerModal('`+d.replace(/'/g,"\\'")+`')">`,s?v+='<img class="b2hm2-pcard-photo" src="'+s+`" onerror="this.style.display='none';this.nextSibling.style.display='flex'"><div class="b2hm2-pcard-avatar" style="display:none;background:`+c+"22;color:"+c+'">'+l(b)+"</div>":v+='<div class="b2hm2-pcard-avatar" style="background:'+c+"22;color:"+c+'">'+l(b)+"</div>",v+='<div style="font-size:11px;font-weight:900;color:'+c+';line-height:1.2">'+l(i&&i.name||"")+"</div>",(u||n!==null)&&(v+='<div style="font-size:10px;color:var(--text3);display:flex;align-items:center;gap:2px">'+u,n!==null&&(v+='<span style="color:'+a+';font-weight:800;margin-left:2px">'+n+"%</span>"),v+="</div>"),v+="</div>"}),v+="</div>",r.innerHTML=v,x.classList.add("show")}catch(x){}}function _b2HeatmapView(){const p="hm_"+Math.random().toString(36).slice(2,7),T=new Set((typeof univCfg!="undefined"?univCfg:[]).filter(t=>t.dissolved||t.hidden).map(t=>String(t.name||"").trim())),f=(_b2VisUnivs?_b2VisUnivs():[]).filter(t=>t.name&&t.name!=="\uBB34\uC18C\uC18D"),x=players.filter(t=>!t.hidden&&!t.retired&&!t.hideFromBoard&&!T.has(String((t==null?void 0:t.univ)||"").trim())),A=typeof TIERS!="undefined"?TIERS:[],r=window._b2HeatmapMode||"count",l=window._b2HeatmapSortRow||"name",g=window._b2HeatmapSortCol||"tier",C=[...new Set(x.map(t=>t.tier||"\uBBF8\uC815"))];let $=A.filter(t=>C.includes(t)).concat(C.filter(t=>!A.includes(t)));const m={};f.forEach(t=>{m[t.name]={}}),x.forEach(t=>{const e=String((t==null?void 0:t.univ)||"").trim(),o=t.tier||"\uBBF8\uC815";m[e]||(m[e]={}),m[e][o]||(m[e][o]={count:0,wins:0,losses:0}),m[e][o].count++,(Array.isArray(t.history)?t.history:[]).forEach(n=>{n.result==="\uC2B9"?m[e][o].wins++:n.result==="\uD328"&&m[e][o].losses++})});const k={};f.forEach(t=>{let e=0,o=0,n=0;$.forEach(a=>{var S;const d=(S=m[t.name])==null?void 0:S[a];d&&(e+=d.count,o+=d.wins,n+=d.losses)}),k[t.name]={count:e,wins:o,losses:n,wr:o+n>0?Math.round(o/(o+n)*100):null}});const y={};$.forEach(t=>{let e=0,o=0,n=0;f.forEach(a=>{var S;const d=(S=m[a.name])==null?void 0:S[t];d&&(e+=d.count,o+=d.wins,n+=d.losses)}),y[t]={count:e,wins:o,losses:n,wr:o+n>0?Math.round(o/(o+n)*100):null}});let w=[...f];l==="name"&&w.sort((t,e)=>(t.name||"").localeCompare(e.name||"","ko")),l==="count"&&w.sort((t,e)=>{var o,n;return(((o=k[e.name])==null?void 0:o.count)||0)-(((n=k[t.name])==null?void 0:n.count)||0)}),l==="wr"&&w.sort((t,e)=>{var o,n,a,d;return((n=(o=k[e.name])==null?void 0:o.wr)!=null?n:-1)-((d=(a=k[t.name])==null?void 0:a.wr)!=null?d:-1)});let z=[...$];g==="count"&&z.sort((t,e)=>{var o,n;return(((o=y[e])==null?void 0:o.count)||0)-(((n=y[t])==null?void 0:n.count)||0)}),g==="wr"&&z.sort((t,e)=>{var o,n,a,d;return((n=(o=y[e])==null?void 0:o.wr)!=null?n:-1)-((d=(a=y[t])==null?void 0:a.wr)!=null?d:-1)});const I=t=>{const e=String(t||"").trim().replace("#","");if(e.length===3){const o=parseInt(e[0]+e[0],16),n=parseInt(e[1]+e[1],16),a=parseInt(e[2]+e[2],16);return[o,n,a].some(d=>isNaN(d))?null:{r:o,g:n,b:a}}if(e.length>=6){const o=parseInt(e.slice(0,2),16),n=parseInt(e.slice(2,4),16),a=parseInt(e.slice(4,6),16);return[o,n,a].some(d=>isNaN(d))?null:{r:o,g:n,b:a}}return null},P=(t,e,o)=>{if(!t||e===0)return"transparent";const n=t/e;if(r==="count"){const a=I(o)||I("#3b82f6")||{r:59,g:130,b:246},d=Math.min(.92,Math.max(.12,n*.78+.12));return`rgba(${a.r},${a.g},${a.b},${d.toFixed(2)})`}else{const a=t<50?255:Math.round(255*(1-(t-50)/50)),d=t>50?255:Math.round(255*(t/50));return`rgba(${a},${d},80,0.55)`}},M=(t,e)=>!t||e===0?"var(--text3)":t/e>.55?"#fff":"var(--text1)",E=Math.max(1,...f.flatMap(t=>$.map(e=>{var o,n;return((n=(o=m[t.name])==null?void 0:o[e])==null?void 0:n.count)||0}))),v=[{key:"count",label:"\u{1F465} \uC778\uC6D0\uC218"},{key:"wr",label:"\u{1F4C8} \uC2B9\uB960"}];let i=`<style>
  ...
  </style>`;i+=`<div class="b2hm2-ctrl">
    <div class="b2hm2-ctrl-group">
      <span class="b2hm2-lbl">\uD45C\uC2DC:</span>
      ${v.map(t=>`<button class="b2hm2-btn${r===t.key?" on":""}" onclick="window._b2HeatmapMode='${t.key}';render()">${t.label}</button>`).join("")}
    </div>
  ...
  </div>`,i+='<div class="b2hm2-wrap"><table class="b2hm2-tbl">';const u=100;i+=`<thead><tr>
    <th class="row-head col-head">\uB300\uD559 \\ \uD2F0\uC5B4</th>
    ${z.map(t=>{const e=typeof getTierBtnColor=="function"?getTierBtnColor(t):"#64748b",o=typeof getTierBtnTextColor=="function"&&getTierBtnTextColor(t)||"#fff",n=y[t],a=r==="count"?`${n.count}\uBA85`:n.wr!==null?`${n.wr}%`:"-";return`<th class="col-head"><div style="display:flex;flex-direction:column;align-items:center;gap:2px">
    ...
    <th class="col-head" style="border-left:2px solid var(--border2)">\uD569\uACC4</th>
  </tr></thead><tbody>`,w.forEach(t=>{const e=gc&&gc(t.name)||"#64748b",o=k[t.name];o.count&&(i+=`<tr>
      <td class="univ-name" style="border-left:3px solid ${e};background:var(--bg) !important">
        <span style="color:${e}">${t.name}</span>
        <div style="font-size:9px;color:var(--text3);font-weight:600">${r==="count"?`${o.count}\uBA85`:o.wr!==null?`${o.wr}%`:"-"}</div>
      </td>
      ${z.map(n=>{var W;const a=(W=m[t.name])==null?void 0:W[n];if(!a||!a.count)return'<td style="background:var(--bg) !important"><span class="b2hm2-empty">-</span></td>';const d=r==="count"?a.count:a.wins+a.losses>0?Math.round(a.wins/(a.wins+a.losses)*100):0,S=r==="count"?E:100;let B=P(d,S,e),_=M(d,S);const N=r==="count"?`${a.count}\uBA85`:`${d}%`,R=r==="wr"?`${a.wins}\uC2B9${a.losses}\uD328`:"",H=typeof escAttr=="function"?escAttr:O=>String(O||"").replace(/&/g,"&amp;").replace(/"/g,"&quot;").replace(/</g,"&lt;").replace(/>/g,"&gt;"),L=(a.wins||0)+(a.losses||0);return r==="wr"&&L>0&&L<5&&(B="rgba(148,163,184,0.16)",_="var(--text3)"),`<td style="background:${B} !important;color:${_}" title="${t.name} / ${n}: ${a.count}\uBA85 ${a.wins}\uC2B9 ${a.losses}\uD328" data-hm-uid="${p}" data-hm-univ="${H(t.name)}" data-hm-tier="${H(n)}" data-hm-color="${H(e)}" onclick="_b2HeatmapCellClick(this)">
          <div style="font-size:12px;font-weight:900">${N}</div>
          ${R?`<div style="font-size:9px;opacity:.8">${R}</div>`:""}
        </td>`}).join("")}
      <td class="total-cell" style="background:var(--surface) !important;color:${e}; cursor: pointer;" data-hm-uid="${p}" data-hm-univ="${typeof escAttr=="function"?escAttr(t.name):String(t.name||"").replace(/&/g,"&amp;").replace(/"/g,"&quot;").replace(/</g,"&lt;").replace(/>/g,"&gt;")}" data-hm-color="${typeof escAttr=="function"?escAttr(e):String(e||"").replace(/&/g,"&amp;").replace(/"/g,"&quot;").replace(/</g,"&lt;").replace(/>/g,"&gt;")}" onclick="_b2HeatmapTotalClick(this)">
        <div>${r==="count"?`${o.count}\uBA85`:o.wr!==null?`${o.wr}%`:"-"}</div>
        ${r==="wr"?`<div style="font-size:9px;color:var(--text3)">${o.wins}\uC2B9${o.losses}\uD328</div>`:`<div style="font-size:9px;color:var(--text3)">${o.wins}\uC2B9${o.losses}\uD328</div>`}
      </td>
    </tr>`)});const h=Object.values(k).reduce((t,e)=>t+e.wins,0),s=Object.values(k).reduce((t,e)=>t+e.losses,0),b=h+s,c=b>0?Math.round(h/b*100):null;return i+=`<tr style="border-top:2px solid var(--border2)">
    <td class="univ-name" style="background:var(--surface) !important;font-weight:900;color:var(--text1)">\uD569\uACC4</td>
    ${z.map(t=>{var n;const e=y[t],o=r==="count"?e.count:(n=e.wr)!=null?n:0;return`<td style="background:var(--surface);font-weight:900;color:var(--text2)">
        <div>${r==="count"?`${e.count}\uBA85`:e.wr!==null?`${e.wr}%`:"-"}</div>
    ...
    <td class="total-cell" style="background:var(--surface) !important;font-weight:900;color:var(--text1)">
      <div>${r==="count"?`${x.length}\uBA85`:c!==null?`${c}%`:"-"}</div>
      <div style="font-size:9px;color:var(--text3)">${h}\uC2B9${s}\uD328</div>
    </td>
  </tr>`,i+="</tbody></table></div>",i+=`<div id="${p}-popup" class="b2hm2-popup" onclick="if(event.target===this)this.classList.remove('show')">
    <div class="b2hm2-popup-inner">
      ...
      <span>100%</span>
    </div>`,i}function _b2BubbleView(){const p=new Set((typeof univCfg!="undefined"?univCfg:[]).filter(l=>l.dissolved||l.hidden).map(l=>String(l.name||"").trim())),T=(_b2VisUnivs?_b2VisUnivs():[]).filter(l=>l.name&&l.name!=="\uBB34\uC18C\uC18D"),f=players.filter(l=>!l.hidden&&!l.retired&&!l.hideFromBoard&&!p.has(String((l==null?void 0:l.univ)||"").trim())&&!_B2_ROLE_ORDER.includes(l.role||"")),x=T.map(l=>{var b;const g=f.filter(c=>String((c==null?void 0:c.univ)||"").trim()===l.name),C=g.filter(c=>c.race==="P").length,$=g.filter(c=>c.race==="T").length,m=g.filter(c=>c.race==="Z").length,k=gc(l.name)||"#64748b";let y=0,w=0;g.forEach(c=>{(Array.isArray(c.history)?c.history:[]).forEach(t=>{t.result==="\uC2B9"?y++:t.result==="\uD328"&&w++})});const z=y+w,I=z>0?Math.round(y/z*100):null,{fromN:P,toN:M}=_b2ThisWeekRange();let E=0;g.forEach(c=>{(Array.isArray(c.history)?c.history:[]).filter(o=>{const n=_b2DateNum(o.date||o.d||"");return n>=P&&n<=M}).length>0&&E++});const v=typeof TIERS!="undefined"?TIERS:[],u=((b=g.slice().sort((c,t)=>{const e=v.indexOf(c.tier||""),o=v.indexOf(t.tier||"");return(e>=0?e:999)-(o>=0?o:999)})[0])==null?void 0:b.tier)||null,h=typeof getTierBtnColor=="function"&&u?getTierBtnColor(u):"#94a3b8",s=typeof getTierBtnTextColor=="function"&&u&&getTierBtnTextColor(u)||"#fff";return{name:l.name,total:g.length,P:C,T:$,Z:m,color:k,wins:y,losses:w,games:z,wr:I,weekActive:E,topTier:u,topTierCol:h,topTierTc:s}}).filter(l=>l.total>0).sort((l,g)=>g.total-l.total),A=JSON.stringify(x),r="bbl_"+Math.random().toString(36).slice(2,8);return`<style>
    #${r}-wrap { position:relative; }
    #${r}-canvas { display:block; width:100%; cursor:pointer; border-radius:12px; }
    #${r}-tooltip { position:absolute; pointer-events:none; opacity:0; background:var(--white); border:1px solid var(--border2); border-radius:14px; padding:14px 16px; box-shadow:0 8px 32px #0003; transition:opacity .15s ease; min-width:180px; z-index:var(--z-dropdown,100); }
    #${r}-legend { display:flex; flex-wrap:wrap; gap:6px; margin-top:10px; }
    .${r}-sort-btn { padding:5px 12px; border-radius:20px; border:1.5px solid var(--border2); background:var(--surface); font-size:12px; font-weight:700; color:var(--text2); cursor:pointer; transition:all .15s; }
    .${r}-sort-btn.on { background:var(--text1); color:var(--white); border-color:var(--text1); }
    .${r}-sort-btn:hover:not(.on) { border-color:var(--text2); }
    #${r}-popup { display:none; position:fixed; inset:0; z-index:999; align-items:center; justify-content:center; background:rgba(0,0,0,.45); }
    #${r}-popup.show { display:flex; }
    #${r}-popup-inner { background:var(--white); border-radius:20px; padding:24px; max-width:340px; width:90%; box-shadow:0 20px 60px #0005; position:relative; animation:b2bblIn .25s ease; }
    @keyframes b2bblIn { from{opacity:0;transform:scale(.92) translateY(12px)} to{opacity:1;transform:none} }
    #${r}-popup-close { position:absolute;top:14px;right:14px;background:none;border:none;font-size:18px;cursor:pointer;color:var(--text3);line-height:1 }
    #${r}-popup-close:hover { color:var(--text1) }
  </style>
  <div id="${r}-wrap">
    <div style="display:flex;align-items:center;gap:8px;margin-bottom:10px;flex-wrap:wrap">
      ...
      <div style="margin-left:auto;display:flex;gap:4px;flex-wrap:wrap">
        <button class="${r}-sort-btn on" onclick="_${r}setSort('total',this)">\uC778\uC6D0\uC21C</button>
        <button class="${r}-sort-btn" onclick="_${r}setSort('wr',this)">\uC2B9\uB960\uC21C</button>
        <button class="${r}-sort-btn" onclick="_${r}setSort('P',this)">P\uBE44\uC728</button>
        <button class="${r}-sort-btn" onclick="_${r}setSort('T',this)">T\uBE44\uC728</button>
        <button class="${r}-sort-btn" onclick="_${r}setSort('Z',this)">Z\uBE44\uC728</button>
      </div>
    </div>
    <canvas id="${r}-canvas"></canvas>
    <div id="${r}-tooltip"></div>
    <div id="${r}-legend"></div>
  </div>

  <!-- \uD074\uB9AD \uC0C1\uC138 \uD31D\uC5C5 -->
  <div id="${r}-popup" onclick="if(event.target===this)this.classList.remove('show')">
    <div id="${r}-popup-inner">
      <button id="${r}-popup-close" onclick="document.getElementById('${r}-popup').classList.remove('show')">\u2715</button>
      <div id="${r}-popup-body"></div>
    </div>
  </div>
  ...
  (function(){
    ...
    const ttip    = document.getElementById('${r}-tooltip');
    const legendEl= document.getElementById('${r}-legend');
    const popup   = document.getElementById('${r}-popup');
    const popBody = document.getElementById('${r}-popup-body');
    if (!canvas) return;
    const ctx = canvas.getContext('2d');
    ...
    window['_${r}setSort']=function(key,btn){
      sortKey=key;
      document.querySelectorAll('.${r}-sort-btn').forEach(b=>b.classList.remove('on'));
...
var g=Object.defineProperty,P=Object.defineProperties;var R=Object.getOwnPropertyDescriptors;var N=Object.getOwnPropertySymbols;var j=Object.prototype.hasOwnProperty,O=Object.prototype.propertyIsEnumerable;var z=(s,d,c)=>d in s?g(s,d,{enumerable:!0,configurable:!0,writable:!0,value:c}):s[d]=c,T=(s,d)=>{for(var c in d||(d={}))j.call(d,c)&&z(s,c,d[c]);if(N)for(var c of N(d))O.call(d,c)&&z(s,c,d[c]);return s},_=(s,d)=>P(s,R(d));function _b2WeeklyAggregate(s,d,c){const f=t=>parseInt(String(t||"").replace(/[-\.\/]/g,""))||0,n=f(d),l=f(c),u=t=>{const e=f(t);return e>=n&&e<=l},y=t=>{const e=String(t||"").trim();return e&&!["\uC2A4\uD3F0\uC11C","\uC2A4\uD06C\uB9AC\uBBF8\uC9C0","\uC5F0\uC2B5",""].includes(e)},E=t=>String(t||"").indexOf("\uD504\uB85C\uB9AC\uADF8")!==-1,v=t=>{const e=String(t||"").trim();return e.indexOf("\uD504\uB85C\uB9AC\uADF8")!==-1||e.indexOf("\uAC1C\uC778\uC804")!==-1||e.indexOf("\uB05D\uC7A5\uC804")!==-1},b={},h=(t,e,i,a,o)=>{!t||!e||!i||u(e)&&(v(o)||(b[t]||(b[t]=[]),b[t].push({date:e,result:i,oppRace:a||"",mode:o||""})))},r=t=>Array.isArray(t)?t.map(e=>e&&typeof e=="object"?String(e.name||"").trim():String(e||"").trim()).filter(Boolean):String(t||"").split(/[,+，]/).map(e=>e.trim()).filter(Boolean),x=(t,e,i)=>{if(!t||!e||!t.winner)return;const a=Array.isArray(t.teamA)&&t.teamA.length?r(t.teamA):t.a1||t.a2?[t.a1,t.a2].filter(Boolean):r(t.playerA),o=Array.isArray(t.teamB)&&t.teamB.length?r(t.teamB):t.b1||t.b2?[t.b1,t.b2].filter(Boolean):r(t.playerB);if(a.length>=2&&o.length>=2){const p=t.winner==="A"?a:o,$=t.winner==="A"?o:a;return p.forEach(m=>h(m,e,"\uC2B9","",i)),$.forEach(m=>h(m,e,"\uD328","",i)),!0}return!1};try{(typeof indM!="undefined"&&Array.isArray(indM)?indM:[]).forEach(t=>{if(!t||!t.d||!t.wName||!t.lName)return;const e=s.find(a=>a.name===t.wName),i=s.find(a=>a.name===t.lName);h(t.wName,t.d,"\uC2B9",(i==null?void 0:i.race)||"",t.mode||"\uAC1C\uC778\uC804"),h(t.lName,t.d,"\uD328",(e==null?void 0:e.race)||"",t.mode||"\uAC1C\uC778\uC804")})}catch(t){}try{(typeof gjM!="undefined"&&Array.isArray(gjM)?gjM:[]).forEach(t=>{if(!t||!t.d||!t.wName||!t.lName||t._proLabel)return;const e=s.find(a=>a.name===t.wName),i=s.find(a=>a.name===t.lName);h(t.wName,t.d,"\uC2B9",(i==null?void 0:i.race)||"",t.mode||"\uB05D\uC7A5\uC804"),h(t.lName,t.d,"\uD328",(e==null?void 0:e.race)||"",t.mode||"\uB05D\uC7A5\uC804")})}catch(t){}try{(typeof ttM!="undefined"&&Array.isArray(ttM)?ttM:[]).forEach(t=>{!t||!t.d||(t.sets||[]).forEach(e=>{(e.games||[]).forEach(i=>{if(x(i,t.d,"\uD2F0\uC5B4\uB300\uD68C")||!i||!i.playerA||!i.playerB||!i.winner)return;const a=s.find(m=>m.name===i.playerA),o=s.find(m=>m.name===i.playerB),p=i.winner==="A",$=i.winner==="B";h(i.playerA,t.d,p?"\uC2B9":"\uD328",(o==null?void 0:o.race)||"","\uD2F0\uC5B4\uB300\uD68C"),h(i.playerB,t.d,$?"\uC2B9":"\uD328",(a==null?void 0:a.race)||"","\uD2F0\uC5B4\uB300\uD68C")})})})}catch(t){}const A=(t,e)=>{try{(Array.isArray(t)?t:[]).forEach(i=>{!i||!i.d||(i.sets||[]).forEach(a=>{(a.games||[]).forEach(o=>{if(!(!o||!o.winner)&&!x(o,i.d,e)&&o.playerA&&o.playerB){const p=s.find(m=>m.name===o.playerA),$=s.find(m=>m.name===o.playerB);h(o.playerA,i.d,o.winner==="A"?"\uC2B9":"\uD328",($==null?void 0:$.race)||"",e),h(o.playerB,i.d,o.winner==="B"?"\uC2B9":"\uD328",(p==null?void 0:p.race)||"",e)}})})})}catch(i){}};A(typeof miniM!="undefined"?miniM:[],"\uBBF8\uB2C8\uB300\uC804"),A(typeof univM!="undefined"?univM:[],"\uB300\uD559\uB300\uC804"),A(typeof ckM!="undefined"?ckM:[],"\uB300\uD559CK");try{(typeof tourneys!="undefined"&&Array.isArray(tourneys)?tourneys:[]).forEach(t=>{(t.groups||[]).forEach(e=>{(e.matches||[]).forEach(i=>{!i||!i.d||(i.sets||[]).forEach(a=>{(a.games||[]).forEach(o=>{if(x(o,i.d,"\uB300\uD68C")||!o||!o.playerA||!o.playerB||!o.winner)return;const p=s.find(m=>m.name===o.playerA),$=s.find(m=>m.name===o.playerB);h(o.playerA,i.d,o.winner==="A"?"\uC2B9":"\uD328",($==null?void 0:$.race)||"","\uB300\uD68C"),h(o.playerB,i.d,o.winner==="B"?"\uC2B9":"\uD328",(p==null?void 0:p.race)||"","\uB300\uD68C")})})})}),Object.values((t.bracket||{}).matchDetails||{}).forEach(e=>{!e||!e.d||(e.sets||[]).forEach(i=>{(i.games||[]).forEach(a=>{if(x(a,e.d,"\uB300\uD68C")||!a||!a.playerA||!a.playerB||!a.winner)return;const o=s.find($=>$.name===a.playerA),p=s.find($=>$.name===a.playerB);h(a.playerA,e.d,a.winner==="A"?"\uC2B9":"\uD328",(p==null?void 0:p.race)||"","\uB300\uD68C"),h(a.playerB,e.d,a.winner==="B"?"\uC2B9":"\uD328",(o==null?void 0:o.race)||"","\uB300\uD68C")})})}),(t.normalMatches||[]).forEach(e=>{!e||!e.d||(e.sets||[]).forEach(i=>{(i.games||[]).forEach(a=>{if(x(a,e.d,"\uB300\uD68C")||!a||!a.playerA||!a.playerB||!a.winner)return;const o=s.find($=>$.name===a.playerA),p=s.find($=>$.name===a.playerB);h(a.playerA,e.d,a.winner==="A"?"\uC2B9":"\uD328",(p==null?void 0:p.race)||"","\uB300\uD68C"),h(a.playerB,e.d,a.winner==="B"?"\uC2B9":"\uD328",(o==null?void 0:o.race)||"","\uB300\uD68C")})})})})}catch(t){}return s.map(t=>{const e=(Array.isArray(t.history)?t.history:[]).filter(w=>u(w.date||w.d||"")&&!v(w.mode||w.label||w.type||w.kind||w.cat||"")),i=(b[t.name]||[]).filter(w=>!v(w.mode||"")),a=new Set(e.map(w=>`${w.date||w.d||""}|${w.result||""}`)),o=i.filter(w=>!a.has(`${w.date||""}|${w.result||""}`)),p=[...e,...o],$=p.filter(w=>w.result==="\uC2B9").length,m=p.filter(w=>w.result==="\uD328").length,B=$+m,k=p.filter(w=>y(w.mode)),W=p.filter(w=>!y(w.mode)),M={P:{w:0,l:0},T:{w:0,l:0},Z:{w:0,l:0}};return p.forEach(w=>{const S=String(w.oppRace||"").trim().toUpperCase();M[S]&&(w.result==="\uC2B9"?M[S].w++:M[S].l++)}),{p:t,wins:$,losses:m,total:B,winRate:B?Math.round($/B*100):null,offWins:k.filter(w=>w.result==="\uC2B9").length,offLosses:k.filter(w=>w.result==="\uD328").length,spWins:W.filter(w=>w.result==="\uC2B9").length,spLosses:W.filter(w=>w.result==="\uD328").length,vsRace:M,hist:p}})}function _b2WeeklyUnivStats(s,d,c,f){const n=_b2WeeklyAggregate(s,d,c);return f.map(l=>{const u=n.filter(r=>{var x;return String(((x=r.p)==null?void 0:x.univ)||"").trim()===l.name}),y=u.filter(r=>r.total>0),E=y.reduce((r,x)=>r+x.wins,0),v=y.reduce((r,x)=>r+x.losses,0),b=E+v,h={P:{w:0,l:0},T:{w:0,l:0},Z:{w:0,l:0}};return y.forEach(r=>{["P","T","Z"].forEach(x=>{h[x].w+=r.vsRace[x].w,h[x].l+=r.vsRace[x].l})}),{u:l,members:u,active:y,tw:E,tl:v,tg:b,wr:b?Math.round(E/b*100):null,raceCount:h}}).sort((l,u)=>u.tg-l.tg)}function _b2WeeklyMVP(s){let d=null,c=-1;return s.forEach(f=>{f.active.forEach(n=>{var u;if(n.total<3||String(((u=n.p)==null?void 0:u.gender)||"").trim()!=="F")return;const l=n.wins*3+(n.total>0?n.wins/n.total*10:0)+n.offWins*2;l>c&&(c=l,d=n)})}),d}function _b2WeeklyMVP2(s,d){var l;let c=null,f=-1;const n=((l=d==null?void 0:d.p)==null?void 0:l.name)||null;return s.forEach(u=>{u.active.forEach(y=>{var v,b;if(y.total<3||String(((v=y.p)==null?void 0:v.gender)||"").trim()!=="F"||n&&((b=y.p)==null?void 0:b.name)===n)return;const E=y.wins*3+(y.total>0?y.wins/y.total*10:0)+y.offWins*2;E>f&&(f=E,c=y)})}),c}function _b2WeeklyWorst(s){let d=null,c=-1;return s.forEach(f=>{f.active.forEach(n=>{var u;if(n.total<2||String(((u=n.p)==null?void 0:u.gender)||"").trim()!=="F")return;const l=n.losses*3+(n.total>0?(n.total-n.wins)/n.total*10:0);l>c&&(c=l,d=n)})}),d}function _b2WeeklyUnivMVP(s){const d=(Array.isArray(s)?s:[]).filter(n=>n&&n.total>0).map(n=>{var E;const l=(n.wins||0)-(n.losses||0),u=n.total>0?(E=n.winRate)!=null?E:Math.round((n.wins||0)/n.total*100):null,y=(n.offWins||0)+(n.offLosses||0);return _(T({},n),{netWins:l,offTotal:y,aceQualified:n.total>=3&&(u!=null?u:0)>=50&&l>=1,aceScore:l*100+(u!=null?u:0)*2+y*4+(n.wins||0)})}),c=(n,l)=>{var u,y;return l.aceScore-n.aceScore||l.netWins-n.netWins||((u=l.winRate)!=null?u:-1)-((y=n.winRate)!=null?y:-1)||l.offTotal-n.offTotal||l.total-n.total||l.wins-n.wins},f=d.filter(n=>n.aceQualified).sort(c);return f.length?f[0]:null}function _b2WeeklyForm(s){return[...s].sort((c,f)=>{const n=parseInt(String(c.date||"").replace(/[-\.\/]/g,""))||0,l=parseInt(String(f.date||"").replace(/[-\.\/]/g,""))||0;return n!==l?n-l:(c.time||0)-(f.time||0)}).slice(-5).map(c=>{const f=c.result==="\uC2B9"?"#10b981":c.result==="\uD328"?"#ef4444":"#94a3b8",n=c.result==="\uC2B9"?"W":c.result==="\uD328"?"L":"-";return`<span style="display:inline-flex;align-items:center;justify-content:center;width:16px;height:16px;border-radius:50%;background:${f};font-size:9px;color:#fff;font-weight:900;flex-shrink:0">${n}</span>`}).join("")}function _b2WeeklyBarChart(s){const d=s.filter(r=>r.tg>0).slice(0,10);if(!d.length)return"";const c=Math.max(...d.map(r=>r.tg),1),f=28,n=6,l=90,u=160,y=14,v=d.length*(f+n)+y+10,b="100%";let h="";return d.forEach((r,x)=>{const A=y+x*(f+n),t=(gc?gc(r.u.name):"#64748b")||"#64748b",e=`${Math.round(r.tw/c*100)}%`,i=`${Math.round(r.tl/c*100)}%`,a=r.wr!==null?`${r.wr}%`:"-",o=r.wr===null?"#94a3b8":r.wr>=60?"#10b981":r.wr>=40?"#f59e0b":"#ef4444";h+=`
      <text x="${l-6}" y="${A+f/2+4}" text-anchor="end" font-size="11" font-weight="700" fill="var(--text2)" style="font-family:inherit">${r.u.name.length>6?r.u.name.slice(0,6)+"\u2026":r.u.name}</text>
      <rect x="${l}" y="${A}" width="0" height="${f*.55}" rx="3" fill="${t}" opacity="0.85">
        <animate attributeName="width" from="0" to="${e}" dur="0.5s" fill="freeze" calcMode="spline" keySplines="0.4 0 0.2 1"/>
      </rect>
      <rect x="${l}" y="${A+f*.58}" width="0" height="${f*.38}" rx="3" fill="${t}" opacity="0.35">
        <animate attributeName="width" from="0" to="${i}" dur="0.5s" fill="freeze" calcMode="spline" keySplines="0.4 0 0.2 1"/>
      </rect>
      <text x="${l+4}" y="${A+f*.55-5}" font-size="10" fill="${t}" font-weight="800">${r.tw}\uC2B9</text>
      <text x="${l+4}" y="${A+f-4}" font-size="10" fill="${t}" opacity="0.7">${r.tl}\uD328</text>
      <text x="calc(${l}px + ${e})" y="${A+f/2+4}" font-size="12" font-weight="900" fill="${o}" style="font-family:inherit">${a}</text>`}),`<div style="width:100%;overflow:hidden;padding:4px 0">
    <svg viewBox="0 0 520 ${v}" width="100%" style="overflow:visible;display:block">
      <defs>
        <style>.b2wchart-label{font-family:inherit}</style>
      </defs>
      ${d.map((r,x)=>{const A=y+x*(f+n),t=(gc?gc(r.u.name):"#64748b")||"#64748b",e=Math.round(r.tw/c*(520-l-u)),i=Math.round(r.tl/c*(520-l-u)),a=r.wr!==null?`${r.wr}%`:"-",o=r.wr===null?"#94a3b8":r.wr>=60?"#10b981":r.wr>=40?"#f59e0b":"#ef4444",p=r.u.name.length>6?r.u.name.slice(0,6)+"\u2026":r.u.name,$=520-l-u;return`
          <text x="${l-6}" y="${A+f*.62}" text-anchor="end" font-size="11" font-weight="700" fill="var(--text2)">${p}</text>
          <rect x="${l}" y="${A}" width="${e}" height="${f*.52}" rx="3" fill="${t}" opacity="0.9"/>
          <rect x="${l}" y="${A+f*.56}" width="${i}" height="${f*.38}" rx="3" fill="${t}" opacity="0.3"/>
          ${r.tw>0?`<text x="${l+e+4}" y="${A+f*.44}" font-size="10" font-weight="900" fill="${t}">${r.tw}\uC2B9</text>`:""}
          ${r.tl>0?`<text x="${l+i+4}" y="${A+f*.88}" font-size="10" fill="${t}" opacity="0.7">${r.tl}\uD328</text>`:""}
          <text x="${520-u+8}" y="${A+f*.62}" font-size="13" font-weight="900" fill="${o}">${a}</text>
          <text x="${520-u+50}" y="${A+f*.62}" font-size="11" fill="var(--text3)">${r.tg}\uC804 ${r.active.length}\uBA85</text>`}).join("")}
    </svg>
  </div>`}function _b2WeeklyRaceStats(s){return`<div class="b2w2-race-table">
    ...
    ${[{key:"P",label:"\uD504\uB85C\uD1A0\uC2A4",ico:"\u{1F52E}",color:"#8b5cf6"},{key:"T",label:"\uD14C\uB780",ico:"\u2694\uFE0F",color:"#3b82f6"},{key:"Z",label:"\uC800\uADF8",ico:"\u{1F98E}",color:"#f59e0b"}].map(({key:f,label:n,ico:l,color:u})=>{const{w:y,l:E}=s[f],v=y+E,b=v?Math.round(y/v*100):null,h=b===null?"#94a3b8":b>=60?"#10b981":b>=40?"#f59e0b":"#ef4444";return`<div class="b2w2-race-row">
      <div class="b2w2-race-cell b2w2-race-cell-main">
        <span style="font-size:13px;width:20px;text-align:center;flex-shrink:0">${l}</span>
        <span style="font-size:11px;font-weight:800;color:var(--text2);white-space:nowrap">${n}</span>
      </div>
      <div class="b2w2-race-cell"><span class="b2w2-race-pill win">${y}</span></div>
      <div class="b2w2-race-cell"><span class="b2w2-race-pill loss">${E}</span></div>
      <div class="b2w2-race-cell"><span class="b2w2-race-count">${v}</span></div>
      <div class="b2w2-race-cell"><span class="b2w2-race-rate" style="color:${h};border-color:${u}2e;background:${u}10">${b!==null?`${b}%`:"-"}</span></div>
    </div>`}).join("")}
...
var Vt=Object.defineProperty,Gt=Object.defineProperties;var Lt=Object.getOwnPropertyDescriptors;var gt=Object.getOwnPropertySymbols;var Kt=Object.prototype.hasOwnProperty,At=Object.prototype.propertyIsEnumerable;var vt=(s,o,i)=>o in s?Vt(s,o,{enumerable:!0,configurable:!0,writable:!0,value:i}):s[o]=i,Z=(s,o)=>{for(var i in o||(o={}))Kt.call(o,i)&&vt(s,i,o[i]);if(gt)for(var i of gt(o))At.call(o,i)&&vt(s,i,o[i]);return s},H=(s,o)=>Gt(s,Lt(o));function _b2WeeklyGetDefaultRange(s){const o=new Date,i=s||0,d=o.getDay(),p=d===0?-6:1-d,w=new Date(o);w.setDate(o.getDate()+p+i*7);const S=new Date(w);S.setDate(w.getDate()+6);const y=J=>J.toISOString().slice(0,10);return{from:y(w),to:y(S)}}function _b2MonthlyGetDefaultRange(s,o){const i=new Date,d=s||0,p=new Date(i.getFullYear(),i.getMonth()+d,1),w=new Date(p.getFullYear(),p.getMonth(),1),S=o?new Date(p.getFullYear(),p.getMonth()+1,0):d===0?new Date(i.getFullYear(),i.getMonth(),i.getDate()):new Date(p.getFullYear(),p.getMonth()+1,0),y=J=>J.toISOString().slice(0,10);return{from:y(w),to:y(S)}}function _b2EnsureStyleTag(s,o){try{const i=document.head||document.getElementsByTagName&&document.getElementsByTagName("head")[0];if(!i)return;const d=String(o||"");let p=document.getElementById(s);if(!p){p=document.createElement("style"),p.id=s,p.type="text/css",p.appendChild(document.createTextNode(d)),i.appendChild(p);return}(p.textContent||"")!==d&&(p.textContent=d)}catch(i){}}function _b2IsValidDateStr(s){return/^\d{4}-\d{2}-\d{2}$/.test(String(s||"").trim())}function _b2NormalizeBriefingRange(s,o){const i=String(s||"").trim().slice(0,10),d=String(o||"").trim().slice(0,10);if(!_b2IsValidDateStr(i)||!_b2IsValidDateStr(d))return{from:i,to:d,swapped:!1};const p=parseInt(i.replace(/-/g,""),10)||0,w=parseInt(d.replace(/-/g,""),10)||0;return p&&w&&p>w?{from:d,to:i,swapped:!0}:{from:i,to:d,swapped:!1}}function _b2BriefingLoadState(){try{const s=localStorage.getItem("b2w2_state_v1");if(!s)return null;const o=JSON.parse(s);if(!o||typeof o!="object")return null;const i=String(o.preset||"").trim(),d=String(o.from||"").trim(),p=String(o.to||"").trim(),w=String(o.univ||"").trim()||"\uC804\uCCB4",S=["thisWeek","lastWeek","thisMonth","lastMonth","custom"].includes(i),y=_b2NormalizeBriefingRange(d,p);return{preset:S?i:null,from:_b2IsValidDateStr(y.from)?y.from:null,to:_b2IsValidDateStr(y.to)?y.to:null,univ:w}}catch(s){return null}}function _b2BriefingSaveState(){try{const s=String(window._b2WeeklyPreset||"").trim(),o=String(window._b2WeeklyDateFrom||"").trim(),i=String(window._b2WeeklyDateTo||"").trim(),d=String(window._b2WeeklyUniv||"\uC804\uCCB4").trim()||"\uC804\uCCB4",p={preset:["thisWeek","lastWeek","thisMonth","lastMonth","custom"].includes(s)?s:"custom",from:o,to:i,univ:d};localStorage.setItem("b2w2_state_v1",JSON.stringify(p))}catch(s){}}function _b2BriefingPresetRange(s){const o=String(s||"thisWeek");return o==="lastWeek"?_b2WeeklyGetDefaultRange(-1):o==="thisMonth"?_b2MonthlyGetDefaultRange(0,!1):o==="lastMonth"?_b2MonthlyGetDefaultRange(-1,!0):_b2WeeklyGetDefaultRange(0)}function _b2SetBriefingPreset(s){const o=_b2BriefingPresetRange(s);window._b2WeeklyPreset=String(s||"thisWeek"),window._b2WeeklyDateFrom=o.from,window._b2WeeklyDateTo=o.to,_b2BriefingSaveState(),typeof render=="function"&&render()}function _b2GetBriefingInputValues(){const s=document.getElementById("b2w2-from"),o=document.getElementById("b2w2-to"),i=document.getElementById("b2w2-univ"),d=_b2BriefingPresetRange("thisWeek");return{from:s&&s.value||window._b2WeeklyDateFrom||d.from,to:o&&o.value||window._b2WeeklyDateTo||d.to,univ:i&&i.value||window._b2WeeklyUniv||"\uC804\uCCB4"}}function _b2SyncBriefingCustomInputs(s){const o=_b2GetBriefingInputValues(),i=_b2NormalizeBriefingRange(o.from,o.to);if(window._b2WeeklyDateFrom=i.from,window._b2WeeklyDateTo=i.to,window._b2WeeklyUniv=o.univ,window._b2WeeklyPreset="custom",i.swapped){const d=document.getElementById("b2w2-from"),p=document.getElementById("b2w2-to");d&&(d.value=i.from),p&&(p.value=i.to)}_b2BriefingSaveState(),s&&typeof render=="function"&&render()}function _b2ApplyBriefingCustomFromInputs(){_b2SyncBriefingCustomInputs(!0)}function _b2ActivateBriefingCustom(s){_b2SyncBriefingCustomInputs(!0),s&&setTimeout(()=>{const o=document.getElementById("b2w2-from");o&&typeof o.focus=="function"&&o.focus();try{o&&typeof o.showPicker=="function"&&o.showPicker()}catch(i){}},30)}function _b2SetBriefingRecentDays(s){const o=Math.max(1,Number(s)||7),i=new Date;i.setHours(0,0,0,0);const d=new Date(i);d.setDate(i.getDate()-(o-1));const p=w=>w.toISOString().slice(0,10);window._b2WeeklyPreset="custom",window._b2WeeklyDateFrom=p(d),window._b2WeeklyDateTo=p(i),_b2BriefingSaveState(),typeof render=="function"&&render()}function _b2OpenBriefingDateInput(s){const o=s==="to"?"b2w2-to":"b2w2-from",i=document.getElementById(o);if(!i)return;try{typeof i.focus=="function"&&i.focus()}catch(S){}try{if(typeof i.showPicker=="function"){i.showPicker();return}}catch(S){}const d=String(i.value||(s==="to"?window._b2WeeklyDateTo:window._b2WeeklyDateFrom)||"").trim(),p=window.prompt("\uB0A0\uC9DC\uB97C YYYY-MM-DD \uD615\uC2DD\uC73C\uB85C \uC785\uB825\uD558\uC138\uC694.",d);if(p==null)return;const w=String(p).trim().replace(/\./g,"-").replace(/\//g,"-");if(!/^\d{4}-\d{2}-\d{2}$/.test(w)){alert("\uB0A0\uC9DC \uD615\uC2DD\uC740 YYYY-MM-DD \uB85C \uC785\uB825\uD574\uC8FC\uC138\uC694.");return}i.value=w,_b2SyncBriefingCustomInputs(!0)}function _b2WeeklyBriefingView(){var s,o,i,d,p,w,S,y,J,$e,_e,ze,De,Se,We,Pe,Me,Be,Re,Te,Ce,Ie,je,Fe,Ee,Ne,Ue,Ve,Ge,Le,Ke,Ae,Oe;try{if(typeof window._b2WeeklyPreset=="undefined"||!window._b2WeeklyDateFrom||!window._b2WeeklyDateTo||typeof window._b2WeeklyUniv=="undefined"){const e=_b2BriefingLoadState();e&&(typeof window._b2WeeklyPreset=="undefined"&&e.preset&&(window._b2WeeklyPreset=e.preset),!window._b2WeeklyDateFrom&&e.from&&(window._b2WeeklyDateFrom=e.from),!window._b2WeeklyDateTo&&e.to&&(window._b2WeeklyDateTo=e.to),typeof window._b2WeeklyUniv=="undefined"&&e.univ&&(window._b2WeeklyUniv=e.univ))}if(typeof window._b2WeeklyPreset=="undefined"&&(window._b2WeeklyPreset="thisWeek"),!window._b2WeeklyDateFrom||!window._b2WeeklyDateTo){const e=_b2BriefingPresetRange(window._b2WeeklyPreset);window._b2WeeklyDateFrom=e.from,window._b2WeeklyDateTo=e.to}typeof window._b2WeeklyUniv=="undefined"&&(window._b2WeeklyUniv="\uC804\uCCB4");const re=_b2NormalizeBriefingRange(window._b2WeeklyDateFrom,window._b2WeeklyDateTo);window._b2WeeklyDateFrom=re.from,window._b2WeeklyDateTo=re.to;const h=String(window._b2WeeklyPreset||"thisWeek"),C=window._b2WeeklyDateFrom,F=window._b2WeeklyDateTo,Ot=e=>parseInt(String(e||"").replace(/[-\.\/]/g,""))||0,Ye=Math.round((new Date(F)-new Date(C))/864e5)+1,le=new Date(C);le.setDate(le.getDate()-1);const be=new Date(le);be.setDate(be.getDate()-(Ye-1));const Ze=e=>e.toISOString().slice(0,10),oe=Ze(be),ie=Ze(le),ft=new Set((typeof univCfg!="undefined"?univCfg:[]).filter(e=>e.dissolved||e.hidden).map(e=>String(e.name||"").trim())),pe=players.filter(e=>!e.hidden&&!e.retired&&!e.hideFromBoard&&!ft.has(String((e==null?void 0:e.univ)||"").trim())),we=(_b2VisUnivs?_b2VisUnivs():[]).filter(e=>e.name&&e.name!=="\uBB34\uC18C\uC18D"),W=window._b2WeeklyUniv||"\uC804\uCCB4",u=e=>String(e||"").slice(0,10).replace(/-/g,"."),He={thisWeek:{kicker:"Weekly Briefing",title:"\uBE0C\uB9AC\uD551",short:"\uC774\uBC88\uC8FC",prevLabel:"\uC9C0\uB09C\uC8FC",desc:"\uC774\uBC88 \uC8FC \uD65C\uB3D9\uACFC \uD750\uB984\uC744 \uCE74\uB4DC \uC704\uC8FC\uB85C \uBE60\uB974\uAC8C \uD6D1\uC5B4\uBCFC \uC218 \uC788\uB3C4\uB85D \uC815\uB9AC\uD55C \uD654\uBA74\uC785\uB2C8\uB2E4."},lastWeek:{kicker:"Weekly Briefing",title:"\uBE0C\uB9AC\uD551",short:"\uC9C0\uB09C\uC8FC",prevLabel:"\uADF8 \uC804 \uC8FC",desc:"\uC9C0\uB09C\uC8FC \uD65C\uB3D9 \uD750\uB984\uACFC \uC8FC\uC694 \uBCC0\uD654\uB97C \uB418\uC9DA\uC5B4\uBCF4\uAE30 \uC88B\uAC8C \uC815\uB9AC\uD55C \uD654\uBA74\uC785\uB2C8\uB2E4."},thisMonth:{kicker:"Monthly Briefing",title:"\uC6D4\uAC04 \uBE0C\uB9AC\uD551",short:"\uC774\uBC88\uB2EC",prevLabel:"\uC9C0\uB09C\uB2EC",desc:"\uC774\uBC88 \uB2EC \uD65C\uB3D9 \uD750\uB984\uACFC \uC6D4\uAC04 \uBCC0\uD654 \uD3EC\uC778\uD2B8\uB97C \uD55C \uD654\uBA74\uC5D0\uC11C \uBCF4\uAE30 \uC88B\uAC8C \uC815\uB9AC\uD55C \uD654\uBA74\uC785\uB2C8\uB2E4."},lastMonth:{kicker:"Monthly Briefing",title:"\uC6D4\uAC04 \uBE0C\uB9AC\uD551",short:"\uC9C0\uB09C\uB2EC",prevLabel:"\uADF8 \uC804 \uB2EC",desc:"\uC9C0\uB09C\uB2EC \uD65C\uB3D9 \uD750\uB984\uACFC \uC6D4\uAC04 \uC694\uC57D\uC744 \uB418\uB3CC\uC544\uBCF4\uAE30 \uC88B\uAC8C \uC815\uB9AC\uD55C \uD654\uBA74\uC785\uB2C8\uB2E4."},custom:{kicker:"Period Briefing",title:"\uAE30\uAC04 \uBE0C\uB9AC\uD551",short:"\uC0AC\uC6A9\uC790 \uAE30\uAC04",prevLabel:"\uC774\uC804 \uAE30\uAC04",desc:"\uC9C1\uC811 \uC9C0\uC815\uD55C \uAE30\uAC04\uC758 \uD65C\uB3D9 \uD750\uB984\uACFC \uD575\uC2EC \uBCC0\uD654\uB97C \uBE44\uAD50\uD574\uC11C \uBCF4\uB294 \uD654\uBA74\uC785\uB2C8\uB2E4."}},E=He[h]||He.custom,f=h==="thisMonth"||h==="lastMonth",P=h==="custom",Je=h==="thisMonth"?"\uC774\uB2EC MVP":h==="lastMonth"?"\uC9C0\uB09C\uB2EC MVP":"\uC774\uBC88 \uC8FC MVP",mt=f?"\uD65C\uB3D9 \uB9CE\uC740 \uB300\uD559 TOP 5":"\uD65C\uB3D9 \uB9CE\uC740 \uB300\uD559 TOP 3",xt=f?5:3,_=_b2WeeklyUnivStats(pe,C,F,we),qe=_b2WeeklyUnivStats(pe,oe,ie,we),Qe={};qe.forEach(e=>{Qe[e.u.name]=e});const ge=W==="\uC804\uCCB4"?_:_.filter(e=>e.u.name===W),Xe=_b2WeeklyMVP(_),Yt=_b2WeeklyMVP2(_,Xe),Zt=_b2WeeklyWorst(_),ht=(e,t,n,r)=>{var v,Y;if(!e)return"";const a=e.p,c=gc?gc(String((a==null?void 0:a.univ)||"")):n?"#ef4444":t===1?"#f59e0b":"#94a3b8",l=typeof getTierBtnColor=="function"&&a.tier?getTierBtnColor(a.tier):"#475569",b=typeof getTierBtnTextColor=="function"&&a.tier&&getTierBtnTextColor(a.tier)||"#fff",D=a.race==="P"?"\u{1F52E}":a.race==="T"?"\u2694\uFE0F":a.race==="Z"?"\u{1F98E}":"",T=a.photo?typeof toHttpsUrl=="function"?toHttpsUrl(a.photo):a.photo:"",U=String(a.name||"-").trim().slice(0,1),V=String(a.name||"").replace(/\\/g,"\\\\").replace(/'/g,"\\'"),K=n?"b2w2-mvp-worst":t===1?"b2w2-mvp-first":"b2w2-mvp-second",A=r==="b2w2-mvp-card-mini"?n?"3\uB4F1":t===1?"1\uB4F1":"2\uB4F1":n?f?"\uC774\uB2EC\uC758 \uCD5C\uC545":"\uC774\uBC88\uC8FC \uCD5C\uC545":t===1?Je:f?"\uC774\uB2EC\uC758 2\uC704":"\uC774\uBC88\uC8FC 2\uC704",g=n?"\u{1F480}":t===1?"\u{1F3C6}":"\u{1F948}",O="b2w2-mvp-sv-win",te="b2w2-mvp-sv-loss",$="b2w2-mvp-sv-rate",R=n?`<div class="b2w2-mvp-stat"><span class="b2w2-mvp-sv ${te}">${e.losses}</span><span class="b2w2-mvp-sl">\uD328</span></div>
      ...
      </div>`},ut=_b2WeeklyAggregate(pe,C,F),yt=_b2WeeklyAggregate(pe,oe,ie),ve={};yt.forEach(e=>{var t;ve[((t=e.p)==null?void 0:t.name)||""]=e});const I=ut.filter(e=>e.total>0),M=[..._].filter(e=>e.tg>0).sort((e,t)=>{var n,r;return t.tg-e.tg||t.active.length-e.active.length||((n=t.wr)!=null?n:-1)-((r=e.wr)!=null?r:-1)}).slice(0,xt),q=_.filter(e=>e.tg===0).map(e=>e.u.name),Q=I.map(e=>{var a,c,l;const t=ve[((a=e.p)==null?void 0:a.name)||""]||null,n=t&&t.total>0&&(c=t.winRate)!=null?c:0,r=t&&t.total||0;return H(Z({},e),{wrDelta:((l=e.winRate)!=null?l:0)-n,totalDelta:e.total-r,prevTotal:r})}).filter(e=>e.total>=2).sort((e,t)=>t.wrDelta-e.wrDelta||t.totalDelta-e.totalDelta||t.wins-e.wins),x=Q[0]||null,de=Q.filter(e=>e.prevTotal>=2&&e.wrDelta<0).slice().sort((e,t)=>e.wrDelta-t.wrDelta||e.totalDelta-t.totalDelta),j=de[0]||null,et=(e,t)=>{const n=[...e].sort((a,c)=>{const l=parseInt(String(a.date||"").replace(/[-\.\/]/g,""))||0,b=parseInt(String(c.date||"").replace(/[-\.\/]/g,""))||0;return b!==l?b-l:(c.time||0)-(a.time||0)});let r=0;for(const a of n)if(a.result===t)r++;else break;return r},tt=I.map(e=>H(Z({},e),{streak:et(e.hist,"\uC2B9")})).filter(e=>e.streak>=2).sort((e,t)=>t.streak-e.streak),ne=tt[0]||null,at=I.map(e=>H(Z({},e),{streak:et(e.hist,"\uD328")})).filter(e=>e.streak>=2).sort((e,t)=>t.streak-e.streak),se=at[0]||null,fe=I.filter(e=>e.total>=3).slice().sort((e,t)=>{var n,r;return((n=t.winRate)!=null?n:-1)-((r=e.winRate)!=null?r:-1)||t.total-e.total}),k=fe[0]||null,me=I.map(e=>H(Z({},e),{offTotal:e.offWins+e.offLosses})).filter(e=>e.offTotal>0).sort((e,t)=>t.offTotal-e.offTotal),G=me[0]||null,xe=I.filter(e=>e.total>0).slice().sort((e,t)=>{var n,r;return t.total-e.total||((n=t.winRate)!=null?n:-1)-((r=e.winRate)!=null?r:-1)}),z=xe[0]||null,rt=[...I].sort((e,t)=>{var n,r;return t.total-e.total||t.wins-e.wins||((n=t.winRate)!=null?n:-1)-((r=e.winRate)!=null?r:-1)}).slice(0,5),Ht=rt[0]||null,ot=(e,t)=>{var n,r,a,c;return t.tw-e.tw||((n=t.wr)!=null?n:-1)-((r=e.wr)!=null?r:-1)||t.tg-e.tg||t.active.length-e.active.length||String(((a=e.u)==null?void 0:a.name)||"").localeCompare(String(((c=t.u)==null?void 0:c.name)||""),"ko",{sensitivity:"base"})},B=((e,t)=>{const n={};return(t||[]).filter(r=>r.tg>0).slice().sort(ot).forEach((r,a)=>{n[r.u.name]=a+1}),(e||[]).filter(r=>r.tg>0).slice().sort(ot).map((r,a)=>{const c=a+1,l=n[r.u.name]||null,b=l?l-c:null;return H(Z({},r),{rank:c,prevRank:l,rankDelta:b})})})(_,qe),it=B,nt=B.map(e=>H(Z({},e),{ace:_b2WeeklyUnivMVP(e.active)})),ce=it.length,st=`b2w2-monthly-ranks-more-${h}`,lt=`b2w2-monthly-ranks-btn-${h}`,pt=`b2w2-monthly-aces-more-${h}`,dt=`b2w2-monthly-aces-btn-${h}`,he=nt.find(e=>e.ace)||null,ct=(()=>{var t,n,r;const e=[];return f&&B[0]?e.push(`${B[0].u.name} ${B[0].tw}\uC2B9 ${B[0].tl}\uD328 \xB7 \uC2B9\uB960 ${(t=B[0].wr)!=null?t:0}%\uB85C 1\uC704`):M[0]&&e.push(`${M[0].u.name} \uD65C\uB3D9\uB7C9 1\uC704 \xB7 ${M[0].tg}\uC804 \xB7 \uD65C\uB3D9 ${M[0].active.length}\uBA85`),x&&x.wrDelta>0&&e.push(`${((n=x.p)==null?void 0:n.name)||"-"} \uC2B9\uB960 \uBCC0\uB3D9 ${x.wrDelta>0?"+":""}${x.wrDelta}%p`),f&&he&&e.push(`${he.u.name} \uC5D0\uC774\uC2A4 ${((r=he.ace.p)==null?void 0:r.name)||"-"}`),q.length&&e.push(`\uAE30\uB85D \uC5C6\uB294 \uB300\uD559 ${q.length}\uACF3`),e.length?`${e.join(" \xB7 ")}.`:"\uC120\uD0DD \uAE30\uAC04 \uD65C\uB3D9\uB7C9\uACFC \uBE44\uAD50 \uC9C0\uD45C\uB97C \uC815\uB9AC\uD588\uC2B5\uB2C8\uB2E4."})(),kt=(()=>{var e;if(f&&B[0]){const t=B[0],n=t.rankDelta===null?"\uCCAB \uC9D1\uACC4":t.rankDelta>0?`\uC804\uAE30 \uB300\uBE44 \u25B2${t.rankDelta}`:t.rankDelta<0?`\uC804\uAE30 \uB300\uBE44 \u25BC${Math.abs(t.rankDelta)}`:"\uC804\uAE30\uC640 \uB3D9\uC77C";return`${t.u.name} 1\uC704 \xB7 ${t.tw}\uC2B9 ${t.tl}\uD328 \xB7 \uC2B9\uB960 ${(e=t.wr)!=null?e:0}% \xB7 ${n}`}return M[0]?`${M[0].u.name} \uD65C\uB3D9\uB7C9 1\uC704 \xB7 ${M[0].tg}\uC804 \xB7 \uD65C\uB3D9 ${M[0].active.length}\uBA85`:"\uC120\uD0DD \uAE30\uAC04 \uD575\uC2EC \uC9C0\uD45C\uB97C \uBE60\uB974\uAC8C \uD655\uC778\uD560 \uC218 \uC788\uB3C4\uB85D \uC815\uB9AC\uD588\uC2B5\uB2C8\uB2E4"})(),$t=f?"\uC9D1\uACC4 \uBC94\uC704":P?"\uC0AC\uC6A9\uC790 \uAE30\uAC04":"\uC8FC\uAC04 \uBC94\uC704",_t=f?`\uB300\uD559 ${B.length}\uACF3`:`\uD65C\uB3D9 ${I.length}\uBA85`,zt=`${E.prevLabel} ${u(oe)} ~ ${u(ie)}`;_b2EnsureStyleTag("b2w2-style",`
    ...
    `);let m="";const Dt=_.reduce((e,t)=>e+(t.tg||0),0),St=_.filter(e=>e.tg>0).length,L=Ye;if(m+=`<div class="b2w2-wrap">
      <div class="b2w2-masthead">
        <span>STAR DATACENTER</span>
        <span>${u(C)} ~ ${u(F)} \uBC1C\uD589</span>
      </div>
      <section class="b2w2-hero">
        <div class="b2w2-hero-main">
          ...
          <div class="b2w2-hero-badges">
            ...
            <span class="b2w2-hero-badge">\uC120\uD0DD \uAE30\uAC04 ${u(C)} ~ ${u(F)}</span>
        ...
        <div class="b2w2-hero-stats">
          ...
          <div class="b2w2-hero-stat">
            ...
            <div class="b2w2-hero-stat-sub">${u(oe)} ~ ${u(ie)}</div>
          </div>
        </div>
      </section>
      <div class="b2w2-modebar">
        <div class="b2w2-modecard ${!f&&!P?"is-active":""}" onclick="_b2SetBriefingPreset('thisWeek')">
          ...
          <div class="b2w2-presetrow">
            ${[["thisWeek","\uC774\uBC88\uC8FC"],["lastWeek","\uC9C0\uB09C\uC8FC"]].map(([e,t])=>`<button type="button" class="b2w2-preset${h===e?" on":""}" onclick="event.stopPropagation();_b2SetBriefingPreset('${e}')">${t}</button>`).join("")}
          </div>
        </div>
        <div class="b2w2-modecard ${f?"is-active":""}" onclick="_b2SetBriefingPreset('thisMonth')">
          <div class="b2w2-modehead">
            ...
            <span class="b2w2-modebadge">${f?"\uC120\uD0DD\uB428":"\uAE4A\uAC8C \uBCF4\uAE30"}</span>
          </div>
          <div class="b2w2-modedesc">\uC774\uBC88\uB2EC\uACFC \uC9C0\uB09C\uB2EC \uD750\uB984\uC744 \uC870\uAE08 \uB354 \uB113\uAC8C \uD655\uC778\uD560 \uB54C \uC801\uD569\uD569\uB2C8\uB2E4.</div>
          <div class="b2w2-presetrow">
            ${[["thisMonth","\uC774\uBC88\uB2EC"],["lastMonth","\uC9C0\uB09C\uB2EC"]].map(([e,t])=>`<button type="button" class="b2w2-preset${h===e?" on":""}" onclick="event.stopPropagation();_b2SetBriefingPreset('${e}')">${t}</button>`).join("")}
          </div>
        </div>
        <div class="b2w2-modecard ${P?"is-active":""}" onclick="_b2ActivateBriefingCustom(true)">
          ...
          <div class="b2w2-presetrow">
            <button type="button" class="b2w2-preset${P&&L===7?" on":""}" onclick="event.stopPropagation();_b2SetBriefingRecentDays(7)">\uCD5C\uADFC 7\uC77C</button>
            <button type="button" class="b2w2-preset${P&&L===14?" on":""}" onclick="event.stopPropagation();_b2SetBriefingRecentDays(14)">\uCD5C\uADFC 14\uC77C</button>
            <button type="button" class="b2w2-preset${P&&L===30?" on":""}" onclick="event.stopPropagation();_b2SetBriefingRecentDays(30)">\uCD5C\uADFC 30\uC77C</button>
            <button type="button" class="b2w2-preset${P&&![7,14,30].includes(L)?" on":""}" onclick="event.stopPropagation();_b2ActivateBriefingCustom(true)">\uC9C1\uC811 \uC9C0\uC815</button>
            <button type="button" class="b2w2-preset${P&&![7,14,30].includes(L)?" on":""}" onclick="event.stopPropagation();_b2ApplyBriefingCustomFromInputs()">${P?`${u(C)} ~ ${u(F)}`:"\uC785\uB825\uAC12 \uC870\uD68C"}</button>
          </div>
        </div>
      </div>
      <div class="b2w2-hdr">
      ...
      <span style="font-size:11px;color:var(--text3);margin-left:auto">${u(C)} ~ ${u(F)}</span>
      <span style="font-size:10px;color:var(--text3)">(${E.prevLabel}: ${u(oe)}~${u(ie)})</span>
    </div>
    <div style="display:flex;align-items:center;gap:6px;flex-wrap:wrap;padding:7px 2px 10px;border-bottom:1px dashed var(--b2w-rule-soft);margin-bottom:16px">
    ...
    </div>`,!ge.some(e=>e.tg>0))return m+='<div class="b2w2-empty"><div style="font-size:28px;margin-bottom:8px">\u{1F4ED}</div>\uD574\uB2F9 \uAE30\uAC04\uC5D0 \uAE30\uB85D\uB41C \uACBD\uAE30\uAC00 \uC5C6\uC2B5\uB2C8\uB2E4.<div style="font-size:11px;margin-top:4px">\uAE30\uAC04\uC744 \uBCC0\uACBD\uD574\uBCF4\uC138\uC694</div></div></div>',m;const N=f?B[0]:M[0],Wt=f?"\uC120\uB450 \uB300\uD559":"\uD65C\uB3D9\uB7C9 1\uC704 \uB300\uD559",Pt=N?N.u.name:"-",Mt=N?f?`${N.tw}\uC2B9 ${N.tl}\uD328 \xB7 \uC2B9\uB960 ${(s=N.wr)!=null?s:0}%`:`${N.tg}\uC804 \xB7 \uD65C\uB3D9 ${N.active.length}\uBA85`:"\uC9D1\uACC4 \uB370\uC774\uD130 \uC5C6\uC74C",Bt=k?`${((o=k.p)==null?void 0:o.name)||"-"} \xB7 ${k.total}\uC804`:"\uD45C\uBCF8 \uBD80\uC871";m+=`<section class="b2w2-kpi-grid">
      <article class="b2w2-kpi-card">
        <div class="b2w2-kpi-label">\uD65C\uB3D9 \uB300\uD559</div>
        <div class="b2w2-kpi-value">${St}\uACF3</div>
        <div class="b2w2-kpi-sub">\uC120\uD0DD \uAE30\uAC04\uC5D0 \uACBD\uAE30 \uAE30\uB85D\uC774 \uC788\uB294 \uB300\uD559 \uC218</div>
      </article>
      <article class="b2w2-kpi-card">
        <div class="b2w2-kpi-label">\uCD1D \uACBD\uAE30 \uC218</div>
        <div class="b2w2-kpi-value">${Dt}\uC804</div>
        <div class="b2w2-kpi-sub">\uC9D1\uACC4 \uAE30\uAC04 ${L}\uC77C \uAE30\uC900</div>
      </article>
      <article class="b2w2-kpi-card">
        <div class="b2w2-kpi-label">${Wt}</div>
        <div class="b2w2-kpi-value">${Pt}</div>
        <div class="b2w2-kpi-sub">${Mt}</div>
      </article>
      <article class="b2w2-kpi-card">
        <div class="b2w2-kpi-label">\uCD5C\uACE0 \uC2B9\uB960</div>
        <div class="b2w2-kpi-value">${k?`${k.winRate}%`:"-"}</div>
      ...
      <article class="b2w2-highlight-card b2w2-lead-card" style="border-color:var(--b2w-accent-border);--hc-top:var(--b2w-accent)">
        ...
        <div style="display:flex;gap:8px;flex-wrap:wrap">
          ...
          <span class="b2w2-note-chip">${L}\uC77C \uC9D1\uACC4</span>
        </div>
      </article>
            ...
            ${x?`
              <div class="b2w2-dual-head">
                <div style="min-width:0">
                  ...
                  <div class="b2w2-dual-sub"><span style="font-weight:900;color:var(--text1);cursor:pointer" onclick="openPlayerModal('${((d=(i=x.p)==null?void 0:i.name)==null?void 0:d.replace(/\\/g,"\\\\").replace(/'/g,"\\'"))||""}')">${((p=x.p)==null?void 0:p.name)||"-"}</span> \xB7 ${String(((w=x.p)==null?void 0:w.univ)||"\uBB34\uC18C\uC18D")}</div>
                </div>
            ...
            ${j?`
              <div class="b2w2-dual-head">
                <div style="min-width:0">
                  ...
                  <div class="b2w2-dual-sub"><span style="font-weight:900;color:var(--text1);cursor:pointer" onclick="openPlayerModal('${((J=(y=j.p)==null?void 0:y.name)==null?void 0:J.replace(/\\/g,"\\\\").replace(/'/g,"\\'"))||""}')">${(($e=j.p)==null?void 0:$e.name)||"-"}</span> \xB7 ${String(((_e=j.p)==null?void 0:_e.univ)||"\uBB34\uC18C\uC18D")}</div>
                </div>
              ...
              <div class="b2w2-mini-list">
                ...
                ${de[1]?`<div class="b2w2-mini-row"><span style="color:var(--text3)">\uB2E4\uC74C</span><span style="color:#dc2626">${((ze=de[1].p)==null?void 0:ze.name)||"-"} ${de[1].wrDelta}%p</span></div>`:""}
              </div>
      ...
      <article class="b2w2-highlight-card" style="--hc-top:#16a34a">
        ...
        ${k?`
          <div style="display:flex;align-items:center;justify-content:space-between;gap:12px">
            <div>
              <div style="font-size:18px;font-weight:950;color:var(--text1);cursor:pointer" onclick="openPlayerModal('${((Ie=(Ce=k.p)==null?void 0:Ce.name)==null?void 0:Ie.replace(/\\/g,"\\\\").replace(/'/g,"\\'"))||""}')">${((je=k.p)==null?void 0:je.name)||"-"}</div>
              <div style="font-size:12px;color:var(--text3);margin-top:4px">${String(((Fe=k.p)==null?void 0:Fe.univ)||"\uBB34\uC18C\uC18D")}</div>
            </div>
            <span class="b2w2-note-chip" style="border-color:#bbf7d0;color:#16a34a;background:#f0fdf4">${k.winRate}%</span>
          </div>
          <div class="b2w2-highlight-list">
            <div class="b2w2-highlight-row"><span style="font-size:11px;color:var(--text3)">\uC804\uC801</span><strong style="font-size:12px;color:var(--text1)">${k.total}\uC804 ${k.wins}\uC2B9 ${k.losses}\uD328</strong></div>
          </div>
          ${fe.length>1?`
      ...
      <article class="b2w2-highlight-card" style="--hc-top:#2563eb">
        ...
        ${G?`
          <div style="display:flex;align-items:center;justify-content:space-between;gap:12px">
            <div>
              <div style="font-size:18px;font-weight:950;color:var(--text1);cursor:pointer" onclick="openPlayerModal('${((Ne=(Ee=G.p)==null?void 0:Ee.name)==null?void 0:Ne.replace(/\\/g,"\\\\").replace(/'/g,"\\'"))||""}')">${((Ue=G.p)==null?void 0:Ue.name)||"-"}</div>
              <div style="font-size:12px;color:var(--text3);margin-top:4px">${String(((Ve=G.p)==null?void 0:Ve.univ)||"\uBB34\uC18C\uC18D")}</div>
            </div>
      ...
      <article class="b2w2-highlight-card" style="--hc-top:#7c3aed">
        ...
        ${z?`
          <div style="display:flex;align-items:center;justify-content:space-between;gap:12px">
            <div>
              <div style="font-size:18px;font-weight:950;color:var(--text1);cursor:pointer" onclick="openPlayerModal('${((Le=(Ge=z.p)==null?void 0:Ge.name)==null?void 0:Le.replace(/\\/g,"\\\\").replace(/'/g,"\\'"))||""}')">${((Ke=z.p)==null?void 0:Ke.name)||"-"}</div>
              <div style="font-size:12px;color:var(--text3);margin-top:4px">${String(((Ae=z.p)==null?void 0:Ae.univ)||"\uBB34\uC18C\uC18D")}</div>
            </div>
            <span class="b2w2-note-chip" style="border-color:#ddd6fe;color:#7c3aed;background:#f5f3ff">${z.total}\uC804</span>
          </div>
          <div class="b2w2-highlight-list">
            <div class="b2w2-highlight-row"><span style="font-size:11px;color:var(--text3)">\uC804\uCCB4 \uC804\uC801</span><strong style="font-size:12px;color:var(--text1)">${z.wins}\uC2B9 ${z.losses}\uD328 \xB7 ${(Oe=z.winRate)!=null?Oe:"-"}%</strong></div>
            ${z.offWins+z.offLosses>0?`<div class="b2w2-highlight-row"><span style="font-size:11px;color:var(--text3)">\uACF5\uC2DD\uC804</span><strong style="font-size:12px;color:var(--text1)">${z.offWins+z.offLosses}\uC804</strong></div>`:""}
          </div>
          ${xe.length>1?`
          <div class="b2w2-highlight-list" style="margin-top:4px;padding-top:8px;border-top:1px dashed rgba(148,163,184,.25)">
    ...
    </section>`;const Rt=e=>{if(!e.length)return'<div class="b2w2-highlight-desc">\uC6D4\uAC04 \uB300\uD559 \uC21C\uC704\uB97C \uACC4\uC0B0\uD560 \uAE30\uB85D\uC774 \uC5C6\uC2B5\uB2C8\uB2E4.</div>';const t=a=>{var D;const c=(typeof gc=="function"?gc(a.u.name):"#64748b")||"#64748b",l=a.rankDelta===null?"new":a.rankDelta>0?"up":a.rankDelta<0?"down":"same",b=a.rankDelta===null?"NEW":a.rankDelta>0?`\u25B2${a.rankDelta}`:a.rankDelta<0?`\u25BC${Math.abs(a.rankDelta)}`:"\uC720\uC9C0";return`
              <div class="b2w2-rank-row">
                <div class="b2w2-rank-main">
                  <span class="b2w2-rank-badge" style="background:${c}18;color:${c}">${a.rank}</span>
                  <div style="min-width:0">
                    <div class="b2w2-rank-name">${a.u.name}</div>
                    <div class="b2w2-rank-sub">
                      <span>${a.tw}\uC2B9 ${a.tl}\uD328</span>
                      <span>\uC2B9\uB960 ${(D=a.wr)!=null?D:0}%</span>
                      <span>${a.tg}\uC804</span>
                    </div>
                  </div>
                </div>
      ...
      `:""}`},Tt=e=>{if(!e.length)return'<div class="b2w2-highlight-desc">\uB300\uD559\uBCC4 \uC5D0\uC774\uC2A4\uB97C \uBF51\uC744 \uC218 \uC788\uB294 \uAE30\uB85D\uC774 \uC5C6\uC2B5\uB2C8\uB2E4.</div>';const t=a=>{var D,T,U,V,K,ee,A,g,O,te;const c=(typeof gc=="function"?gc(a.u.name):"#64748b")||"#64748b",l=a.ace;if(!l)return`
              <div class="b2w2-ace-empty">
                <div class="b2w2-ace-head" style="margin-bottom:0">
                  <div class="b2w2-ace-univ">
                    <span class="b2w2-ace-dot" style="background:${c}"></span>
                    <span class="b2w2-ace-univ-name">${a.u.name}</span>
                  </div>
                  <span class="b2w2-ace-rank">${a.rank}\uC704 \uB300\uD559</span>
                </div>
                ...
                <div class="b2w2-ace-player">
                  <div style="min-width:0">
                    ...
                    <div class="b2w2-ace-player-sub">
                      ...
                      <span style="color:${((A=l.winRate)!=null?A:0)>=60?"var(--green)":((g=l.winRate)!=null?g:0)>=50?"var(--b2w-accent)":"var(--gray)"}">\uC2B9\uB960 ${(O=l.winRate)!=null?O:0}%</span>
                      <span>\uC21C\uC2B9 +${(te=l.netWins)!=null?te:0}</span>
                      <span>${l.total}\uC804</span>
                    </div>
                  </div>
                  <div style="display:flex;align-items:center;gap:3px;flex-shrink:0">${_b2WeeklyForm(l.hist)}</div>
                </div>
                <div class="b2w2-ace-badges">
                  <span class="b2w2-ace-badge" style="background:${b.badgeBg};color:${b.badgeCol};border-color:${b.badgeBorder}">${b.label}</span>
      ...
      `:""}`};f&&W==="\uC804\uCCB4"&&(m+=`<section class="b2w2-monthly-grid">
        <article class="b2w2-highlight-card">
          ...
          <div class="b2w2-highlight-title">${h==="thisMonth"?"\uC774\uBC88\uB2EC \uB300\uD559 \uC21C\uC704":"\uC9C0\uB09C\uB2EC \uB300\uD559 \uC21C\uC704"}</div>
        ...
        <article class="b2w2-highlight-card">
          ...
          <div class="b2w2-highlight-title">${h==="thisMonth"?"\uB300\uD559\uBCC4 \uC5D0\uC774\uC2A4":"\uC9C0\uB09C\uB2EC \uB300\uD559\uBCC4 \uC5D0\uC774\uC2A4"}</div>
      ...
      </div>`}return ge.filter(e=>e.tg>0).forEach((e,t)=>{const{u:n,active:r,tw:a,tl:c,tg:l,wr:b,raceCount:D}=e,T=(gc?gc(n.name):"#64748b")||"#64748b",U=Qe[n.name],V=U&&U.tg>0?U.wr:null,K=b===null?"":b>=60?"#10b981":b>=40?"#f59e0b":"#ef4444",ee=`b2w2-body-${t}`,A=`b2w2-ic-${t}`,g=_b2WeeklyUnivMVP(r),O=[...r].sort(($,R)=>{const v=$.total?$.wins/$.total:0,Y=R.total?R.wins/R.total:0;return v!==Y?Y-v:R.total-$.total});m+=`<div class="b2w2-card" style="border-top:3px solid ${T}">
        <div class="b2w2-card-head" onclick="(function(){
          ...
          <div class="b2w2-card-title">
            <span class="b2w2-card-dot" style="background:${T}"></span>
            <div style="min-width:0">
              <div class="b2w2-card-name">${n.name}</div>
              <div class="b2w2-card-sub">
                <span>\uD65C\uB3D9 ${r.length}\uBA85</span>
                <span>${l}\uC804 ${a}\uC2B9 ${c}\uD328</span>
                ${b!==null?`<span style="font-weight:900;color:${K}">\uC2B9\uB960 ${b}%${_b2WeeklyDelta(b,V)}</span>`:""}
              </div>
            </div>
          </div>
        ...
        <div id="${ee}" class="b2w2-card-body">
          <div class="b2w2-card-summary">
            <div class="b2w2-card-kpis">
              <div class="b2w2-card-kpi">
                ...
                <div class="b2w2-card-kpi-value">${r.length}\uBA85</div>
                <div class="b2w2-card-kpi-sub">\uC774\uBC88 \uAE30\uAC04 \uCD9C\uC804 \uC120\uC218</div>
              </div>
              <div class="b2w2-card-kpi">
                <div class="b2w2-card-kpi-label">\uD300 \uC804\uC801</div>
                <div class="b2w2-card-kpi-value">${a}<span style="color:#10b981">\uC2B9</span> ${c}<span style="color:#ef4444">\uD328</span></div>
                <div class="b2w2-card-kpi-sub">\uCD1D ${l}\uC804 \uC18C\uD654</div>
              </div>
              <div class="b2w2-card-kpi">
                <div class="b2w2-card-kpi-label">\uD300 \uC2B9\uB960</div>
                <div class="b2w2-card-kpi-value" style="color:${K}">${b!==null?`${b}%`:"-"}</div>
                <div class="b2w2-card-kpi-sub">${V!==null&&b!==null?`\uC804\uAE30 \uB300\uBE44 ${_b2WeeklyDelta(b,V)}`:"\uBE44\uAD50 \uB370\uC774\uD130 \uC5C6\uC74C"}</div>
              </div>
            </div>
            <div class="b2w2-card-spotlight">
              ${g?`
                ...
                <div class="b2w2-card-spotlight-title">
                  <span onclick="openPlayerModal(this.dataset.n);event.stopPropagation()" data-n="${g.p.name}" style="cursor:pointer;border-bottom:1.5px solid ${T}55">${g.p.name}</span>
          ...
          </div>`,m+=`<div class="b2w2-table-wrap"><table class="b2w2-tbl"><thead><tr>
        <th style="width:28px">#</th>
        <th>\uC120\uC218</th>
        <th>\uC804\uCCB4 \uC804\uC801</th>
        <th>\uACF5\uC2DD\uC804</th>
        <th>\uCD5C\uADFC \uD3FC</th>
      </tr></thead><tbody>`,O.forEach(($,R)=>{const{p:v,wins:Y,losses:Ct,total:It,winRate:ae,offWins:ue,offLosses:ye}=$,jt=ae===null?"#94a3b8":ae>=60?"#10b981":ae>=40?"#f59e0b":"#ef4444",Ft=typeof getTierBtnColor=="function"&&v.tier?getTierBtnColor(v.tier):"#64748b",Et=typeof getTierBtnTextColor=="function"&&v.tier&&getTierBtnTextColor(v.tier)||"#fff",bt=v.race==="P"?"\u{1F52E}":v.race==="T"?"\u2694\uFE0F":v.race==="Z"?"\u{1F98E}":"",Nt=R===0?"\u{1F947}":R===1?"\u{1F948}":R===2?"\u{1F949}":`${R+1}`,wt=g&&g.p===v,ke=ve[v.name]||null,Ut=ke&&ke.total>0?ke.winRate:null;m+=`<tr ${wt?'style="background:#fef9c322"':""}>
          ...
          <td>
            <span style="font-weight:900;color:var(--text1)">${It}\uC804</span>
            <span style="color:#10b981;font-size:11px"> ${Y}\uC2B9</span>
            <span style="color:#ef4444;font-size:11px"> ${Ct}\uD328</span>
            ${ae!==null?`<span style="font-size:11px;font-weight:800;color:${jt};margin-left:3px">${ae}%</span>${_b2WeeklyDelta(ae,Ut)}`:""}
          </td>
          <td>
          ...
          <td><div style="display:flex;align-items:center;gap:2px">${_b2WeeklyForm($.hist)}</div></td>
        </tr>`}),m+="</tbody></table></div>",["P","T","Z"].some($=>D[$].w+D[$].l>0)&&(m+=`<div class="b2w2-race-box">
          <div class="b2w2-race-title">\u2694\uFE0F \uC885\uC871\uBCC4 \uC0C1\uB300 \uC804\uC801 (\uB300\uD559 \uC804\uCCB4)</div>
          ${_b2WeeklyRaceStats(D)}
