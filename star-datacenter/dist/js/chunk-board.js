...
var at=Object.defineProperty,st=Object.defineProperties;var lt=Object.getOwnPropertyDescriptors;var Ve=Object.getOwnPropertySymbols;var dt=Object.prototype.hasOwnProperty,ct=Object.prototype.propertyIsEnumerable;var Ze=(e,t,r)=>t in e?at(e,t,{enumerable:!0,configurable:!0,writable:!0,value:r}):e[t]=r,Te=(e,t)=>{for(var r in t||(t={}))dt.call(t,r)&&Ze(e,r,t[r]);if(Ve)for(var r of Ve(t))ct.call(t,r)&&Ze(e,r,t[r]);return e},Ae=(e,t)=>st(e,lt(t));function _b2UnivView(){let e=_b2VisUnivs().filter(i=>i.name!=="\uBB34\uC18C\uC18D"&&i.name);if(!e.length)return'<div style="text-align:center;color:var(--text3);padding:40px">\uD45C\uC2DC\uD560 \uB300\uD559\uC774 \uC5C6\uC2B5\uB2C8\uB2E4</div>';const t=new Set((typeof univCfg!="undefined"?univCfg:[]).filter(i=>i.dissolved).map(i=>String(i.name||"").trim())),r=new Set(e.map(i=>String(i&&i.name||"").trim()).filter(Boolean)),c={},o=[];(players||[]).forEach(i=>{const $=String((i==null?void 0:i.univ)||"").trim();r.has($)&&(i.hidden||i.retired||i.hideFromBoard||t.has($)||(o.push(i),(c[$]||(c[$]=[])).push(i)))});const g={};o.forEach(i=>{const $=i.tier||"?";g[$]=(g[$]||0)+1});const{fromN:a,toN:x}=_b2ThisWeekRange(),b=_b2WeeklyAggregate(o,String(a).replace(/(\d{4})(\d{2})(\d{2})/,"$1-$2-$3"),String(x).replace(/(\d{4})(\d{2})(\d{2})/,"$1-$2-$3")),u=b.filter(i=>i.total>0).length,n=b.reduce((i,$)=>i+$.total,0),d={P:0,T:0,Z:0};o.forEach(i=>{const $=String(i.race||"").trim().toUpperCase();($==="P"||$==="T"||$==="Z")&&d[$]++});const s=d.P+d.T+d.Z,h=s>0?["T","P","Z"].map(i=>{const $={T:{cls:"race-T",label:"\uD14C\uB780"},P:{cls:"race-P",label:"\uD504\uB85C\uD1A0\uC2A4"},Z:{cls:"race-Z",label:"\uC800\uADF8"}}[i];if(!d[i])return"";const M=Math.round(d[i]/s*100);return`<button type="button" class="b2-race-badge ${$.cls}" title="${$.label} ${M}%" style="cursor:pointer" onclick="if(typeof openB2RaceTierModal==='function')openB2RaceTierModal('${i}')">${i}<span style="opacity:.75;font-size:10px;margin-left:6px">${M}%</span></button>`}).filter(Boolean).join(""):"",T=(Array.isArray(TIERS)?TIERS:[]).filter(i=>g[i]).map(i=>{const $=typeof getTierBtnColor=="function"?getTierBtnColor(i):"#64748b",M=typeof getTierBtnTextColor=="function"&&getTierBtnTextColor(i)||"#fff";return`<button type="button" class="b2-tier-badge" title="${i}\uD2F0\uC5B4 ${g[i]}\uBA85" style="cursor:pointer;background:${$};color:${M};border:1px solid ${$}55" onclick="if(typeof openB2TierUnivModal==='function')openB2TierUnivModal('${String(i).replace(/\\/g,"\\\\").replace(/'/g,"\\'")}')">${i}</button>`}).join("");try{window._b2LastAllVisPlayers=o}catch(i){}const k=e.map(i=>{if(!(c[String(i.name||"").trim()]||[]).length)return"";const M=gc(i.name),E=_b2ContrastColor(M);return`<button class="b2-jump-chip" onclick="const el=document.getElementById('${"b2-univ-anchor-"+i.name.replace(/[^a-zA-Z0-9가-힣]/g,"_")}');if(el){el.scrollIntoView({behavior:'smooth',block:'start'});}" style="--chip-color:${M}40;border:1.5px solid ${M}bb;background:linear-gradient(135deg,${M}ee,${M}cc);color:${E}"><span style="letter-spacing:-.01em">${i.name}</span></button>`}).join(""),w=_b2GetUnivProfileViewMode(),B=(i,$)=>`
    ...
    <div style="padding:14px;border-radius:22px;border:1px solid rgba(148,163,184,.18);background:linear-gradient(180deg,rgba(255,255,255,.99),rgba(248,250,252,.96));box-shadow:0 16px 28px rgba(15,23,42,.05)">
  ...
  </div>`,l=typeof boardGridCols!="undefined"&&boardGridCols===2?"repeat(2,1fr)":"1fr";let m=z+"<style>.b2-bottom-img{max-width:130px;max-height:110px;object-fit:contain;}.b2-side-panel{float:right;width:230px;margin:0 0 6px 10px;border-radius:10px;padding:8px;box-sizing:border-box;}@media(min-width:769px) and (max-width:1024px){.b2-univ-grid{grid-template-columns:1fr!important;}.b2-side-panel{width:180px;}}@media(max-width:900px){.b2-univ-grid{grid-template-columns:1fr!important;}}@media(max-width:640px){.b2-side-panel{display:none!important;}.b2-bottom-img{display:none!important;}}</style>";return m+=`<div class="b2-univ-grid" style="display:grid;grid-template-columns:${l};gap:12px;align-items:start">`,e.forEach(i=>{if(!i.name){console.warn("[\uD604\uD669\uD310] \uB300\uD559 \uC774\uB984\uC774 \uC5C6\uB294 \uB370\uC774\uD130\uAC00 \uBC1C\uACAC\uB418\uC5C8\uC2B5\uB2C8\uB2E4:",i);return}const $=c[String(i.name||"").trim()]||[],M="b2-univ-anchor-"+i.name.replace(/[^a-zA-Z0-9가-힣]/g,"_");m+=`<div id="${M}" style="scroll-margin-top:56px">`+_b2UnivBlock(i.name,gc(i.name),$)+"</div>"}),m+="</div>",m}try{window.openB2RaceTierModal||(window.openB2RaceTierModal=function(e){try{const t=Array.isArray(window._b2LastAllVisPlayers)?window._b2LastAllVisPlayers:[],r=String(e||"").trim().toUpperCase(),c=r==="P"?"\uD504\uB85C\uD1A0\uC2A4":r==="T"?"\uD14C\uB780":r==="Z"?"\uC800\uADF8":"\uC885\uC871",o=t.filter(n=>String((n==null?void 0:n.race)||"").trim().toUpperCase()===r),g=Array.isArray(window.TIERS)&&window.TIERS.length?window.TIERS.slice():["S","A","B","C","D","E","F","?"],a={},x={};if(o.forEach(n=>{const d=String((n==null?void 0:n.tier)||"?"),s=String((n==null?void 0:n.univ)||"\uBB34\uC18C\uC18D");a[d]=(a[d]||0)+1,x[s]=(x[s]||0)+1}),window._b2RaceTierState=window._b2RaceTierState||{},window._b2RaceTierState.race=r,window._b2RaceTierState.tier=window._b2RaceTierState.tier||"ALL",window._b2RaceTierState.univ=window._b2RaceTierState.univ||"ALL",window._b2RaceTierState.list=o,window._b2RaceTierState.counts=a,window._b2RaceTierState.univCounts=x,window._b2RaceTierState.tiers=g,window._b2RaceTierState.label=c,!document.getElementById("b2RaceTierStyle")){const n=document.createElement("style");n.id="b2RaceTierStyle",n.textContent=`
      ...
      `,F.addEventListener("click",Z=>{Z.target===F&&F.remove()}),document.body.appendChild(F)};const r=_b2VisUnivs().filter(v=>v.name);if(!r.length)return'<div style="text-align:center;color:var(--text3);padding:40px">\uD45C\uC2DC\uD560 \uB300\uD559\uC774 \uC5C6\uC2B5\uB2C8\uB2E4</div>';typeof univCfg!="undefined"&&univCfg.length?r.sort((v,f)=>{const S=univCfg.findIndex(U=>U.name===v.name),I=univCfg.findIndex(U=>U.name===f.name);return(S>=0?S:999)-(I>=0?I:999)}):r.sort((v,f)=>(v.name||"").localeCompare(f.name||"","ko",{sensitivity:"base"}));const c=new Set((typeof univCfg!="undefined"?univCfg:[]).filter(v=>v.dissolved).map(v=>String(v.name||"").trim())),o={};r.forEach(v=>{o[v.name]=players.filter(f=>String((f==null?void 0:f.univ)||"").trim()===String(v.name||"").trim()&&!f.hidden&&!f.retired&&!f.hideFromBoard&&!c.has(String((f==null?void 0:f.univ)||"").trim()))});const g=Math.max(60,Math.min(520,parseInt(t.logoSize||150,10)||150)),a=Math.max(-120,Math.min(120,parseInt((we=t.logoOffsetX)!=null?we:0,10)||0)),x=Math.max(-120,Math.min(120,parseInt(($e=t.logoOffsetY)!=null?$e:0,10)||0)),b=Math.max(-120,Math.min(120,parseInt((_e=t.titleOffsetX)!=null?_e:0,10)||0)),u=Math.max(-120,Math.min(120,parseInt((ce=t.titleOffsetY)!=null?ce:0,10)||0)),n=Math.max(0,Math.min(70,parseInt((pe=t.bgOverlay)!=null?pe:0,10))),d=n/70*.22,s=n/70*.52,h=Math.max(16,Math.min(44,parseInt(t.titleSize||28,10)||28)),T=Math.max(28,Math.min(160,parseInt(t.playerImgSize||64,10)||64)),k={sharp:"0px",roundedsm:"6px",square:"10px",roundedlg:"22px",roundedxl:"34px",circle:"50%"}[t.playerImgShape]||"10px",w=Math.max(2,Math.min(12,parseInt(t.rowsPerCol||5,10)||5)),B=Math.max(80,Math.min(360,parseInt(t.colWidth||170,10)||170)),z=Math.max(0,Math.min(28,parseInt(t.colGap||10,10)||10)),l=10,m=Math.max(0,Math.min(120,parseInt(t.univGap||18,10)||18)),i=Math.max(10,Math.min(18,parseInt(t.countFontSize||12,10)||12)),$=Math.max(0,Math.min(40,parseInt(t.contentPadX||16,10)||16)),M=t.contentAlign==="left"||t.contentAlign==="center"?t.contentAlign:"left",E=Math.max(-40,Math.min(40,parseInt(t.contentOffsetX||0,10)||0)),A=Math.max(0,Math.min(80,parseInt(t.headGap||10,10)||10)),H=!(t.autoLayout===0||t.autoLayout===!1),_=typeof window!="undefined"&&(document.documentElement.clientWidth||window.innerWidth)||1280,L=Math.max(0,Math.min(80,$+E)),C=Math.max(0,Math.min(80,$-E));function j(v){let f=5;v>=55?f=9:v>=45?f=8:v>=35?f=7:v>=25?f=6:f=5;let S=175;return _<=520?(f=Math.max(f,8),S=150):_<=768?(f=Math.max(f,7),S=160):_<=1024?(f=Math.max(f,6),S=170):S=v>=45?160:175,f=Math.max(4,Math.min(12,f)),S=Math.max(130,Math.min(220,S)),{rowsPerCol:f,colWidth:S}}const D=Math.max(10,Math.min(24,parseInt(t.subtitleSize||12,10)||12)),N=[400,500,600,700,800,900].includes(parseInt(t.subtitleWeight||800,10))?parseInt(t.subtitleWeight||800,10):800,J=typeof t.subtitleColor=="string"?t.subtitleColor:"",me=Math.max(10,Math.min(28,parseInt(t.nameFontSize||16,10)||16)),oe=Math.max(9,Math.min(16,parseInt(t.roleFontSize||10,10)||10)),re=Math.max(9,Math.min(16,parseInt(t.tierBadgeSize||10,10)||10)),ne=Math.max(4,Math.min(12,parseInt(t.tierBadgePadX||6,10)||6)),ve=Math.max(10,Math.min(28,parseInt(t.starSize||15,10)||15)),ee=(()=>{switch(t.titleFont){case"app":return"var(--app-font)";case"noto":return"'Noto Sans KR', system-ui, -apple-system, 'Segoe UI', Roboto, Arial, sans-serif";case"pretendard":return"'Pretendard Variable', Pretendard, system-ui, -apple-system, 'Segoe UI', Roboto, Arial, sans-serif";case"nanum":return"'Nanum Gothic', 'Noto Sans KR', system-ui, -apple-system, 'Segoe UI', Roboto, Arial, sans-serif";case"gmarket":return"'GmarketSans', 'Noto Sans KR', system-ui, -apple-system, 'Segoe UI', Roboto, Arial, sans-serif";default:return"system-ui, -apple-system, 'Segoe UI', Roboto, Arial, sans-serif"}})();(function(){const v=document.head||document.getElementsByTagName("head")[0];if(!v)return;const f=(U,p)=>{if(!p){const R=document.getElementById(U);R&&R.remove();return}let y=document.getElementById(U);y||(y=document.createElement("link"),y.id=U,y.rel="stylesheet",v.appendChild(y)),y.href=p},S={noto:"https://fonts.googleapis.com/css2?family=Noto+Sans+KR:wght@400;700;900&display=swap",pretendard:"https://cdn.jsdelivr.net/gh/orioncactus/pretendard@latest/dist/web/variable/pretendardvariable.css",nanum:"https://fonts.googleapis.com/css2?family=Nanum+Gothic:wght@400;700;800&display=swap",gmarket:"https://cdn.jsdelivr.net/gh/projectnoonnu/noonfonts_2001@1.1/GmarketSans.css"},I=t.titleFont;f("femco-titlefont-css",S[I]||"")})();const ae=v=>{const f=v.tier||"",S=typeof TIERS!="undefined"&&TIERS.includes(f)?TIERS.indexOf(f):999;return S>=0?S:999},he=v=>{const f=(v.role||"").trim(),I=["\uC774\uC0AC\uC7A5","\uCD1D\uC7A5","\uAD50\uC218","\uCF54\uCE58"].indexOf(f);return I>=0?I:99},se=v=>v.race==="P"?"P":v.race==="T"?"T":v.race==="Z"?"Z":"?",le=v=>{const f=String(v||"").replace("#","").trim();if(f.length<6)return null;const S=parseInt(f.slice(0,2),16),I=parseInt(f.slice(2,4),16),U=parseInt(f.slice(4,6),16);return[S,I,U].some(p=>Number.isNaN(p))?null:{r:S,g:I,b:U}},X=(v,f,S)=>"#"+[v,f,S].map(I=>Math.max(0,Math.min(255,Math.round(I))).toString(16).padStart(2,"0")).join(""),te=(v,f,S)=>{const I=le(v),U=le(f);if(!I||!U)return v||f||"#94a3b8";const p=Math.max(0,Math.min(1,+S||0));return X(I.r*(1-p)+U.r*p,I.g*(1-p)+U.g*p,I.b*(1-p)+U.b*p)},ye=v=>{const f=le(v);if(!f)return 0;const S=y=>(y/=255,y<=.03928?y/12.92:Math.pow((y+.055)/1.055,2.4)),I=S(f.r),U=S(f.g),p=S(f.b);return .2126*I+.7152*U+.0722*p},ie=(v,f)=>{const S=ye(v),I=ye(f),U=Math.max(S,I),p=Math.min(S,I);return(U+.05)/(p+.05)},ze=(v,f=3)=>{let S=v||"#94a3b8";if(ie(S,"#ffffff")>=f)return S;const I=[.25,.4,.55,.7];for(const U of I){const p=te(S,"#0f172a",U);if(ie(p,"#ffffff")>=f)return p}return te(S,"#0f172a",.75)},Me=(v,f)=>{const S=v.race==="P"?"#c084fc":v.race==="T"?"#38bdf8":v.race==="Z"?"#34d399":"#94a3b8",I=f?te(S,f,.22):S;return ze(I,3)};function Ie(v,f){var y;const S=v&&v.photo?String(v.photo):"",I=v&&v.name?String(v.name).slice(0,1):"?",U=`${f}55`;let p="";try{const R=getStatusIcon(v.name),F=getStatusIconHTML(v.name),q=T,Z=parseInt((y=t.statusIconSize)!=null?y:18,10),P=Z===0?0:Math.max(10,Math.min(36,Z||Math.round(q*.38))),Se=R&&(typeof _siIsImg=="function"?_siIsImg(R):!1),Le=Se?`<img src="${R}" style="width:${P}px;height:${P}px;border-radius:50%;object-fit:cover;opacity:.86" onerror="this.style.display='none'">`:F?F.replace(/margin-left:[^;]+;/g,"").replace(/font-size:[^;]+;/g,""):"",ke=Se?"rgba(255,255,255,.72)":"transparent",Oe=-Math.round(P*.26),K=-Math.round(P*.26);p=F?`<span style="position:absolute;top:${Oe}px;left:${K}px;width:${P}px;height:${P}px;border-radius:50%;background:${ke};overflow:hidden;display:flex;align-items:center;justify-content:center;font-size:${Math.round(P*.82)}px;line-height:1;filter:drop-shadow(0 1px 2px rgba(0,0,0,.65))">${Le}</span>`:""}catch(R){console.warn("[femcoAvatarSquare] \uC0C1\uD0DC \uC544\uC774\uCF58 \uC0DD\uC131 \uC2E4\uD328:",R.message)}return S?`<span style="position:relative;display:block;width:100%;height:100%">
        ...
        ${p}
      </span>`:`<div style="position:relative;width:100%;height:100%;border-radius:inherit;background:${f};display:flex;align-items:center;justify-content:center;font-weight:1000;font-size:22px;color:#fff;border:2px solid ${U}">${I}${p}</div>`}let de=`
    <style>
  ...
  `;return r.forEach(v=>{var We;const f=v.name,S=o[f]||[];if(!S.length)return;const U=(t.univColorOverrides||{})[f]||gc(f),p=_b2ContrastColor(U),y=(typeof univCfg!="undefined"?univCfg.find(O=>O.name===f):null)||{},R=(()=>{const O=parseInt(y.logoSizeFemco||"",10);return!isNaN(O)&&O>0?Math.max(60,Math.min(520,O)):g})(),F=y.icon||y.img||"",q=F?`<img src="${toHttpsUrl(F)}" style="width:${R}px;height:${R}px;object-fit:contain" onerror="this.style.display='none'">`:`<span style="display:inline-flex;align-items:center;justify-content:center;width:${Math.round(R*.62)}px;height:${Math.round(R*.62)}px;opacity:.85;font-size:${Math.round(R*.48)}px;line-height:1">\u{1F3EB}</span>`,Z=S.filter(O=>(O.role||"").trim()==="\uC774\uC0AC\uC7A5").length,P=S.filter(O=>["\uAD50\uC218","\uCF54\uCE58"].includes((O.role||"").trim())).length,Se=Math.max(0,S.length-Z-P),Le=[...S].sort((O,V)=>{const G=he(O),fe=he(V);if(G!==fe)return G-fe;const xe=ae(O),ue=ae(V);return xe!==ue?xe-ue:(O.name||"").localeCompare(V.name||"","ko",{sensitivity:"base"})}),ke=((t.univSubtitles||{})[f]||"").trim(),Oe=J&&J.trim()?J:p,K=(t.univBgMedia||{})[f]||"",W=(function(){const O={url:"",alpha:30,sizeMode:"cover",sizeVal:90,pos:"center",repeat:"no-repeat",ox:0,oy:0};return K?typeof K=="string"?Ae(Te({},O),{url:String(K).trim()}):typeof K=="object"?Ae(Te(Te({},O),K),{url:String(K.url||"").trim()}):O:O})(),Y=(W.url||"").trim(),Ue=Y.toLowerCase(),Re=Y&&/\.(png|jpe?g|webp|gif)(\?|#|$)/i.test(Ue),Be=Y&&/\.(mp4|webm|ogg)(\?|#|$)/i.test(Ue),Ce=Y&&/(youtube\.com|youtu\.be|twitch\.tv)/i.test(Ue),Pe=Be||Ce||Y&&!Re?`<button class="b2-femco-pill no-export" style="cursor:pointer" onclick="_b2FemcoOpenBgMedia('${f.replace(/'/g,"\\'")}', '${Y.replace(/'/g,"\\'")}');event.stopPropagation();">${Be?"\u{1F39E}\uFE0F \uBC30\uACBD\uC601\uC0C1":Ce?"\u{1F517} \uBC30\uACBD\uB9C1\uD06C":"\u{1F5BC}\uFE0F \uBC30\uACBD\uB9C1\uD06C"}</button>`:"",Fe=t.logoPos||"top",Q=["left","right","top","bottom","center"].includes(Fe)?Fe:"top",He=!!((We=t.logoAttachTitle)==null||We),Ne=t.titlePos||"bottom",je=["left","right","top","bottom"].includes(Ne)?Ne:"bottom",Xe=(y.championships||0)>0?`<span class="b2-femco-stars">${"<span>\u2B50</span>".repeat(y.championships)}</span>`:"",ge=`
    ...
    `,Ye=(()=>{if(He)return"";const O=$;return Q==="left"?`position:absolute;left:${O}px;top:50%;transform:translateY(-50%) translate(${a}px,${x}px);`:Q==="right"?`position:absolute;right:${O}px;top:50%;transform:translateY(-50%) translate(${a}px,${x}px);`:Q==="bottom"?`position:absolute;left:50%;bottom:10px;transform:translateX(-50%) translate(${a}px,${x}px);`:`position:absolute;left:50%;top:10px;transform:translateX(-50%) translate(${a}px,${x}px);`})(),Je=(()=>{if(!He){const G=Math.max(0,Math.round(R*.55)+16);return`
      ...
      <section class="b2-femco-univ" style="position:relative;overflow:hidden;background:${U};">
        ${rt}${nt}
        <div class="b2-femco-head" style="position:relative;z-index:2;color:${p};padding-left:${L}px;padding-right:${C}px">
          <div class="b2-femco-countbox" style="color:${p};left:${L}px;${p==="#ffffff"?"text-shadow:0 1px 2px rgba(0,0,0,.45);":""}">
            <div>\uCD1D ${S.length}</div>
            <div>\uC774\uC0AC\uC7A5 ${Z}</div>
            <div>\uAD50\uC218+\uCF54\uCE58 ${P}</div>
            <div>\uD559\uC0DD ${Se}</div>
          ...
          <div class="b2-femco-grid" style="--rowsPerCol:${Ge.rowsPerCol};--colWidth:${Ge.colWidth}px">
            ${Le.map(O=>{const V=(O.name||"").replace(/'/g,"\\'"),G=O.tier||"?",fe=G&&G!=="?"&&typeof getTierBtnColor=="function"?getTierBtnColor(G):"#64748b",xe=G&&G!=="?"&&(typeof getTierBtnTextColor=="function"?getTierBtnTextColor(G):"#fff")||"#fff",ue=(O.role||"").trim(),Ee=Me(O,U);return`
                <div class="b2-femco-item" onclick="openPlayerModal('${V}');event.stopPropagation();">
                  ...
                  <div class="b2-femco-text" style="${O.inactive?"opacity:.65":""};color:${p}">
                    ...
                    <div><span class="b2-femco-race-pill" style="color:${Ee};border-color:${Ee}88;background:${p==="#ffffff"?"rgba(0,0,0,.28)":"rgba(255,255,255,.92)"};box-shadow:0 1px 2px rgba(0,0,0,.18)">${se(O)}</span></div>
                  </div>
                </div>
              `}).join("")}
          </div>
...
`+(a.message||"\uC54C \uC218 \uC5C6\uB294 \uC624\uB958\uAC00 \uBC1C\uC0DD\uD588\uC2B5\uB2C8\uB2E4."))}finally{document.body.removeChild(r),t&&(t.disabled=!1,t.textContent="\u{1F4BE} \uC804\uCCB4 \uC800\uC7A5")}}function _b2UnivBlock(e,t,r,c=!1){var U;if(!e)return`<div style="border-radius:14px;border:2px dashed #ccc55;padding:16px 18px;background:#f5f5f5;display:flex;align-items:center;gap:10px;opacity:.7">
    ...
    </div>`;const w=r.filter(p=>_B2_ROLE_ORDER.includes(p.role||""));w.sort((p,y)=>_b2RoleRank(p)-_b2RoleRank(y));const B=r.filter(p=>!_B2_ROLE_ORDER.includes(p.role||"")),z={};B.forEach(p=>{const y=p.tier||"?";z[y]||(z[y]=[]),z[y].push(p)});const l=TIERS.filter(p=>z[p]).concat(Object.keys(z).filter(p=>!TIERS.includes(p))),m=o.memo||"",i=(o.memoImgs||[]).concat(o.memoImg?[o.memoImg]:[]),$=!!(m||i.length),M=(p,y,R)=>`
    <div data-b2-univ-row="1" style="display:flex;align-items:stretch;gap:0;margin-bottom:8px">
      <div style="background:${b}!important;min-width:70px;width:70px;display:flex;align-items:center;justify-content:center;padding:10px 6px;flex-shrink:0;border-radius:16px 0 0 16px;border:1px solid ${t}33;border-right:none;box-shadow:inset 0 1px 0 rgba(255,255,255,.28)">
        <span style="font-size:11px;font-weight:900;color:${t};text-align:center;line-height:1.35;word-break:keep-all;letter-spacing:-.01em">${p}</span>
      </div>
      <div style="flex:1;background:${s};padding:10px 12px;border-radius:0 16px 16px 0;border:1px solid ${T};box-shadow:${k}">
        ${R}
      </div>
    </div>`,E={},A=[];w.forEach(p=>{const y=p.role||"";E[y]||(E[y]=[],A.push(y)),E[y].push(p)});const H=o.bgImgPos||"center center",_=o.bgImgSize||"auto",L=((U=o.bgImgAlpha)!=null?U:b2BgImgAlpha)/100,C=(u?Math.max(.64,L+.08):L).toFixed(2),j=String(e||"").trim(),D=j.toUpperCase(),N=(()=>{const p={wmGlobalOn:1,wmOn:1,wmScale:150,wmRight:120,wmBottom:30,bgScale:100};try{const y=String(localStorage.getItem("su_b2_univ_logo_overlay_v1")||"").trim(),R=y?JSON.parse(y)||{}:{},F=R&&R.default&&typeof R.default=="object"?R.default:{},q=R&&R.perUniv&&typeof R.perUniv=="object"?R.perUniv:{},Z=j&&q&&q[j]&&typeof q[j]=="object"?q[j]:{},P=Object.assign({},p,F,Z);return P.wmGlobalOn=P.wmGlobalOn==null||Number(P.wmGlobalOn)?1:0,P.wmOn=P.wmOn==null||Number(P.wmOn)?1:0,P.wmScale=Math.max(50,Math.min(250,parseInt(P.wmScale||150,10)||150)),P.wmRight=Math.max(0,Math.min(260,parseInt(P.wmRight||120,10)||120)),P.wmBottom=Math.max(0,Math.min(160,parseInt(P.wmBottom||30,10)||30)),P.bgScale=Math.max(60,Math.min(120,parseInt(P.bgScale||100,10)||100)),P}catch(y){return p}})(),J=["\uB287\uCE90\uC2AC","\uB274\uCEA3\uC2AC","\uCE84\uBAAC\uC2A4\uD0C0\uC988","\uCF00\uC774\uB300","\uC5E0\uBE44\uB300","\uC640\uD50C\uB300","\uC218\uC220\uB300","\uD751\uCE74\uB370\uBBF8"],me=j.includes("\uBAAC\uC2A4\uD0C0")||D.includes("MONSTAR"),oe=D==="HM"||D==="DM"||D==="SSG"||D==="JSA"||D==="BGM"||J.includes(j)||me,re="44% 50%",ne=(()=>{const p=D==="JSA"||D==="BGM"||J.includes(j)||me;return D==="JSA"||j==="\uD751\uCE74\uB370\uBBF8"?"min(72%,620px) auto":j==="\uC218\uC220\uB300"||j==="\uC5E0\uBE44\uB300"||j==="\uCF00\uC774\uB300"?"min(84%,740px) auto":p?"min(78%,680px) auto":"min(86%,760px) auto"})(),ve=(()=>{const p=(N.bgScale||100)/100;if(p===1)return ne;const y=String(ne||"").match(/min\(\s*(\d+)\s*%\s*,\s*(\d+)\s*px\s*\)/i);if(!y)return ne;const R=Math.max(10,Math.min(100,Math.round(parseInt(y[1],10)*p))),F=Math.max(80,Math.min(1200,Math.round(parseInt(y[2],10)*p)));return`min(${R}%,${F}px) auto`})(),ee=oe?String(Math.min(.48,parseFloat(C)||.48).toFixed(2)):C,ae=_b2GetUnivProfileViewMode(),he=o.bgImg?c?oe?`<img src="${o.bgImg}" crossorigin="anonymous" style="position:absolute;left:50%;top:50%;transform:translate(-50%,-50%);width:${ve.replace(" auto","")};max-width:760px;max-height:78%;height:auto;object-fit:contain;object-position:${re};opacity:${ee};pointer-events:none;z-index:0" onerror="this.style.display='none'">`:`<img src="${o.bgImg}" crossorigin="anonymous" class="b2-fit-auto" data-fit-kind="bg" data-fit-mode="${_}" style="position:absolute;inset:0;width:100%;height:100%;object-fit:${_==="auto"?"cover":_};object-position:${H};opacity:${ee};pointer-events:none;z-index:0" onload="_b2ApplyBgAutoSizing(this)">`:oe?`<div class="b2-bg-layer" data-bg-src="${String(o.bgImg).replace(/"/g,"&quot;")}" data-bg-pos="${re}" style="position:absolute;inset:0;opacity:${ee};pointer-events:none;z-index:0;background-position:${re};background-size:${ve};background-repeat:no-repeat"></div>`:`<div class="b2-bg-layer" data-bg-src="${String(o.bgImg).replace(/"/g,"&quot;")}" data-bg-pos="${String(H).replace(/"/g,"&quot;")}" data-bg-size-mode="${_}" style="position:absolute;inset:0;opacity:${ee};pointer-events:none;z-index:0;background-position:${H};background-size:${_==="auto"?"cover":_};background-repeat:no-repeat"></div>`:"";let se="";A.forEach(p=>{const y=E[p],R=_b2RenderUnivGroupCards(y,t,!0,ae);se+=M(p,!0,R)}),l.forEach(p=>{const y=z[p];y.sort((F,q)=>(F.name||"").localeCompare(q.name||"","ko",{sensitivity:"base"}));const R=_b2RenderUnivGroupCards(y,t,!1,ae);se+=M(p,!1,R)});const le=$?`<div style="margin-top:10px;background:${h};padding:12px;box-sizing:border-box;overflow:hidden;border-radius:18px;border:1px solid ${d};box-shadow:0 14px 26px rgba(15,23,42,.06)">
    <div style="font-size:11px;font-weight:900;color:${t};margin-bottom:${i.length||m?"10px":"0"}">\uC0AC\uC774\uB4DC \uBA54\uBAA8</div>
    ${i.map((p,y)=>`<img src="${p}" style="width:100%;max-width:260px;border-radius:12px;${y<i.length-1||m?"margin-bottom:8px;":""}display:block;object-fit:contain;border:1px solid rgba(148,163,184,.14);background:#fff" onerror="this.style.display='none'">`).join("")}
    ${m?`<div style="font-size:11px;color:#334155;white-space:pre-wrap;line-height:1.65;margin-top:${i.length?"8px":"0"}">${m}</div>`:""}
  </div>`:"",X=(()=>{const p=String(e||"").trim(),y=p.toUpperCase();return y==="HM"||y==="DM"||y==="SSG"?{pct:20,max:148,op1:".34",op0:".24"}:y==="JSA"||p==="\uD751\uCE74\uB370\uBBF8"?{pct:22,max:160,op1:".36",op0:".26",right:66,bottom:28}:y==="JSA"||y==="BGM"||J.includes(p)||p.includes("\uBAAC\uC2A4\uD0C0")||y.includes("MONSTAR")?{pct:26,max:182,op1:".36",op0:".26",right:46,bottom:28}:{pct:22,max:160,op1:".36",op0:".26"}})(),te=(N.wmScale||100)/100,ye=Math.max(6,Math.min(60,Math.round(X.pct*te))),ie=Math.max(60,Math.min(520,Math.round(X.max*te))),ze=typeof X.right=="number"?X.right:18,Me=typeof X.bottom=="number"?X.bottom:22,Ie=typeof N.wmRight=="number"?N.wmRight:ze,de=typeof N.wmBottom=="number"?N.wmBottom:Me,we=Math.round(ie*.7),$e=(N.wmGlobalOn==null?!0:!!Number(N.wmGlobalOn))&&(N.wmOn==null?!0:!!Number(N.wmOn)),_e=`<div class="b2-bg-host" style="position:relative;overflow:hidden;background:${u?"transparent":"linear-gradient(180deg,rgba(255,255,255,.92),rgba(248,250,252,.82))"}">
    ${he}
  ...
  </div>`,ce=String(o.createdAt||o.created||o.createDate||o.since||o.startDate||"").trim(),pe=(()=>{if(!ce)return"";const p=String(ce).trim();let y=p.match(/^(\d{4})[.\-\/](\d{2})[.\-\/](\d{2})/);return y||(y=p.match(/^(\d{4})(\d{2})(\d{2})/)),y?`${y[1]}.${y[2]}.${y[3]}`:p.slice(0,10)})(),v=o.bMemo||"",f=(o.bMemoImgs||[]).concat(o.bMemoImg?[o.bMemoImg]:[]),S=f.map(p=>`<img class="b2-bottom-img" src="${p}" style="border-radius:12px;display:inline-block;border:1px solid rgba(148,163,184,.14);background:#fff" onerror="this.style.display='none'">`).join(""),I=v||f.length?`<div style="padding:14px 16px 16px;background:${u?"linear-gradient(180deg,rgba(255,255,255,.28),rgba(248,250,252,.14))":"linear-gradient(180deg,rgba(255,255,255,.92),rgba(248,250,252,.86))"};border-top:1px solid rgba(148,163,184,.16)">
    ...
    </div>`}function _b2FreeView(){const e=new Set((typeof univCfg!="undefined"?univCfg:[]).filter(_=>_.dissolved).map(_=>String(_.name||"").trim())),t=players.filter(_=>{const L=String((_==null?void 0:_.univ)||"").trim();return(!L||L==="\uBB34\uC18C\uC18D"||e.has(L))&&!_.hidden&&!_.retired&&!_.hideFromBoard});if(!t.length)return'<div style="text-align:center;color:var(--text3);padding:40px">\uBB34\uC18C\uC18D \uBA64\uBC84\uAC00 \uC5C6\uC2B5\uB2C8\uB2E4</div>';const r=t.filter(_=>_B2_ROLE_ORDER.includes(_.role||""));r.sort((_,L)=>_b2RoleRank(_)-_b2RoleRank(L));const c=t.filter(_=>!_B2_ROLE_ORDER.includes(_.role||"")),o={};c.forEach(_=>{const L=_.tier||"?";o[L]||(o[L]=[]),o[L].push(_)});const g=TIERS.filter(_=>o[_]).concat(Object.keys(o).filter(_=>!TIERS.includes(_))),a=new Date,x=a.getDay(),b=new Date(a);b.setDate(a.getDate()+(x===0?-6:1-x));const u=parseInt(b.toISOString().slice(0,10).replace(/-/g,"")),n=parseInt(a.toISOString().slice(0,10).replace(/-/g,"")),d=_=>parseInt(String(_||"").replace(/[-\.]/g,""))||0;let s=0,h=0,T=0,k=0,w=0;c.forEach(_=>{let L=!1;(Array.isArray(_.history)?_.history:[]).forEach(C=>{C.result==="\uC2B9"?s++:C.result==="\uD328"&&h++;const j=d(C.date||C.d||"");j>=u&&j<=n&&(C.result==="\uC2B9"?T++:C.result==="\uD328"&&k++,L=!0)}),L&&w++});const B=s+h,z=B>0?Math.round(s/B*100):null,l=z===null?"#94a3b8":z>=60?"#10b981":z>=40?"#f59e0b":"#ef4444",m=T+k,i={P:0,T:0,Z:0,"?":0};c.forEach(_=>{const L=_.race||"?";i[L in i?L:"?"]++});const $=c.length||1,M="#64748b",E=_b2GetFreeViewMode(),A=(_,L)=>`
    ...
    <div style="display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:8px;margin-bottom:10px">
      <div style="padding:10px 11px;border-radius:14px;background:${c}12;border:1px solid ${c}22"><div style="font-size:10px;font-weight:900;color:var(--text3)">\uC9C1\uCC45\uC790</div><div style="margin-top:5px;font-size:18px;font-weight:1000;color:${c}">${g.length}</div></div>
...
`+(n.message||"\uC54C \uC218 \uC5C6\uB294 \uC624\uB958\uAC00 \uBC1C\uC0DD\uD588\uC2B5\uB2C8\uB2E4."))}finally{document.body.removeChild(a),r&&(r.disabled=!1,r.textContent="\u{1F4F7} \uC774\uBBF8\uC9C0\uC800\uC7A5")}}function _b2PastelBg(e,t){const{r,g:c,b:o}=typeof _hexToRgbObj=="function"?_hexToRgbObj(e):{r:100,g:116,b:139},g=typeof t=="number"?t:.1,a=x=>Math.round(255*(1-g)+x*g);return`rgb(${a(r)},${a(c)},${a(o)})`}function _b2GetUnivProfileViewMode(){try{const e=String(localStorage.getItem("su_b2_univ_profile_view")||"").trim();return e==="card"?"poster":e==="compact"||e==="media"||e==="board"||e==="split"?"rank":["default","poster","rank","glass","table"].includes(e)?e:"default"}catch(e){return"default"}}function _b2SetUnivProfileViewMode(e){const t=["default","poster","rank","glass","table"].includes(String(e||""))?String(e):"default";try{localStorage.setItem("su_b2_univ_profile_view",t)}catch(r){}typeof render=="function"&&render()}function _b2UnivRankRow(e,t,r,c){const o=(e.name||"").replace(/'/g,"\\'"),g=e.photo?toHttpsUrl(e.photo):"",a=e.race&&e.race!=="N"?e.race:"?",x={T:"#2563eb",P:"#d97706",Z:"#7c3aed"}[e.race]||"#475569",b=r&&(e.tier||e.role)||"",u=e.tier&&typeof getTierBtnColor=="function"?getTierBtnColor(e.tier):t,n=e.tier&&typeof getTierBtnTextColor=="function"&&getTierBtnTextColor(e.tier)||"#fff",d=Number(e.win||0),s=Number(e.loss||0),h=d+s,T=h?Math.round(d/h*100):null,k=T==null?"#94a3b8":T>=50?"#16a34a":"#dc2626",w=h?`${d}\uC2B9 ${s}\uD328`:"\uAE30\uB85D \uC5C6\uC74C";return`
    ...
    <div style="position:relative;width:122px;max-width:100%;aspect-ratio:.78;${a}overflow:hidden;border:1px solid rgba(255,255,255,.16);background:#0b1120;box-shadow:0 10px 20px rgba(15,23,42,.12);cursor:pointer" onclick="openPlayerModal('${c}')">
      ${d}
      ${s}
    ...
    </div>`}function _b2UnivDefaultTag(e,t,r){const c=(e.name||"").replace(/'/g,"\\'"),o=e.crewName&&typeof _gcCrew=="function"&&_gcCrew(e.crewName)||"";return`
