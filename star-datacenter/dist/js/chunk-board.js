  ...
  `:"",weeklyBtn=_b2TabBtn2("weekly","#f59e0b",typeof getTabLabel=="function"?getTabLabel("board2","weekly","\u{1F4C5} \uBE0C\uB9AC\uD551"):"\u{1F4C5} \uBE0C\uB9AC\uD551"),oldBtn=isLoggedIn?_b2TabBtn2("old","#64748b",typeof getTabLabel=="function"?getTabLabel("board2","old","\u{1F4CA} \uAD6C\uD604\uD669\uD310"):"\u{1F4CA} \uAD6C\uD604\uD669\uD310"):"",summaryBtn=_b2TabBtn2("summary","#10b981",typeof getTabLabel=="function"?getTabLabel("board2","summary","\u{1F4CA} \uC694\uC57D"):"\u{1F4CA} \uC694\uC57D"),rankingBtn=_b2TabBtn2("ranking","#f97316",typeof getTabLabel=="function"?getTabLabel("board2","ranking","\u{1F947} \uB7AD\uD0B9"):"\u{1F947} \uB7AD\uD0B9"),heatmapBtn=_b2TabBtn2("heatmap","#db2777",typeof getTabLabel=="function"?getTabLabel("board2","heatmap","\u{1F5FA}\uFE0F \uD788\uD2B8\uB9F5"):"\u{1F5FA}\uFE0F \uD788\uD2B8\uB9F5"),bubbleBtn=_b2TabBtn2("bubble","#0891b2",typeof getTabLabel=="function"?getTabLabel("board2","bubble","\u{1F310} \uBC84\uBE14\uB9F5"):"\u{1F310} \uBC84\uBE14\uB9F5"),_b2TabDefs=[{id:"weekly",label:typeof getTabLabel=="function"?getTabLabel("board2","weekly","\u{1F4C5} \uBE0C\uB9AC\uD551"):"\u{1F4C5} \uBE0C\uB9AC\uD551"},{id:"live",label:typeof getTabLabel=="function"?getTabLabel("board2","live","\u{1F4FA} \uB77C\uC774\uBE0C"):"\u{1F4FA} \uB77C\uC774\uBE0C"},{id:"lineup",label:typeof getTabLabel=="function"?getTabLabel("board2","lineup","\u{1F3BD} \uB77C\uC778\uC5C5"):"\u{1F3BD} \uB77C\uC778\uC5C5"},{id:"univ",label:typeof getTabLabel=="function"?getTabLabel("board2","univ","\u{1F3DF}\uFE0F \uB300\uD559\uBCC4"):"\u{1F3DF}\uFE0F \uB300\uD559\uBCC4"},{id:"femco",label:typeof getTabLabel=="function"?getTabLabel("board2","femco","\u{1F9E9} \uD3A8\uCF54"):"\u{1F9E9} \uD3A8\uCF54"},{id:"free",label:typeof getTabLabel=="function"?getTabLabel("board2","free","\u{1F6B6} \uBB34\uC18C\uC18D"):"\u{1F6B6} \uBB34\uC18C\uC18D"},{id:"players",label:typeof getTabLabel=="function"?getTabLabel("board2","players",profileTabLabel):profileTabLabel},{id:"heatmap",label:typeof getTabLabel=="function"?getTabLabel("board2","heatmap","\u{1F5FA}\uFE0F \uD788\uD2B8\uB9F5"):"\u{1F5FA}\uFE0F \uD788\uD2B8\uB9F5"},{id:"bubble",label:typeof getTabLabel=="function"?getTabLabel("board2","bubble","\u{1F310} \uBC84\uBE14\uB9F5"):"\u{1F310} \uBC84\uBE14\uB9F5"},{id:"summary",label:typeof getTabLabel=="function"?getTabLabel("board2","summary","\u{1F4CA} \uC694\uC57D"):"\u{1F4CA} \uC694\uC57D"}];isLoggedIn&&_b2TabDefs.push({id:"old",label:typeof getTabLabel=="function"?getTabLabel("board2","old","\u{1F4CA} \uAD6C\uD604\uD669\uD310"):"\u{1F4CA} \uAD6C\uD604\uD669\uD310"}),window._b2TabPopoverItems=_b2TabDefs.map(it=>({id:it.id,label:it.label,action:`_b2View='${it.id}';render()`,active:_b2View===it.id}));const _b2TabMobileTrigger=`<button type="button" class="mode-select-trigger mode-select-trigger--block" onclick="_toggleModePopover(this,'\uD604\uD669\uD310 \uD654\uBA74 \uC120\uD0DD',window._b2TabPopoverItems)">
    ...
    <div class="b2-shell">
      ...
      <div class="b2-toolbar-card">
        ...
        ${weeklyBtn}
        ${_b2TabBtn2("live","#e11d48",typeof getTabLabel=="function"?getTabLabel("board2","live","\u{1F4FA} \uB77C\uC774\uBE0C"):"\u{1F4FA} \uB77C\uC774\uBE0C")}
...
function _b2UnivBlock(univName,col,members,forExport=!1){var _a;if(!univName)return`<div style="border-radius:14px;border:2px dashed #ccc55;padding:16px 18px;background:#f5f5f5;display:flex;align-items:center;gap:10px;opacity:.7">
    ...
    <div style="background:linear-gradient(180deg,rgba(255,255,255,.96),rgba(248,250,252,.90));padding:16px">`;if(_fvMode==="stat"){let _statHtml="";roledFree.length&&(_statHtml+=`<div style="display:flex;align-items:center;gap:8px;margin:0 0 10px;padding-bottom:6px;border-bottom:2px solid ${defCol}33">
...
/* board2-live-view.js */
var _b2LiveUnivFilter="\uC804\uCCB4",_b2LiveTierFilter="\uC804\uCCB4",_b2LiveSearch="",_b2LiveSortMode=(()=>{try{return localStorage.getItem("su_b2_live_sort")||"tier"}catch(e){return"tier"}})(),_b2LiveCardSize=(()=>{try{const s=localStorage.getItem("su_b2_live_card_size");return["s","m","l"].includes(s)?s:"m"}catch(e){return"m"}})(),_b2LiveObserver=null,_b2LiveStatusCache={},_b2LivePollTimer=null,_b2LivePollInFlight=!1,_b2LivePollIntervalMs=45e3,_b2LiveHoverOpenTimer=null,_b2LiveHoverCloseTimer=null,_b2LiveHoverOpenId="",_b2LiveHoverOpenName="";function _b2LiveSoopId(input){const s=String(input||"").trim();if(!s)return"";try{const u=new URL(s,window.location.href),host=(u.hostname||"").toLowerCase();if(host.includes("sooplive.co.kr")||host.includes("sooplive.com")||host.includes("afreecatv.com")){const m=(u.pathname||"").match(/^\/([^\/]+)/);return m?m[1]:""}}catch(e){}return""}function _b2LiveEmbedUrl(id){return id?`https://play.sooplive.co.kr/${id}/embed?mute=y&showChat=false`:""}function _b2LiveSetSort(mode){_b2LiveSortMode=["tier","name","univ"].includes(mode)?mode:"tier";try{localStorage.setItem("su_b2_live_sort",_b2LiveSortMode)}catch(e){}const el=document.getElementById("b2-content");el&&(el.innerHTML=_b2LiveView(),typeof injectUnivIcons=="function"&&injectUnivIcons(el))}function _b2LiveSetCardSize(size){_b2LiveCardSize=["s","m","l"].includes(size)?size:"m";try{localStorage.setItem("su_b2_live_card_size",_b2LiveCardSize)}catch(e){}const el=document.getElementById("b2-content");el&&(el.innerHTML=_b2LiveView(),typeof injectUnivIcons=="function"&&injectUnivIcons(el))}function _b2LiveInitObservers(container){try{if(!container)return;if(_b2LiveObserver){try{_b2LiveObserver.disconnect()}catch(e){}_b2LiveObserver=null}const boxes=container.querySelectorAll(".b2-live-frame-box[data-src]");if(!boxes.length)return;if(!window.IntersectionObserver){boxes.forEach(b=>{const f=b.querySelector("iframe");f&&!f.src&&(f.src=b.dataset.src)});return}_b2LiveObserver=new IntersectionObserver(entries=>{entries.forEach(entry=>{if(!entry.isIntersecting)return;const box=entry.target,f=box.querySelector("iframe");f&&!f.src&&(f.src=box.dataset.src),_b2LiveObserver.unobserve(box)})},{root:null,rootMargin:"200px 0px",threshold:.01}),boxes.forEach(b=>_b2LiveObserver.observe(b))}catch(e){}}function _b2LiveEnlarge(id,name){try{if(!id)return;let ov=document.getElementById("b2LiveEnlargeOverlay");ov||(ov=document.createElement("div"),ov.id="b2LiveEnlargeOverlay",ov.className="su-modal-overlay",document.body.appendChild(ov)),ov.style.display="flex",ov.innerHTML=`
    ...
    `,ov.onclick=e=>{e.target===ov&&(ov.style.display="none",ov.innerHTML="")}}catch(e){}}function _b2LiveCanHoverPreview(){try{if(window.matchMedia&&window.matchMedia("(hover: none)").matches)return!1}catch(e){}return!0}function _b2LiveEnsureHoverOverlay(){let ov=document.getElementById("b2LiveHoverOverlay");return ov||(ov=document.createElement("div"),ov.id="b2LiveHoverOverlay",ov.className="su-modal-overlay",ov.style.display="none",ov.addEventListener("mousedown",e=>{try{e.target===ov&&_b2LiveHideHoverPreview(!0)}catch(_){}}),ov.addEventListener("mouseenter",()=>{try{clearTimeout(_b2LiveHoverCloseTimer)}catch(e){}}),ov.addEventListener("mouseleave",()=>{_b2LiveHoverLeave()}),document.body.appendChild(ov),ov)}function _b2LiveShowHoverPreview(anchorEl,id,name){try{if(!_b2LiveCanHoverPreview()||!anchorEl||!id)return;const ov=_b2LiveEnsureHoverOverlay(),safeName=String(name||"").replace(/'/g,"\\'");_b2LiveHoverOpenId=String(id||""),_b2LiveHoverOpenName=String(name||""),ov.style.display="flex",ov.innerHTML=`
    ...
    `;try{const modal=ov.querySelector(".su-modal");modal&&!modal.dataset.boundHover&&(modal.dataset.boundHover="1",modal.addEventListener("mouseenter",()=>{try{clearTimeout(_b2LiveHoverCloseTimer)}catch(e){}}),modal.addEventListener("mouseleave",()=>{_b2LiveHoverLeave()}))}catch(e){}}catch(e){}}function _b2LiveHideHoverPreview(immediate){try{clearTimeout(_b2LiveHoverOpenTimer),clearTimeout(_b2LiveHoverCloseTimer);const ov=document.getElementById("b2LiveHoverOverlay");if(!ov)return;const close=()=>{ov.style.display="none",ov.innerHTML="",_b2LiveHoverOpenId="",_b2LiveHoverOpenName=""};immediate?close():_b2LiveHoverCloseTimer=setTimeout(close,180)}catch(e){}}function _b2LiveHoverEnter(anchorEl,id,name){try{clearTimeout(_b2LiveHoverCloseTimer),clearTimeout(_b2LiveHoverOpenTimer),_b2LiveHoverOpenTimer=setTimeout(()=>_b2LiveShowHoverPreview(anchorEl,id,name),140)}catch(e){}}function _b2LiveHoverLeave(e){try{const ov=document.getElementById("b2LiveHoverOverlay"),related=e&&e.relatedTarget;if(ov&&related&&ov.contains(related))return}catch(_){}_b2LiveHideHoverPreview(!1)}async function _b2LiveFetchStatus(ids){if(!ids||!ids.length)return{};try{const res=await fetch("/api/soop-live-status",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({ids})});if(!res.ok)return{};const data=await res.json().catch(()=>null);return data&&data.results||{}}catch(e){return{}}}function _b2LiveApplyStatusToDom(container){if(!container)return;const cards=container.querySelectorAll(".b2-live-card[data-soop-id]");let liveCount=0;cards.forEach(card=>{const id=card.getAttribute("data-soop-id"),st=_b2LiveStatusCache[id],badge=card.querySelector(".b2-live-badge"),avatarBadge=card.querySelector(".b2-live-preview-badge");st&&st.live?(liveCount++,badge&&(badge.style.display="inline-flex"),avatarBadge&&(avatarBadge.style.display="inline-flex"),card.classList.add("is-live")):(badge&&(badge.style.display="none"),avatarBadge&&(avatarBadge.style.display="none"),card.classList.remove("is-live"))});const counter=document.getElementById("b2-live-count-badge");counter&&(counter.textContent=`\u{1F534} \uB77C\uC774\uBE0C ${liveCount}\uBA85`)}async function _b2LivePoll(){if(_b2LivePollInFlight)return;const container=document.getElementById("b2-content"),cards=container?container.querySelectorAll(".b2-live-card[data-soop-id]"):null;if(!container||!cards||!cards.length){_b2LiveStopPoll();return}const ids=Array.from(cards).map(c=>c.getAttribute("data-soop-id")).filter(Boolean);_b2LivePollInFlight=!0;try{const results=await _b2LiveFetchStatus(ids),now=Date.now();Object.keys(results).forEach(id=>{_b2LiveStatusCache[id]=Object.assign({ts:now},results[id])});const stillLive=document.getElementById("b2-content");stillLive&&stillLive.querySelector(".b2-live-card[data-soop-id]")&&_b2LiveApplyStatusToDom(stillLive)}finally{_b2LivePollInFlight=!1}}function _b2LiveStartPoll(){_b2LiveStopPoll(),_b2LivePoll(),_b2LivePollTimer=setInterval(_b2LivePoll,_b2LivePollIntervalMs)}function _b2LiveStopPoll(){_b2LivePollTimer&&(clearInterval(_b2LivePollTimer),_b2LivePollTimer=null)}function _b2LiveView(){const soopPlayers=(typeof players!="undefined"?players:[]).filter(p=>p.hidden||p.retired||p.hideFromBoard||String((p==null?void 0:p.univ)||"").trim()==="YB"?!1:!!_b2LiveSoopId(p.channelUrl)).map(p=>Object.assign({_soopId:_b2LiveSoopId(p.channelUrl)},p)),univList=[...new Set(soopPlayers.map(p=>String((p==null?void 0:p.univ)||"").trim()).filter(Boolean))];typeof univCfg!="undefined"?univList.sort((a,b)=>{const idxA=univCfg.findIndex(u=>u.name===a),idxB=univCfg.findIndex(u=>u.name===b);return(idxA>=0?idxA:999)-(idxB>=0?idxB:999)}):univList.sort();const univFiltered=_b2LiveUnivFilter==="\uC804\uCCB4"?soopPlayers:soopPlayers.filter(p=>String((p==null?void 0:p.univ)||"").trim()===_b2LiveUnivFilter),tierFiltered0=_b2LiveTierFilter==="\uC804\uCCB4"?univFiltered:univFiltered.filter(p=>p.tier===_b2LiveTierFilter),q=String(_b2LiveSearch||"").trim().toLowerCase(),searched=q?tierFiltered0.filter(p=>String(p.name||"").toLowerCase().includes(q)):tierFiltered0,tierOrder=typeof TIERS!="undefined"?TIERS:[],univOrder=typeof univCfg!="undefined"?univCfg.map(u=>u.name):[],tierFiltered=searched.slice().sort((a,b)=>{if(_b2LiveSortMode==="name")return String(a.name||"").localeCompare(String(b.name||""),"ko");if(_b2LiveSortMode==="univ"){const ia=univOrder.indexOf(a.univ),ib=univOrder.indexOf(b.univ),ra=ia>=0?ia:999,rb=ib>=0?ib:999;return ra!==rb?ra-rb:String(a.name||"").localeCompare(String(b.name||""),"ko")}const idxA=tierOrder.indexOf(a.tier),idxB=tierOrder.indexOf(b.tier),rankA=idxA>=0?idxA:999,rankB=idxB>=0?idxB:999;return rankA!==rankB?rankA-rankB:String(a.name||"").localeCompare(String(b.name||""),"ko")}),liveFiltered=tierFiltered,sizeCfgMap={s:{min:130,avatar:34,stacked:!0,fullImage:!0,pad:"0",nameFs:"11px",tagFs:"8.5px",gap:8,radius:16},m:{min:226,avatar:56,stacked:!1,fullImage:!1,pad:"12px 13px",nameFs:"12.5px",tagFs:"9px",gap:11,radius:14,ring:3},l:{min:306,avatar:80,stacked:!1,fullImage:!1,pad:"16px 16px 14px",nameFs:"15px",tagFs:"10.5px",gap:14,radius:18,ring:4,labeled:!0}},sizeCfg=sizeCfgMap[_b2LiveCardSize]||sizeCfgMap.m,cardMinPx=sizeCfg.min,sizeIconPx={s:8,m:11,l:14},sizeBtn=(v,label)=>`<button type="button" class="b2-toolbar-btn b2-size-btn" onclick="_b2LiveSetCardSize('${v}')" title="${label==="S"?"\uC791\uAC8C":label==="M"?"\uBCF4\uD1B5":"\uD06C\uAC8C"}"
    style="display:inline-flex;align-items:center;gap:5px;padding:4px 10px;border-radius:8px;border:1px solid ${_b2LiveCardSize===v?"#2563eb":"var(--border2)"};background:${_b2LiveCardSize===v?"linear-gradient(135deg,#eff6ff,#dbeafe)":"var(--white)"};color:${_b2LiveCardSize===v?"#1d4ed8":"var(--text2)"};font-size:var(--fs-sm);font-weight:${_b2LiveCardSize===v?900:700};cursor:pointer;margin-bottom:0">
      <span style="display:inline-block;width:${sizeIconPx[v]}px;height:${sizeIconPx[v]}px;border-radius:3px;background:currentColor;opacity:.85;flex-shrink:0"></span>${label}
    </button>`,filterBar=`
    <style>
      @keyframes b2LivePulse { 0%,100%{opacity:1} 50%{opacity:.35} }
      .b2-live-card{ transition:box-shadow .18s ease,border-color .18s ease,transform .18s ease; }
      .b2-live-card:hover{ box-shadow:0 10px 24px rgba(15,23,42,.10); border-color:var(--border-strong,var(--border2)); transform:translateY(-2px); }
      .b2-live-card.is-live{ border-color:rgba(220,38,38,.45); box-shadow:0 0 0 1px rgba(220,38,38,.14) inset; }
      .b2-live-card.is-live:hover{ box-shadow:0 0 0 1px rgba(220,38,38,.18) inset,0 10px 24px rgba(220,38,38,.14); }
      .b2-live-icon-btn{ transition:background .15s ease,border-color .15s ease,transform .15s ease; }
      .b2-live-icon-btn:hover{ background:var(--gray-bg,#f1f5f9); border-color:#94a3b8; transform:scale(1.08); }
      .b2-live-icon-btn:active{ transform:scale(.96); }
      .b2-live-glass-btn:hover{ background:rgba(17,24,39,.68) !important; border-color:rgba(255,255,255,.55) !important; }
      .b2-live-avatar-btn{ transition:transform .15s ease,box-shadow .15s ease; }
      .b2-live-avatar-btn:hover{ transform:scale(1.05); box-shadow:0 8px 18px rgba(15,23,42,.16); }
      .b2-live-photo-wrap img{ transition:transform .4s ease; }
      .b2-live-photo-wrap:hover img{ transform:scale(1.06); }
      .b2-size-btn{ transition:transform .12s ease; }
      .b2-size-btn:active{ transform:scale(.94); }
    </style>
  ...
  `;if(!soopPlayers.length)return`
      ...
      <div style="padding:60px 20px;text-align:center;color:var(--gray-l)">
        ...
        <div style="font-weight:700">\uD574\uB2F9 \uC870\uAC74\uC5D0 \uB9DE\uB294 \uC2A4\uD2B8\uB9AC\uBA38\uAC00 \uC5C6\uC2B5\uB2C8\uB2E4</div>
         ...
         <span style="display:none;width:100%;height:100%;align-items:center;justify-content:center;background:${univColor}18;color:${univColor};font-size:18px;font-weight:1000">${safeNameHtml.slice(0,1)||"?"}</span>`:`<span style="width:100%;height:100%;display:flex;align-items:center;justify-content:center;background:${univColor}18;color:${univColor};font-size:18px;font-weight:1000">${safeNameHtml.slice(0,1)||"?"}</span>`;let groupHeader="";if(showTierGroups){const tk=p.tier||"__none__";if(tk!==_lastTierKey){const isFirst=_lastTierKey===void 0;_lastTierKey=tk;const label=p.tier?typeof getTierLabel=="function"?getTierLabel(p.tier):p.tier:"\uBBF8\uC9C0\uC815";groupHeader=`
          ...
          </div>`}}const isS=sizeCfg.fullImage,isL=!!sizeCfg.labeled,enlargeBtn=`<button type="button" class="b2-live-icon-btn" onclick="_b2LiveEnlarge('${p._soopId}','${safeName}')" title="\uD655\uB300\uBCF4\uAE30"
            style="width:30px;height:30px;border-radius:50%;border:1px solid var(--border2);background:var(--white);color:var(--text2);font-size:13px;cursor:pointer;line-height:1;padding:0;flex-shrink:0;display:inline-flex;align-items:center;justify-content:center">\u26F6</button>`,linkBtn=`<a href="https://ch.sooplive.co.kr/${p._soopId}" target="_blank" rel="noopener" class="b2-live-icon-btn"
            style="width:30px;height:30px;border-radius:50%;border:1px solid var(--border2);background:var(--white);font-size:13px;text-decoration:none;flex-shrink:0;display:inline-flex;align-items:center;justify-content:center" title="SOOP \uCC44\uB110\uB85C \uC774\uB3D9">\u{1F517}</a>`,enlargeBtnLabeled=`<button type="button" class="b2-live-icon-btn" onclick="_b2LiveEnlarge('${p._soopId}','${safeName}')"
            style="display:inline-flex;align-items:center;gap:5px;padding:6px 12px;border-radius:9px;border:1px solid var(--border2);background:var(--white);color:var(--text2);font-size:11.5px;font-weight:800;cursor:pointer">\u26F6 \uD655\uB300\uBCF4\uAE30</button>`,linkBtnLabeled=`<a href="https://ch.sooplive.co.kr/${p._soopId}" target="_blank" rel="noopener" class="b2-live-icon-btn"
            style="display:inline-flex;align-items:center;gap:5px;padding:6px 12px;border-radius:9px;border:1px solid var(--border2);background:var(--white);color:var(--text2);font-size:11.5px;font-weight:800;text-decoration:none;cursor:pointer">\u{1F517} \uCC44\uB110 \uC774\uB3D9</a>`,enlargeBtnOnPhoto=`<button type="button" class="b2-live-icon-btn b2-live-glass-btn" onclick="_b2LiveEnlarge('${p._soopId}','${safeName}')" title="\uD655\uB300\uBCF4\uAE30"
            style="width:22px;height:22px;border-radius:50%;border:1px solid rgba(255,255,255,.4);background:rgba(17,24,39,.42);backdrop-filter:blur(3px);-webkit-backdrop-filter:blur(3px);color:#fff;font-size:11px;cursor:pointer;line-height:1;padding:0;flex-shrink:0;display:inline-flex;align-items:center;justify-content:center">\u26F6</button>`,linkBtnOnPhoto=`<a href="https://ch.sooplive.co.kr/${p._soopId}" target="_blank" rel="noopener" class="b2-live-icon-btn b2-live-glass-btn" title="SOOP \uCC44\uB110\uB85C \uC774\uB3D9"
            style="width:22px;height:22px;border-radius:50%;border:1px solid rgba(255,255,255,.4);background:rgba(17,24,39,.42);backdrop-filter:blur(3px);-webkit-backdrop-filter:blur(3px);color:#fff;font-size:11px;text-decoration:none;flex-shrink:0;display:inline-flex;align-items:center;justify-content:center">\u{1F517}</a>`,ringShadow=sizeCfg.ring?`0 0 0 ${sizeCfg.ring}px ${tierBg}2e,`:"",avatarBlock=`
      <div style="position:relative;flex-shrink:0" onmouseenter="_b2LiveHoverEnter(this,'${p._soopId}','${safeName}')" onmouseleave="_b2LiveHoverLeave(event)">
        <button type="button" class="b2-live-avatar-btn" onclick="openPlayerModal&&openPlayerModal('${safeName}')" title="${badgeInitDisplay==="inline-flex"?"\uC120\uC218 \uC0C1\uC138 \xB7 \uB9C8\uC6B0\uC2A4 \uC62C\uB9AC\uBA74 \uB77C\uC774\uBE0C \uBBF8\uB9AC\uBCF4\uAE30":"\uC120\uC218 \uC0C1\uC138"}"
          style="width:${sizeCfg.avatar}px;height:${sizeCfg.avatar}px;padding:0;border:1px solid var(--border2);border-radius:var(--su_profile_radius,50%);clip-path:var(--su_profile_clip,none);overflow:hidden;background:var(--white);cursor:pointer;box-shadow:${ringShadow}0 4px 12px rgba(15,23,42,.08)">
          ${avatarHtml}
        </button>
      ...
      </div>`,nameHtml=`<span style="font-weight:900;font-size:${sizeCfg.nameFs};cursor:pointer;min-width:0;overflow:hidden;text-overflow:ellipsis;white-space:nowrap" onclick="openPlayerModal&&openPlayerModal('${safeName}')">${p.name||""}</span>`,univTag=p.univ?`<span style="font-size:${sizeCfg.tagFs};font-weight:800;padding:1px 7px;border-radius:999px;background:${univColor}1a;color:${univColor};white-space:nowrap">${p.univ}</span>`:"",tierTag=p.tier?`<span style="font-size:${sizeCfg.tagFs};font-weight:800;padding:1px 7px;border-radius:999px;background:${tierBg};color:${tierFg};white-space:nowrap">${typeof getTierLabel=="function"?getTierLabel(p.tier):p.tier}</span>`:"",cardBody=isS?`
        <div class="b2-live-photo-wrap" style="position:relative;width:100%;aspect-ratio:3/4;background:${univColor}12;overflow:hidden"
          onmouseenter="_b2LiveHoverEnter(this,'${p._soopId}','${safeName}')" onmouseleave="_b2LiveHoverLeave(event)">
          ${photoUrl?`<img src="${photoUrl}" alt="${safeNameHtml}" loading="lazy" decoding="async" style="width:100%;height:100%;object-fit:cover;display:block;cursor:pointer" onclick="openPlayerModal&&openPlayerModal('${safeName}')" onerror="this.style.display='none';this.nextElementSibling.style.display='flex'">
               <span style="display:none;width:100%;height:100%;align-items:center;justify-content:center;background:${univColor}18;color:${univColor};font-size:38px;font-weight:1000;cursor:pointer" onclick="openPlayerModal&&openPlayerModal('${safeName}')">${safeNameHtml.slice(0,1)||"?"}</span>`:`<span style="width:100%;height:100%;display:flex;align-items:center;justify-content:center;background:${univColor}18;color:${univColor};font-size:38px;font-weight:1000;cursor:pointer" onclick="openPlayerModal&&openPlayerModal('${safeName}')">${safeNameHtml.slice(0,1)||"?"}</span>`}
          <div style="position:absolute;top:0;left:0;right:0;height:3px;background:${tierBg};z-index:2;pointer-events:none"></div>
          ...
          <div style="position:absolute;top:9px;right:8px;display:flex;gap:5px;z-index:2">${enlargeBtnOnPhoto}${linkBtnOnPhoto}</div>
          <span class="b2-live-preview-badge" title="\uB9C8\uC6B0\uC2A4\uB97C \uC62C\uB9AC\uBA74 \uB77C\uC774\uBE0C \uBBF8\uB9AC\uBCF4\uAE30"
            style="display:${badgeInitDisplay};align-items:center;gap:3px;position:absolute;top:9px;left:8px;padding:2px 7px;border:1px solid rgba(255,255,255,.9);border-radius:999px;background:#dc2626;color:#fff;font-size:9px;font-weight:900;letter-spacing:.2px;line-height:1.4;box-shadow:0 2px 6px rgba(220,38,38,.35);pointer-events:none;z-index:2">
            <span style="width:4px;height:4px;border-radius:50%;background:#fff;animation:b2LivePulse 1.4s infinite"></span>LIVE
          </span>
        ...
        <div style="display:flex;gap:12px;align-items:flex-start">
          ${avatarBlock}
          <div style="display:flex;flex-direction:column;gap:8px;min-width:0;flex:1;padding-top:3px">
            <div style="min-width:0">${nameHtml}</div>
            <div style="display:flex;gap:5px;flex-wrap:wrap">${univTag}${tierTag}</div>
            <div style="display:flex;gap:6px;margin-top:3px;flex-wrap:wrap">${enlargeBtnLabeled}${linkBtnLabeled}</div>
          </div>
        </div>`:`
        <div style="display:flex;align-items:center;gap:11px">
          ...
          <div style="display:flex;flex-direction:column;gap:5px;flex-shrink:0">${enlargeBtn}${linkBtn}</div>
        </div>`,cardWash=isS?"":`background:linear-gradient(135deg,${univColor}0c,var(--white) 62%);`;return groupHeader+`
      <div class="b2-live-card" data-soop-id="${p._soopId}" style="position:relative;${cardWash||"background:var(--white);"}border:1.5px solid var(--border2);border-radius:${sizeCfg.radius}px;overflow:hidden;padding:${sizeCfg.pad}">
        ${cardBody}
      </div>
    `}).join("");return setTimeout(()=>{try{const el=document.getElementById("b2-content");_b2LiveApplyStatusToDom(el),_b2LiveStartPoll()}catch(e){}},0),filterBar+`
