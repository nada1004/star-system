...
(function _pqInjectCSS() {
  ...
  s.textContent = [
    ...
    '.pq-desc{margin-top:4px;font-size:var(--fs-sm);line-height:1.6;color:var(--text3);max-width:440px}',
    '.pq-stats{display:grid;grid-template-columns:repeat(auto-fit,minmax(84px,1fr));gap:8px;margin-top:16px}',
    '.pq-stat{display:flex;align-items:center;gap:9px;padding:10px 12px;border-radius:var(--r2);background:rgba(255,255,255,.9);border:1px solid rgba(148,163,184,.16);box-shadow:0 8px 16px rgba(15,23,42,.05);min-width:0}',
    '.pq-stat-icon{flex:none;width:30px;height:30px;border-radius:var(--r);display:flex;align-items:center;justify-content:center;font-size:var(--fs-md);background:#f1f5f9}',
    '.pq-stat-meta{display:flex;flex-direction:column;min-width:0;line-height:1.25}',
    '.pq-stat-val{font-size:var(--fs-md);font-weight:950;color:var(--text1);white-space:nowrap;overflow:hidden;text-overflow:ellipsis}',
    ...
    '.pq-section-label{margin-top:16px;font-size:var(--fs-caption);font-weight:900;color:var(--text3);letter-spacing:.02em}',
    '.pq-actions{display:flex;gap:8px;margin-top:16px;flex-wrap:wrap}',
    '.pq-btn{padding:11px 18px;border-radius:14px;border:1px solid rgba(148,163,184,.22);background:linear-gradient(180deg,#fff,#f8fafc);color:var(--text2);font-size:var(--fs-base);font-weight:900;cursor:pointer;box-shadow:0 10px 18px rgba(15,23,42,.05);font-family:inherit;transition:.12s;white-space:nowrap}',
    ...
    '.pq-hint-btn{padding:9px 16px;border-radius:14px;border:1px dashed rgba(148,163,184,.4);background:rgba(248,250,252,.9);color:var(--text2);font-size:var(--fs-sm);font-weight:900;cursor:pointer;font-family:inherit;transition:.12s}',
    ...
    '.pq-tool-btn{padding:9px 14px;border-radius:14px;border:1px solid rgba(148,163,184,.24);background:linear-gradient(180deg,#fff,#f8fafc);color:var(--text2);font-size:var(--fs-sm);font-weight:900;cursor:pointer;font-family:inherit;transition:.12s}',
    ...
    '.pq-tries-left{font-size:var(--fs-caption);font-weight:800;color:var(--text3)}',
    '.pq-status{width:100%;max-width:420px;display:flex;align-items:center;gap:8px;padding:11px 14px;border-radius:14px;font-size:var(--fs-sm);font-weight:800;line-height:1.5}',
    ...
    '.pq-opt{padding:14px 10px;border-radius:var(--r2);border:1px solid rgba(148,163,184,.22);background:linear-gradient(180deg,#fff,#f8fafc);color:var(--text1);font-size:14px;font-weight:800;cursor:pointer;font-family:inherit;transition:.12s;text-align:center;box-shadow:0 6px 14px rgba(15,23,42,.05)}',
    ...
    '.pq-result-sub{font-size:var(--fs-sm);color:var(--text3)}',
    '.pq-empty-note{font-size:var(--fs-sm);color:#b45309;background:#fffbeb;border:1px solid #fde68a;border-radius:12px;padding:12px 14px;margin-top:14px;line-height:1.6}',
    '.pq-mode-bar{display:flex;gap:6px;flex-wrap:wrap;margin-top:12px}',
    '.pq-mode-pill{padding:7px 12px;border-radius:999px;border:1px solid rgba(148,163,184,.22);background:linear-gradient(180deg,#fff,#f8fafc);color:var(--text2);font-size:var(--fs-sm);font-weight:800;cursor:pointer;font-family:inherit;transition:.12s;white-space:nowrap}',
    ...
    '.pq-type-submit{padding:12px 18px;border-radius:14px;border:none;background:linear-gradient(135deg,#60a5fa,#3b82f6 52%,#6366f1);color:#fff;font-size:var(--fs-base);font-weight:900;cursor:pointer;font-family:inherit;box-shadow:0 6px 0 #1e3a8a,0 12px 20px rgba(59,130,246,.22);white-space:nowrap}',
    '.pq-type-submit:disabled{opacity:.5;cursor:default}',
    '.pq-type-hint{font-size:var(--fs-caption);color:var(--text3);width:100%;max-width:420px;text-align:center}',
    ...
    '@media (max-width:520px){.pq-card{padding:16px 14px 16px}.pq-stats{grid-template-columns:repeat(2,1fr)}.pq-icon-badge{width:38px;height:38px;font-size:var(--fs-lg)}.pq-title{font-size:var(--fs-md)}}',
  ].join('');
